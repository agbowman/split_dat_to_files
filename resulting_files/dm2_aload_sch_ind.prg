CREATE PROGRAM dm2_aload_sch_ind
 ...
 SUBROUTINE dac_load_cload(lc_pkg_in)
   ...
   ENDIF
 END ;Subroutine
 IF (check_logfile("dm2_aload_sch_ind",".log","dm2_aload_sch_ind")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_aload_sch_ind"
 CALL disp_msg(" ",dm_err->logfile,0)
 ...
 IF (dac_pop_coldic_rec("DM_AFD_INDEXES")=0)
  GO TO exit_program
 ENDIF
 IF ((dm_err->debug_flag > 0))
  SET dm_err->eproc = "Determining maintenance type for DM_AFD_INDEXES."
  CALL disp_msg(" ",dm_err->logfile,0)
 ENDIF
 SELECT INTO "nl:"
 ...
 SELECT INTO "nl:"
  ...
  PLAN (d
   ...
   WHERE dai.owner=dat.owner
    ...
    AND dai.table_name=dat.table_name)
...
#exit_program
 IF ((dm_err->err_ind=0))
  SET dm_err->eproc = "Dm2_aload_sch_ind completed"
 ENDIF
 CALL final_disp_msg("dm2_aload_sch_ind")
END GO
