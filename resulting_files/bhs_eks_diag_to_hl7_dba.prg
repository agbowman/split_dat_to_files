CREATE PROGRAM bhs_eks_diag_to_hl7:dba
 ...
 ELSEIF (ml_mod_option="D")
  ...
  SET ms_tmp_message = build(ms_tmp_message," misc1 = ",eksdata->tqual[3].qual[ml_pos].data[1].misc,
   " misc2 = ",eksdata->tqual[3].qual[ml_pos].data[2].misc)
 ENDIF
 SET ms_file_name = concat("diag_hl7_",trim(cnvtstring(rand(0),20),3),"_",trim(cnvtstring(cnvtreal(
     eksdata->tqual[3].qual[ml_pos].data[2].misc),20),3),"_",
  ms_trans_name,".txt")
 SELECT INTO "nl:"
  FROM diagnosis d,
   nomenclature n
