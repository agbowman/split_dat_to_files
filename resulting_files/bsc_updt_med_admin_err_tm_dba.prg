CREATE PROGRAM bsc_updt_med_admin_err_tm:dba
 ...
 SUBROUTINE setreadmetimings(null)
   ...
   RETURN(1)
 END ;Subroutine
 IF (setdrivertable("MED_ADMIN_MED_ERROR")=0)
  GO TO exit_script
 ENDIF
 IF (fetchandsetdrivertable(4106)=0)
  GO TO exit_script
 ENDIF
 CALL setrangeincrement(250000)
 CALL settimeperbatch(11.452083)
 CALL addtimedreadme(4107)
 CALL addtimedreadme(4108)
 CALL addtimedreadme(4109)
