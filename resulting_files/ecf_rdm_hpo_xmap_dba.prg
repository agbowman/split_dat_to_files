CREATE PROGRAM ecf_rdm_hpo_xmap:dba
 ...
 SET kia_tbl_desc = "HPO XMAP"
 SET kia_short_desc = "HPO XMAP"
 SET kia_rdm_log_name = "ecf_rdm_hpo_xmap.log"
 SET kia_rdm_nbr = 9971
 ...
 CALL log_sub(concat("ecf_rdm_hpo_xmap Begin> ",format(cnvtdatetime(curdate,curtime3),
