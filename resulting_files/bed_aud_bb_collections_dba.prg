CREATE PROGRAM bed_aud_bb_collections:dba
 ...
 SUBROUTINE bederrorcheck(errordescription)
  ...
  ENDIF
 END ;Subroutine
 DECLARE lab = f8 WITH public, noconstant(uar_get_code_by("MEANING",6000,"GENERAL LAB"))
 DECLARE bb = f8 WITH public, noconstant(uar_get_code_by("MEANING",106,"BB"))
 ...
 IF (cnt > 0)
  ...
  IF ((request->skip_volume_check_ind=0))
   ...
   IF ((reply->high_volume_flag IN (1, 2)))
    SET reply->output_filename = build("bb_collections_audit.csv")
