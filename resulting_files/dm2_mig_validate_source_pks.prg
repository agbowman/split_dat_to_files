CREATE PROGRAM dm2_mig_validate_source_pks
 ...
 SUBROUTINE dir_get_admin_db_link(dgadl_report_fail_ind,dgadl_admin_db_link,dgadl_fail_ind)
   ...
   RETURN(1)
 END ;Subroutine
 IF (check_logfile("dm2_mig_vspk",".log","dm2_mig_validate_source_pks")=0)
  GO TO exit_script
 ENDIF
 IF (dmr_prompt_retrieve_mig_data(0,1,0,0)=0)
  GO TO exit_script
 ENDIF
 IF (dmr_issue_summary_screen(1,0,"")=0)
  GO TO exit_script
 ENDIF
 IF ((((dmr_mig_data->cur_db_type != "SOURCE")) OR (currdbuser != "V500")) )
  ...
  ENDIF
 ENDIF
 EXECUTE dm2_validate_pks "DM2NOTSET", "DM2NOTSET", "MIGRATION SOURCE"
 IF ((dm_err->err_ind=1))
  GO TO exit_script
 ENDIF
 GO TO exit_script
#exit_script
 SET dm_err->eproc = "dm2_mig_validate_source_pks completed"
 CALL final_disp_msg("dm2_mig_vspk")
END GO
