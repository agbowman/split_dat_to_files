CREATE PROGRAM bed_ens_pharm_identifiers:dba
 ...
 FOR (x = 1 TO size(request->items,5))
   ...
   FOR (y = 1 TO size(request->items[x].identifiers,5))
     SET request_main->items[x].identifiers[y].action_flag = request->items[x].identifiers[y].
     action_flag
     SET request_main->items[x].identifiers[y].identifier_id = request->items[x].identifiers[y].
     identifier_id
     SET request_main->items[x].identifiers[y].ident_type_code_value = request->items[x].identifiers[
     y].ident_type_code_value
     SET request_main->items[x].identifiers[y].value = request->items[x].identifiers[y].value
   ENDFOR
 ENDFOR
 FREE SET request
 RECORD request(
