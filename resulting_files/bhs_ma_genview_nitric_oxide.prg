CREATE PROGRAM bhs_ma_genview_nitric_oxide
 SET rhead =
 ...
 SET labordflag = 0
 SET rtab = "\tab "
 DECLARE nitric_level = f8 WITH public, constant(uar_get_code_by("DISPLAYKEY",72,"FENO"))
 ...
 SELECT DISTINCT INTO "nl:"
  ...
  PLAN (e
   ...
   WHERE ce.person_id=e.person_id
    ...
    AND ce.event_cd IN (nitric_level)
    AND ce.view_level=1
  ...
  HEAD REPORT
   cnt = 0, temp_disp = "Fractional Exhaled Nitric Oxide: (FENO)", drec->line_qual[lidx].disp_line =
