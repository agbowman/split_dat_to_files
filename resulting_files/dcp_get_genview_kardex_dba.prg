CREATE PROGRAM dcp_get_genview_kardex:dba
 SET rhead =
   ...
   SELECT INTO "nl"
    ...
    DETAIL
     ...
     IF (((n.source_string > " ") OR (p.problem_ftdesc > " ")) )
      ...
      ENDIF
      temp_disp3 = "Since: ", temp_disp4 = format(p.onset_dt_tm,"mm/dd/yyyy;;d"), drec->line_qual[
      lidx].disp_line = concat("         ",trim(temp_disp1)," (",trim(temp_disp3),trim(temp_disp4),
       ")",reol),
      ";;T"
     ENDIF
    FOOT REPORT
