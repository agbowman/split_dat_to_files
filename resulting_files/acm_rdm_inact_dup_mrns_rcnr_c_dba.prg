CREATE PROGRAM acm_rdm_inact_dup_mrns_rcnr_c:dba
 ...
 SET ms_child_info_domain_nm = "ACM_RDM_INACT_DUP_MRNS_RCNR2"
 SET ms_range_prefix = "ACM_RDM_INACT_DUP_MRNS_RCNR_RANGE"
 SET ms_child_max_name = "MAX ENCNTR_ALIAS_ID EVALUATED"
