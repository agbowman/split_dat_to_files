CREATE PROGRAM bhs_rpt_fmc_braden_score:dba
 PROMPT
 ...
 SET org3 = uar_get_code_by("DESCRIPTION",220,"BAYSTATE FRANKLIN MEDICAL CENTER")
 SET org4 = uar_get_code_by("DESCRIPTION",220,"BAYSTATE FRANKLIN MEDICAL CENTER INPATIENT PSYCHIATRY"
  )
 SET count = 0
 RECORD temp_rec(
   1 bradens[*]
 ...
 SELECT INTO "nl:"
  ...
  PLAN (ce
   ...
   WHERE elh.encntr_id=ce.encntr_id
    ...
    AND elh.loc_facility_cd IN (org3, org4))
   JOIN (p
