CREATE PROGRAM dcp_elh_cleanup_child:dba
 ...
 SET ms_child_info_domain_nm = "DCP_ELH_CLEANUP PROCESS"
 SET ms_range_prefix = "ENCNTR_LOC_HIST_ID RANGE "
 SET ms_child_max_name = "MAX ENCNTR_LOC_HIST_ID EVALUATED"
