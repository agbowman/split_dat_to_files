CREATE PROGRAM ecf_rdm_hpo_concept:dba
 ...
 SUBROUTINE kia_script_inc(pkg,ccl_obj)
   ...
   CALL parser(obj_prs)
 END ;Subroutine
 DECLARE kia_concept_filename = vc WITH public, constant("hpo_concept.csv")
 DECLARE kia_cur_ver_beg_dt = vc WITH public, noconstant("")
 SET kia_tbl_desc = "HPO CONCEPT"
 SET kia_short_desc = "HPO CONCEPT"
 SET kia_rdm_log_name = "ecf_rdm_hpo_concept.log"
 SET kia_rdm_nbr = 9969
 SET kia_rdm_vocab_mean = "HPO"
 SET readme_data->status = "F"
 ...
 EXECUTE kia_dm_dbimport "cer_install:hpo_version.csv", "kia_get_rdm_vars", 100,
 0
 CALL kia_chk_script_failure("KIA_GET_RDM_VARS")
 SET start_time_var = cnvtdatetime(curdate,curtime3)
 CALL log_sub(concat("ecf_rdm_hpo_concept Begin> ",format(cnvtdatetime(curdate,curtime3),
 ...
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9968,"HPO NOMEN"))
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9969,"HPO CONCEPT"))
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9970,"HPO RELTN"))
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9971,"HPO XMAP"))
