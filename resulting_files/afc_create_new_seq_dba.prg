CREATE PROGRAM afc_create_new_seq:dba
 ...
 EXECUTE dm_add_sequence "bce_batch_num_seq", 0, 0,
 0, 0
 IF ((dm_seq_reply->status="F"))
  GO TO exit_script
 ENDIF
 EXECUTE dm_add_sequence "bce_event_log_seq", 0, 0,
 0, 0
 IF ((dm_seq_reply->status="F"))
  GO TO exit_script
 ENDIF
 EXECUTE dm_add_sequence "cssumm_seq", 0, 0,
 0, 0
 IF ((dm_seq_reply->status="F"))
  GO TO exit_script
 ENDIF
 EXECUTE dm_add_sequence "cs_org_reltn_seq", 0, 0,
 0, 0
 IF ((dm_seq_reply->status="F"))
  GO TO exit_script
 ENDIF
