CREATE PROGRAM bhs_gvw_inpt_med_discrepancy:dba
 ...
 IF ((med_recon_request->recon_type="A"))
  SET reply->text = concat(reply->text,wb,"Inpatient Medication Discrepancy"," \cell\par\intbl",wb,
