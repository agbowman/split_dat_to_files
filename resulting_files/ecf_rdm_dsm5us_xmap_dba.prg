CREATE PROGRAM ecf_rdm_dsm5us_xmap:dba
 ...
 SET kia_tbl_desc = "DSM-5-TR XMAP"
 SET kia_short_desc = "DSM-5-TR XMAP"
 SET kia_rdm_log_name = "ecf_rdm_dsm5us_xmap.log"
 SET kia_rdm_nbr = 10269
 SET kia_rdm_vocab_mean = "DSM5"
 SET readme_data->status = "F"
 ...
 EXECUTE kia_dm_dbimport "cer_install:dsm-5-tr_version.csv", "kia_get_rdm_vars", 100,
 0
 CALL kia_chk_script_failure("KIA_GET_RDM_VARS")
 SET start_time_var = cnvtdatetime(curdate,curtime3)
 CALL log_sub(concat("ECF_RDM_DSM5US_XMAP Begin> ",format(cnvtdatetime(curdate,curtime3),
