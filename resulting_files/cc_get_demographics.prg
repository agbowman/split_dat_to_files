CREATE PROGRAM cc_get_demographics
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "Prsnl Id" = 0.0,
  "List Id" = 0.0
  WITH outdev, prsnlid, listid
 ...
 SUBROUTINE (validatesrvreply(nsrvstat=i4,recorddata=vc(ref),zeroforceexit=i2) =i4 WITH protect)
   ...
   ENDIF
 END ;Subroutine
 DECLARE request_number = i4 WITH protect, constant(3208632)
 DECLARE srv_request = vc WITH protect, constant("QueryPatientDemographics")
 ...
 SET nsrvstat = uar_srvsetdouble(hreq,"patient_list_id", $LISTID)
