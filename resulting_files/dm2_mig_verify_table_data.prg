CREATE PROGRAM dm2_mig_verify_table_data
 ...
 SUBROUTINE dm2_get_rdbms_version(null)
   ...
   RETURN(1)
 END ;Subroutine
 DECLARE dvd_comp_single_table_owner = vc WITH protect, noconstant(cnvtupper( $1))
 DECLARE dvd_comp_single_table = vc WITH protect, noconstant(cnvtupper( $2))
 IF (check_logfile("dm2migvtbldata",".log","dm2_mig_verify_table_data")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_mig_verify_table_data"
 CALL disp_msg(" ",dm_err->logfile,0)
 ...
 ENDIF
#exit_program
 SET dm_err->eproc = "dm2_mig_verify_table_data completed"
 CALL final_disp_msg("dm2migvtbldata")
END GO
