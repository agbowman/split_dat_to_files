CREATE PROGRAM dm_cmb_ppr_80:dba
 ...
 SET readme_data->message = "Failed readme: starting dm_cmb_ppr_80.prg program"
 EXECUTE dm_dbimport "cer_install:dm_cmb_loc_generic.csv", "dm_dm_cmb_exception_import", 100
