CREATE PROGRAM bhs_him_prod_analysis_det_lyt
 PROMPT
 ...
 SUBROUTINE initializereport(dummy)
   ...
   ELSE
    ...
    SET rptreport->m_reportname = "BHS_HIM_PROD_ANALYSIS_DET_LYT"
 ...
 IF (( $7=1))
  SET _bsubreport = 1
  EXECUTE bhs_him_prod_analysis_det_grp  $1,  $2,  $3,
   $4,  $5,  $6
  SET _bsubreport = 0
 ENDIF
 IF (( $7=0))
  SET _bsubreport = 1
  EXECUTE bhs_him_prod_analysis_det_ngrp  $1,  $2,  $3,
   $4,  $5,  $6
  SET _bsubreport = 0
 ENDIF
 IF (_bishtml != 0)
