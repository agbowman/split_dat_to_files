CREATE PROGRAM dm_cmb_ex_pft_balance:dba
 ...
 ENDIF
 EXECUTE dm_dbimport "cer_install:dm_cmb_ex_PFT_BALANCE.csv", "dm_dm_cmb_exception_import", 10
 IF ((readme_data->status="F"))
  SET readme_data->message = "cer_install:dm_cmb_ex_PFT_BALANCE.csv was not found"
  GO TO end_program
 ENDIF
