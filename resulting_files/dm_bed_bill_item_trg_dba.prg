CREATE PROGRAM dm_bed_bill_item_trg:dba
 ...
 SET readme_data->message = "Check RDDS triggers for table BED and BILL_ITEM"
 ...
 SELECT DISTINCT INTO "nl:"
  ...
  WHERE u.table_name IN ("BED", "BILL_ITEM")
  ...
  WITH nocounter
 ;end select
 IF (check_error("Check if RDDS triggers exist for table BED and BILL_ITEM") != 0)
  SET readme_data->status = "F"
 ...
 SET readme_data->message = "Generating RDDS trigger for table BED and BILL_ITEM successfully"
#exit_script
