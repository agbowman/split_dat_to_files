CREATE PROGRAM bhs_rpt_rad_sched_accept:dba
 PROMPT
 ...
 END ;Subroutine
 SUBROUTINE (sec_patinfo_ct(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
 ...
 SUBROUTINE (tablerow16abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   IF (ncalc=rpt_render)
    ...
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 7.500),offsety,(offsetx+ 7.500),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.000),(offsety+ 0.000),(offsetx+ 7.501),(offsety+
     0.000))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.000),(offsety+ sectionheight),(offsetx+ 7.501),(
 ...
 SUBROUTINE (tablerow8abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.420069), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow6abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.293010), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   SET rptsd->m_y = (offsety+ 0.007)
   SET rptsd->m_x = (offsetx+ 0.007)
   SET rptsd->m_width = 1.494
   SET rptsd->m_height = 0.287
   SET _dummyfont = uar_rptsetfont(_hreport,_times100)
   SET _dummypen = uar_rptsetpen(_hreport,_pen14s0c0)
   IF (ncalc=rpt_render)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build("",char(0)))
   ...
   SET rptsd->m_paddingwidth = 0.000
   SET rptsd->m_y = (offsety+ 0.007)
   SET rptsd->m_x = (offsetx+ 1.507)
   SET rptsd->m_width = 1.556
   SET rptsd->m_height = 0.287
   IF (ncalc=rpt_render)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build("",char(0)))
   ENDIF
   ...
   SET rptsd->m_paddingwidth = 0.000
   SET rptsd->m_y = (offsety+ 0.007)
   SET rptsd->m_x = (offsetx+ 3.507)
   SET rptsd->m_width = 0.494
   SET rptsd->m_height = 0.287
   IF (ncalc=rpt_render)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build("",char(0)))
   ENDIF
   ...
   IF (ncalc=rpt_render)
    ...
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 1.500),offsety,(offsetx+ 1.500),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 3.062),offsety,(offsetx+ 3.062),(offsety+
     sectionheight))
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow7(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow7abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow7abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.363239), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (sec_patinfo_ctabs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(2.880000), private
   ...
   DECLARE __acr = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_acr_score,char(0))), protect
   DECLARE __acr_ack_reason = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_acr_ack_reason,char(0
      ))), protect
   IF (ncalc=rpt_render)
    ...
    IF (ncalc=rpt_render)
     ...
     SET holdheight += tablerow7(rpt_render)
    ...
    SET rptsd->m_height = 0.313
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2("ACR Score",char(0)))
    ...
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__acr)
    SET rptsd->m_flags = 4
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    ...
    SET rptsd->m_height = 0.251
    SET _dummyfont = uar_rptsetfont(_hreport,_times100)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2("ACR Bypass Reason",char(0)))
    ...
    SET rptsd->m_height = 0.313
    SET _dummyfont = uar_rptsetfont(_hreport,_times80)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__acr_ack_reason)
    SET _yoffset = (offsety+ sectionheight)
   ENDIF
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (sec_patinfo_mri(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
 ...
 SUBROUTINE (tablerow15abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.248982), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow22abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow23(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow23abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow23abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.248982), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
 ...
 SUBROUTINE (tablerow24abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.317582), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow26(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow26abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow26abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
 ...
 SUBROUTINE (tablerow27abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow28(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow28abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow28abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.264883), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (sec_patinfo_mriabs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(2.820000), private
   DECLARE holdheight = f8 WITH noconstant(0.0), private
   DECLARE __patname = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_person_name_full,char(0))),
   protect
   DECLARE __relevantpreviousfilms = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_rel_prev_films,
   ...
   IF (ncalc=rpt_render)
    ...
    IF (ncalc=rpt_render)
     ...
     SET holdheight += tablerow23(rpt_render)
     SET holdheight += tablerow24(rpt_render)
     SET holdheight += tablerow26(rpt_render)
     SET holdheight += tablerow27(rpt_render)
     SET holdheight += tablerow28(rpt_render)
     SET _yoffset = offsety
    ENDIF
    SET rptsd->m_flags = 4
    SET rptsd->m_borders = rpt_sdnoborders
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (sec_body_mri(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
 ...
 SUBROUTINE (tablerow25abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.307225), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow29(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow29abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow29abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.307225), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow30(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow30abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow30abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.307225), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow31(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow31abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow31abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.307225), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow32(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow32abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow32abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.307225), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow33(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow33abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow33abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.307225), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow36(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow36abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow36abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.307225), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow34(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow34abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow34abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.266986), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow35(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow35abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow35abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.288108), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow39abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.309864), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow40abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.331853), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow11abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.402603), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   SET rptsd->m_paddingwidth = 0.000
   SET rptsd->m_y = (offsety+ 0.007)
   SET rptsd->m_x = (offsetx+ 0.758)
   SET rptsd->m_width = 6.744
   SET rptsd->m_height = 0.396
   IF (ncalc=rpt_render)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build("",char(0)))
   ENDIF
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow37(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow37abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow37abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.375017), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow42abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.557907), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow45abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.247717), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow43abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.386432), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (sec_body_mriabs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(6.070000), private
   DECLARE holdheight = f8 WITH noconstant(0.0), private
   ...
   DECLARE __creat_ord_res_dt = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_creat_lab_dt,char(0
      ))), protect
   DECLARE __creat_ord_result = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_creat_result,char(0
      ))), protect
   ...
   DECLARE __gfrnona_ord_result = vc WITH noconstant(build2(schdata->qual[ml_cnt].
     s_gfrnonafrican_result,char(0))), protect
   DECLARE __gfra_ord_result = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_gfrafrican_result,
     char(0))), protect
   DECLARE __gfrnona_ord_res_dt = vc WITH noconstant(build2(schdata->qual[ml_cnt].
     s_gfrnonafrican_lab_dt,char(0))), protect
   DECLARE __gfra_ord_res_dt = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_gfrafrican_lab_dt,
     char(0))), protect
   DECLARE __comment32 = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_action_comment,char(0))),
   protect
   IF (ncalc=rpt_render)
    SET _oldpen = uar_rptsetpen(_hreport,_pen14s0c0)
    SET _yoffset = (offsety+ 0.250)
    ...
    IF (ncalc=rpt_render)
     ...
     SET holdheight += tablerow29(rpt_render)
     SET holdheight += tablerow30(rpt_render)
     SET holdheight += tablerow31(rpt_render)
     SET holdheight += tablerow32(rpt_render)
     SET holdheight += tablerow33(rpt_render)
     SET holdheight += tablerow36(rpt_render)
     SET holdheight += tablerow34(rpt_render)
     SET holdheight += tablerow35(rpt_render)
     SET holdheight += tablerow39(rpt_render)
     SET holdheight += tablerow40(rpt_render)
     SET holdheight += tablerow11(rpt_render)
     SET holdheight += tablerow37(rpt_render)
    ...
    SET rptsd->m_width = 1.438
    SET rptsd->m_height = 0.188
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__creat_ord_res_dt)
    SET rptsd->m_flags = 4
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    ...
    SET rptsd->m_width = 1.188
    SET rptsd->m_height = 0.188
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__creat_ord_result)
    SET rptsd->m_flags = 4
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    ...
    SET rptsd->m_width = 1.375
    SET rptsd->m_height = 0.188
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2("GFR Non African American",char(0)))
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    ...
    SET rptsd->m_width = 1.250
    SET rptsd->m_height = 0.188
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2("GFR African American",char(0)))
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    SET rptsd->m_y = (offsety+ 4.375)
    ...
    SET rptsd->m_height = 0.188
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2("Creatinine Blood",char(0)))
    SET rptsd->m_flags = 0
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    ...
    SET rptsd->m_width = 1.188
    SET rptsd->m_height = 0.188
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__gfrnona_ord_result)
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    SET rptsd->m_y = (offsety+ 4.563)
    ...
    SET rptsd->m_width = 1.188
    SET rptsd->m_height = 0.188
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__gfra_ord_result)
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    SET rptsd->m_y = (offsety+ 4.750)
    ...
    SET rptsd->m_width = 1.438
    SET rptsd->m_height = 0.188
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__gfrnona_ord_res_dt)
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    SET rptsd->m_y = (offsety+ 4.563)
    ...
    SET rptsd->m_width = 1.438
    SET rptsd->m_height = 0.188
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__gfra_ord_res_dt)
    SET rptsd->m_flags = 4
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    ...
    SET rptsd->m_height = 0.376
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2(concat("Special ",_crlf,"Comments :"),
      char(0)))
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    SET rptsd->m_y = (offsety+ 4.011)
    SET rptsd->m_x = (offsetx+ 0.063)
    SET rptsd->m_width = 0.688
    SET rptsd->m_height = 0.376
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2(concat("Action  ",_crlf,"Comments :"),
      char(0)))
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    ...
    SET rptsd->m_height = 0.376
    SET _dummyfont = uar_rptsetfont(_hreport,_times80)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__comment32)
    SET _yoffset = (offsety+ sectionheight)
   ENDIF
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (sec_body_ct(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
 ...
 SUBROUTINE (tablerow9abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.313500), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   SET rptsd->m_y = (offsety+ 0.007)
   SET rptsd->m_x = (offsetx+ 0.007)
   SET rptsd->m_width = 1.744
   SET rptsd->m_height = 0.307
   SET _dummyfont = uar_rptsetfont(_hreport,_times100)
   SET _dummypen = uar_rptsetpen(_hreport,_pen14s0c0)
   IF (ncalc=rpt_render)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build("",char(0)))
   ...
   SET rptsd->m_paddingwidth = 0.000
   SET rptsd->m_y = (offsety+ 0.007)
   SET rptsd->m_x = (offsetx+ 1.758)
   SET rptsd->m_width = 2.056
   SET rptsd->m_height = 0.307
   IF (ncalc=rpt_render)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build("",char(0)))
   ENDIF
 ...
 SUBROUTINE (tablerow10abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.250807), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow12abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.506225), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow13abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.364703), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow18abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.261253), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow5abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.366010), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (tablerow38(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = tablerow38abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (tablerow38abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.375000), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
 ...
 SUBROUTINE (tablerow44abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.564307), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow47abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.270577), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
 ...
 SUBROUTINE (tablerow17abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.394541), private
   SET rptsd->m_flags = 0
   SET rptsd->m_borders = rpt_sdnoborders
   SET rptsd->m_padding = rpt_sdnoborders
   SET rptsd->m_paddingwidth = 0.000
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (sec_body_ctabs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(4.190000), private
   DECLARE holdheight = f8 WITH noconstant(0.0), private
   ...
   DECLARE __gfra_ord_res_dt = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_gfrafrican_lab_dt,
     char(0))), protect
   DECLARE __comment30 = vc WITH noconstant(build2(schdata->qual[ml_cnt].s_action_comment,char(0))),
   protect
   IF (ncalc=rpt_render)
    SET _oldpen = uar_rptsetpen(_hreport,_pen14s0c0)
    SET _yoffset = (offsety+ 0.250)
    ...
    IF (ncalc=rpt_render)
     ...
     SET holdheight += tablerow38(rpt_render)
    ...
    SET rptsd->m_height = 0.376
    SET _dummyfont = uar_rptsetfont(_hreport,_times80)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__comment30)
    SET _yoffset = (offsety+ sectionheight)
   ENDIF
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (sec_comment_mri(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = sec_comment_mriabs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (sec_comment_mriabs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (sec_comment_ct(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = sec_comment_ctabs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (sec_comment_ctabs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
 ...
 SUBROUTINE initializereport(dummy)
   ...
   SET rptreport->m_reportname = "BHS_RPT_RAD_SCHED_ACCEPT"
 ...
 RECORD schdata(
   ...
   1 qual[*]
     ...
     2 s_allergy = vc
     2 s_action_comment = vc
     2 s_acr_score = vc
     2 s_acr_ack_reason = vc
     2 s_acr_ack_reason_comment = vc
 ) WITH protect
 FREE RECORD m_appt
 RECORD m_appt(
   1 l_cnt = i4
 ...
 SELECT INTO "nl:"
  ...
  HEAD REPORT
   per->l_cnt = 0
  DETAIL
   per->l_cnt += 1, stat = alterlist(per->qual,per->l_cnt), per->qual[per->l_cnt].f_person_id = p
   .person_id
  WITH nocounter
 ;end select
 IF ((per->l_cnt=0))
 ...
 SELECT INTO "nl:"
  ...
  PLAN (cv
   WHERE cv.code_set=14230
    AND ((cnvtupper(cv.display) IN ("CT*", "MRA*", "MRI*")) OR (cnvtupper(cv.display) IN ("XCT*",
   "XMRI*"))) )
  HEAD REPORT
   m_appt->l_cnt = 0
  DETAIL
   m_appt->l_cnt += 1
   IF ((m_appt->l_cnt > size(m_appt->qual,5)))
    CALL alterlist(m_appt->qual,(m_appt->l_cnt+ 99))
   ENDIF
   m_appt->qual[m_appt->l_cnt].f_appt_type_cd = cv.code_value
  FOOT REPORT
   CALL alterlist(m_appt->qual,m_appt->l_cnt)
  WITH nocounter
 ;end select
 SELECT INTO "nl:"
  FROM sch_appt sa,
  ...
  PLAN (sa
   ...
   WHERE cv.code_value=se.appt_type_cd
    AND expand(ml_cnt2,1,m_appt->l_cnt,cv.code_value,m_appt->qual[ml_cnt2].f_appt_type_cd))
   JOIN (sed
  ...
  HEAD REPORT
   schdata->l_cnt = 0
  HEAD sa.sch_appt_id
   schdata->l_cnt += 1, stat = alterlist(schdata->qual,schdata->l_cnt), schdata->qual[schdata->l_cnt]
   .f_sch_appt_id = sa.sch_appt_id,
 ...
 FOR (ml_cnt = 1 TO schdata->l_cnt)
   SELECT INTO "nl:"
    ...
    PLAN (o
     ...
     WHERE ce.order_id=o.order_id
      AND ce.event_end_dt_tm >= cnvtdatetime((curdate - 30),curtime3)
    ...
    DETAIL
     IF (ml_ord_result=1)
      IF (ce.event_cd=mf_creat_blood_cd)
       schdata->qual[ml_cnt].f_creat_lab_dt = ce.event_end_dt_tm, schdata->qual[ml_cnt].
       s_creat_lab_dt = format(ce.event_end_dt_tm,";;q"), schdata->qual[ml_cnt].s_creat_result = ce
       .result_val
      ENDIF
      IF (ce.event_cd=mf_gfrafricanamerican_cd)
       schdata->qual[ml_cnt].f_gfrafrican_lab_dt = ce.event_end_dt_tm, schdata->qual[ml_cnt].
       s_gfrafrican_lab_dt = format(ce.event_end_dt_tm,";;q"), schdata->qual[ml_cnt].
       s_gfrafrican_result = ce.result_val
      ENDIF
      IF (ce.event_cd=mf_gfrnonafricanamerican_cd)
       schdata->qual[ml_cnt].f_gfrnonafrican_lab_dt = ce.event_end_dt_tm, schdata->qual[ml_cnt].
       s_gfrnonafrican_lab_dt = format(ce.event_end_dt_tm,";;q"), schdata->qual[ml_cnt].
   ...
   SELECT INTO "nl:"
    ...
    PLAN (sea
     WHERE (sea.sch_event_id=schdata->qual[ml_cnt].f_sch_event_id)
     ...
     WHERE off.oe_field_id=od.oe_field_id
      AND o.oe_format_id=off.oe_format_id
      AND off.label_text IN ("ACR Score", "ACR Acknowledgment Reason",
     "ACR Acknowledgment Reason Comment"))
    ORDER BY o.order_id, od.oe_field_id, od.action_sequence DESC
    HEAD o.order_id
     null
    HEAD od.oe_field_id
     IF (off.label_text="ACR Score")
      schdata->qual[ml_cnt].s_acr_score = trim(od.oe_field_display_value,3)
     ELSEIF (off.label_text="ACR Acknowledgment Reason")
      schdata->qual[ml_cnt].s_acr_ack_reason = trim(od.oe_field_display_value,3)
     ELSEIF (off.label_text="ACR Acknowledgment Reason Comment")
      schdata->qual[ml_cnt].s_acr_ack_reason_comment = trim(od.oe_field_display_value,3)
     ENDIF
    FOOT  o.order_id
     IF (trim(cnvtupper(schdata->qual[ml_cnt].s_acr_ack_reason),3)="OTHER")
      schdata->qual[ml_cnt].s_acr_ack_reason = schdata->qual[ml_cnt].s_acr_ack_reason_comment
     ENDIF
    WITH nocounter
   ;end select
   ...
   SELECT INTO "nl:"
    ...
    PLAN (a
     ...
     WHERE bnl.nomen_list_key IN ("RAD_ALLERGY_CT", "RAD_ALLERGY_MRI")
      ...
      AND bnl.active_ind=1)
    DETAIL
     IF (substring(1,2,trim(schdata->qual[ml_cnt].s_appt_type,3)) IN ("CT", "xC")
      AND bnl.nomen_list_key="RAD_ALLERGY_CT")
      schdata->qual[ml_cnt].s_allergy = "Yes"
     ENDIF
     IF (substring(1,3,trim(schdata->qual[ml_cnt].s_appt_type,3)) IN ("xMR", "MRI", "MRA")
   ...
   SELECT INTO "nl:"
    FROM sch_event se,
     ...
     long_text lt
    PLAN (se
     WHERE (se.sch_event_id=schdata->qual[ml_cnt].f_sch_event_id)
    ...
    HEAD sea.sch_action_id
     IF (substring(1,1,trim(lt.long_text,3)) != "[")
      IF (trim(lt.long_text,3) != trim(schdata->qual[ml_cnt].s_comment,3))
       schdata->qual[ml_cnt].s_action_comment = concat(schdata->qual[ml_cnt].s_action_comment," ",
        trim(lt.long_text,3))
      ENDIF
     ENDIF
    WITH nocounter
 ...
 FOR (ml_cnt = 1 TO schdata->l_cnt)
  IF (( $MF_ORD_TYPE=1)
   AND (schdata->qual[ml_cnt].s_appt_type IN ("CT*", "xC*")))
  ...
  ENDIF
  IF (( $MF_ORD_TYPE=2)
   AND (schdata->qual[ml_cnt].s_appt_type IN ("MRI*", "MRA*", "xMR*")))
   CALL echo(schdata->qual[ml_cnt].s_person_name_full)
   CALL echo(schdata->qual[ml_cnt].s_person_weight)
   CALL echo(schdata->qual[ml_cnt].s_order_prov)
   CALL echo(schdata->qual[ml_cnt].s_appt_date)
 ...
 SET last_mod = "004 01/03/20 Dave McDonald  Modified to include protocol appointments"
END GO
