CREATE PROGRAM br_reg_text_config:dba
 ...
 SET readme_data->message = "Readme Failed: Starting <br_reg_text_config.prg> script"
 ...
 INSERT  FROM br_long_text b,
  ...
  SET b.long_text_id = seq(bedrock_seq,nextval), b.parent_entity_name = "BR_DATAMART_TEXT", b
   ...
   b.long_text = requestin->list_0[d.seq].text, b.updt_cnt = 0, b.updt_dt_tm = cnvtdatetime(curdate,
    curtime3),
 ...
 SET readme_data->message = "Readme Succeeded: <br_reg_text_config.prg> script"
#exit_script
 FREE RECORD br_metainfo
END GO
