CREATE PROGRAM dm_pucb_cdi_doc_entity_reltn:dba
 ...
 IF ((dm_cmb_cust_script->exc_maint_ind=1))
  ...
  SET dcem_request->qual[1].script_name = "DM_PUCB_CDI_DOC_ENTITY_RELTN"
 ...
 SUBROUTINE entity_ucb_upt(dummy)
   UPDATE  FROM cdi_doc_entity_reltn
    ...
    WHERE (cdi_doc_entity_reltn_id=rchildren->qual1[det_cnt].entity_id)
    WITH nocounter
   ;end update
   IF (curqual=0)
