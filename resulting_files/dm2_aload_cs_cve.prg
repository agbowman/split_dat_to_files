CREATE PROGRAM dm2_aload_cs_cve
 ...
 SUBROUTINE dac_load_cload(lc_pkg_in)
   ...
   ENDIF
 END ;Subroutine
 IF (check_logfile("dm2_aload_cs_cve",".log","dm2_aload_cs_cve")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_aload_cs_cve"
 CALL disp_msg(" ",dm_err->logfile,0)
 DECLARE dcve_cnt = i4 WITH protect, noconstant(0)
 DECLARE dcve_str = vc WITH protect, noconstant("")
 IF (dac_pop_coldic_rec("DM_AFD_CODE_VALUE_EXTENSION")=0)
  GO TO exit_program
 ENDIF
...
#exit_program
 IF ((dm_err->err_ind=0))
  SET dm_err->eproc = "Dm2_aload_cs_cve completed"
 ENDIF
 CALL final_disp_msg("dm2_aload_cs_cve")
END GO
