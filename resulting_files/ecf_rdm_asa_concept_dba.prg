CREATE PROGRAM ecf_rdm_asa_concept:dba
 ...
 SET kia_rdm_log_name = "ecf_rdm_asa_concept.log"
 SET kia_rdm_nbr = 9999
 ...
 CALL log_sub(concat("ecf_rdm_asa_concept Begin> ",format(cnvtdatetime(curdate,curtime3),
 ...
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9999,"ASA NOMEN"))
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9999,"ASA CONCEPT"))
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9999,"ASA XMAP"))
 CALL echo(build("README'S ALREADY COMPLETED:",kia_version_chk))
 IF (kia_version_chk=4)
