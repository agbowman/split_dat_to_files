CREATE PROGRAM bbt_rdm_obs_donor:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "bbt_rdm_obs_donor"
 ...
 CALL logmsg("Loading Record Structure with table names",(e_dispmsg+ e_logtofile))
 SET count = size(tblnames->list,5)
 SET stat = alterlist(tblnames->list,53)
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "ACCEPT_POS_TEST"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_BAG_TYPE_PRODUCT"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_CONFIDENTIAL_NOTE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_CONTACT_METHOD"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_CONTACT_NOTE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_CORRECT_DEF_REASON"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_CORRECT_DONOR"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_CORRECT_DON_PROD_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_CORRECT_DON_RSLTS"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_COUNSELING_NOTE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_DEFERRAL_REASON"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_DONOR_ELIGIBILITY"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_MOBILE_PREF"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_ORG_QUOTA"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_OTHER_CONTACT"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_OUTCOME_BAG_TYPE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_OUTCOME_REASON"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_PROCEDURE_OUTCOME"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_PRODUCT_ELIGIBILITY"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_RARE_TYPES"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_RECRUITING_ANTIGEN"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_RECRUITING_DONOR_RELTN"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_RECRUITING_LIST"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_RECRUITING_ZIPCODE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_RECRUITMENT_RSLTS"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_SPECIAL_INTEREST"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_UPLOAD_REVIEW"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BB_CATEG_REPORT_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BB_REPORT_MANAGEMENT"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BB_REPORT_MOD_CAT_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "DONOR_VENIPUNCTURE_SITE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "INITIAL_PRODUCT_STATE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "PROCEDURE_BAG_TYPE_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "PROCEDURE_ELIGIBILITY_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "PROCEDURE_OUTCOME_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "PROC_BAG_PRODUCT_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "PROC_OUTCOME_REASON_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "ACCEPT_POS_PROD_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_DONATION_PROCEDURE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_DONATION_RESULTS"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_DONOR_CONTACT"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_Donor_Contact_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_DONOR_NOTE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "BBD_DON_PRODUCT_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "CROSS_RESULTS"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "CROSS_RESULTS_R"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "DONATION_PROCEDURE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "DONOR_ABORH"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "DONOR_ANTIBODY"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "DONOR_ANTIGEN"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "DONOR_RH_PHENOTYPE"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "INTERP_DONOR_REASON"
 SET count = (count+ 1)
 SET tblnames->list[count].tblname = "PERSON_DONOR"
 CALL logmsg("Begin Obsoleting Donor Tables",(e_dispmsg+ e_logtofile))
 FOR (i = 1 TO size(tblnames->list,5))
  EXECUTE dm_drop_obsolete_objects tblnames->list[i].tblname, "TABLE", 1
  IF (errcode != 0)
   SET err_ind = 1
   SET recstatus->sstatusmsg = build("Table Obsoletion Failure:",tblnames->list[i].tblname,"-",errmsg
    )
   GO TO exit_script
  ENDIF
 ENDFOR
