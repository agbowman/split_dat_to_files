CREATE PROGRAM dm2_set_ready_to_run:dba
 IF (validate(priority_tmp->priority_cnt,- (1)) < 0)
  FREE RECORD priority_tmp
  RECORD priority_tmp(
    1 priority_cnt = i4
    1 priorities[*]
      2 priority = i4
  )
  SET priority_tmp->priority_cnt = 0
 ENDIF
 FREE RECORD dsrtr_work
 RECORD dsrtr_work(
   1 schema_date = dq8
 )
 DECLARE dm2_mod = vc WITH private, constant("000")
 DECLARE cpreview = vc WITH protect, constant("PREVIEW")
 DECLARE priorityx = i4 WITH protect, noconstant(0)
 DECLARE ddl_in_error = i2 WITH protect, noconstant(0)
 DECLARE cur_priority_running = i2 WITH protect, noconstant(0)
 DECLARE cur_priority_null = i2 WITH protect, noconstant(0)
 DECLARE dsrtr_ocd = i4 WITH protect, noconstant(0)
 DECLARE err_msg = vc WITH protect, noconstant("")
 DECLARE dsrtr_priority_grp = vc WITH protect, noconstant(" ")
 DECLARE dsrtr_idx = i4 WITH protect, noconstant(0)
 DECLARE dsrtr_priority_from = i4 WITH protect, noconstant(0)
 DECLARE dsrtr_priority_to = i4 WITH protect, noconstant(0)
 DECLARE dsrtr_runner_timestamp = f8 WITH protect, noconstant(0.0)
 DECLARE dsrtr_display_msg = vc WITH protect, noconstant(" ")
 DECLARE dsrtr_display_msg2 = vc WITH protect, noconstant(" ")
 DECLARE dsrtr_expimp_complete = i2 WITH protect, noconstant(0)
 DECLARE dsrtr_exists_ind = i2 WITH protect, noconstant(0)
 DECLARE dsrtr_calltime = f8 WITH protect, noconstant(0.0)
 DECLARE dsrtr_remote_ind = i2 WITH protect, noconstant(0)
 DECLARE dsrtr_ui_chkpt1_issued = i2 WITH protect, noconstant(0)
 DECLARE dsrtr_pause_message = vc WITH protect, noconstant("")
 DECLARE dsrtr_performed_pause_ret = i2 WITH protect, noconstant(0)
 DECLARE dsrtr_accept = vc WITH protect, noconstant("")
 DECLARE dsrtr_overalltime = f8 WITH protect, noconstant(0.0)
 DECLARE dsrtr_elapsed_hours = i4 WITH protect, noconstant(0)
 DECLARE dsrtr_rr_runners = i4 WITH protect, noconstant(0)
 DECLARE dsrtr_rr_main_ident = vc WITH protect, noconstant("DM2NOTSET")
 DECLARE dsrtr_rr_runner_ident = vc WITH protect, noconstant("DM2NOTSET")
 DECLARE dsrtr_status = i2 WITH protect, noconstant(0)
 DECLARE dsrtr_ui_syspause_event = vc WITH protect, noconstant("SYSPAUSE:DDL_EXCL")
 DECLARE dsrtr_ui_install_event = vc WITH protect, noconstant("SCHEMA")
 DECLARE dsrtr_ddl_rpt_filename = vc WITH protect, noconstant("")
 DECLARE dsrtr_node_name = vc WITH protect, noconstant("")
 DECLARE dsrtr_tmp_len = i4 WITH protect, noconstant(0)
 DECLARE dsrtr_total_len = i4 WITH protect, noconstant(0)
 DECLARE dsrtr_bypass_node_check = i4 WITH protect, noconstant(0)
 DECLARE dsrtr_module_name = vc WITH protect, constant("DM_INSTALL_PROCESS")
 DECLARE dsrtr_action_name = vc WITH protect, constant("MAIN_RUNNER")
 DECLARE dsrtr_original_module = vc WITH protect, noconstant("")
 DECLARE dsrtr_original_action = vc WITH protect, noconstant("")
 DECLARE dsrtr_killed_ddl_ind = i2 WITH protect, noconstant(0)
 DECLARE dsrtr_err_msg = vc WITH protect, noconstant("")
