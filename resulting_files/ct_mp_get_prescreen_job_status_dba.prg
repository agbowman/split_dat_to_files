CREATE PROGRAM ct_mp_get_prescreen_job_status:dba
 PROMPT
 ...
 SUBROUTINE (istaskgranted(task_number=i4(val)) =i2 WITH protect)
   ...
   RETURN(task_granted)
 END ;Subroutine
 SET log_program_name = "ct_mp_get_prescreen_job_status"
 ...
 SET reply->status_data.status = "F"
 IF (( $JSONREQUEST=""))
  CALL populate_subeventstatus_rec("REQUEST","F","ct_mp_get_prescreen_job_status",
 ...
 SELECT INTO "nl:"
  ...
  HEAD cpp.prot_master_id
   IF (cpj.job_status_cd=failed_cd)
   ...
   reply->start_dt_tm = cpj.job_start_dt_tm, reply->completed_flag = cpp.completed_flag, reply->
   error_text = lt.long_text,
