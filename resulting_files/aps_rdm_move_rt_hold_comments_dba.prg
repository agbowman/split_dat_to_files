CREATE PROGRAM aps_rdm_move_rt_hold_comments:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "aps_rdm_move_rt_hold_comments"
 ...
 CALL logmsg("Getting ready to begin reading for report_task hold comment.",((e_dispmsg+ e_rdmstatus)
  + e_logtofile))
 SELECT INTO "nl:"
  FROM report_task rt
