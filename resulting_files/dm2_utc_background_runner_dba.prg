CREATE PROGRAM dm2_utc_background_runner:dba
 ...
 SUBROUTINE dm2_get_dbase_name(dgdn_name_out)
   ...
   RETURN(1)
 END ;Subroutine
 DECLARE dubr_get_conversion_status(null) = i2
 DECLARE dubr_dbase_name = vc WITH protect, noconstant(" ")
 DECLARE dubr_dop = i4 WITH protect, noconstant(0)
 DECLARE dubr_cmd = vc WITH protect, noconstant("")
 DECLARE dm2_utc_bkgrnd_calling_script = vc WITH public, noconstant("DM2_UTC_BACKGROUND_RUNNER")
 IF (check_logfile("dm2_utc_br_",".log","DM2_UTC_BACKGROUND_RUNNER LOGFILE")=0)
  GO TO end_program
 ENDIF
 IF (dm2_get_dbase_name(dubr_dbase_name)=0)
  GO TO end_program
 ENDIF
 SET dm2_install_schema->target_dbase_name = cnvtupper(dubr_dbase_name)
 ...
 ENDIF
 IF (dubr_get_conversion_status(null)=0)
  GO TO end_program
 ENDIF
 ...
 ENDIF
 IF (dubr_dop > 0)
  SET dubr_cmd = concat("rdb alter session force parallel ddl parallel ",cnvtstring(dubr_dop)," go")
  IF (dm2_push_cmd(dubr_cmd,1)=0)
   GO TO end_program
  ENDIF
 ENDIF
 ...
 ENDIF
 GO TO end_program
 SUBROUTINE dubr_get_conversion_status(null)
 ...
 END ;Subroutine
#end_program
 SET dm_err->eproc = "DM2_UTC_BACKGROUND_RUNNER Completed."
 CALL final_disp_msg("dm2_utc_br_")
END GO
