CREATE PROGRAM dcp_upd_dx_icd9_hli_syn_c:dba
 ...
 SET ms_child_info_domain_nm = "DCP_UPD_DX_ALL"
 ...
 IF (sbr_fetch_min_max(ms_child_info_domain_nm,ms_range_prefix,ms_child_max_name,mf_max_range_id,
  ...
  GO TO exit_program
 ENDIF
 IF (sbr_sync_ccl_tmp_def("TEMP_DX_ICD9_HLI_SYN")=0)
  GO TO exit_program
 ENDIF
...
#exit_program
 IF ((readme_data->status="F"))
  ROLLBACK
 ELSE
  CALL sbr_truncate_table("TEMP_DX_ICD9_HLI_SYN")
 ENDIF
