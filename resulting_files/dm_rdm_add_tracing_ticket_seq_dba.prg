CREATE PROGRAM dm_rdm_add_tracing_ticket_seq:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_rdm_add_tracing_ticket_seq..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("TRACING_TICKET_SEQ")
 SELECT INTO "nl:"
 ...
 IF (seqexists=1)
  ...
  GO TO exit_script
 ENDIF
 EXECUTE dm_add_sequence value(sequencename), 1, 10000000,
 1, 0
