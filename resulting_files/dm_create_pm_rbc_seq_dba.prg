CREATE PROGRAM dm_create_pm_rbc_seq:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_create_pm_rbc_seq..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("PM_RBC_SEQ")
 SELECT INTO "nl:"
