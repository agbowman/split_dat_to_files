CREATE PROGRAM dm2_mig_replicate_monitor
 ...
 SUBROUTINE dmr_create_di_macro(dcdm_in_dir,dcdm_gg_version)
   ...
   RETURN(1)
 END ;Subroutine
 IF (check_logfile("dm2_mig_repl_monitor",".log","DM2_MIG_REPLICATE_MONITOR LOG FILE")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "BEGIN DM2_MIG_REPLICATE_MONITOR"
 CALL disp_msg(" ",dm_err->logfile,0)
...
#exit_program
 IF ((dm_err->err_ind=1))
  ...
  CALL echo("*")
 ENDIF
 SET dm_err->eproc = "DM2_MIG_REPLICATE_MONITOR completes successfully"
 CALL final_disp_msg("dm2_mig_repl_monitor")
END GO
