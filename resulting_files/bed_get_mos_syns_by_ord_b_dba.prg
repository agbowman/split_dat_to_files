CREATE PROGRAM bed_get_mos_syns_by_ord_b:dba
 ...
 FOR (w = 1 TO req_cnt)
   ...
   ENDIF
   SELECT INTO "nl:"
    FROM (dummyt d3  WITH seq = value(syn_cnt)),
     (dummyt d  WITH seq = 1),
    ...
    PLAN (d3
     WHERE maxrec(d,size(treply2->orders[w].synonyms[d3.seq].sentences,5)))
     JOIN (d
     WHERE maxrec(d2,size(treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details,5)))
     JOIN (d2)
     JOIN (ofm
     WHERE (ofm.oe_field_meaning=treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq]
     .field_meaning))
     JOIN (oef
     ...
     WHERE off.oe_field_id=oef.oe_field_id
      ...
      AND (off.oe_format_id=reply->orders[w].synonyms[d3.seq].oe_format_id))
    ORDER BY d2.seq
    DETAIL
     treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].codeset = oef.codeset,
     treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].oe_field_id = oef
     .oe_field_id, treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].
     oe_field_label = oef.description,
     treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].field_type_flag = oef
     .field_type_flag, treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].field_seq
      = off.field_seq, treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].group_seq
      = off.group_seq,
     treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].label_text = off.label_text,
     treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].clin_line_label = off
     .clin_line_label, treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].
     clin_suffix_ind = off.clin_suffix_ind,
     treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].clin_line_ind = off
     .clin_line_ind, treply2->orders[w].synonyms[d3.seq].sentences[d.seq].details[d2.seq].
   ...
   FOR (x = 1 TO syn_cnt)
     ...
     IF (sent_cnt > 0)
      SELECT INTO "nl:"
       ...
       DETAIL
        ...
        ELSE
         treply->orders[w].synonyms[x].sentences[d.seq].details[dtcnt].field_code_value = cnvtint(osd
          .oe_field_value)
        ENDIF
        treply->orders[w].synonyms[x].sentences[d.seq].details[dtcnt].field_meaning = oem
        .oe_field_meaning, treply->orders[w].synonyms[x].sentences[d.seq].details[dtcnt].
        oe_field_label = oef.description, treply->orders[w].synonyms[x].sentences[d.seq].details[
        dtcnt].field_type_flag = oef.field_type_flag,
        treply->orders[w].synonyms[x].sentences[d.seq].details[dtcnt].field_seq = off.field_seq,
        treply->orders[w].synonyms[x].sentences[d.seq].details[dtcnt].group_seq = off.group_seq,
        ...
        clin_suffix_ind = off.clin_suffix_ind, treply->orders[w].synonyms[x].sentences[d.seq].
        details[dtcnt].clin_line_ind = off.clin_line_ind,
        treply->orders[w].synonyms[x].sentences[d.seq].details[dtcnt].disp_yes_no_flag = off
        .disp_yes_no_flag
       FOOT  d.seq
      ...
      SELECT INTO "nl:"
       ...
       PLAN (d
        WHERE (treply->orders[w].synonyms[x].sentences[d.seq].source=3))
        JOIN (osf
        WHERE (osf.order_sentence_id=treply->orders[w].synonyms[x].sentences[d.seq].os_id))
        JOIN (cv_age
       ...
       DETAIL
        treply->orders[w].synonyms[x].sentences[d.seq].filters.order_sentence_filter_id = osf
        .order_sentence_filter_id, treply->orders[w].synonyms[x].sentences[d.seq].filters.
        age_min_value = osf.age_min_value, treply->orders[w].synonyms[x].sentences[d.seq].filters.
        age_max_value = osf.age_max_value,
        treply->orders[w].synonyms[x].sentences[d.seq].filters.age_unit_cd.code_value = osf
        .age_unit_cd, treply->orders[w].synonyms[x].sentences[d.seq].filters.age_unit_cd.display =
        cv_age.display, treply->orders[w].synonyms[x].sentences[d.seq].filters.age_unit_cd.
        description = cv_age.description,
        treply->orders[w].synonyms[x].sentences[d.seq].filters.age_unit_cd.mean = cv_age.cdf_meaning,
        treply->orders[w].synonyms[x].sentences[d.seq].filters.pma_min_value = osf.pma_min_value,
        treply->orders[w].synonyms[x].sentences[d.seq].filters.pma_max_value = osf.pma_max_value,
        treply->orders[w].synonyms[x].sentences[d.seq].filters.pma_unit_cd.code_value = osf
        .pma_unit_cd, treply->orders[w].synonyms[x].sentences[d.seq].filters.pma_unit_cd.display =
        cv_pma.display, treply->orders[w].synonyms[x].sentences[d.seq].filters.pma_unit_cd.
        description = cv_pma.description,
        treply->orders[w].synonyms[x].sentences[d.seq].filters.pma_unit_cd.mean = cv_pma.cdf_meaning,
        treply->orders[w].synonyms[x].sentences[d.seq].filters.weight_min_value = osf
        .weight_min_value, treply->orders[w].synonyms[x].sentences[d.seq].filters.weight_max_value =
        osf.weight_max_value,
        treply->orders[w].synonyms[x].sentences[d.seq].filters.weight_unit_cd.code_value = osf
        .weight_unit_cd, treply->orders[w].synonyms[x].sentences[d.seq].filters.weight_unit_cd.
        display = cv_weight.display, treply->orders[w].synonyms[x].sentences[d.seq].filters.
        weight_unit_cd.description = cv_weight.description,
        treply->orders[w].synonyms[x].sentences[d.seq].filters.weight_unit_cd.mean = cv_weight
        .cdf_meaning
       WITH nocounter
      ;end select
     ENDIF
     SELECT INTO "nl:"
      FROM (dummyt d  WITH seq = value(sent_cnt)),
       ...
       code_value_set cvs
      PLAN (d
       WHERE maxrec(d2,size(treply->orders[w].synonyms[x].sentences[d.seq].details,5)))
       JOIN (d2
       WHERE (treply->orders[w].synonyms[x].sentences[d.seq].details[d2.seq].codeset > 0)
        AND (treply->orders[w].synonyms[x].sentences[d.seq].load_ind=1)
        AND (treply->orders[w].synonyms[x].sentences[d.seq].source IN (1, 2)))
       JOIN (cvs
       WHERE (cvs.code_set=treply->orders[w].synonyms[x].sentences[d.seq].details[d2.seq].codeset))
       JOIN (b
       WHERE b.codeset=outerjoin(cvs.code_set)
        AND b.field_value=outerjoin(cnvtupper(treply->orders[w].synonyms[x].sentences[d.seq].details[
         d2.seq].field_disp_value))
        AND b.parent_entity_name=outerjoin("CODE_VALUE"))
      ORDER BY d.seq, d2.seq
      HEAD d2.seq
       IF (b.br_med_ordsent_map_id=0)
        treply->orders[w].synonyms[x].sentences[d.seq].load_ind = 0
       ELSE
        treply->orders[w].synonyms[x].sentences[d.seq].details[d2.seq].field_code_value = b
        .parent_entity_id, treply->orders[w].synonyms[x].sentences[d.seq].details[d2.seq].
       ...
       FOR (z = 1 TO det_cnt)
         IF ((treply->orders[w].synonyms[x].sentences[y].details[z].field_type_flag=7))
          IF ((treply->orders[w].synonyms[x].sentences[y].details[z].field_disp_value IN ("YES", "1")
           ...
           SET treply->orders[w].synonyms[x].sentences[y].details[z].field_code_value = 1.0
          ENDIF
          IF ((treply->orders[w].synonyms[x].sentences[y].details[z].field_disp_value IN ("NO", "0"))
           ...
           SET treply->orders[w].synonyms[x].sentences[y].details[z].field_code_value = 0.0
          ENDIF
         ELSEIF ((treply->orders[w].synonyms[x].sentences[y].details[z].field_type_flag=2))
          SET treply->orders[w].synonyms[x].sentences[y].details[z].field_code_value = cnvtreal(
           treply->orders[w].synonyms[x].sentences[y].details[z].field_disp_value)
         ENDIF
       ...
       DETAIL
        ...
        orders[w].synonyms[x].sentences[d.seq].source=3))) )
         IF ((treply->orders[w].synonyms[x].sentences[d.seq].source IN (1, 2)))
          ...
          det_cnt = size(treply->orders[w].synonyms[x].sentences[d.seq].details,5), fil_cnt = size(
           treply->orders[w].synonyms[x].sentences[d.seq].filters,5), stat = alterlist(reply->orders[
           w].synonyms[x].sentences[rep_sent_cnt].details,det_cnt)
          FOR (d = 1 TO det_cnt)
         ...
         IF ((treply->orders[w].synonyms[x].sentences[d.seq].source=3))
          ...
          FOR (d = 1 TO det_cnt)
            ...
            orders[w].synonyms[x].sentences[d.seq].details[d].oe_field_label
          ENDFOR
          reply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.order_sentence_filter_id =
          treply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.order_sentence_filter_id,
          reply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.age_min_value = treply->
          orders[w].synonyms[x].sentences[rep_sent_cnt].filters.age_min_value, reply->orders[w].
          synonyms[x].sentences[rep_sent_cnt].filters.age_max_value = treply->orders[w].synonyms[x].
          sentences[rep_sent_cnt].filters.age_max_value,
          reply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.age_unit_cd.code_value =
          treply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.age_unit_cd.code_value, reply
          ->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.age_unit_cd.display = treply->
          orders[w].synonyms[x].sentences[rep_sent_cnt].filters.age_unit_cd.display, reply->orders[w]
          .synonyms[x].sentences[rep_sent_cnt].filters.age_unit_cd.description = treply->orders[w].
          synonyms[x].sentences[rep_sent_cnt].filters.age_unit_cd.description,
          reply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.age_unit_cd.mean = treply->
          orders[w].synonyms[x].sentences[rep_sent_cnt].filters.age_unit_cd.mean, reply->orders[w].
          synonyms[x].sentences[rep_sent_cnt].filters.pma_min_value = treply->orders[w].synonyms[x].
          sentences[rep_sent_cnt].filters.pma_min_value, reply->orders[w].synonyms[x].sentences[
          rep_sent_cnt].filters.pma_max_value = treply->orders[w].synonyms[x].sentences[rep_sent_cnt]
          .filters.pma_max_value,
          reply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.pma_unit_cd.code_value =
          treply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.pma_unit_cd.code_value, reply
          ->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.pma_unit_cd.display = treply->
          orders[w].synonyms[x].sentences[rep_sent_cnt].filters.pma_unit_cd.display, reply->orders[w]
          .synonyms[x].sentences[rep_sent_cnt].filters.pma_unit_cd.description = treply->orders[w].
          synonyms[x].sentences[rep_sent_cnt].filters.pma_unit_cd.description,
          reply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.pma_unit_cd.mean = treply->
          orders[w].synonyms[x].sentences[rep_sent_cnt].filters.pma_unit_cd.mean, reply->orders[w].
          synonyms[x].sentences[rep_sent_cnt].filters.weight_min_value = treply->orders[w].synonyms[x
          ].sentences[rep_sent_cnt].filters.weight_min_value, reply->orders[w].synonyms[x].sentences[
          rep_sent_cnt].filters.weight_max_value = treply->orders[w].synonyms[x].sentences[
          rep_sent_cnt].filters.weight_max_value,
          reply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.weight_unit_cd.code_value =
          treply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.weight_unit_cd.code_value,
          reply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.weight_unit_cd.display =
          treply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.weight_unit_cd.display, reply
          ->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.weight_unit_cd.description = treply
          ->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.weight_unit_cd.description,
          reply->orders[w].synonyms[x].sentences[rep_sent_cnt].filters.weight_unit_cd.mean = treply->
          orders[w].synonyms[x].sentences[rep_sent_cnt].filters.weight_unit_cd.mean
         ENDIF
