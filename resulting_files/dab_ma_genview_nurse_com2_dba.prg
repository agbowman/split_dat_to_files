CREATE PROGRAM dab_ma_genview_nurse_com2:dba
 ...
 SELECT DISTINCT INTO "nl:"
  ...
  PLAN (c
   ...
   abdominalgirth_cd, headcircumference_cd, childspreferredname_cd, weight_cd, height_cd,
   nursecommunicationnutrition_cd, nursecommunicationcardiacrehab_cd, jail_cd,
   ...
   portableunitrequired_cd, patientgoinghomeonoxygen_cd,
   confirmedtransferstarttimedate_cd, pulmonarynurseappointment_cd, ambulanceservices_cd,
   phaseiisiteofcare_cd, cardiacorientationappointment_cd,
  ...
  DETAIL
   ...
   ELSEIF (c.event_cd=needsservicesondischarge_cd)
    dlrec->seq[cnt].category = 3, dlrec->seq[cnt].result_sort = 10
   ELSEIF (c.event_cd=posthospitalservicesrequired_cd)
    dlrec->seq[cnt].category = 3, dlrec->seq[cnt].result_sort = 11
