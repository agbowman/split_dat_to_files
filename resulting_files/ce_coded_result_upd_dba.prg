CREATE PROGRAM ce_coded_result_upd:dba
 RECORD reply(
   1 array_size = i4
   1 num_inserted = i4
   1 error_code = i4
 ...
 UPDATE  FROM ce_coded_result t,
  ...
  SET t.event_id = evaluate2(
   ...
   t.acr_code_str = request->lst[d.seq].acr_code_str, t.proc_code_str = request->lst[d.seq].
   proc_code_str, t.pathology_str = request->lst[d.seq].pathology_str,
