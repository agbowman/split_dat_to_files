CREATE PROGRAM bhs_ma_prsnl_90_day_all:dba
 PROMPT
 ...
 IF (email_ind=1)
  ...
  SET filename_out = concat(format(curdate,"YYYY-MM-DD;;D"),"_90-day-ALL.csv")
  DECLARE subject_line = vc
  SET subject_line = concat(curprog," V5.x - Any BHS CIS Acnts InActive 90 days")
