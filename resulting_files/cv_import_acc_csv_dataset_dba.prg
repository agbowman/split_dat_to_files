CREATE PROGRAM cv_import_acc_csv_dataset:dba
 ...
 SELECT INTO "NL:"
  ...
  WITH nocounter
 ;end select
 CALL echorecord(requestin,"cer_temp:cvRequest.dat")
 RECORD reply_xref(
   1 return_rec[*]
     2 xref_id = f8
     2 xref_internal_name = vc
 ...
 SELECT INTO "NL:"
  ...
  WITH nocounter
 ;end select
 CALL echorecord(request_xref,"cer_temp:cvxref.dat")
 ...
 ENDFOR
 CALL echorecord(request_response,"cer_temp:cvresponse.dat")
