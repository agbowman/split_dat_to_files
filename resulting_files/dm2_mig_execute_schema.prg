CREATE PROGRAM dm2_mig_execute_schema
 ...
 SUBROUTINE dmr_create_di_macro(dcdm_in_dir,dcdm_gg_version)
   ...
   RETURN(1)
 END ;Subroutine
 IF (check_logfile("dm2_mig_exe_sch",".log","DM2_MIG_EXECUTE_SCHEMA LOG FILE")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "BEGIN DM2_MIG_EXECUTE_SCHEMA"
 CALL disp_msg(" ",dm_err->logfile,0)
 ...
 IF ((((dmr_mig_data->cur_db_type != "TARGET")) OR (currdbuser != "V500")) )
  ...
  ENDIF
 ENDIF
 DECLARE dmes_sch_date = vc WITH protect, noconstant( $1)
 DECLARE dmes_op_type = vc WITH protect, noconstant( $2)
 SET dm2_install_schema->curprog = "NONE"
 SET dm2_allow_same_db_name = 1
 EXECUTE dm2_execute_schema dmes_sch_date, dmes_op_type
#exit_program
 IF ((dm_err->err_ind=1))
  ...
  CALL echo("*")
 ENDIF
 SET dm_err->eproc = "DM2_MIG_EXECUTE_SCHEMA completes successfully"
 CALL final_disp_msg("dm2_mig_exe_sch")
END GO
