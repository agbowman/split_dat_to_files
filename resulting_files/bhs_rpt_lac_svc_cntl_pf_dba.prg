CREATE PROGRAM bhs_rpt_lac_svc_cntl_pf:dba
 PROMPT
  "FACILITY:" = - (1)
  WITH facility
 ...
 SET cntl_lac_svc_pf->md_beg_dt_tm = cnvtdatetime((curdate - days),000000)
 SET cntl_lac_svc_pf->md_end_dt_tm = cnvtdatetime(curdate,235900)
 CALL echo("TIMES:")
 ...
 ENDIF
 IF (( $FACILITY="BFMC"))
  SET logical lac_cntl_rpt_file "bhscust:bhs_rpt_fmclac_svc_cntl_pf.csv"
  SET ms_email_filename = "bhs_rpt_fmclac_svc_cntl_pf.cvs"
 ENDIF
 SELECT INTO "nl:"
  FROM code_value cv
  PLAN (cv
