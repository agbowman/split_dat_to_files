 ...
 SELECT INTO  $OUTDEV
  ...
  PLAN (o
   ...
   WHERE e.person_id=o.person_id
    AND (e.loc_facility_cd= $VAR_FAC_CD)
  ...
  DETAIL
   ...
   last_rm_bd, nur_rests += 1, fac_rests += 1,
   ...
   o.orig_order_dt_tm"mm/dd/yy hh:mm;;q", init_wrap
   ...
   spaces)
     ...
     IF (((t_len+ len) > 82))
      ...
      t_len = 0
     ENDIF
     x = movestring(o.clinical_display_line,bw,temp,(t_len+ 1),len), pos += len
     IF (r_cnt >= 55)
