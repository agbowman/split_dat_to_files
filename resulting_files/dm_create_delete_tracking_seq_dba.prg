CREATE PROGRAM dm_create_delete_tracking_seq:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_create_delete_tracking_seq..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("DM_DELETE_TRACKING_SEQ")
 SELECT INTO "nl:"
