CREATE PROGRAM bhs_ma_genview_nurse_com:dba
 ...
 SELECT DISTINCT INTO "nl:"
  ...
  PLAN (c
   ...
   portableunitrequired_cd, patientgoinghomeonoxygen_cd, dsarrangedtransferstarttimedate_cd,
   pulmonarynurseappointment_cd, dstransportationarranged_cd,
