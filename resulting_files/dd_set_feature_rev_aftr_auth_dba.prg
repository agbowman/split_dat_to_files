CREATE PROGRAM dd_set_feature_rev_aftr_auth:dba
 ...
 END ;Subroutine
 SET readme_data->status = "F"
 SET readme_data->message = concat("Error: Fail starting script dd_set_feature_rev_aftr_auth:",
  error_msg)
 CALL setfeatureflag("REVISE_AFTER_AUTH",onflag)
