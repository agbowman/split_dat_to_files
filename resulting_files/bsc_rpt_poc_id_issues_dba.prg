CREATE PROGRAM bsc_rpt_poc_id_issues:dba
 PROMPT
  ...
  IF ((audit_request->display_ind=ndisplayperuser))
   SELECT INTO  $1
    ...
    HEAD name
     ...
     lmednotidentcnt = (lmednotidentcnt+ audit_reply->summary_qual[d.seq].med_not_ident_cnt),
     sdisplay = formatlabelbylength(audit_reply->summary_qual[d.seq].name_full_formatted,29),
     col 00, sdisplay, sdisplay = nullterm(format(audit_reply->summary_qual[d.seq].
       med_admin_event_cnt,"#####;It(1);I")),
     col 30, sdisplay, sdisplay = nullterm(format(audit_reply->summary_qual[d.seq].positive_pat_cnt,
       "#####;It(1);I")),
     col 50, sdisplay, sdisplay = nullterm(format(audit_reply->summary_qual[d.seq].positive_med_cnt,
       "#####;It(1);I")),
     col 70, sdisplay, sdisplay = nullterm(format(audit_reply->summary_qual[d.seq].pat_not_ident_cnt,
       "#####;It(1);I")),
     col 90, sdisplay, sdisplay = nullterm(format(audit_reply->summary_qual[d.seq].med_not_ident_cnt,
       "#####;It(1);I")),
     col 110, sdisplay, row + 1
    FOOT REPORT
