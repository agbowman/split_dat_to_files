CREATE PROGRAM dm_async_exec_daily:dba
 ...
 SUBROUTINE async_exec_script(appid,taskid,reqid,scriptname)
   ...
   IF (iret != 0)
    CALL esmerror(build("Error calling CrmPerform:",iret),esmreturn)
    CALL echo(build("Execution of ",scriptname," was not successful"))
    GO TO end_routine
   ENDIF
   CALL echo(build("Execution of ",scriptname," was successful"))
#end_routine
   IF (hreq > 0)
   ...
   ENDIF
 END ;Subroutine
 SET stat = alterlist(async_exec->qual,5)
 SET async_exec->qual[1].appid = 7700
 SET async_exec->qual[1].taskid = 7700
 SET async_exec->qual[1].reqid = 7702
 SET async_exec->qual[1].scriptname = "dm_stat_lighthouse_wrapper"
 SET async_exec->qual[2].appid = 7700
 SET async_exec->qual[2].taskid = 7700
 SET async_exec->qual[2].reqid = 7703
 SET async_exec->qual[2].scriptname = "dm_stat_preferences"
 SET async_exec->qual[3].appid = 7700
 SET async_exec->qual[3].taskid = 7700
 SET async_exec->qual[3].reqid = 7704
 SET async_exec->qual[3].scriptname = "dm_stat_pref_manager"
 SET async_exec->qual[4].appid = 7700
 SET async_exec->qual[4].taskid = 7700
 SET async_exec->qual[4].reqid = 7705
 SET async_exec->qual[4].scriptname = "dm_stat_core_privs"
 SET async_exec->qual[5].appid = 7700
 SET async_exec->qual[5].taskid = 7700
 SET async_exec->qual[5].reqid = 7706
 SET async_exec->qual[5].scriptname = "dm_stat_ue_unique_patients"
 FOR (itr = 1 TO size(async_exec->qual,5))
   CALL echo(build("Executing Async Daily script: ",async_exec->qual[itr].scriptname))
   CALL echo(build("App Id:",async_exec->qual[itr].appid))
   CALL echo(build("Task Id:",async_exec->qual[itr].taskid))
   CALL echo(build("Request Id:",async_exec->qual[itr].reqid))
   CALL async_exec_script(async_exec->qual[itr].appid,async_exec->qual[itr].taskid,async_exec->qual[
    itr].reqid,async_exec->qual[itr].scriptname)
 ENDFOR
END GO
