CREATE PROGRAM bhs_rpt_suicide_prec:dba
 PROMPT
 ...
 SET echo_ind = 1
 SET rpt_name = "Patients with Suicide Precautions orders"
 SET prg_name = cnvtlower(curprog)
 DECLARE mf_suicideprecautions_cd = f8 WITH protect, constant(uar_get_code_by("DISPLAYKEY",200,
   "SUICIDEPRECAUTIONS"))
 DECLARE mrn_cd = f8
 SET mrn_cd = 0.0
 ...
 SELECT INTO  $OUTDEV
  ...
  PLAN (ed
   ...
   WHERE o.encntr_id=e.encntr_id
    AND o.catalog_cd=mf_suicideprecautions_cd
  ...
  DETAIL
   ...
   mnem = trim(o.ordered_as_mnemonic), col 005, "{b/20}Precautions Ordered: ",
