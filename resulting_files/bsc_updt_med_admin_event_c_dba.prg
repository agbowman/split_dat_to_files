CREATE PROGRAM bsc_updt_med_admin_event_c:dba
 ...
 SET ms_child_info_domain_nm = "UPDATE ADMIN EVENT - EVENT_ID"
 SET ms_range_prefix = "ADMIN EVENT_ID RANGE"
 SET ms_child_max_name = "MAX ADMIN EVENT_ID EVALUATED"
