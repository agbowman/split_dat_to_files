CREATE PROGRAM dm2_test_sch_files2:dba
 ...
 END ;Subroutine
#end_sch_files_inc
 CALL check_logfile("dm2_test_sch_files",".log","DM2_TEST_SCH_FILES LOG FILE")
 SET dm2_sch_file->dest_dir_cclfmt = "cer_install"
 SET dm2_sch_file->file_prefix = "rstest"
 CALL echo("*****CALLING CREATE_SCH_FILES*******")
 CALL create_sch_files(null)
 CALL echo("*****CALLING CLOSE_SCH_FILES*******")
 CALL close_sch_files(null)
 SET dm2_sch_file->src_dir_osfmt = build(logical("cer_install"),"/")
 SET dm2_sch_file->dest_dir_osfmt = "/db2/home/v500/"
 SET dm2_sch_file->file_prefix = "rstest"
 CALL echo("*****COPY_SCH_FILES*******")
 CALL copy_sch_files(null)
 SET dm2_sch_file->dest_dir_cclfmt = "cer_install"
 CALL echo("*****OPEN_SCH_FILES*******")
 CALL open_sch_files(0)
END GO
