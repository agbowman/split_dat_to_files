CREATE PROGRAM bhs_rpt_dietary_report_111708:dba
 PROMPT
 ...
 SELECT INTO "nl:"
  ...
  PLAN (d
   ...
   WHERE (o.encntr_id=diet->qual[d.seq].encntr_id)
    ...
    AND ((o.order_status_cd+ 0)= $ORDER_STATUS)
    AND ((o.catalog_cd=meal_delievery_cd
    AND  EXISTS (
   (SELECT
    od.order_id
    ...
    WHERE od.order_id=o.order_id
     ...
     AND od.oe_field_display_value="Non-select Tray Service"))) OR (o.catalog_cd=non_sel_tray_cd)) )
  ORDER BY o.encntr_id, o.order_id
  HEAD o.encntr_id
   ord_cnt = 0
  HEAD o.order_id
