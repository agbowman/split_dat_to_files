CREATE PROGRAM bhs_rw_pt_ed_pedi_genview:dba
 ...
 ELSE
  ...
  GO TO exit_script
 ENDIF
 SET work->form_desc = "Patient/Family Education - Pedi"
 SELECT INTO "NL:"
  e.person_id
  FROM encounter e
  PLAN (e
 ...
 SELECT INTO "NL:"
  ...
  PLAN (dfa
   ...
   WHERE dfac.parent_entity_id=ce.parent_event_id
    ...
    AND  NOT (ce.event_title_text IN (work->form_desc, "Topic Taught Pedi")))
   JOIN (dsr
