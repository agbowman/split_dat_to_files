CREATE PROGRAM dm2_oragen3_c_to_vc_w:dba
 ...
 SET readme_data->message = "Readme Failed: Starting script dm2_oragen_c_to_vcw..."
 IF (check_logfile("dm2_o3_ctovcw",".log","dm2_o3_ctovcw log file")=0)
  GO TO exit_script
 ENDIF
 EXECUTE dm2_oragen3_c_to_vc "V500"
 IF ((dm_err->err_ind=1))
  GO TO exit_script
 ENDIF
 IF ((dm_err->err_ind=0))
 ...
 IF ((readme_data->status != "F"))
  ...
  SET dm_err->eproc = "dm2_oragen_c_to_vc."
 ENDIF
 FREE RECORD doctv_list
#exit_script
 SET dm_err->eproc = "dm2_oragen_c_to_vcw COMPLETED."
 CALL final_disp_msg("dm2_o3_ctovcw")
 CALL echo("##################################################")
