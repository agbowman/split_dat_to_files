CREATE PROGRAM bed_aud_dta_info:dba
    ...
    SELECT INTO "nl:"
     ...
     DETAIL
      ...
      IF (ar.reference_ind=1)
       temp->dlist[x].rrf[d.seq].al[acnt].reference = "Yes"
      ENDIF
     WITH nocounter
    ;end select
   ENDIF
...
#skip_processing
 ...
 SET reply->collist[14].header_text = "Crit Low"
 SET reply->collist[14].data_type = 1
 SET reply->collist[14].hide_ind = 0
 SET reply->collist[15].header_text = "Crit High"
 ...
 SET reply->collist[20].header_text = "Dilute Ind"
 ...
 SET reply->collist[25].header_text = "Reference Ind"
 SET reply->collist[25].data_type = 1
 SET reply->collist[25].hide_ind = 0
 SET reply->collist[26].header_text = "Report Value"
 SET reply->collist[26].data_type = 1
 SET reply->collist[26].hide_ind = 0
 SET reply->collist[27].header_text = "Use Units"
 SET reply->collist[27].data_type = 1
 SET reply->collist[27].hide_ind = 0
 SET reply->collist[28].header_text = "Units of Measure"
 SET reply->collist[28].data_type = 1
 SET reply->collist[28].hide_ind = 0
 SET reply->collist[29].header_text = "Delta Check Type"
 SET reply->collist[29].data_type = 1
 SET reply->collist[29].hide_ind = 0
 SET reply->collist[30].header_text = "Delta Timeframe"
 SET reply->collist[30].data_type = 1
 SET reply->collist[30].hide_ind = 0
 SET reply->collist[31].header_text = "Delta Timeframe Units"
 SET reply->collist[31].data_type = 1
 SET reply->collist[31].hide_ind = 0
 SET reply->collist[32].header_text = "Delta Value"
 SET reply->collist[32].data_type = 1
 SET reply->collist[32].hide_ind = 0
 SET reply->collist[33].header_text = "Min Digit"
 SET reply->collist[33].data_type = 1
 SET reply->collist[33].hide_ind = 0
 SET reply->collist[34].header_text = "Max Digit"
 SET reply->collist[34].data_type = 1
 SET reply->collist[34].hide_ind = 0
 SET reply->collist[35].header_text = "Min Decimal"
 SET reply->collist[35].data_type = 1
 SET reply->collist[35].hide_ind = 0
 SET reply->collist[36].header_text = "task_assay_cd"
 SET reply->collist[36].data_type = 2
 SET reply->collist[36].hide_ind = 1
 SET reply->collist[37].header_text = "service_resource_cd"
 SET reply->collist[37].data_type = 2
 SET reply->collist[37].hide_ind = 1
 SET reply->collist[38].header_text = "reference_range_factor_id"
 SET reply->collist[38].data_type = 2
 SET reply->collist[38].hide_ind = 1
 SET row_nbr = 0
 FOR (x = 1 TO tcnt)
   SET rcnt = size(temp->dlist[x].rrf,5)
   SET skip_nrrf_ind = 0
   ...
   FOR (y = 1 TO rcnt)
     IF ((temp->dlist[x].rrf[y].skip_ind=0))
      ...
      SET stat = alterlist(reply->rowlist[row_nbr].celllist,38)
      ...
      SET reply->rowlist[row_nbr].celllist[20].string_value = trim(temp->dlist[x].rrf[y].dilute)
      SET reply->rowlist[row_nbr].celllist[21].string_value = trim(temp->dlist[x].rrf[y].fl_disp)
      SET reply->rowlist[row_nbr].celllist[22].string_value = trim(temp->dlist[x].rrf[y].fh_disp)
      SET reply->rowlist[row_nbr].celllist[28].string_value = trim(temp->dlist[x].rrf[y].units)
      SET reply->rowlist[row_nbr].celllist[29].string_value = trim(temp->dlist[x].rrf[y].
       delta_check_type_disp)
      SET reply->rowlist[row_nbr].celllist[30].string_value = cnvtstring(temp->dlist[x].rrf[y].
       delta_time_value)
      SET reply->rowlist[row_nbr].celllist[31].string_value = trim(temp->dlist[x].rrf[y].
       delta_time_unit)
      ...
      SET reply->rowlist[row_nbr].celllist[33].string_value = cnvtstring(temp->dlist[x].rrf[y].
       min_digits)
      SET reply->rowlist[row_nbr].celllist[34].string_value = cnvtstring(temp->dlist[x].rrf[y].
       max_digits)
      SET reply->rowlist[row_nbr].celllist[35].string_value = cnvtstring(temp->dlist[x].rrf[y].
       min_decimal_places)
      SET reply->rowlist[row_nbr].celllist[36].double_value = temp->dlist[x].task_assay_cd
      SET reply->rowlist[row_nbr].celllist[37].double_value = temp->dlist[x].rrf[y].
      service_resource_cd
      SET reply->rowlist[row_nbr].celllist[38].double_value = temp->dlist[x].rrf[y].
...
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("refrange_audit.csv")
 ENDIF
