CREATE PROGRAM cp_inact_pathway:dba
 PROMPT
  "Output to File/Printer/MINE:" = "MINE",
  "Pathway Ids:" = 0.0
  WITH outdev, pathway_id
 RECORD pathwaynodes(
   1 node_list[*]
     2 node_id = f8
 )
 ...
 DECLARE dpathwayid = f8 WITH protect, constant( $PATHWAY_ID)
 ...
 IF ((pathway_updt_reply->pathway_id > 0))
 ...
 SUBROUTINE checkpathwayid(null)
   ...
   SELECT INTO "nl:"
    ...
    WITH nocounter
   ;end select
   SET spathwayname = concat(trim(pathway_updt_reply->pathway_name),"_inactivated_",format(curdate,
     "mm_dd_yyyy;;d"),"_",format(curtime3,"hhmm;3;m"))
   IF (validate(debug_ind,0)=1)
