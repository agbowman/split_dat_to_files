CREATE PROGRAM bed_ens_copy_filter_params:dba
 ...
 FOR (filteridx = 1 TO filter_cnt)
   SET datamartcategoryid = request->filter[filteridx].br_datamart_category_id
   ...
   ENDIF
   CALL insertvalues(filteridx,0.0,0,datamartcategoryid)
