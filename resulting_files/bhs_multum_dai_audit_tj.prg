CREATE PROGRAM bhs_multum_dai_audit_tj
 ...
 SET stat = remove("dai_summary.xls")
 ...
 SELECT INTO "dai_summary.xls"
  ...
  HEAD REPORT
   ...
   percent_3 = 0.00, t_line = "Drug Allergy Interaction Report Detail", col 0,
 ...
 IF (findfile("dai_detail.xls")=1
  AND findfile("dai_summary.xls")=1)
