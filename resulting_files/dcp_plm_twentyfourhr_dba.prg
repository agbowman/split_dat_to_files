CREATE PROGRAM dcp_plm_twentyfourhr:dba
 RECORD temp(
   1 ecnt = i2
   1 el[*]
     2 encntr_id = f8
 ...
 IF (lab_result_ind=1
  ...
  SELECT INTO "nl:"
   ...
   DETAIL
    ...
    ce.event_cd,
    temp->el[d.seq].lr[lcnt].event_name = trim(uar_get_code_display(ce.event_cd))
 ...
 IF (nurse_result_ind=1
  ...
  SELECT INTO "nl:"
   ...
   DETAIL
    ...
    ce.event_cd,
    temp->el[d.seq].nr[ncnt].event_name = trim(uar_get_code_display(ce.event_cd))
    IF (ce.event_class_cd IN (txt_cd, num_cd, date_cd))
  ...
  SELECT INTO "nl:"
   ...
   PLAN (d)
    ...
    WHERE (rad.person_id=temp->el[d.seq].person_id)
     ...
     AND rad.event_end_dt_tm >= cnvtdatetime((curdate - 1),curtime)
 ...
 FOR (x = 1 TO temp->ecnt)
   ...
   FOR (lnk_idx = 1 TO nbr_links)
     IF ((reply->links[lnk_idx].title="LABS"))
      ...
      FOR (y = 1 TO temp->el[x].lr_cnt)
        IF (y=256)
         SET reply->row[x].links[lnk_idx].row[y].separator_ind = 1
         SET reply->row[x].links[lnk_idx].row[y].separator_value = "== UNABLE TO LOAD ALL LABS =="
        ...
        ELSE
         ...
         SET stat = alterlist(reply->row[x].links[lnk_idx].row[y].col,6)
         SET reply->row[x].links[lnk_idx].row[y].col[1].value = temp->el[x].lr[y].event_name
         SET reply->row[x].links[lnk_idx].row[y].col[2].value = temp->el[x].lr[y].normalcy_disp
         IF ((temp->el[x].lr[y].normalcy_disp > " "))
          SET reply->row[x].links[lnk_idx].row[y].color = 255
         ENDIF
         SET reply->row[x].links[lnk_idx].row[y].col[3].value = temp->el[x].lr[y].result_val
         SET reply->row[x].links[lnk_idx].row[y].col[4].value = temp->el[x].lr[y].ref_range
         SET reply->row[x].links[lnk_idx].row[y].col[5].value = temp->el[x].lr[y].event_end_dt_tm
         SET reply->row[x].links[lnk_idx].row[y].col[6].value = temp->el[x].lr[y].note
     ...
     ELSEIF ((reply->links[lnk_idx].title="NURS"))
      ...
      FOR (y = 1 TO temp->el[x].nr_cnt)
        IF (y=256)
         SET reply->row[x].links[lnk_idx].row[y].separator_ind = 1
         SET reply->row[x].links[lnk_idx].row[y].separator_value = "== UNABLE TO LOAD ALL RSLTS =="
         SET y = temp->el[x].nr_cnt
        ELSE
         SET reply->row[x].links[lnk_idx].row[y].separator_ind = 0
         SET reply->row[x].links[lnk_idx].row[y].separator_value = ""
         SET stat = alterlist(reply->row[x].links[lnk_idx].row[y].col,4)
         SET reply->row[x].links[lnk_idx].row[y].col[1].value = temp->el[x].nr[y].event_name
         SET reply->row[x].links[lnk_idx].row[y].col[2].value = temp->el[x].nr[y].result_val
         SET reply->row[x].links[lnk_idx].row[y].col[3].value = temp->el[x].nr[y].event_end_dt_tm
         SET reply->row[x].links[lnk_idx].row[y].col[4].value = temp->el[x].nr[y].note
         SET reply->row[x].links[lnk_idx].row[y].blob = ""
        ENDIF
      ENDFOR
     ELSEIF ((reply->links[lnk_idx].title="RADS"))
      ...
      FOR (y = 1 TO temp->el[x].rad_cnt)
        IF (y=256)
         SET reply->row[x].links[lnk_idx].row[y].separator_ind = 1
         SET reply->row[x].links[lnk_idx].row[y].separator_value = "== UNABLE TO LOAD ALL RADS =="
         SET y = temp->el[x].rad_cnt
        ELSE
         SET reply->row[x].links[lnk_idx].row[y].separator_ind = 0
         SET reply->row[x].links[lnk_idx].row[y].separator_value = ""
         SET stat = alterlist(reply->row[x].links[lnk_idx].row[y].col,4)
         SET reply->row[x].links[lnk_idx].row[y].col[1].value = temp->el[x].rad[y].rad_name
         SET reply->row[x].links[lnk_idx].row[y].col[2].value = temp->el[x].rad[y].rad_author
         SET reply->row[x].links[lnk_idx].row[y].col[3].value = temp->el[x].rad[y].event_end_dt_tm
         SET reply->row[x].links[lnk_idx].row[y].col[4].value = temp->el[x].rad[y].rad_blob
         SET reply->row[x].links[lnk_idx].row[y].blob = ""
        ENDIF
      ENDFOR
     ELSEIF ((reply->links[lnk_idx].title="PROG"))
      ...
      FOR (y = 1 TO temp->el[x].pro_cnt)
        IF (y=256)
         SET reply->row[x].links[lnk_idx].row[y].separator_ind = 1
         SET reply->row[x].links[lnk_idx].row[y].separator_value = "== UNABLE TO LOAD ALL NOTES =="
         SET y = temp->el[x].pro_cnt
        ELSE
         SET reply->row[x].links[lnk_idx].row[y].separator_ind = 0
         SET reply->row[x].links[lnk_idx].row[y].separator_value = ""
         SET stat = alterlist(reply->row[x].links[lnk_idx].row[y].col,4)
         SET reply->row[x].links[lnk_idx].row[y].col[1].value = temp->el[x].pro[y].pro_name
         SET reply->row[x].links[lnk_idx].row[y].col[2].value = temp->el[x].pro[y].pro_author
         SET reply->row[x].links[lnk_idx].row[y].col[3].value = temp->el[x].pro[y].event_end_dt_tm
         SET reply->row[x].links[lnk_idx].row[y].col[4].value = temp->el[x].pro[y].pro_blob
         SET reply->row[x].links[lnk_idx].row[y].blob = ""
        ENDIF
      ENDFOR
     ELSEIF ((reply->links[lnk_idx].title="DOCS"))
      ...
      FOR (y = 1 TO temp->el[x].doc_cnt)
        IF (y=256)
         SET reply->row[x].links[lnk_idx].row[y].separator_ind = 1
         SET reply->row[x].links[lnk_idx].row[y].separator_value = "== UNABLE TO LOAD ALL DOCS =="
         SET y = temp->el[x].doc_cnt
        ELSE
         SET reply->row[x].links[lnk_idx].row[y].separator_ind = 0
         SET reply->row[x].links[lnk_idx].row[y].separator_value = ""
         SET stat = alterlist(reply->row[x].links[lnk_idx].row[y].col,4)
         SET reply->row[x].links[lnk_idx].row[y].col[1].value = temp->el[x].doc[y].doc_name
         SET reply->row[x].links[lnk_idx].row[y].col[2].value = temp->el[x].doc[y].doc_author
         SET reply->row[x].links[lnk_idx].row[y].col[3].value = temp->el[x].doc[y].event_end_dt_tm
         SET reply->row[x].links[lnk_idx].row[y].col[4].value = temp->el[x].doc[y].doc_blob
         SET reply->row[x].links[lnk_idx].row[y].blob = ""
        ENDIF
      ENDFOR
