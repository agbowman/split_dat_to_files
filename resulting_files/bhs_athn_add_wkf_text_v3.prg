CREATE PROGRAM bhs_athn_add_wkf_text_v3
 RECORD wrequest(
   1 patient_id = f8
   1 encntr_id = f8
   1 prsnl_id = f8
 ...
 IF (exists_ind=1)
  ...
  SET prequest->clin_event[1].publish_flag = 0
 ...
 IF (exists_ind=0)
  ...
  SET prequest->clin_event[1].result_set_link_list[1].valid_from_dt_tm = cnvtdatetime(sysdate)
  SET stat = alterlist(prequest->clin_event[1].event_prsnl_list,1)
  SET prequest->clin_event[1].event_prsnl_list[1].action_prsnl_id =  $3
