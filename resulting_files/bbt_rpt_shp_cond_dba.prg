CREATE PROGRAM bbt_rpt_shp_cond:dba
 RECORD reply(
   1 rpt_list[*]
     2 rpt_filename = vc
   1 status_data
 ...
 SET captions->shipping_conditions = uar_i18ngetmessage(i18nhandle,"shipping_conditions",
  "SHIPPING CONDITIONS")
 ...
 SET select_ok_ind = 0
 SET rpt_cnt = 0
 EXECUTE cpm_create_file_name_logical "bbt_ship_cond", "txt", "x"
 SELECT INTO cpm_cfn_info->file_name_logical
  ...
  HEAD PAGE
   ...
   col 50, captions->shipping_conditions, row + 2,
