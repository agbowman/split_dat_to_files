CREATE PROGRAM bbt_rpt_ret_transfer:dba
 RECORD reply(
   1 rpt_list[*]
     2 rpt_filename = vc
   1 status_data
 ...
 SET captions->return_from = uar_i18ngetmessage(i18nhandle,"return_from",
  "RETURN FROM TRANSFER REASONS")
 ...
 SET select_ok_ind = 0
 SET rpt_cnt = 0
 EXECUTE cpm_create_file_name_logical "bbt_ret_trans", "txt", "x"
 SELECT INTO cpm_cfn_info->file_name_logical
  ...
  HEAD PAGE
   ...
   col 45, captions->return_from, row + 2,
