CREATE PROGRAM dm_eucb_cdi_pending_document:dba
 ...
 ENDIF
 DECLARE encounter_ucb_upt(dummy) = i4
 ...
 IF ((dm_cmb_cust_script->exc_maint_ind=1))
  ...
  SET dcem_request->qual[1].script_name = "dm_eucb_cdi_pending_document"
 ...
 ELSE
  ...
  GO TO exit_sub
 ENDIF
 SUBROUTINE encounter_ucb_upt(dummy)
