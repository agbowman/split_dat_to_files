CREATE PROGRAM dm2_wrp_load_drr_plan:dba
 ...
 SUBROUTINE dm2_get_program_stack(null)
   ...
   ENDIF
 END ;Subroutine
 FREE RECORD drldg_col_list
 RECORD drldg_col_list(
   1 tbl = vc
   1 col[*]
     2 col_name = vc
     2 col_type = vc
 ...
 SET readme_data->message = "Readme Failed: Starting script dm2_wrp_load_drr_plan..."
 SET dwtr_tbl = "DRR_PLAN"
 ...
 IF (dwtr_tbl_exists=0)
  ...
  GO TO exit_script
 ENDIF
 EXECUTE dm_dbimport "cer_install:dm2_load_drr_plan.csv", "dm2_rdm_load_drr_plan", 1000
