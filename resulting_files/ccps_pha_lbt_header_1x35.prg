CREATE PROGRAM ccps_pha_lbt_header_1x35
 PROMPT
 ...
 SUBROUTINE facility_secabs(ncalc,offsetx,offsety)
   ...
   DECLARE __facility_description = vc WITH noconstant(build2(trim(label_data->facility.description),
     char(0))), protect
   IF (ncalc=rpt_render)
 ...
 SUBROUTINE initializereport(dummy)
   IF (_bsubreport=0)
    ...
    SET rptreport->m_reportname = "CCPS_PHA_LBT_HEADER_1X35"
