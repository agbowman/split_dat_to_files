CREATE PROGRAM bed_aud_rad_srvres_hier:dba
   ...
   1 ilist[*]
     ...
     2 dlist[*]
       ...
       3 slist[*]
         4 sect_cd = f8
         4 sect_name = vc
         4 sect_short_name = vc
         4 ss_cnt = i2
         4 sslist[*]
           5 subsect_cd = f8
           5 subsect_name = vc
           5 subsect_short_name = vc
           5 r_cnt = i2
           5 rlist[*]
             6 res_cd = f8
             6 res_name = vc
 ...
 DECLARE rad_discipline_cd = f8 WITH public, noconstant(0.0)
 SELECT INTO "nl:"
  FROM code_value cv
  PLAN (cv
 ...
 SELECT INTO "nl:"
  ...
  PLAN (cv
   WHERE cv.code_set=6000
    ...
    AND cv.active_ind=1)
  DETAIL
   rad_discipline_cd = cv.code_value
  WITH nocounter
 ;end select
 SELECT INTO "nl:"
  FROM br_prsnl bp
   ...
   SELECT INTO "nl:"
    ...
    PLAN (rg
     ...
     WHERE sr.service_resource_cd=rg.child_service_resource_cd
      AND sr.discipline_type_cd=rad_discipline_cd)
     JOIN (cv
   ...
   FOR (z = 1 TO temp->ilist[y].d_cnt)
     ...
     SELECT INTO "nl:"
      ...
      DETAIL
       ...
       dlist[z].slist[s_cnt].sect_name = trim(cv.description), temp->ilist[y].dlist[z].slist[s_cnt].
       sect_short_name = trim(cv.display)
      WITH nocounter
     ;end select
     FOR (w = 1 TO temp->ilist[y].dlist[z].s_cnt)
       ...
       SELECT INTO "nl:"
        ...
        DETAIL
         ...
         temp->ilist[y].dlist[z].slist[w].sslist[ss_cnt].subsect_name = trim(cv.description), temp->
         ilist[y].dlist[z].slist[w].sslist[ss_cnt].subsect_short_name = trim(cv.display)
        WITH nocounter
       ;end select
       FOR (v = 1 TO temp->ilist[y].dlist[z].slist[w].ss_cnt)
        ...
        SELECT INTO "nl:"
         ...
         DETAIL
          ...
          res_name = trim(cv.description), temp->ilist[y].dlist[z].slist[w].sslist[v].rlist[r_cnt].
          res_short_name = trim(cv.display)
         WITH nocounter
        ;end select
       ENDFOR
     ENDFOR
 ...
 SET reply->collist[1].header_text = "Institution (Display/Desc)"
 SET reply->collist[1].data_type = 1
 SET reply->collist[1].hide_ind = 0
 SET reply->collist[2].header_text = "Department"
 SET reply->collist[2].data_type = 1
 SET reply->collist[2].hide_ind = 0
 SET reply->collist[3].header_text = "Section Long"
 SET reply->collist[3].data_type = 1
 SET reply->collist[3].hide_ind = 0
 SET reply->collist[4].header_text = "Section Short"
 SET reply->collist[4].data_type = 1
 SET reply->collist[4].hide_ind = 0
 SET reply->collist[5].header_text = "Subsection Long"
 SET reply->collist[5].data_type = 1
 SET reply->collist[5].hide_ind = 0
 SET reply->collist[6].header_text = "Subsection Short"
 SET reply->collist[6].data_type = 1
 SET reply->collist[6].hide_ind = 0
 SET reply->collist[7].header_text = "Resource Long"
 SET reply->collist[7].data_type = 1
 SET reply->collist[7].hide_ind = 0
 SET reply->collist[8].header_text = "Resource Short"
 SET reply->collist[8].data_type = 1
 SET reply->collist[8].hide_ind = 0
 SET reply->collist[9].header_text = "institution_cd"
 SET reply->collist[9].data_type = 2
 SET reply->collist[9].hide_ind = 1
 SET reply->collist[10].header_text = "department_cd"
 SET reply->collist[10].data_type = 2
 SET reply->collist[10].hide_ind = 1
 SET reply->collist[11].header_text = "section_cd"
 SET reply->collist[11].data_type = 2
 SET reply->collist[11].hide_ind = 1
 SET reply->collist[12].header_text = "subsection_cd"
 SET reply->collist[12].data_type = 2
 SET reply->collist[12].hide_ind = 1
 SET reply->collist[13].header_text = "resource_cd"
 SET reply->collist[13].data_type = 2
 SET reply->collist[13].hide_ind = 1
 SET row_nbr = 1
 IF ((temp->i_cnt > 0))
  SET stat = alterlist(reply->rowlist,1)
  SET stat = alterlist(reply->rowlist[1].celllist,13)
 ENDIF
 SET first_res = 1
 SET first_subsect = 1
 SET first_sect = 1
 ...
 FOR (x = 1 TO temp->i_cnt)
   ...
   SET first_subsect = 1
   SET first_res = 1
   SET reply->rowlist[row_nbr].celllist[1].string_value = temp->ilist[x].inst_name
   SET reply->rowlist[row_nbr].celllist[9].double_value = temp->ilist[x].inst_cd
   FOR (y = 1 TO temp->ilist[x].d_cnt)
     ...
     SET first_subsect = 1
     SET first_res = 1
     SET reply->rowlist[row_nbr].celllist[2].string_value = temp->ilist[x].dlist[y].dept_name
     SET reply->rowlist[row_nbr].celllist[10].double_value = temp->ilist[x].dlist[y].dept_cd
     FOR (z = 1 TO temp->ilist[x].dlist[y].s_cnt)
       ...
       SET first_subsect = 1
       SET first_res = 1
       SET reply->rowlist[row_nbr].celllist[3].string_value = temp->ilist[x].dlist[y].slist[z].
       sect_name
       SET reply->rowlist[row_nbr].celllist[4].string_value = temp->ilist[x].dlist[y].slist[z].
       sect_short_name
       SET reply->rowlist[row_nbr].celllist[11].double_value = temp->ilist[x].dlist[y].slist[z].
       sect_cd
       FOR (w = 1 TO temp->ilist[x].dlist[y].slist[z].ss_cnt)
         ...
         sslist[w].subsect_name
         SET reply->rowlist[row_nbr].celllist[6].string_value = temp->ilist[x].dlist[y].slist[z].
         sslist[w].subsect_short_name
         SET reply->rowlist[row_nbr].celllist[12].double_value = temp->ilist[x].dlist[y].slist[z].
         sslist[w].subsect_cd
...
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("rad_serv_res_audit.csv")
 ENDIF
