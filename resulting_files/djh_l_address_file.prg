CREATE PROGRAM djh_l_address_file
 PROMPT
 ...
 SELECT INTO  $OUTDEV
  ...
  a.postal_barcode_info, a.primary_care_cd, a_primary_care_disp = uar_get_code_display(a
   .primary_care_cd),
  a.residence_cd, a_residence_disp = uar_get_code_display(a.residence_cd), a.residence_type_cd,
  a_residence_type_disp = uar_get_code_display(a.residence_type_cd), a.rowid, a.state,
  a.state_cd, a_state_disp = uar_get_code_display(a.state_cd), a.street_addr,
  a.street_addr2, a.street_addr3, a.street_addr4,
  a.updt_applctx, a.updt_cnt, a.updt_dt_tm,
  a.updt_id, a.updt_task, a.zipcode,
  a.zipcode_key, a.zip_code_group_cd, a_zip_code_group_disp = uar_get_code_display(a
   .zip_code_group_cd)
  FROM address a
