CREATE PROGRAM dm_create_cloud_seq:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_create_cloud_seq..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("CLOUD_SEQ")
 SELECT INTO "nl:"
 ...
 IF (seqexists=1)
  ...
  GO TO exit_script
 ENDIF
 EXECUTE dm_add_sequence value(sequencename), 3000000000.0, 0,
 0, 0
