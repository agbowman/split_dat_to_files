CREATE PROGRAM dm_rdm_rem_pathway_action_trig:dba
 ...
 SET readme_data->message = "Readme Failed: Starting script dm_rdm_rem_pathway_action_trig..."
 ...
 SELECT INTO "nl:"
  ...
  WHERE dut.table_name="PATHWAY_ACTION"
 ...
 SELECT
  IF (currdb="ORACLE")
   FROM dm2_user_triggers ut,
    dm_tables_doc dtd
   WHERE dtd.table_name="PATHWAY_ACTION"
 ...
 SELECT INTO "nl:"
  ...
  WHERE pa.pathway_id=0.0
   AND pa.pw_action_seq=0.0
  HEAD REPORT
   rows_found = 0
  DETAIL
