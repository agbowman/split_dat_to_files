CREATE PROGRAM bhs_gvw_cardiology_pt_hx:dba
 RECORD m_request(
 ...
 DECLARE mf_cardiologypatienthistory_cd = f8 WITH protect, constant(uar_get_code_by("DISPLAYKEY",72,
   "CARDIOLOGYPATIENTHISTORY"))
 ...
 SELECT INTO "nl:"
  ...
  PLAN (ce
   WHERE ce.person_id=mf_per_id
    AND ce.event_cd=mf_cardiologypatienthistory_cd
