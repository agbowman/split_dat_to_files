CREATE PROGRAM bed_ens_pharm_items:dba
 ...
 RECORD request_main(
   1 items[*]
     2 item_id = f8
   1 dispense_factor_updt_ind = i2
   1 dispense_factor = f8
   1 strength_updt_ind = i2
   1 strength = f8
   1 strength_unit_updt_ind = i2
   1 strength_unit_code_value = f8
   1 volume_updt_ind = i2
   1 volume = f8
   1 volume_unit_updt_ind = i2
   1 volume_unit_code_value = f8
   1 medication_ind_updt_ind = i2
   1 medication_ind = i2
   1 continuous_ind_updt_ind = i2
   1 continuous_ind = i2
   1 tpn_ind_updt_ind = i2
   1 tpn_ind = i2
   1 intermittent_ind_updt_ind = i2
   1 intermittent_ind = i2
   1 legal_status_updt_ind = i2
   1 legal_status_code_value = f8
   1 formulary_status_updt_ind = i2
   1 formulary_status_code_value = f8
   1 divisibility_ind_updt_ind = i2
   1 divisibility_ind = i2
   1 infinitely_divisible_updt_ind = i2
   1 infinitely_divisible_ind = i2
   1 divisible_factor_updt_ind = i2
   1 divisible_factor = f8
   1 total_volume_flag_updt_ind = i2
   1 total_volume_flag = i2
   1 freetext_dose_upd_ind = i2
   1 freetext_dose = vc
   1 dose_updt_ind = i2
   1 dose = f8
   1 dose_unit_updt_ind = i2
   1 dose_unit_code_value = f8
   1 duration_updt_ind = i2
   1 duration = f8
   1 duration_unit_updt_ind = i2
   1 duration_unit_code_value = f8
   1 stop_type_updt_ind = i2
   1 stop_type_code_value = f8
   1 route_updt_ind = i2
   1 route_code_value = f8
   1 frequency_updt_ind = i2
   1 frequency_code_value = f8
   1 infuse_over_updt_ind = i2
   1 infuse_over = f8
   1 infuse_over_unit_updt_ind = i2
   1 infuse_over_unit_code_value = f8
   1 prn_ind_updt_ind = i2
   1 prn_ind = i2
   1 prn_reason_updt_ind = i2
   1 prn_reason_code_value = f8
   1 dispense_cat_updt_ind = i2
   1 dispense_cat_code_value = f8
   1 price_sched_id_updt_ind = i2
   1 price_sched_id = f8
   1 dosage_form_updt_ind = i2
   1 dosage_form_code_value = f8
   1 order_alerts[*]
     2 order_alert_id = f8
   1 order_type_updt_ind = i2
   1 order_type = i2
   1 dc_interaction_updt_ind = i2
   1 dc_interaction = f8
   1 dc_display_updt_ind = i2
   1 dc_display = f8
   1 therapeutic_updt_ind = i2
   1 therapeutic_code_value = f8
   1 identifiers[*]
     2 identifier_type_code_value = f8
     2 value = vc
     2 primary_ind = i2
   1 dispense_qty_updt_ind = i2
   1 dispense_qty = f8
   1 dispense_qty_unit_updt_ind = i2
   1 dispense_qty_unit_code_vlaue = f8
   1 note1_updt_ind = i2
   1 note1 = vc
   1 note1_type_updt_ind = i2
   1 note1_type = i2
   1 note2_updt_ind = i2
   1 note2 = vc
   1 note2_type_updt_ind = i2
   1 note2_type = i2
 )
 ...
 ENDFOR
 SET stat = alterlist(request_main->identifiers,size(request->identifiers,5))
 FOR (y = 1 TO size(request->identifiers,5))
   SET request_main->identifiers[y].identifier_type_code_value = request->identifiers[y].
   identifier_type_code_value
   SET request_main->identifiers[y].primary_ind = request->identifiers[y].primary_ind
   SET request_main->identifiers[y].value = request->identifiers[y].value
 ENDFOR
 SET request_main->dispense_factor_updt_ind = request->dispense_factor_updt_ind
 SET request_main->dispense_factor = request->dispense_factor
 SET request_main->strength_updt_ind = request->strength_updt_ind
 SET request_main->strength = request->strength
 SET request_main->strength_unit_updt_ind = request->strength_unit_updt_ind
 SET request_main->strength_unit_code_value = request->strength_unit_code_value
 SET request_main->volume_updt_ind = request->volume_updt_ind
 SET request_main->volume = request->volume
 SET request_main->volume_unit_updt_ind = request->volume_unit_updt_ind
 SET request_main->volume_unit_code_value = request->volume_unit_code_value
 SET request_main->medication_ind_updt_ind = request->medication_ind_updt_ind
 SET request_main->medication_ind = request->medication_ind
 SET request_main->continuous_ind_updt_ind = request->continuous_ind_updt_ind
 SET request_main->continuous_ind = request->continuous_ind
 SET request_main->tpn_ind_updt_ind = request->tpn_ind_updt_ind
 SET request_main->tpn_ind = request->tpn_ind
 SET request_main->intermittent_ind_updt_ind = request->intermittent_ind_updt_ind
 SET request_main->intermittent_ind = request->intermittent_ind
 SET request_main->legal_status_updt_ind = request->legal_status_updt_ind
 SET request_main->legal_status_code_value = request->legal_status_code_value
 SET request_main->formulary_status_updt_ind = request->formulary_status_updt_ind
 SET request_main->formulary_status_code_value = request->formulary_status_code_value
 SET request_main->divisibility_ind_updt_ind = request->divisibility_ind_updt_ind
 SET request_main->divisibility_ind = request->divisibility_ind
 SET request_main->infinitely_divisible_updt_ind = request->infinitely_divisible_updt_ind
 SET request_main->infinitely_divisible_ind = request->infinitely_divisible_ind
 SET request_main->divisible_factor_updt_ind = request->divisible_factor_updt_ind
 SET request_main->divisible_factor = request->divisible_factor
 SET request_main->total_volume_flag_updt_ind = request->total_volume_flag_updt_ind
 SET request_main->total_volume_flag = request->total_volume_flag
 SET request_main->freetext_dose_upd_ind = request->freetext_dose_upd_ind
 SET request_main->freetext_dose = request->freetext_dose
 SET request_main->dose_updt_ind = request->dose_updt_ind
 SET request_main->dose = request->dose
 SET request_main->dose_unit_updt_ind = request->dose_unit_updt_ind
 SET request_main->dose_unit_code_value = request->dose_unit_code_value
 SET request_main->duration_updt_ind = request->duration_updt_ind
 SET request_main->duration = request->duration
 SET request_main->duration_unit_updt_ind = request->duration_unit_updt_ind
 SET request_main->duration_unit_code_value = request->duration_unit_code_value
 SET request_main->stop_type_updt_ind = request->stop_type_updt_ind
 SET request_main->stop_type_code_value = request->stop_type_code_value
 SET request_main->route_updt_ind = request->route_updt_ind
 SET request_main->route_code_value = request->route_code_value
 SET request_main->frequency_updt_ind = request->frequency_updt_ind
 SET request_main->frequency_code_value = request->frequency_code_value
 SET request_main->infuse_over_updt_ind = request->infuse_over_updt_ind
 SET request_main->infuse_over = request->infuse_over
 SET request_main->infuse_over_unit_updt_ind = request->infuse_over_unit_updt_ind
 SET request_main->infuse_over_unit_code_value = request->infuse_over_unit_code_value
 SET request_main->prn_ind_updt_ind = request->prn_ind_updt_ind
 SET request_main->prn_ind = request->prn_ind
 SET request_main->prn_reason_updt_ind = request->prn_reason_updt_ind
 SET request_main->prn_reason_code_value = request->prn_reason_code_value
 SET request_main->dispense_cat_updt_ind = request->dispense_cat_updt_ind
 SET request_main->dispense_cat_code_value = request->dispense_cat_code_value
 SET request_main->price_sched_id_updt_ind = request->price_sched_id_updt_ind
 SET request_main->price_sched_id = request->price_sched_id
 SET request_main->dosage_form_updt_ind = request->dosage_form_updt_ind
 SET request_main->dosage_form_code_value = request->dosage_form_code_value
 SET stat = alterlist(request_main->order_alerts,size(request->order_alerts,5))
 FOR (x = 1 TO size(request->order_alerts,5))
   SET request_main->order_alerts[x].order_alert_id = request->order_alerts[x].order_alert_id
 ENDFOR
 SET request_main->order_type_updt_ind = request->order_type_updt_ind
 SET request_main->order_type = request->order_type
 SET request_main->dc_interaction_updt_ind = request->dc_interaction_updt_ind
 SET request_main->dc_interaction = request->dc_interaction
 SET request_main->dc_display_updt_ind = request->dc_display_updt_ind
 SET request_main->dc_display = request->dc_display
 SET request_main->therapeutic_updt_ind = request->therapeutic_updt_ind
 SET request_main->therapeutic_code_value = request->therapeutic_code_value
 SET request_main->dispense_qty_updt_ind = request->dispense_qty_updt_ind
 SET request_main->dispense_qty = request->dispense_qty
 SET request_main->dispense_qty_unit_updt_ind = request->dispense_qty_unit_updt_ind
 SET request_main->dispense_qty_unit_code_vlaue = request->dispense_qty_unit_code_vlaue
 SET request_main->note1_updt_ind = request->note1_updt_ind
 SET request_main->note1 = request->note1
 SET request_main->note1_type_updt_ind = request->note1_type_updt_ind
 SET request_main->note1_type = request->note1_type
 SET request_main->note2_updt_ind = request->note2_updt_ind
 SET request_main->note2 = request->note2
 SET request_main->note2_type_updt_ind = request->note2_type_updt_ind
 SET request_main->note2_type = request->note2_type
 FREE SET request
 RECORD request(
 ...
 SELECT INTO "nl:"
  ...
  WITH nocounter
 ;end select
 IF ((request_main->dose_unit_updt_ind=1))
  SET volume_check = 0
  SET strength_check = 0
  SELECT INTO "nl:"
   FROM code_value_extension e
   WHERE (e.code_value=request_main->dose_unit_code_value)
    AND e.field_name="PHARM_UNIT"
    AND e.code_set=54
   DETAIL
    field_value = cnvtint(e.field_value)
    IF (band(field_value,1) > 0)
     strength_check = 1
    ELSEIF (band(field_value,2) > 0)
     volume_check = 1
    ENDIF
   WITH nocounter
  ;end select
 ...
 FOR (main_i = 1 TO size(request_main->items,5))
   ...
   IF ((request->status_data.status="Z"))
    ...
    SET bad_items->items[bad_len].error_flag = 1
    SET error_ind = 1
   ENDIF
   IF (error_ind=0)
    SET temp_dispense_cat = 0
    SET temp_order_type = 0
    SET cnt = size(request->meddefqual,5)
    FOR (x = 1 TO cnt)
      IF ((request->meddefqual[x].item_id=request_main->items[main_i].item_id))
       ...
       IF ((request_main->dosage_form_updt_ind=1))
        SET request->meddefqual[x].form_cd = request_main->dosage_form_code_value
       ENDIF
       ...
       SELECT INTO "nl:"
        ...
        WITH nocounter
       ;end select
       IF ((request_main->dc_display_updt_ind=1))
        SET request->meddefqual[x].ordcat[1].dc_display_days = request_main->dc_display
       ENDIF
       IF ((request_main->dc_interaction_updt_ind=1))
        SET request->meddefqual[x].ordcat[1].dc_interaction_days = request_main->dc_interaction
       ENDIF
       IF ((request_main->therapeutic_updt_ind=1))
        IF (size(request->meddefqual[x].ordcat[1].ahfs_qual,5)=0)
         SET stat = alterlist(request->meddefqual[x].ordcat[1].ahfs_qual,1)
        ENDIF
        SELECT INTO "nl:"
         FROM alt_sel_cat a
         WHERE (a.alt_sel_category_id=request_main->therapeutic_code_value)
         DETAIL
          request->meddefqual[x].ordcat[1].ahfs_qual[1].ahfs_code = a.short_description
         WITH nocounter
        ;end select
       ELSE
        IF (size(request->meddefqual[x].ordcat[1].ahfs_qual,5) > 0)
       ...
       FOR (y = 1 TO size(request->meddefqual[x].meddefflexqual,5))
        ...
        IF ((request->meddefqual[x].meddefflexqual[y].flex_type_cd=system_code_value))
         IF (size(request_main->order_alerts,5) > 0)
          IF (size(request->meddefqual[x].meddefflexqual[y].medflexobjidxqual,5) > 0)
           ...
           ;end select
          ENDIF
          FOR (a = 1 TO size(request_main->order_alerts,5))
            SET qual_len = size(request->meddefqual[x].meddefflexqual[y].medflexobjidxqual,5)
            SET stat = alterlist(request->meddefqual[x].meddefflexqual[y].medflexobjidxqual,(qual_len
             + 1))
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].
            parent_entity_id = request_main->order_alerts[a].order_alert_id
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].
            db_rec_status = 3
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].
            med_def_flex_id = 0
            ...
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].sequence =
            0
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].
            parent_entity = "CODE_VALUE"
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].
            flex_object_type_cd = order_alert_code_value
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].value = 0
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].value_unit
             = 0
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].
            update_value_ind = 1
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].active_ind
             = 1
            SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[(qual_len+ 1)].updt_cnt =
            0
          ENDFOR
         ENDIF
         ...
         FOR (w = 1 TO size(request_main->identifiers,5))
           IF ((request_main->identifiers[w].identifier_type_code_value=unique_code_value)
            AND unique_code_value > 0)
            SET usr_upd_rx_unique_id = request_main->identifiers[w].value
           ELSE
            IF (size(request->meddefqual[x].meddefflexqual[y].medidentifierqual,5) > 0)
             SET dup_ind = 0
             SELECT INTO "nl:"
              ...
              PLAN (d
               WHERE (request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].
               med_identifier_type_cd=request_main->identifiers[w].identifier_type_code_value)
                AND (request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].value=
               request_main->identifiers[w].value)
                AND (request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].primary_ind=
               request_main->identifiers[w].primary_ind)
                AND (request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].active_ind=1))
              ORDER BY d.seq
              DETAIL
               dup_ind = 1
             ...
             ;end select
             IF (dup_ind=0)
              IF ((request_main->identifiers[w].primary_ind=1))
               IF ((request_main->identifiers[w].identifier_type_code_value=short_desc_code_value)
                AND (request_main->identifiers[w].primary_ind=1))
                SELECT INTO "nl:"
                 FROM (dummyt d  WITH seq = size(request->meddefqual[x].ordcat[1].qual_mnemonic,5))
                 DETAIL
                 ...
                 WITH nocounter
                ;end select
                SET upd_unique_id = replace(upd_unique_id,"/s",request_main->identifiers[w].value)
                SET upd_short_ind = 1
               ENDIF
               IF ((request_main->identifiers[w].identifier_type_code_value=desc_code_value)
                AND (request_main->identifiers[w].primary_ind=1))
                SET upd_unique_id = replace(upd_unique_id,"/d",request_main->identifiers[w].value)
                SET upd_desc_ind = 1
               ENDIF
               ...
               SELECT INTO "nl:"
                ...
                ORDER BY d.seq
                DETAIL
                 request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].primary_ind = 0,
                 request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].active_ind = 1,
                 request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].db_rec_status = 1,
                 request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].sequence = 0
                WITH nocounter
               ;end select
              ENDIF
              SET dup_upd_ind = 0
              SELECT INTO "nl:"
               ...
               DETAIL
                IF (dup_upd_ind=0)
                 request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].primary_ind =
                 request_main->identifiers[w].primary_ind, request->meddefqual[x].meddefflexqual[y].
                 medidentifierqual[d.seq].active_ind = 1, request->meddefqual[x].meddefflexqual[y].
                 medidentifierqual[d.seq].db_rec_status = 1,
                 request->meddefqual[x].meddefflexqual[y].medidentifierqual[d.seq].sequence =
                 request_main->identifiers[w].primary_ind, dup_upd_ind = 1
                ENDIF
               WITH nocounter
              ;end select
              IF (dup_upd_ind=0)
               SET ident_cnt = (size(request->meddefqual[x].meddefflexqual[y].medidentifierqual,5)+ 1
               )
               SET stat = alterlist(request->meddefqual[x].meddefflexqual[y].medidentifierqual,
                ident_cnt)
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               salable_by_vendor_ind = 0
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               salable_by_mfr_ind = 0
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].id_type_cd
                = 0
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               db_rec_status = 3
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               ...
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               med_identifier_id = 0
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].order_set_id
                = 0
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].item_id = 0
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               med_product_id = 0
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].sequence =
               request_main->identifiers[w].primary_ind
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               pharmacy_type_cd = inpatient_code_value
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               parent_entity_id = 0
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               parent_entity = " "
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].flex_type_cd
                = system_code_value
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               med_identifier_type_cd = request_main->identifiers[w].identifier_type_code_value
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].value =
               request_main->identifiers[w].value
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].
               med_type_flag = 0
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].active_ind
                = 1
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].primary_ind
                = request_main->identifiers[w].primary_ind
               SET request->meddefqual[x].meddefflexqual[y].medidentifierqual[ident_cnt].updt_cnt = 0
              ENDIF
             ENDIF
            ENDIF
           ENDIF
         ...
         FOR (z = 1 TO size(request->meddefqual[x].meddefflexqual[y].medflexobjidxqual,5))
           ...
           =med_oe_defaults_code_value))
            ...
            db_rec_status = 1
            IF ((request_main->freetext_dose_upd_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             freetext_dose = request_main->freetext_dose
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             volume_unit_cd = 0
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             volume = 0
            ...
            IF ((request_main->dose_unit_updt_ind=1))
             IF (strength_check=1)
              ...
              freetext_dose = ""
              SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
              strength_unit_cd = request_main->dose_unit_code_value
              SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
              volume_unit_cd = 0
              SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
              volume = 0
             ELSEIF (volume_check=1)
              SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
              volume_unit_cd = request_main->dose_unit_code_value
              SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
              strength_unit_cd = 0
              SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
              strength = 0
             ...
             ENDIF
            ENDIF
            IF ((request_main->dose_updt_ind=1))
             IF (strength_check=1)
              SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
              strength = request_main->dose
              SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
              volume_unit_cd = 0
              SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
              volume = 0
             ...
             ENDIF
            ENDIF
            IF ((request_main->duration_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             duration = request_main->duration
            ENDIF
            IF ((request_main->duration_unit_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             duration_unit_cd = request_main->duration_unit_code_value
            ENDIF
            IF ((request_main->stop_type_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             stop_type_cd = request_main->stop_type_code_value
            ENDIF
            IF ((request_main->route_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             route_cd = request_main->route_code_value
            ENDIF
            IF ((request_main->frequency_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             frequency_cd = request_main->frequency_code_value
            ENDIF
            IF ((request_main->infuse_over_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             infuse_over = request_main->infuse_over
            ENDIF
            IF ((request_main->infuse_over_unit_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             infuse_over_cd = request_main->infuse_over_unit_code_value
            ENDIF
            IF ((request_main->prn_ind_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             prn_ind = request_main->prn_ind
            ENDIF
            IF ((request_main->prn_reason_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             prn_reason_cd = request_main->prn_reason_code_value
            ENDIF
            IF ((request_main->dispense_cat_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             dispense_category_cd = request_main->dispense_cat_code_value
             SET temp_dispense_cat = request_main->dispense_cat_code_value
            ELSE
             SET temp_dispense_cat = request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].
             medoedefaultsqual[1].dispense_category_cd
            ENDIF
            IF ((request_main->price_sched_id_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             price_sched_id = request_main->price_sched_id
            ENDIF
            IF ((request_main->note1_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             comment1_text = request_main->note1
            ELSE
            ...
            ENDIF
            IF ((request_main->note1_type_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             comment1_type = request_main->note1_type
            ENDIF
            IF ((request_main->note2_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             comment2_text = request_main->note2
            ELSE
            ...
            ENDIF
            IF ((request_main->note2_type_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].medoedefaultsqual[1].
             comment2_type = request_main->note2_type
            ENDIF
           ENDIF
         ENDFOR
        ELSEIF ((request->meddefqual[x].meddefflexqual[y].flex_type_cd=system_package_code_value))
         IF ((request_main->dispense_qty_updt_ind=1))
          SET request->meddefqual[x].meddefflexqual[y].pack[1].qty = request_main->dispense_qty
          SET request->pack_rec_status = 1
          SET request->meddefqual[x].meddefflexqual[y].pack[1].db_rec_status = 1
         ENDIF
         IF ((request_main->dispense_qty_unit_updt_ind=1))
          SET request->meddefqual[x].meddefflexqual[y].pack[1].uom_cd = request_main->
          dispense_qty_unit_code_vlaue
          SELECT INTO "nl:"
           FROM code_value cv
           WHERE (cv.code_value=request_main->dispense_qty_unit_code_vlaue)
           DETAIL
            request->meddefqual[x].meddefflexqual[y].pack[1].description = cv.display
           WITH nocounter
          ;end select
          SET request->pack_rec_status = 1
          SET request->meddefqual[x].meddefflexqual[y].pack[1].db_rec_status = 1
         ...
         FOR (z = 1 TO size(request->meddefqual[x].meddefflexqual[y].medflexobjidxqual,5))
           ...
           med_dispense_code_value))
            ...
            db_rec_status = 1
            IF ((request_main->strength_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             strength = request_main->strength
            ENDIF
            IF ((request_main->strength_unit_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             strength_unit_cd = request_main->strength_unit_code_value
            ENDIF
            IF ((request_main->volume_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             volume = request_main->volume
            ENDIF
            IF ((request_main->volume_unit_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             volume_unit_cd = request_main->volume_unit_code_value
            ENDIF
            IF ((request_main->medication_ind_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             med_filter_ind = request_main->medication_ind
            ENDIF
            IF ((request_main->continuous_ind_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             continuous_filter_ind = request_main->continuous_ind
            ENDIF
            IF ((request_main->tpn_ind_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             tpn_filter_ind = request_main->tpn_ind
            ENDIF
            IF ((request_main->intermittent_ind_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             intermittent_filter_ind = request_main->intermittent_ind
            ENDIF
            IF ((request_main->legal_status_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             legal_status_cd = request_main->legal_status_code_value
            ENDIF
            IF ((request_main->formulary_status_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             formulary_status_cd = request_main->formulary_status_code_value
            ENDIF
            IF ((request_main->divisibility_ind_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             divisible_ind = request_main->divisibility_ind
            ENDIF
            IF ((request_main->infinitely_divisible_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             infinite_div_ind = request_main->infinitely_divisible_ind
            ENDIF
            IF ((request_main->divisible_factor_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             base_issue_factor = request_main->divisible_factor
            ENDIF
            IF ((request_main->total_volume_flag_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             used_as_base_ind = request_main->total_volume_flag
            ENDIF
            IF ((request_main->dispense_factor_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             dispense_factor = request_main->dispense_factor
            ENDIF
            IF ((request_main->order_type_updt_ind=1))
             SET request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].meddispensequal[1].
             oe_format_flag = request_main->order_type
             SET temp_order_type = request_main->order_type
            ELSE
             SET temp_order_type = request->meddefqual[x].meddefflexqual[y].medflexobjidxqual[z].
             meddispensequal[1].oe_format_flag
            ENDIF
           ENDIF
         ENDFOR
        ENDIF
      ...
      ENDIF
    ENDFOR
    SET check_disp_ind = 0
    IF ((((request_main->order_type_updt_ind=1)) OR ((request_main->dispense_cat_updt_ind=1))) )
     IF (((temp_order_type=0) OR (temp_dispense_cat=0)) )
      SET check_disp_ind = 1
     ELSE
      SELECT INTO "nl:"
       FROM dispense_category dc
       WHERE dc.dispense_category_cd=temp_dispense_cat
        AND dc.order_type_flag=temp_order_type
       DETAIL
        check_disp_ind = 1
       WITH nocounter
      ;end select
    ...
    ELSE
     ...
     SET stat = alterlist(bad_items->items,bad_len)
     SET bad_items->items[bad_len].item_id = request_main->items[main_i].item_id
     SET bad_items->items[bad_len].error_flag = 2
    ENDIF
   ENDIF
...
#exit_script
 ...
 IF (size(bad_items->items,5) > 0)
  ...
  FOR (x = 1 TO size(bad_items->items,5))
   ...
   SET reply->items_not_saved[x].error_flag = bad_items->items[x].error_flag
  ENDFOR
 ENDIF
 IF (error_flag="N")
