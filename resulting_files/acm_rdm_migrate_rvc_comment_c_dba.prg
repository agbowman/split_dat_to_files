CREATE PROGRAM acm_rdm_migrate_rvc_comment_c:dba
 ...
 IF (error(ms_errmsg,0) != 0)
  ...
  GO TO exit_program
 ENDIF
 SET ms_child_info_domain_nm = "ACM_RDM_MIGRATE_RVC_COMMENT_TO_TIMELINE"
 SET ms_range_prefix = "ACM_RDM_MIGRATE_RVC_COMMENT_TO_TIMELINE RANGE"
 SET ms_child_max_name = "MAX RVC_COMMENT_HIST_ID EVALUATED"
 ...
 IF (sbr_fetch_min_max(ms_child_info_domain_nm,ms_range_prefix,ms_child_max_name,mf_max_range_id,
  ...
  GO TO exit_program
 ENDIF
 IF (sbr_sync_ccl_tmp_def("TEMP_RDM_ACM_MIGRATE_COMMENT")=0)
  GO TO exit_program
 ENDIF
