CREATE PROGRAM bhs_gvw_gastroenterology_pt_hx:dba
 RECORD m_request(
 ...
 DECLARE mf_cs72_gastropatienthistory = f8 WITH constant(uar_get_code_by("DISPLAYKEY",72,
   "GASTROENTEROLOGYPATIENTHISTORY")), protect
 ...
 SELECT INTO "nl:"
  ...
  PLAN (ce
   WHERE ce.person_id=mf_per_id
    AND ce.event_cd=mf_cs72_gastropatienthistory
