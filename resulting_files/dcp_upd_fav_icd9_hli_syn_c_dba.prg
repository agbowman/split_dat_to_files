CREATE PROGRAM dcp_upd_fav_icd9_hli_syn_c:dba
 ...
 SET mf_range_id_increment = 25000
 SET ms_child_info_domain_nm = "DCP_UPD_FAV_ALL"
 SET ms_range_prefix = "RANGE"
 SET ms_child_max_name = "MAX ID EVALUATED"
 ...
 IF (sbr_fetch_min_max(ms_child_info_domain_nm,ms_range_prefix,ms_child_max_name,mf_max_range_id,
  ...
  GO TO exit_program
 ENDIF
 CALL echo(mf_max_range_id)
 CALL echo(mf_min_range_id)
 IF (sbr_sync_ccl_tmp_def("TEMP_FAV_ICD9_HLI_SYN")=0)
  GO TO exit_program
 ENDIF
...
#exit_program
 IF ((readme_data->status="F"))
  ROLLBACK
 ELSE
  CALL sbr_truncate_table("TEMP_FAV_ICD9_HLI_SYN")
 ENDIF
