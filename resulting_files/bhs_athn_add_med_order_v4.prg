CREATE PROGRAM bhs_athn_add_med_order_v4
 FREE RECORD result
 RECORD result(
   1 encntr_id = f8
   1 person_id = f8
 ...
 SET result->ordered_dose =  $25
 SET result->ordered_dose_unit_cd =  $26
...
#exit_script
 ...
 SUBROUTINE calladdorder(null)
   ...
   ELSE
    ...
    IF ((result->ordered_dose > 0.0)
     AND (result->ordered_dose_unit_cd > 0.0))
     SET req560201->orderlist[1].subcomponentlist[1].scordereddose = result->ordered_dose
     SET req560201->orderlist[1].subcomponentlist[1].scordereddosedisp = trim(formatdosevalue(result
       ->ordered_dose),3)
     SET req560201->orderlist[1].subcomponentlist[1].scordereddoseunitcd = result->
     ordered_dose_unit_cd
     SET req560201->orderlist[1].subcomponentlist[1].scordereddoseunitdisp = uar_get_code_display(
      result->ordered_dose_unit_cd)
    ENDIF
 ...
 SUBROUTINE calladdorderautoverify(null)
   ...
   ELSE
    ...
    IF ((result->ordered_dose > 0.0)
     AND (result->ordered_dose_unit_cd > 0.0))
     SET req560251->orderlist[1].subcomponentlist[1].scordereddose = result->ordered_dose
     SET req560251->orderlist[1].subcomponentlist[1].scordereddosedisp = trim(formatdosevalue(result
       ->ordered_dose),3)
     SET req560251->orderlist[1].subcomponentlist[1].scordereddoseunitcd = result->
     ordered_dose_unit_cd
     SET req560251->orderlist[1].subcomponentlist[1].scordereddoseunitdisp = uar_get_code_display(
      result->ordered_dose_unit_cd)
    ENDIF
