CREATE PROGRAM bed_get_iview_posloc:dba
 FREE SET reply
 RECORD reply(
   1 positions[*]
     2 entry_id = f8
 ...
 IF ((request->working_view_name > " "))
  SET view_name = cnvtlower(request->working_view_name)
  SELECT INTO "nl:"
   ...
   HEAD REPORT
    a = 0, b = 0, z = 0
   DETAIL
    z = findstring(view_name,p4.entry_data)
    IF (z > 0)
