CREATE PROGRAM dm_ins_upd_tbl_doc:dba
 ...
 ENDIF
 DECLARE iutd_logfile_prefix = vc WITH protect, constant("dm_ins_upd_tbl_doc")
 DECLARE iutd_pkg_num = i4 WITH protect, noconstant(0)
 IF (check_logfile(iutd_logfile_prefix,".log","DM_INS_UPD_TBL_DOC LOGFILE")=0)
  GO TO exit_script
 ENDIF
 SET dm_err->eproc = "Beginning Insert/Update maintenance on DM_TABLES_DOC...."
 CALL disp_msg(" ",dm_err->logfile,0)
 IF (validate(dm2_db_options->dm2_toolset_usage,"@")="Y")
  SET dm_err->eproc = "Maintenance on DM_TABLES_DOC will be performed later in the process...."
  CALL disp_msg(" ",dm_err->logfile,0)
  FREE RECORD tbl_doc
  GO TO exit_script
 ENDIF
 ...
 ELSEIF (ocd_number <= 0)
  ...
  GO TO exit_script
 ELSE
  SET iutd_pkg_num = ocd_number
 ENDIF
 EXECUTE dm2_chk_tbl_doc iutd_pkg_num
 IF ((dm_err->err_ind=1))
  GO TO exit_script
 ENDIF
 ...
 GO TO exit_script
#exit_script
 SET dm_err->eproc = "Insert/Update maintenance on DM_TABLES_DOC Complete"
 CALL final_disp_msg(iutd_logfile_prefix)
END GO
