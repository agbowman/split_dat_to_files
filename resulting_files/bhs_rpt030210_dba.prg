CREATE PROGRAM bhs_rpt030210:dba
 ...
 IF (validate(request->batch_selection))
  ...
  ENDIF
  SET t_record->action_dt_tm = datetimeadd(t_record->action_dt_tm,- (10))
 ...
 ENDIF
 SET t_record->beg_date = cnvtdatetime("01-FEB-2010 00:00:00")
 SET t_record->end_date = cnvtdatetime("28-FEB-2010 23:59:59")
   ...
   PLAN (ce
    ...
    (SELECT
     ...
     WHERE e.encntr_id=ce.encntr_id
      AND e.loc_facility_cd=673936.00)))
