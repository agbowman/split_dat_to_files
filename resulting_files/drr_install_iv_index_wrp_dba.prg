CREATE PROGRAM drr_install_iv_index_wrp:dba
 ...
 SET readme_data->message = "Readme Failed: Starting script drr_install_iv_index_wrp..."
 EXECUTE dm_dbimport "cer_install:drr_iv_index.csv", "drr_install_iv_index", 1000
 IF ((dm_err->err_ind=0))
