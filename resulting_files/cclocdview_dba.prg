CREATE PROGRAM cclocdview:dba
 ...
 CALL video(n)
 SET num = 0
 CALL text(22,05,"Enter the OCD number.")
 ...
 CALL text(22,05,"Enter S for source or B for backup dictionary.")
 CALL accept(23,05,"P(1);C",group
  WHERE curaccept IN ("S", "s", "B", "b"))
