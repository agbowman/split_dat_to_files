CREATE PROGRAM bhs_him_prod_analysis_sum_grp
 PROMPT
 ...
 DECLARE _bcontfieldname031 = i2 WITH noconstant(0), protect
 ...
 SUBROUTINE main(dummy)
   SELECT
    ...
    ORDER BY organization_name, organization_id, user_name,
     ...
     patient_type_name, patient_type_cd
    HEAD REPORT
     _d0 = los_days, _d1 = tat_create_to_final, _d2 = tat_discharge_to_final,
     _d3 = fin, _d4 = user_name, _d5 = organization_name,
     _d6 = task_queue_name, _d7 = user_username, _fenddetail = (rptreport->m_pagewidth - rptreport->
     m_marginbottom),
     daterange = getdaterangedisplay(dates,him_dash), totalchartsperorganization = 0,
     totaltatperorganization = 0,
     avgtatperorganization = 0, totaltattaskperorganization = 0, avgtattaskperorganization = 0,
     totalchartsperuser = 0, totaltatperuser = 0, avgtatperuser = 0,
     totaltattaskperuser = 0, avgtattaskperuser = 0, totalchartsperqueue = 0,
     totallengthofstayperqueue = 0, avglengthofstayperqueue = 0, totaltatperqueue = 0,
     avgtatperqueue = 0, totaltattaskperqueue = 0, avgtattaskperqueue = 0,
     detailcount = 0, rowcount = 0, dataqualcount = size(data->qual,5),
    ...
    HEAD organization_id
     organization = organization_name, totalchartsperorganization = 0, totaltatperorganization = 0,
     avgtatperorganization = 0, totaltattaskperorganization = 0, avgtattaskperorganization = 0,
    ...
    FOOT  patient_type_name
     row + 0
    FOOT  task_queue_cd
     usernamerowone = user_name, totalchartsrowone = build(totalchartsperqueue), avglosdisplayrowone
      = trim(build(los_days),3),
     usernamerowtwo = user_name, totalchartsrowtwo = build(totalchartsperqueue), avglosdisplayrowtwo
      = trim(build(los_days),3),
    ...
    FOOT  organization_id
     totalchartsperorganizationdisplay = build(totalchartsperorganization)
     IF (totalchartsperorganization > 0)
      avgtatperorgdisplay = build(cnvtminstodayshoursmins((totaltatperorganization/
        totalchartsperorganization)))
     ELSE
      avgtatperorgdisplay = build(cnvtminstodayshoursmins(0))
     ENDIF
     IF (totalchartsperorganization > 0)
      avgtattaskperorgdisplay = build(cnvtminstodayshoursmins((totaltattaskperorganization/
        totalchartsperorganization)))
     ELSE
      avgtattaskperorgdisplay = build(cnvtminstodayshoursmins(0))
     ENDIF
     _bcontfieldname031 = 0, bfirsttime = 1
     WHILE (((_bcontfieldname031=1) OR (bfirsttime=1)) )
       _bholdcontinue = _bcontfieldname031, _fdrawheight = fieldname031(rpt_calcheight,(_fenddetail
         - _yoffset),_bholdcontinue)
       IF (((_bholdcontinue=1) OR (_fdrawheight > 0)) )
        IF ((_fenddetail >= (_yoffset+ _fdrawheight)))
         _fdrawheight += fieldname032(rpt_calcheight)
        ENDIF
        IF ((_fenddetail >= (_yoffset+ _fdrawheight)))
         _fdrawheight += fieldname033(rpt_calcheight)
        ENDIF
        IF ((_fenddetail >= (_yoffset+ _fdrawheight)))
         _fdrawheight += fieldname034(rpt_calcheight)
        ENDIF
        IF ((_fenddetail >= (_yoffset+ _fdrawheight)))
         _fdrawheight += fieldname035(rpt_calcheight)
        ENDIF
       ENDIF
       IF (((_yoffset+ _fdrawheight) > _fenddetail))
        BREAK
       ELSEIF (_bholdcontinue=1
        AND _bcontfieldname031=0)
        BREAK
       ENDIF
       dummy_val = fieldname031(rpt_render,(_fenddetail - _yoffset),_bcontfieldname031), bfirsttime
        = 0
     ENDWHILE
     _fdrawheight = fieldname032(rpt_calcheight)
     IF (_fdrawheight > 0)
     ...
     IF (((_yoffset+ _fdrawheight) > _fenddetail))
      BREAK
     ENDIF
     dummy_val = fieldname032(rpt_render), _fdrawheight = fieldname033(rpt_calcheight)
     IF (_fdrawheight > 0)
      IF ((_fenddetail >= (_yoffset+ _fdrawheight)))
       _fdrawheight += fieldname034(rpt_calcheight)
      ENDIF
     ...
     IF (((_yoffset+ _fdrawheight) > _fenddetail))
      BREAK
     ENDIF
     dummy_val = fieldname033(rpt_render), _fdrawheight = fieldname034(rpt_calcheight)
     IF (_fdrawheight > 0)
      IF ((_fenddetail >= (_yoffset+ _fdrawheight)))
       _fdrawheight += fieldname035(rpt_calcheight)
      ENDIF
     ...
     IF (((_yoffset+ _fdrawheight) > _fenddetail))
      BREAK
     ENDIF
     dummy_val = fieldname034(rpt_render), _fdrawheight = fieldname035(rpt_calcheight)
     IF (((_yoffset+ _fdrawheight) > _fenddetail))
      BREAK
     ENDIF
     dummy_val = fieldname035(rpt_render)
 ...
 SUBROUTINE (mainhtml(ndummy=i2) =null WITH protect)
  ...
  SELECT
   ...
   HEAD REPORT
    _d0 = los_days, _d1 = tat_create_to_final, _d2 = tat_discharge_to_final,
    _d3 = fin, _d4 = user_name, _d5 = organization_name,
    _d6 = task_queue_name, _d7 = user_username, _htmlfileinfo->file_buf = build2("<STYLE>",
     ...
     " vertical-align: middle;}",".FieldName0232 { border-width: 0.014in; border-color: #000000;",
     " border-style: none none none none;"," padding: 0.000in 0.000in 0.000in 0.000in;",
     " font:   10pt Times;",
     " "," color: #000000;"," "," text-align: right;"," vertical-align: middle;}",
     ".FieldName0235 { border-width: 0.014in; border-color: #000000;",
     " border-style: none none none none;"," padding: 0.000in 0.000in 0.000in 0.100in;",
     " font:   10pt Times;"," ",
     " color: #000000;"," "," text-align: right;"," vertical-align: middle;}",
     ...
     " vertical-align: middle;}",".FieldName0250 { border-width: 0.014in; border-color: #000000;",
     " border-style: none none none none;"," padding: 0.000in 0.000in 0.000in 0.200in;",
     " font:  bold 10pt Times;",
     " "," color: #000000;"," background: #ffffff;"," text-align: right;"," vertical-align: middle;}",
     ...
     " vertical-align: middle;}",".FieldName0310 { border-width: 0.014in; border-color: #000000;",
     " border-style: solid none none none;"," padding: 0.000in 0.000in 0.000in 0.000in;",
     " font:  bold 11pt Times;",
     " "," color: #000000;"," background: #ffff80;"," text-align: left;"," vertical-align: middle;}",
     ".FieldName0320 { border-width: 0.014in; border-color: #000000;",
     " border-style: none none none none;"," padding: 0.000in 0.000in 0.000in 0.230in;",
     " font:  bold 10pt Times;"," ",
     " color: #000000;"," background: #ffff80;"," text-align: left;"," vertical-align: middle;}",
     ".FieldName0350 { border-width: 0.025in; border-color: #000000;",
     " border-style: none none none none;"," padding: 0.000in 0.000in 0.000in 0.000in;",
     " font:  bold 10pt Times;"," "," color: #000000;",
     " "," text-align: center;"," vertical-align: middle;}","</STYLE>"),
    _htmlfilestat = cclio("WRITE",_htmlfileinfo), _htmlfileinfo->file_buf =
    "<table width='100%'><caption>", _htmlfilestat = cclio("WRITE",_htmlfileinfo),
    _htmlfileinfo->file_buf = build2("<colgroup span=10>","<col width=102/>","<col width=48/>",
     "<col width=25/>","<col width=75/>",
     "<col width=38/>","<col width=112/>","<col width=25/>","<col width=163/>","<col width=212/>",
     "<col width=184/>","</colgroup>"), _htmlfilestat = cclio("WRITE",_htmlfileinfo), daterange =
    getdaterangedisplay(dates,him_dash),
    ...
    dummy_val = fieldname04html(0), dummy_val = fieldname05html(0), dummy_val = fieldname06html(0),
    dummy_val = fieldname07html(0), dummy_val = fieldname08html(0), dummy_val = fieldname09html(0),
    dummy_val = fieldname010html(0), dummy_val = fieldname011html(0), dummy_val = fieldname012html(0),
    dummy_val = fieldname013html(0), dummy_val = fieldname014html(0), _htmlfileinfo->file_buf =
    "</thead>",
   ...
   FOOT  task_queue_cd
    ...
    usernamerowtwo = user_name, totalchartsrowtwo = build(totalchartsperqueue), avglosdisplayrowtwo
     = trim(build(los_days),3),
    dummy_val = fieldname023html(0), dummy_val = fieldname024html(0)
   FOOT  user_id
    totalchartsperuserdisplay = build(totalchartsperuser)
    IF (totalchartsperuser > 0)
     avgtatperuserdisplay = build(cnvtminstodayshoursmins((totaltatperuser/ totalchartsperuser)))
   ...
   FOOT  organization_id
    ...
    ELSE
     avgtattaskperorgdisplay = build(cnvtminstodayshoursmins(0))
    ENDIF
    dummy_val = fieldname031html(0), dummy_val = fieldname032html(0), dummy_val = fieldname033html(0),
    dummy_val = fieldname034html(0), dummy_val = fieldname035html(0)
   FOOT REPORT
 ...
 SUBROUTINE (fieldname01html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName010' colspan='10'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName0",
 ...
 SUBROUTINE (fieldname02html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName020' colspan='10'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName1","Summary Report"),
   "</td>","</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname09html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName040' colspan='2'>","","</td>",
   "<td class='FieldName050' colspan='3'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName5","User Name(s):"),"</td>",
   "<td class='FieldName082' colspan='5'>",userlist,"</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname010html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName040' colspan='2'>","","</td>",
   "<td class='FieldName050' colspan='3'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName7","Task Queue(s):"),
 ...
 SUBROUTINE (fieldname014html(dummy=i2) =null WITH protect)
   IF (rowcount > 0)
    SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0140' colspan='3'>",
     uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName12","User Name"),"</td>",
     "<td class='FieldName0141' colspan='2'>",
     uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName13","Task Queue"),"</td>",
     "<td class='FieldName0142' colspan='2'>",uar_i18ngetmessage(_hi18nhandle,
      "BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName14","Total Charts Analyzed"),"</td>",
     "<td class='FieldName0142' colspan='1'>",uar_i18ngetmessage(_hi18nhandle,
      "BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName17","Avg LOS (Days)"),"</td>",
     "<td class='FieldName0144' colspan='1'>",uar_i18ngetmessage(_hi18nhandle,
      "BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName21","Avg TAT (Discharge to Final)"),
     "</td>","<td class='FieldName0145' colspan='1'>",uar_i18ngetmessage(_hi18nhandle,
      "BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName22","Avg TAT Task (Create to Final)"),"</td>","</tr>")
    SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
   ENDIF
 END ;Subroutine
 ...
 SUBROUTINE (fieldname015html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0150' colspan='10'>",organization,
   "</td>","</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname019html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0140' colspan='1'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName47","User Name"),"</td>",
   "<td class='FieldName0140' colspan='2'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_User_ID","User ID"),"</td>",
   "<td class='FieldName0141' colspan='2'>",uar_i18ngetmessage(_hi18nhandle,
    "BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName52","Task Queue"),"</td>",
   "<td class='FieldName0141' colspan='2'>",uar_i18ngetmessage(_hi18nhandle,
    "BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName53","Total Charts Analyzed"),"</td>",
   "<td class='FieldName0142' colspan='1'>",uar_i18ngetmessage(_hi18nhandle,
    "BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName56","Avg LOS (Days)"),
   "</td>","<td class='FieldName0144' colspan='1'>",uar_i18ngetmessage(_hi18nhandle,
    "BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName59","Avg TAT (Discharge to Final)"),"</td>",
   "<td class='FieldName0144' colspan='1'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName60",
 ...
 SUBROUTINE (fieldname026html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0260' colspan='10'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName48",
 ...
 SUBROUTINE (fieldname027html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0270' colspan='4'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName72",
 ...
 SUBROUTINE (fieldname028html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0270' colspan='4'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName49",
 ...
 SUBROUTINE (fieldname029html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0270' colspan='4'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName9",
 ...
 SUBROUTINE (fieldname030html(dummy=i2) =null WITH protect)
  ...
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 SUBROUTINE (fieldname031(ncalc=i2,maxheight=f8,bcontinue=i2(ref)) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = fieldname031abs(ncalc,_xoffset,_yoffset,maxheight,bcontinue)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (fieldname031abs(ncalc=i2,offsetx=f8,offsety=f8,maxheight=f8,bcontinue=i2(ref)) =f8 WITH
  protect)
   DECLARE sectionheight = f8 WITH noconstant(0.220000), private
   DECLARE growsum = i4 WITH noconstant(0), private
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (fieldname031html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0310' colspan='10'>",
  ...
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 SUBROUTINE (fieldname032(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = fieldname032abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (fieldname032abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.200000), private
   IF (ncalc=rpt_render)
    SET rptsd->m_flags = 288
    SET rptsd->m_borders = rpt_sdnoborders
    ...
    SET oldbackcolor = uar_rptsetbackcolor(_hreport,uar_rptencodecolor(255,255,128))
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build(uar_i18ngetmessage(_hi18nhandle,
       "FieldName032_CellName33",build2("Total # of Charts Analyzed:",char(0))),char(0)))
    SET oldbackcolor = uar_rptresetbackcolor(_hreport)
    SET _dummypen = uar_rptsetpen(_hreport,_pen0s0c0)
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.000),(offsety+ 0.000),(offsetx+ 10.000),(offsety
     + 0.000))
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (fieldname032html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0320' colspan='4'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName33",
    "Total # of Charts Analyzed:"),"</td>","<td class='FieldName0271' colspan='2'>",
   totalchartsperorganizationdisplay,"</td>","<td class='FieldName0272' colspan='4'>","","</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 SUBROUTINE (fieldname033(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = fieldname033abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (fieldname033abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.250000), private
   IF (ncalc=rpt_render)
    SET rptsd->m_flags = 288
    SET rptsd->m_borders = rpt_sdnoborders
    ...
    SET rptsd->m_height = 0.251
    SET oldbackcolor = uar_rptsetbackcolor(_hreport,uar_rptencodecolor(255,255,128))
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build(avgtatperorgdisplay,char(0)))
    SET oldbackcolor = uar_rptresetbackcolor(_hreport)
    SET rptsd->m_flags = 288
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdleftborder
    ...
    SET oldbackcolor = uar_rptsetbackcolor(_hreport,uar_rptencodecolor(255,255,128))
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build(uar_i18ngetmessage(_hi18nhandle,
       "FieldName033_CellName29",build2("Avg TAT (Discharge to Final):",char(0))),char(0)))
    SET oldbackcolor = uar_rptresetbackcolor(_hreport)
    SET _dummypen = uar_rptsetpen(_hreport,_pen0s0c0)
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.000),(offsety+ 0.000),(offsetx+ 10.000),(offsety
     + 0.000))
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (fieldname033html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0320' colspan='4'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName29",
    "Avg TAT (Discharge to Final):"),"</td>","<td class='FieldName0271' colspan='2'>",
   avgtatperorgdisplay,"</td>","<td class='FieldName0272' colspan='4'>","","</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 SUBROUTINE (fieldname034(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = fieldname034abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (fieldname034abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.220000), private
   IF (ncalc=rpt_render)
    SET rptsd->m_flags = 288
    SET rptsd->m_borders = rpt_sdnoborders
    ...
    SET rptsd->m_height = 0.219
    SET oldbackcolor = uar_rptsetbackcolor(_hreport,uar_rptencodecolor(255,255,128))
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build(avgtattaskperorgdisplay,char(0)))
    SET oldbackcolor = uar_rptresetbackcolor(_hreport)
    SET rptsd->m_flags = 288
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdleftborder
    ...
    SET oldbackcolor = uar_rptsetbackcolor(_hreport,uar_rptencodecolor(255,255,128))
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build(uar_i18ngetmessage(_hi18nhandle,
       "FieldName034_CellName8",build2("Avg TAT Task (Create to Final):",char(0))),char(0)))
    SET oldbackcolor = uar_rptresetbackcolor(_hreport)
    SET _dummypen = uar_rptsetpen(_hreport,_pen0s0c0)
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.000),(offsety+ 0.000),(offsetx+ 10.000),(offsety
     + 0.000))
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (fieldname034html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0320' colspan='4'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_CellName8",
    "Avg TAT Task (Create to Final):"),"</td>","<td class='FieldName0271' colspan='2'>",
   avgtattaskperorgdisplay,"</td>","<td class='FieldName0272' colspan='4'>","","</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 SUBROUTINE (fieldname035(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = fieldname035abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (fieldname035abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.130000), private
   IF (ncalc=rpt_render)
    SET rptsd->m_flags = 272
    SET rptsd->m_borders = rpt_sdnoborders
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (fieldname035html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0350' colspan='10'>","","</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname036html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0350' colspan='10'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_SUM_GRP_EndOfReport","**END OF REPORT**"),
   "</td>","</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 SUBROUTINE initializereport(dummy)
   IF (_bsubreport=0)
    ...
    ELSE
     ...
     SET rptreport->m_reportname = "BHS_HIM_PROD_ANALYSIS_SUM_GRP"
