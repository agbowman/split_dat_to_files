CREATE PROGRAM bed_aud_ap_work_rtg:dba
 ...
 DECLARE ap_cd = f8 WITH protect, noconstant(0.0)
 ...
 SET reply->collist[3].header_text = "Bench"
 ...
 SET reply->collist[10].header_text = "Bench Status"
...
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("ap_work_rtg_audit.csv")
 ENDIF
