CREATE PROGRAM ec_profiler_m83:dba
 ...
 DECLARE dpharmcatcd = f8 WITH constant(uar_get_code_by("MEANING",6000,"PHARMACY"))
  ...
  SELECT INTO "nl:"
   ...
   PLAN (oa
    ...
    WHERE o.order_id=oa.order_id
     ...
     AND o.catalog_type_cd=dpharmcatcd)
    JOIN (elh
   ...
   ORDER BY elh.loc_facility_cd, p.position_cd, o.order_id
