CREATE PROGRAM bed_get_iview_cern_rep_groups
 ...
 DECLARE getlabelassaysfortheview(dummyvar=i2) = null
 CALL getlabelassaysfortheview(0)
#exit_script
 CALL bedexitscript(0)
 SUBROUTINE getlabelassaysfortheview(dummyvar)
   CALL bedlogmessage("getLabelAssaysForTheView","Entering ...")
   ...
   SELECT INTO "nl:"
    ...
    ORDER BY dta.label_template_id
   ...
   SELECT INTO "nl:"
    ...
    WITH nocounter
   ;end select
   CALL bedlogmessage("getLabelAssaysForTheView","Exiting ...")
 END ;Subroutine
END GO
