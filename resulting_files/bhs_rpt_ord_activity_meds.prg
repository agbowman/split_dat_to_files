CREATE PROGRAM bhs_rpt_ord_activity_meds
 PROMPT
 ...
 SELECT DISTINCT INTO  $OUTDEV
  ...
  .csa_schedule,
  order_detail = o.clinical_display_line, current_status = uar_get_code_display(o.order_status_cd),
  organization_id = org.organization_id,
  prsnl_id = prsnl.person_id, order_id = o.order_id, ord_provider_id = prsnl.person_id,
  entry_provider_id = prsnl2.person_id, patient_id = p.person_id
  FROM orders o,
   order_action oa,
   order_catalog oc,
   encounter e,
