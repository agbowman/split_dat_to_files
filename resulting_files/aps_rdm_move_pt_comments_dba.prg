CREATE PROGRAM aps_rdm_move_pt_comments:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "aps_rdm_move_pt_comments"
 ...
 CALL logmsg("Getting ready to begin reading for processing_task comment.",((e_dispmsg+ e_rdmstatus)
  + e_logtofile))
 SELECT INTO "nl:"
