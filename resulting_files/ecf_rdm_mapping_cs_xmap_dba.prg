CREATE PROGRAM ecf_rdm_mapping_cs_xmap:dba
 ...
 SET kia_tbl_desc = "CERNER CODESET MAPPING XMAP"
 SET kia_short_desc = "CERNER CODESET MAPPING XMAP"
 SET kia_rdm_log_name = "ecf_rdm_mapping_cs_xmap.log"
 SET kia_rdm_nbr = 10346
 ...
 EXECUTE kia_dm_dbimport "cer_install:mapping_cs_version.csv", "kia_get_rdm_vars", 100,
 0
 CALL kia_chk_script_failure("KIA_GET_RDM_VARS")
 SET start_time_var = cnvtdatetime(curdate,curtime3)
 CALL log_sub(concat("ecf_rdm_mapping_cs_xmap Begin>  ",format(cnvtdatetime(curdate,curtime3),
 ...
 IF (kia_obj_suc_ind=0)
  EXECUTE kia_load_xmap kia_rdm_vocab_mean, "CERNER CODESET MAPPING XMAP"
