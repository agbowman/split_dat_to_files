CREATE PROGRAM djh_ma_45_day_nologin_cns
 PROMPT
 ...
 IF (email_ind=1)
  ...
  SET filename_out = concat(format(curdate,"YYYY-MM-DD ;;D"),"-CN.csv")
  DECLARE subject_line = vc
  SET subject_line = concat(curprog," - CIS CN Acnts InAct 45 days")
