CREATE PROGRAM dm2_ref_data_mover_0635:dba
 ...
 SET v_cd = uar_get_code_by("DISPLAY",361571,nullterm(v_str_temp))
 IF (v_cd < 0)
  SET v_cd = uar_get_code_by("DISPLAY",361571,nullterm(v_code_set))
  IF (v_cd < 0)
 ...
 ENDIF
 IF (v_cd > 0)
  SET v_alg_type = uar_get_code_meaning(v_cd)
  ...
  CASE (v_alg_type)
   ...
   OF "BADLOG":
    SET dm2_ref_data_reply->error_ind = 1
    SET dm2_ref_data_reply->error_msg = "BADLOG"
