CREATE PROGRAM bhs_gen_transfuse_orders
 IF ( NOT (validate(request,0)))
  ...
  SET request->visit[1].encntr_id = 50018502
 ...
 SET transfuserbcspedi3059kg = uar_get_code_by("DISPLAYKEY",200,"TRANSFUSERBCSPEDI3059KG")
 SET transfusecryoprecipitatepedi30kg = uar_get_code_by("DISPLAYKEY",200,
  "TRANSFUSECRYOPRECIPITATEPEDI30KG")
 SET transfuseffppedi30kg = uar_get_code_by("DISPLAYKEY",200,"  TRANSFUSEFFPPEDI30KG")
 SET transfuseplateletspedi3059kg = uar_get_code_by("DISPLAYKEY",200,"TRANSFUSEPLATELETSPEDI3059KG")
 SET transfuseplateletspedi30kg = uar_get_code_by("DISPLAYKEY",200,"TRANSFUSEPLATELETSPEDI30KG")
 SET transfuserbcsautologouspedi3059kg = uar_get_code_by("DISPLAYKEY",200,
  "TRANSFUSERBCSAUTOLOGOUSPEDI3059KG")
 SET transfuserbcsautologouspedi30kg = uar_get_code_by("DISPLAYKEY",200,
  "TRANSFUSERBCSAUTOLOGOUSPEDI30KG")
 SET transfuserbcspedi30kg = uar_get_code_by("DISPLAYKEY",200,"TRANSFUSERBCSPEDI30KG")
 SET transfuseffppedi3059kg = uar_get_code_by("DISPLAYKEY",200,"TRANSFUSEFFPPEDI3059KG")
 ...
 SELECT INTO "nl:"
  ...
  PLAN (o
   ...
   ord21, ord22, ord23, transfuserbcspedi3059kg, transfusecryoprecipitatepedi30kg,
   transfuseffppedi3059kg, transfuseffppedi30kg, transfuseplateletspedi3059kg,
   transfuseplateletspedi30kg, transfuserbcsautologouspedi3059kg,
   transfuserbcsautologouspedi30kg, transfuserbcspedi30kg)
    AND o.current_start_dt_tm >= cnvtdatetime((curdate - 3),curtime3)
