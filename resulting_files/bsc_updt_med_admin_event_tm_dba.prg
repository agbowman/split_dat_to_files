CREATE PROGRAM bsc_updt_med_admin_event_tm:dba
 ...
 SUBROUTINE setreadmetimings(null)
   ...
   RETURN(1)
 END ;Subroutine
 IF (setdrivertable("MED_ADMIN_EVENT")=0)
  GO TO exit_script
 ENDIF
 IF (fetchandsetdrivertable(4112)=0)
  GO TO exit_script
 ENDIF
 CALL setrangeincrement(250000)
 CALL settimeperbatch(5.770476)
 CALL addtimedreadme(4113)
 CALL addtimedreadme(4114)
 CALL addtimedreadme(4115)
