CREATE PROGRAM bhs_athn_med_order_ls_v5
 ...
 SELECT DISTINCT INTO "NL:"
  ...
  HEAD o.order_id
   ...
   order_list->qual[d1.seq].order_catalog_cki = trim(o.cki,3), order_list->qual[d1.seq].stop_type_cd
    = o.stop_type_cd,
   order_list->qual[d1.seq].stop_type_disp = uar_get_code_display(o.stop_type_cd), order_list->qual[
   d1.seq].stop_type_mean = uar_get_code_meaning(o.stop_type_cd), order_list->qual[d1.seq].
   ...
   update_datetime = format(o.updt_dt_tm,"MM/DD/YYYY HH:MM:SS;;D"), order_list->qual[d1.seq].
   status_datetime = format(o.status_dt_tm,"MM/DD/YYYY HH:MM:SS;;D"),
   order_list->qual[d1.seq].prescription_order_id = cnvtstring(o.prescription_order_id), order_list->
   qual[d1.seq].prn_indicator = cnvtbool(o.prn_ind), order_list->qual[d1.seq].medication_ordertype_cd
    = cnvtstring(o.med_order_type_cd),
   ...
   order_list->qual[d1.seq].iv_indicator = o.iv_ind, order_list->qual[d1.seq].department_status_cd =
   o.dept_status_cd, order_list->qual[d1.seq].department_status_disp = uar_get_code_display(o
    .dept_status_cd),
   order_list->qual[d1.seq].department_status_mean = uar_get_code_meaning(o.dept_status_cd),
   ...
   order_list->qual[d1.seq].template_order_id = o.template_order_id, order_list->qual[d1.seq].
   billonly_indicator = oc.bill_only_ind, order_list->qual[d1.seq].discontinue_indicator = o
   .discontinue_ind,
   order_list->qual[d1.seq].discontinue_datetime = format(o.discontinue_effective_dt_tm,
    "MM/DD/YYYY HH:MM:SS;;D"), order_list->qual[d1.seq].discontinue_datetimezone = substring(21,3,
    datetimezoneformat(o.discontinue_effective_dt_tm,o.discontinue_effective_tz,
     "MM/dd/yyyy hh:mm:ss ZZZ",curtimezonedef)), order_list->qual[d1.seq].discontinue_type =
   uar_get_code_display(o.discontinue_type_cd),
   order_list->qual[d1.seq].witness_flag = os.witness_flag, order_list->qual[d1.seq].pathway_plan = p
   .display_description, order_list->qual[d1.seq].proposal_status = uar_get_code_display(op
    .proposal_status_cd),
   order_list->qual[d1.seq].ingredient_display = "1", order_list->qual[d1.seq].dcdisplay_days =
   cnvtstring(oc.dc_display_days), order_list->qual[d1.seq].default_stop_duration = oc.stop_duration,
