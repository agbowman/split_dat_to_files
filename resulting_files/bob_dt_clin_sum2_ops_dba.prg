CREATE PROGRAM bob_dt_clin_sum2_ops:dba
    ...
    DETAIL
     CASE (mso)
      ...
      OF 3:
       ...
       CALL echo(build("BOB - GOT HERE 1"))
       CALL echo(build("Order ID: ",o.order_id,".... Ordername:",o.order_mnemonic,"(",
   ...
   IF (prn_med_cnt > 0)
    SELECT DISTINCT INTO "nl:"
     ...
     HEAD oa.action_sequence
      ...
      clinical_display_line = oa.clinical_display_line,
      CALL echo(build("**********************BOB - GOT HERE 2")),
      CALL echo(build("Ordered as mnemonic:",o.ordered_as_mnemonic)),
      CALL echo(build("Order ID:",o.order_id,"......Action sequence:",oa.action_sequence)),
      CALL echo(build("CLINICAL_DISPLAY_LINE:",oa.clinical_display_line))
     DETAIL
      IF (actioncnt=1)
       admincnt = (admincnt+ 1)
     ...
     IF (size(prn_orders_disp->prn_orders,5) > 0)
      ...
      FOR (z1 = 1 TO size(prn_orders_disp->prn_orders,5))
        ...
        IF (size(prn_orders_disp->prn_orders[z1].core_actions,5) > 0)
         ...
         row + 1, ycol = (ycol+ 8), tempstring = concat("Order Detail :",prn_orders_disp->prn_orders[
          z1].core_actions[1].clinical_display_line),
         wrapcol = 122, line_wrap2
         IF (comment_string > "")
