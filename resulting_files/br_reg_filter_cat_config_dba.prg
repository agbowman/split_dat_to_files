CREATE PROGRAM br_reg_filter_cat_config:dba
 ...
 SET readme_data->message = "Readme Failed: Starting <br_reg_filter_cat_config.prg> script"
 ...
 SET readme_data->message = "Readme Succeeded: <br_reg_filter_cat_config.prg> script"
#exit_script
 FREE RECORD br_existsinfo
END GO
