CREATE PROGRAM bhs_gvw_lab_collected_ord:dba
 ...
 SELECT INTO "nl:"
  ...
  WHERE (o.person_id=request->person[1].person_id)
   ...
   AND o.dept_status_cd IN (mf_cs14281_collected_cd, mf_cs14281_inprocess_cd)
 ...
 IF ((prsn_orders->n_cnt > 0))
  ...
  ENDFOR
 ELSE
  SET s_text = concat(s_text," No Pending Labs \par ")
 ENDIF
