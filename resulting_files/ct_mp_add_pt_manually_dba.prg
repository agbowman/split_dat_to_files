CREATE PROGRAM ct_mp_add_pt_manually:dba
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "ProtId" = 0.0,
  "PersonId" = 0.0
  WITH outdev, protid, personid
 ...
 SELECT INTO "nl:"
  ...
  WHERE (pt.prot_master_id= $PROTID)
 ...
 INSERT  FROM pt_prot_prescreen ppp
  SET ppp.person_id =  $PERSONID, ppp.added_via_flag = 1, ppp.pt_prot_prescreen_id =
   pt_prot_prescreen_id,
   ppp.prot_master_id =  $PROTID, ppp.screener_person_id = added_by_id, ppp.screening_status_cd =
   pending_cd,
