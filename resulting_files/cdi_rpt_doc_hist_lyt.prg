CREATE PROGRAM cdi_rpt_doc_hist_lyt
 PROMPT
 ...
 SUBROUTINE batch_query(dummy)
   SELECT
    ...
    batch_lyt_batch_details_module_name = substring(1,30,batch_lyt->batch_details[dtrs1.seq].
     module_name), batch_lyt_batch_details_ascent_user = substring(1,30,batch_lyt->batch_details[
     dtrs1.seq].ascent_user),
    ...
    batch_lyt_batch_details_blob_handle = substring(1,60,batch_lyt->batch_details[dtrs1.seq].
     blob_handle), batch_lyt_batch_details_version = substring(1,15,batch_lyt->batch_details[dtrs1
     .seq].version), batch_lyt_batch_details_cdi_queue_cd = batch_lyt->batch_details[dtrs1.seq].
    cdi_queue_cd,
    batch_lyt_batch_details_action_type = substring(1,30,batch_lyt->batch_details[dtrs1.seq].
     action_type), batch_lyt_batch_details_reason_cd = batch_lyt->batch_details[dtrs1.seq].reason_cd,
    ...
    batch_lyt_batch_details_patient_name = substring(1,30,batch_lyt->batch_details[dtrs1.seq].
     patient_name), batch_lyt_batch_details_encntr_id = batch_lyt->batch_details[dtrs1.seq].encntr_id,
    ...
    external_batch_ident, batch_lyt_batch_details_perf_prsnl_name = substring(1,30,batch_lyt->
     batch_details[dtrs1.seq].perf_prsnl_name), change_description_change = substring(1,60,batch_lyt
     ->batch_details[dtrs1.seq].change_description[d1.seq].change),
    batch_details_parent_entity_alias = substring(1,30,batch_lyt->batch_details[dtrs1.seq].
     parent_entity_alias), batch_lyt_batch_details_subject = substring(1,60,batch_lyt->batch_details[
     dtrs1.seq].subject), batch_lyt_batch_details_doc_type_alias = substring(1,30,batch_lyt->
     batch_details[dtrs1.seq].doc_type_alias),
    change_description_action_sequence = batch_lyt->batch_details[dtrs1.seq].change_description[d1
    .seq].action_sequence, parent_aliases_name_1 = substring(1,30,batch_lyt->batch_details[dtrs1.seq]
     .parent_aliases[d3.seq].name_1), parent_aliases_value_1 = substring(1,30,batch_lyt->
     batch_details[dtrs1.seq].parent_aliases[d3.seq].value_1),
    parent_aliases_name_2 = substring(1,30,batch_lyt->batch_details[dtrs1.seq].parent_aliases[d3.seq]
     .name_2), parent_aliases_value_2 = substring(1,30,batch_lyt->batch_details[dtrs1.seq].
     parent_aliases[d3.seq].value_2), parent_alias_row = d3.seq,
    ...
    ORDER BY batch_lyt_batch_details_version_nbr, batch_lyt_batch_details_blob_handle,
     batch_lyt_batch_details_action_dt_tm,
     batch_lyt_batch_details_trans_log_id, parent_alias_row, batch_lyt_batch_details_trans_log_id2,
     change_description_action_sequence
    HEAD REPORT
     _d0 = batch_lyt_batch_details_module_name, _d1 = batch_lyt_batch_details_ascent_user, _d2 =
     batch_lyt_batch_details_ac_start_dt_tm,
     _d3 = batch_lyt_batch_details_ac_end_dt_tm, _d4 = batch_lyt_batch_details_ac_ind, _d5 =
     batch_lyt_batch_details_blob_handle,
     _d6 = batch_lyt_batch_details_version, _d7 = batch_lyt_batch_details_cdi_queue_cd, _d8 =
     batch_lyt_batch_details_action_type,
     _d9 = batch_lyt_batch_details_reason_cd, _d10 = batch_lyt_batch_details_result_status_cd, _d11
      = batch_lyt_batch_details_action_dt_tm,
     _d12 = batch_lyt_batch_details_batch_name, _d13 = batch_lyt_batch_details_doc_type, _d14 =
     batch_lyt_batch_details_patient_name,
     _d15 = batch_lyt_batch_details_ax_appid, _d16 = batch_lyt_batch_details_ax_docid, _d17 =
     batch_lyt_batch_details_blob_type,
     _d18 = batch_lyt_batch_details_blob_ref_id, _d19 = batch_lyt_batch_details_page_cnt, _d20 =
     batch_lyt_batch_details_perf_prsnl_name,
     _d21 = change_description_change, _d22 = batch_details_parent_entity_alias, _d23 =
     batch_lyt_batch_details_subject,
     _d24 = batch_lyt_batch_details_doc_type_alias, _d25 = parent_aliases_name_1, _d26 =
     parent_aliases_value_1,
     _d27 = parent_aliases_name_2, _d28 = parent_aliases_value_2, _d29 = parent_alias_row,
     _d30 = max_parent_alias_row, _fenddetail = (rptreport->m_pageheight - rptreport->m_marginbottom),
     ...
     IF (((_yoffset+ _fdrawheight) > (rptreport->m_pageheight - rptreport->m_marginbottom)))
      CALL pagebreak(0)
     ENDIF
     dummy_val = headreportsection(rpt_render), ihnamcnt = 0, _fdrawheight = headreportsection1(
      rpt_calcheight)
     IF (((_yoffset+ _fdrawheight) > (rptreport->m_pageheight - rptreport->m_marginbottom)))
      CALL pagebreak(0)
     ENDIF
    ...
    HEAD batch_lyt_batch_details_trans_log_id
     ...
     WHILE (((_bcontheadbatch_lyt_batch_details_trans_log_idsection=1) OR (bfirsttime=1)) )
       ...
       IF (((_bholdcontinue=1) OR (_fdrawheight > 0)) )
        ...
        ENDIF
        IF ((_fenddetail >= (_yoffset+ _fdrawheight)))
         _fdrawheight += headbatch_lyt_batch_details_action_dt_tmsection1(rpt_calcheight)
        ENDIF
        IF ((_fenddetail >= (_yoffset+ _fdrawheight)))
       ...
       ELSEIF (_bholdcontinue=1
        ...
        BREAK
       ENDIF
       dummy_val = headbatch_lyt_batch_details_trans_log_idsection(rpt_render,(_fenddetail - _yoffset
        ),_bcontheadbatch_lyt_batch_details_trans_log_idsection), bfirsttime = 0
     ENDWHILE
     _fdrawheight = headbatch_lyt_batch_details_trans_log_idsection1(rpt_calcheight)
     IF (_fdrawheight > 0)
      IF ((_fenddetail >= (_yoffset+ _fdrawheight)))
     ...
     IF (trim(uar_get_code_display(batch_lyt_batch_details_cdi_queue_cd))="HNAM")
      ihnamcnt += 1
     ENDIF
     _fdrawheight = detailsection1(rpt_calcheight)
     IF (((_yoffset+ _fdrawheight) > _fenddetail))
 ...
 SUBROUTINE (headreportsectionabs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   IF (ncalc=rpt_render)
    ...
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2(concat("ProVision Document Imaging",
       _crlf,"Document History Report"),char(0)))
 ...
 END ;Subroutine
 SUBROUTINE (headreportsection1(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = headreportsection1abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (headreportsection1abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_trans_log_idsection(ncalc=i2,maxheight=f8,bcontinue=i2(ref)
  ) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   ...
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_trans_log_idsectionabs(ncalc=i2,offsetx=f8,offsety=f8,
  maxheight=f8,bcontinue=i2(ref)) =f8 WITH protect)
   ...
   IF (((size(trim(cnvtstring(batch_lyt_batch_details_action_dt_tm))) > 4) OR (((size(trim(
     batch_lyt_batch_details_batch_name)) > 0) OR (size(trim(batch_lyt_batch_details_blob_handle)) >
   0)) ))
    AND batch_lyt_batch_details_ac_ind=0
    AND ihnamcnt < 1)
    DECLARE __batch_lyt_batch_details_cdi_queue_cd_disp = vc WITH noconstant(build2(
      IF (trim(batch_lyt_batch_details_action_type)="Receive") concat(trim(uar_get_code_display(
          batch_lyt_batch_details_cdi_queue_cd))," (PRELIMINARY)")
      ELSE trim(uar_get_code_display(batch_lyt_batch_details_cdi_queue_cd))
      ENDIF
      ,char(0))), protect
   ENDIF
   IF ( NOT (((size(trim(cnvtstring(batch_lyt_batch_details_action_dt_tm))) > 4) OR (((size(trim(
     batch_lyt_batch_details_batch_name)) > 0) OR (size(trim(batch_lyt_batch_details_blob_handle)) >
   0)) ))
    AND batch_lyt_batch_details_ac_ind=0
    AND ihnamcnt < 1))
    ...
    IF (_rembatch_lyt_batch_details_cdi_queue_cd_disp > 0)
     SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(
        _rembatch_lyt_batch_details_cdi_queue_cd_disp,((size(
         __batch_lyt_batch_details_cdi_queue_cd_disp) - _rembatch_lyt_batch_details_cdi_queue_cd_disp
        )+ 1),__batch_lyt_batch_details_cdi_queue_cd_disp)))
     ...
     ELSEIF ((rptsd->m_drawlength < size(nullterm(substring(
      ...
      SET _rembatch_lyt_batch_details_cdi_queue_cd_disp += rptsd->m_drawlength
     ELSE
      SET _rembatch_lyt_batch_details_cdi_queue_cd_disp = 0
     ENDIF
     SET growsum += _rembatch_lyt_batch_details_cdi_queue_cd_disp
    ENDIF
   ELSE
    SET _rembatch_lyt_batch_details_cdi_queue_cd_disp = 0
    SET _holdrembatch_lyt_batch_details_cdi_queue_cd_disp =
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_trans_log_idsection1(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = headbatch_lyt_batch_details_trans_log_idsection1abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_trans_log_idsection1abs(ncalc=i2,offsetx=f8,offsety=f8) =f8
  WITH protect)
   ...
   0)) ))
    ...
    DECLARE __batch_lyt_batch_details_version = vc WITH noconstant(build2(uar_i18ngetmessage(0,"vers",
       batch_lyt_batch_details_version),char(0))), protect
   ENDIF
   IF ( NOT (((size(trim(cnvtstring(batch_lyt_batch_details_action_dt_tm))) > 4) OR (((size(trim(
     batch_lyt_batch_details_batch_name)) > 0) OR (size(trim(batch_lyt_batch_details_blob_handle)) >
   0)) ))
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_action_dt_tmsection1(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = headbatch_lyt_batch_details_action_dt_tmsection1abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_action_dt_tmsection1abs(ncalc=i2,offsetx=f8,offsety=f8) =f8
  WITH protect)
   ...
   0)) ))
    ...
    DECLARE __batch_lyt_batch_details_doc_type2 = vc WITH noconstant(build2(
      IF (((trim(uar_get_code_display(batch_lyt_batch_details_cdi_queue_cd))="HNAM") OR (trim(
       uar_get_code_display(batch_lyt_batch_details_reason_cd))="Submit"
       AND trim(batch_lyt_batch_details_action_type)="Submit"))
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (headparent_alias_rowsection(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = headparent_alias_rowsectionabs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (headparent_alias_rowsectionabs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.200000), private
   IF (size(trim(parent_aliases_name_1)) > 1
    AND ((size(trim(cnvtstring(batch_lyt_batch_details_action_dt_tm))) > 4) OR (((size(trim(
     batch_lyt_batch_details_batch_name)) > 0) OR (size(trim(batch_lyt_batch_details_blob_handle)) >
   0)) ))
    AND batch_lyt_batch_details_ac_ind=0
    AND trim(batch_lyt_batch_details_action_type) != "Receive")
    DECLARE __parent_aliases_name_1 = vc WITH noconstant(build2(build(parent_aliases_name_1,":"),char
      (0))), protect
   ENDIF
   ...
   0)) ))
    AND batch_lyt_batch_details_ac_ind=0
    AND trim(batch_lyt_batch_details_action_type) != "Receive")
    DECLARE __parent_aliases_name_2 = vc WITH noconstant(build2(build(parent_aliases_name_2,":"),char
      (0))), protect
   ENDIF
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_action_dt_tmsection2(ncalc=i2,maxheight=f8,bcontinue=i2(ref)
  ) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   ...
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_action_dt_tmsection2abs(ncalc=i2,offsetx=f8,offsety=f8,
  maxheight=f8,bcontinue=i2(ref)) =f8 WITH protect)
   ...
   0)) ))
    ...
    IF (_rembatch_lyt_batch_details_perf_prsnl_name > 0)
     SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(
        _rembatch_lyt_batch_details_perf_prsnl_name,((size(__batch_lyt_batch_details_perf_prsnl_name)
         - _rembatch_lyt_batch_details_perf_prsnl_name)+ 1),__batch_lyt_batch_details_perf_prsnl_name
        )))
     ...
     ELSEIF ((rptsd->m_drawlength < size(nullterm(substring(
      ...
      SET _rembatch_lyt_batch_details_perf_prsnl_name += rptsd->m_drawlength
     ELSE
      SET _rembatch_lyt_batch_details_perf_prsnl_name = 0
     ENDIF
     SET growsum += _rembatch_lyt_batch_details_perf_prsnl_name
    ENDIF
   ELSE
    SET _rembatch_lyt_batch_details_perf_prsnl_name = 0
    SET _holdrembatch_lyt_batch_details_perf_prsnl_name = _rembatch_lyt_batch_details_perf_prsnl_name
   ...
   0)) )) )
    ...
    IF (_rembatch_lyt_batch_details_action_dt_tm > 0)
     ...
     ELSEIF ((rptsd->m_drawlength < size(nullterm(substring(_rembatch_lyt_batch_details_action_dt_tm,
        ((size(__batch_lyt_batch_details_action_dt_tm) - _rembatch_lyt_batch_details_action_dt_tm)+ 1
        ),__batch_lyt_batch_details_action_dt_tm)))))
      SET _rembatch_lyt_batch_details_action_dt_tm += rptsd->m_drawlength
     ELSE
      SET _rembatch_lyt_batch_details_action_dt_tm = 0
     ENDIF
     SET growsum += _rembatch_lyt_batch_details_action_dt_tm
    ENDIF
   ELSE
    SET _rembatch_lyt_batch_details_action_dt_tm = 0
    SET _holdrembatch_lyt_batch_details_action_dt_tm = _rembatch_lyt_batch_details_action_dt_tm
    ...
    IF (_rembatch_lyt_batch_details_reason_cd_disp > 0)
     SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(
        _rembatch_lyt_batch_details_reason_cd_disp,((size(__batch_lyt_batch_details_reason_cd_disp)
         - _rembatch_lyt_batch_details_reason_cd_disp)+ 1),__batch_lyt_batch_details_reason_cd_disp))
      )
     ...
     ELSEIF ((rptsd->m_drawlength < size(nullterm(substring(
      ...
      SET _rembatch_lyt_batch_details_reason_cd_disp += rptsd->m_drawlength
     ELSE
      SET _rembatch_lyt_batch_details_reason_cd_disp = 0
     ENDIF
     SET growsum += _rembatch_lyt_batch_details_reason_cd_disp
    ENDIF
   ELSE
    SET _rembatch_lyt_batch_details_reason_cd_disp = 0
    SET _holdrembatch_lyt_batch_details_reason_cd_disp = _rembatch_lyt_batch_details_reason_cd_disp
   ...
   0)) ))
    ...
    IF (_rembatch_lyt_batch_details_action_type > 0)
     ...
     ELSEIF ((rptsd->m_drawlength < size(nullterm(substring(_rembatch_lyt_batch_details_action_type,(
        (size(__batch_lyt_batch_details_action_type) - _rembatch_lyt_batch_details_action_type)+ 1),
        __batch_lyt_batch_details_action_type)))))
      SET _rembatch_lyt_batch_details_action_type += rptsd->m_drawlength
     ELSE
      SET _rembatch_lyt_batch_details_action_type = 0
     ENDIF
     SET growsum += _rembatch_lyt_batch_details_action_type
    ENDIF
   ELSE
    SET _rembatch_lyt_batch_details_action_type = 0
    SET _holdrembatch_lyt_batch_details_action_type = _rembatch_lyt_batch_details_action_type
    ...
    IF (((size(trim(cnvtstring(batch_lyt_batch_details_action_dt_tm))) > 4) OR (((size(trim(
     ...
     SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(
        _holdrembatch_lyt_batch_details_perf_prsnl_name,((size(
         __batch_lyt_batch_details_perf_prsnl_name) - _holdrembatch_lyt_batch_details_perf_prsnl_name
    ...
    IF (((size(trim(cnvtstring(batch_lyt_batch_details_action_dt_tm))) > 4) OR (((size(trim(
     ...
     SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(
        _holdrembatch_lyt_batch_details_action_dt_tm,((size(__batch_lyt_batch_details_action_dt_tm)
         - _holdrembatch_lyt_batch_details_action_dt_tm)+ 1),__batch_lyt_batch_details_action_dt_tm))
      )
    ENDIF
   ELSE
   ...
   IF (ncalc=rpt_render
    ...
    IF (((size(trim(cnvtstring(batch_lyt_batch_details_action_dt_tm))) > 4) OR (((size(trim(
     ...
     uar_get_code_display(batch_lyt_batch_details_reason_cd))="Submit"
     AND trim(batch_lyt_batch_details_action_type)="Submit")) )
     SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,__batch_lyt_batch_details_result_status_cd9)
    ENDIF
   ENDIF
   SET _dummypen = uar_rptsetpen(_hreport,_oldpen)
   IF (ncalc=rpt_render)
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_trans_log_idsection2(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = headbatch_lyt_batch_details_trans_log_idsection2abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_trans_log_idsection2abs(ncalc=i2,offsetx=f8,offsety=f8) =f8
  WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.200000), private
   IF (((size(trim(cnvtstring(batch_lyt_batch_details_action_dt_tm))) > 4) OR (((size(trim(
     batch_lyt_batch_details_batch_name)) > 0) OR (size(trim(batch_lyt_batch_details_blob_handle)) >
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_action_dt_tmsection3(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = headbatch_lyt_batch_details_action_dt_tmsection3abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (headbatch_lyt_batch_details_action_dt_tmsection3abs(ncalc=i2,offsetx=f8,offsety=f8) =f8
  WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.200000), private
   IF ( NOT (parent_alias_row=max_parent_alias_row
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (headchange_description_action_sequencesection(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = headchange_description_action_sequencesectionabs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (headchange_description_action_sequencesectionabs(ncalc=i2,offsetx=f8,offsety=f8) =f8
  WITH protect)
 ...
 SUBROUTINE (detailsectionabs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   IF (ncalc=rpt_render)
    ...
    SET _oldpen = uar_rptsetpen(_hreport,_pen14s0c0)
    IF (size(trim(change_description_change)) > 0)
     SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2(change_description_change,char(0)))
    ENDIF
    SET _dummypen = uar_rptsetpen(_hreport,_oldpen)
    SET _yoffset = (offsety+ sectionheight)
   ENDIF
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (detailsection1(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = detailsection1abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (detailsection1abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   IF (ncalc=rpt_render)
    ...
    IF (((size(trim(cnvtstring(batch_lyt_batch_details_action_dt_tm))) > 4) OR (((size(trim(
      batch_lyt_batch_details_batch_name)) > 0) OR (size(trim(batch_lyt_batch_details_blob_handle))
     > 0)) )) )
     SET _rptstat = uar_rptline(_hreport,(offsetx+ - (0.062)),(offsety+ 0.595),(offsetx+ 7.438),(
      offsety+ 0.595))
    ENDIF
    SET _dummyfont = uar_rptsetfont(_hreport,_oldfont)
    SET _dummypen = uar_rptsetpen(_hreport,_oldpen)
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (footbatch_lyt_batch_details_trans_log_idsection(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = footbatch_lyt_batch_details_trans_log_idsectionabs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (footbatch_lyt_batch_details_trans_log_idsectionabs(ncalc=i2,offsetx=f8,offsety=f8) =f8
  WITH protect)
   DECLARE sectionheight = f8 WITH noconstant(0.060000), private
   IF (ncalc=rpt_render)
    SET _oldpen = uar_rptsetpen(_hreport,_pen14s0c12632256)
