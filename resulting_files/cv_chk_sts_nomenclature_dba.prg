CREATE PROGRAM cv_chk_sts_nomenclature:dba
 ...
 ENDIF
 SET actual_cnt = 0
 SET expected_cnt = 211
 DECLARE cv_mnemonic = vc WITH public, constant("B-SMONOSTRUTMECHPROS")
 DECLARE cv_mnemonic2 = vc WITH public, constant("CARBOMEDICMECHPROS")
 DECLARE cv_mnemonic3 = vc WITH public, constant("EDWARDSTEKNAMECHPROS")
 SET readme_type = "STS_NOMENCLATURE:"
 SELECT INTO "nl:"
  table_count = count(*)
