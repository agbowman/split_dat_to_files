CREATE PROGRAM dm2_repl_insert_pwds:dba
 ...
 SUBROUTINE ds_scramble(null)
   ...
   RETURN(1)
 END ;Subroutine
 IF (check_logfile("dm2replinsertpwds",".log","Starting dm2_repl_insert_pwds...")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_repl_insert_pwds"
 CALL disp_msg(" ",dm_err->logfile,0)
 IF (dcdur_insert_pwds(currdbname,trim( $1),trim( $2),trim( $3))=0)
  GO TO exit_program
 ENDIF
 GO TO exit_program
#exit_program
 SET dm_err->eproc = "Ending dm2_repl_insert_pwds"
 CALL final_disp_msg("dm2replinsertpwds")
END GO
