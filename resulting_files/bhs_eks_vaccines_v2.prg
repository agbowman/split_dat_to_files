CREATE PROGRAM bhs_eks_vaccines_v2
 PROMPT
 ...
 SELECT INTO "nl:"
  ...
  PLAN (oa
   ...
   WHERE o.order_id=oa.order_id
    AND ((( $4="1")
    AND o.catalog_cd IN (flu_vaccine_cd, flu_vaccine_live_cd, h1n1_1, h1n1_2, h1n1_3,
   h1n1_4)) OR (((( $4="2")
    AND o.catalog_cd IN (pneum_23vaccine_cd, pneum_7vaccine_cd, pneum_vaccine_cd)) OR (( $4="3")
    AND o.catalog_cd IN (flu_vaccine_cd, flu_vaccine_live_cd, pneum_23vaccine_cd, pneum_7vaccine_cd,
   pneum_vaccine_cd,
   h1n1_1, h1n1_2, h1n1_3, h1n1_4))) ))
    AND  EXISTS (
   (SELECT
    e.encntr_id
    FROM encounter e
  ...
  HEAD o.order_id
   ...
   vaccine->list[cnt].person_id = o.person_id, vaccine->list[cnt].new_ordered_as_mnemonic = o
   .ordered_as_mnemonic, vaccine->list[cnt].new_clinical_display_line = o.clinical_display_line,
