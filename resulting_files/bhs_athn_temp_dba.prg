CREATE PROGRAM bhs_athn_temp:dba
 RECORD orequest(
   1 oeformatid = f8
   1 actiontypecd = f8
   1 positioncd = f8
 ...
 FOR (i = 1 TO size(oreply->fieldlist,5))
   ...
   IF ((oreply->fieldlist[i].fieldtypeflag=0))
    SET t_record->fieldlist[i].field_type = "ALPHANUMERIC"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=1))
    SET t_record->fieldlist[i].field_type = "INTEGER"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=2))
    SET t_record->fieldlist[i].field_type = "DECIMIAL"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=3))
    SET t_record->fieldlist[i].field_type = "DATE"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=5))
    SET t_record->fieldlist[i].field_type = "DATE/TIME"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=6))
    SET t_record->fieldlist[i].field_type = "CODESET"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=7))
    SET t_record->fieldlist[i].field_type = "YES/NO"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=8))
    SET t_record->fieldlist[i].field_type = "PROVIDER"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=9))
    SET t_record->fieldlist[i].field_type = "LOCATION"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=10))
    SET t_record->fieldlist[i].field_type = "ICD9"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=11))
    SET t_record->fieldlist[i].field_type = "PRINTER"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=12))
    SET t_record->fieldlist[i].field_type = "LIST"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=13))
    SET t_record->fieldlist[i].field_type = "USER/PERSONNEL"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=14))
    SET t_record->fieldlist[i].field_type = "ACCESSION"
   ELSEIF ((oreply->fieldlist[i].fieldtypeflag=15))
    SET t_record->fieldlist[i].field_type = "SURGICAL DURATION"
   ENDIF
   SET t_record->fieldlist[i].oefieldid = oreply->fieldlist[i].oefieldid
   SET t_record->fieldlist[i].oefieldmeaningid = oreply->fieldlist[i].oefieldmeaningid
   ...
   SET t_record->fieldlist[i].acceptflag = oreply->fieldlist[i].acceptflag
   ...
   ENDIF
   SET t_record->fieldlist[i].promptentityid = oreply->fieldlist[i].promptentityid
   ...
   SET t_record->fieldlist[i].minval = oreply->fieldlist[i].minval
   SET t_record->fieldlist[i].maxval = oreply->fieldlist[i].maxval
   ...
   SET t_record->fieldlist[i].promptentityname = oreply->fieldlist[i].filterparams
