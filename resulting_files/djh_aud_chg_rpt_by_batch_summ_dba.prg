CREATE PROGRAM djh_aud_chg_rpt_by_batch_summ:dba
 PROMPT
  "Output to File/Printer/MINE" = "bmc282ptact1",
  "Batch Number" = 0
  WITH outdev, var_batch_num
 ...
 DECLARE output_dev = vc WITH public, noconstant
 ...
 SELECT INTO  $OUTDEV
  ...
  HEAD REPORT
   ...
   node_dev_disp = trim(concat(trim(node,3)," / ",trim(output_dev,3)),3), col_stat = (79 - textlen(
