CREATE PROGRAM bhs_athn_add_med_order_v2
 FREE RECORD result
 RECORD result(
   1 encntr_id = f8
   1 person_id = f8
...
#exit_script
 ...
 SUBROUTINE calladdorder(null)
   ...
   SET req560201->orderlist[1].medordertypecd =  $15
   ...
   IF (size(result->subcomponents,5) > 0)
    ...
    FOR (idx = 1 TO size(result->subcomponents,5))
      SET req560201->orderlist[1].subcomponentlist[idx].sccatalogcd = result->subcomponents[idx].
      catalog_cd
      SET req560201->orderlist[1].subcomponentlist[idx].scsynonymid = result->subcomponents[idx].
      synonym_id
      SET req560201->orderlist[1].subcomponentlist[idx].scorderedasmnemonic = result->subcomponents[
      idx].synonym_mnemonic
      IF (size(trim(result->subcomponents[idx].free_text_dose,3))=0)
       IF ((result->subcomponents[idx].str_dose > 0))
        SET req560201->orderlist[1].subcomponentlist[idx].scstrengthdose = result->subcomponents[idx]
        .str_dose
        SET req560201->orderlist[1].subcomponentlist[idx].scstrengthdosedisp = trim(formatdosevalue(
          result->subcomponents[idx].str_dose),3)
        SET req560201->orderlist[1].subcomponentlist[idx].scstrengthunit = result->subcomponents[idx]
        .str_dose_unit_cd
        SET req560201->orderlist[1].subcomponentlist[idx].scstrengthunitdisp = uar_get_code_display(
         result->subcomponents[idx].str_dose_unit_cd)
       ENDIF
       IF ((result->subcomponents[idx].vol_dose > 0))
        SET req560201->orderlist[1].subcomponentlist[idx].scvolumedose = result->subcomponents[idx].
        vol_dose
        SET req560201->orderlist[1].subcomponentlist[idx].scvolumedosedisp = trim(formatdosevalue(
          result->subcomponents[idx].vol_dose),3)
        SET req560201->orderlist[1].subcomponentlist[idx].scvolumeunit = result->subcomponents[idx].
        vol_dose_unit_cd
        SET req560201->orderlist[1].subcomponentlist[idx].scvolumeunitdisp = uar_get_code_display(
         result->subcomponents[idx].vol_dose_unit_cd)
       ENDIF
      ELSE
       SET req560201->orderlist[1].subcomponentlist[idx].scfreetextdose = result->subcomponents[idx].
       free_text_dose
      ENDIF
      SET req560201->orderlist[1].subcomponentlist[idx].scfrequency = result->subcomponents[idx].
      frequency_cd
      SET req560201->orderlist[1].subcomponentlist[idx].scfrequencydisp = uar_get_code_display(result
       ->subcomponents[idx].frequency_cd)
      SET req560201->orderlist[1].subcomponentlist[idx].scclinicallysignificantflag =
      clinically_significant
      SET req560201->orderlist[1].subcomponentlist[idx].schnaordermnemonic = result->subcomponents[
      idx].primary_mnemonic
      IF (band(result->subcomponents[idx].rx_mask,1) > 0)
       SET req560201->orderlist[1].subcomponentlist[idx].scingredienttypeflag =
       ingredient_type_diluent
       SET req560201->orderlist[1].subcomponentlist[idx].scincludeintotalvolumeflag =
       included_in_total_volume
      ELSE
       SET req560201->orderlist[1].subcomponentlist[idx].scingredienttypeflag =
       ingredient_type_additive
      ENDIF
      SET req560201->orderlist[1].subcomponentlist[idx].scmodifiedflag = 1
      SET req560201->orderlist[1].subcomponentlist[idx].scdosecalculatorlongtext = getdosecalctext(
       result->order_id,result->subcomponents[idx].synonym_id)
      IF ((result->subcomponents[idx].normalized_rate > 0))
       SET req560201->orderlist[1].subcomponentlist[idx].scnormalizedrate = result->subcomponents[idx
       ].normalized_rate
       SET req560201->orderlist[1].subcomponentlist[idx].scnormalizedratedisp = trim(formatdosevalue(
         result->subcomponents[idx].normalized_rate),3)
       SET req560201->orderlist[1].subcomponentlist[idx].scnormalizedrateunitcd = result->
       subcomponents[idx].normalized_rate_unit_cd
       SET req560201->orderlist[1].subcomponentlist[idx].scnormalizedrateunitdisp =
       uar_get_code_display(result->subcomponents[idx].normalized_rate_unit_cd)
      ENDIF
      IF ((result->subcomponents[idx].concentration > 0))
       SET req560201->orderlist[1].subcomponentlist[idx].scconcentration = result->subcomponents[idx]
       .concentration
       SET req560201->orderlist[1].subcomponentlist[idx].scconcentrationdisp = trim(formatdosevalue(
         result->subcomponents[idx].concentration),3)
       SET req560201->orderlist[1].subcomponentlist[idx].scconcentrationunitcd = result->
       subcomponents[idx].concentration_unit_cd
       SET req560201->orderlist[1].subcomponentlist[idx].scconcentrationunitdisp =
       uar_get_code_display(result->subcomponents[idx].concentration_unit_cd)
      ENDIF
      IF ((result->subcomponents[idx].ordered_dose > 0))
       SET req560201->orderlist[1].subcomponentlist[idx].scordereddose = result->subcomponents[idx].
       ordered_dose
       SET req560201->orderlist[1].subcomponentlist[idx].scordereddosedisp = trim(formatdosevalue(
         result->subcomponents[idx].ordered_dose),3)
       SET req560201->orderlist[1].subcomponentlist[idx].scordereddoseunitcd = result->subcomponents[
       idx].ordered_dose_unit_cd
       SET req560201->orderlist[1].subcomponentlist[idx].scordereddoseunitdisp = uar_get_code_display
       (result->subcomponents[idx].ordered_dose_unit_cd)
      ENDIF
      SET req560201->orderlist[1].subcomponentlist[idx].scorderedassynonymid = result->subcomponents[
      idx].synonym_id
    ENDFOR
 ...
 SUBROUTINE calladdorderautoverify(null)
   ...
   SET req560251->orderlist[1].medordertypecd =  $15
   ...
   IF (size(result->subcomponents,5) > 0)
    ...
    FOR (idx = 1 TO size(result->subcomponents,5))
      SET req560251->orderlist[1].subcomponentlist[idx].sccatalogcd = result->subcomponents[idx].
      catalog_cd
      SET req560251->orderlist[1].subcomponentlist[idx].scsynonymid = result->subcomponents[idx].
      synonym_id
      SET req560251->orderlist[1].subcomponentlist[idx].scorderedasmnemonic = result->subcomponents[
      idx].synonym_mnemonic
      IF (size(trim(result->subcomponents[idx].free_text_dose,3))=0)
       IF ((result->subcomponents[idx].str_dose > 0))
        SET req560251->orderlist[1].subcomponentlist[idx].scstrengthdose = result->subcomponents[idx]
        .str_dose
        SET req560251->orderlist[1].subcomponentlist[idx].scstrengthdosedisp = trim(formatdosevalue(
          result->subcomponents[idx].str_dose),3)
        SET req560251->orderlist[1].subcomponentlist[idx].scstrengthunit = result->subcomponents[idx]
        .str_dose_unit_cd
        SET req560251->orderlist[1].subcomponentlist[idx].scstrengthunitdisp = uar_get_code_display(
         result->subcomponents[idx].str_dose_unit_cd)
       ENDIF
       IF ((result->subcomponents[idx].vol_dose > 0))
        SET req560251->orderlist[1].subcomponentlist[idx].scvolumedose = result->subcomponents[idx].
        vol_dose
        SET req560251->orderlist[1].subcomponentlist[idx].scvolumedosedisp = trim(formatdosevalue(
          result->subcomponents[idx].vol_dose),3)
        SET req560251->orderlist[1].subcomponentlist[idx].scvolumeunit = result->subcomponents[idx].
        vol_dose_unit_cd
        SET req560251->orderlist[1].subcomponentlist[idx].scvolumeunitdisp = uar_get_code_display(
         result->subcomponents[idx].vol_dose_unit_cd)
       ENDIF
      ELSE
       SET req560251->orderlist[1].subcomponentlist[idx].scfreetextdose = result->subcomponents[idx].
       free_text_dose
      ENDIF
      SET req560251->orderlist[1].subcomponentlist[idx].scfrequency = result->subcomponents[idx].
      frequency_cd
      SET req560251->orderlist[1].subcomponentlist[idx].scfrequencydisp = uar_get_code_display(result
       ->subcomponents[idx].frequency_cd)
      SET req560251->orderlist[1].subcomponentlist[idx].scclinicallysignificantflag =
      clinically_significant
      SET req560251->orderlist[1].subcomponentlist[idx].schnaordermnemonic = result->subcomponents[
      idx].primary_mnemonic
      IF (band(result->subcomponents[idx].rx_mask,1) > 0)
       SET req560251->orderlist[1].subcomponentlist[idx].scingredienttypeflag =
       ingredient_type_diluent
       SET req560251->orderlist[1].subcomponentlist[idx].scincludeintotalvolumeflag =
       included_in_total_volume
      ELSE
       SET req560251->orderlist[1].subcomponentlist[idx].scingredienttypeflag =
       ingredient_type_additive
      ENDIF
      SET req560251->orderlist[1].subcomponentlist[idx].scmodifiedflag = 1
      SET req560251->orderlist[1].subcomponentlist[idx].scdosecalculatorlongtext = getdosecalctext(
       result->order_id,result->subcomponents[idx].synonym_id)
      IF ((result->subcomponents[idx].normalized_rate > 0))
       SET req560251->orderlist[1].subcomponentlist[idx].scnormalizedrate = result->subcomponents[idx
       ].normalized_rate
       SET req560251->orderlist[1].subcomponentlist[idx].scnormalizedratedisp = trim(formatdosevalue(
         result->subcomponents[idx].normalized_rate),3)
       SET req560251->orderlist[1].subcomponentlist[idx].scnormalizedrateunitcd = result->
       subcomponents[idx].normalized_rate_unit_cd
       SET req560251->orderlist[1].subcomponentlist[idx].scnormalizedrateunitdisp =
       uar_get_code_display(result->subcomponents[idx].normalized_rate_unit_cd)
      ENDIF
      IF ((result->subcomponents[idx].ordered_dose > 0))
       SET req560251->orderlist[1].subcomponentlist[idx].scordereddose = result->subcomponents[idx].
       ordered_dose
       SET req560251->orderlist[1].subcomponentlist[idx].scordereddosedisp = trim(formatdosevalue(
         result->subcomponents[idx].ordered_dose),3)
       SET req560251->orderlist[1].subcomponentlist[idx].scordereddoseunitcd = result->subcomponents[
       idx].ordered_dose_unit_cd
       SET req560251->orderlist[1].subcomponentlist[idx].scordereddoseunitdisp = uar_get_code_display
       (result->subcomponents[idx].ordered_dose_unit_cd)
      ENDIF
      IF ((result->subcomponents[idx].concentration > 0))
       SET req560251->orderlist[1].subcomponentlist[idx].scconcentration = result->subcomponents[idx]
       .concentration
       SET req560251->orderlist[1].subcomponentlist[idx].scconcentrationdisp = trim(formatdosevalue(
         result->subcomponents[idx].concentration),3)
       SET req560251->orderlist[1].subcomponentlist[idx].scconcentrationunitcd = result->
       subcomponents[idx].concentration_unit_cd
       SET req560251->orderlist[1].subcomponentlist[idx].scconcentrationunitdisp =
       uar_get_code_display(result->subcomponents[idx].concentration_unit_cd)
      ENDIF
      SET req560251->orderlist[1].subcomponentlist[idx].scorderedassynonymid = result->subcomponents[
      idx].synonym_id
    ENDFOR
