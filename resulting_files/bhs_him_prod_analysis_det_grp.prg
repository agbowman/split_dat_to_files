CREATE PROGRAM bhs_him_prod_analysis_det_grp
 PROMPT
 ...
 DECLARE _remtimestamp01 = i4 WITH noconstant(1), protect
 ...
 DECLARE _remtask_hist_task_create_dt_tm___ = i4 WITH noconstant(1), protect
 ...
 DECLARE _remcellname26 = i4 WITH noconstant(1), protect
 ...
 SUBROUTINE main(dummy)
   SELECT INTO "nl:"
    ...
    WHERE d.seq > 0
    ORDER BY organization_name, organization_id, user_name,
     user_id, task_queue_name, task_queue_cd,
     task_hist_task_create_dt_tm
    HEAD REPORT
     _d0 = patient_name, _d1 = disch_dt_tm, _d2 = los_days,
     _d3 = tat_create_to_final, _d4 = tat_discharge_to_final, _d5 = mrn,
     _d6 = fin, _d7 = user_name, _d8 = organization_name,
     _d9 = patient_type_name, _d10 = task_queue_name, _d11 = user_username,
     _d12 = task_hist_task_create_dt_tm, _fenddetail = (rptreport->m_pagewidth - rptreport->
     m_marginbottom), daterange = getdaterangedisplay(dates,him_dash),
     totalchartsperorganization = 0, totalchartsperuser = 0, totalchartsperqueue = 0,
     totallengthofstay = 0, rowcount = 0, dataqualcount = size(data->qual,5),
     blank = "", allfacilities = uar_i18ngetmessage(i18nhandlehim,"ALLFACILITIES","All Facilities"),
     facilitylist = makelistofqualitemnames(organizations,allfacilities),
     allusers = uar_i18ngetmessage(i18nhandlehim,"ALLUSERS","All Users"), userlist =
     makelistofqualitemnames(users,allusers), alltaskqueues = uar_i18ngetmessage(i18nhandlehim,
      "ALLTASKQUEUES","All Task Queues"),
     taskqueuelist = makelistofqualitemnames(task_queues,alltaskqueues), _fdrawheight = fieldname00(
      rpt_calcheight)
     IF (_fdrawheight > 0)
 ...
 SUBROUTINE (mainhtml(ndummy=i2) =null WITH protect)
  ...
  SELECT INTO "nl:"
   ...
   HEAD REPORT
    ...
    _d6 = fin, _d7 = user_name, _d8 = organization_name,
    _d9 = patient_type_name, _d10 = task_queue_name, _d11 = user_username,
    _d12 = task_hist_task_create_dt_tm, _htmlfileinfo->file_buf = "<table width='100%'><caption>",
    _htmlfilestat = cclio("WRITE",_htmlfileinfo),
    _htmlfileinfo->file_buf = build2("<colgroup span=21>","<col width=94/>","<col width=12/>",
     "<col width=44/>","<col width=27/>",
     "<col width=1/>","<col width=70/>","<col width=40/>","<col width=6/>","<col width=12/>",
     "<col width=19/>","<col width=49/>","<col width=20/>","<col width=34/>","<col width=10/>",
     "<col width=96/>","<col width=68/>","<col width=73/>","<col width=51/>","<col width=124/>",
     "<col width=17/>","<col width=117/>","</colgroup>"), _htmlfilestat = cclio("WRITE",_htmlfileinfo
    ...
    "<thead>", _htmlfilestat = cclio("WRITE",_htmlfileinfo),
    dummy_val = fieldname00html(0), dummy_val = fieldname01html(0), dummy_val = fieldname02html(0),
    dummy_val = fieldname03html(0), dummy_val = fieldname04html(0), dummy_val = fieldname05html(0),
    dummy_val = fieldname06html(0), dummy_val = fieldname07html(0), dummy_val = fieldname08html(0),
    dummy_val = fieldname09html(0), dummy_val = fieldname010html(0), dummy_val = fieldname011html(0),
    dummy_val = fieldname012html(0), dummy_val = fieldname013html(0), _htmlfileinfo->file_buf =
    "</thead>",
   ...
   HEAD organization_id
    organization = organization_name, totalchartsperorganization = 0, dummy_val = fieldname015html(0)
   HEAD user_name
 ...
 SUBROUTINE (fieldname00html(dummy=i2) =null WITH protect)
   IF (_bgeneratehtml)
    SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName000' colspan='21'>",
 ...
 SUBROUTINE (fieldname01html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName010' colspan='21'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName0",
 ...
 SUBROUTINE (fieldname02html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName020' colspan='21'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName1","Detailed Report"),
   "</td>","</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname03html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName030' colspan='21'>",daterange,
   "</td>","</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname04html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName040' colspan='21'>",blank,"</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname05html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName050' colspan='3'>",i18ndateprinted,
   "</td>","<td class='FieldName051' colspan='18'>",
 ...
 SUBROUTINE (fieldname07html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName050' colspan='3'>",
   i18npromptsfilters,"</td>","<td class='FieldName071' colspan='18'>",
   "","</td>","</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname08html(dummy=i2) =null WITH protect)
   IF (i1multifacilitylogicind)
    SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName040' colspan='3'>","","</td>",
     "<td class='FieldName050' colspan='4'>",
     i18nfacilities,"</td>","<td class='FieldName082' colspan='14'>",facilitylist,"</td>",
     "</tr>")
    SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
   ENDIF
 END ;Subroutine
 ...
 SUBROUTINE (fieldname09html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName040' colspan='3'>","","</td>",
   "<td class='FieldName050' colspan='4'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName5","User Name(s):"),"</td>",
   "<td class='FieldName082' colspan='14'>",userlist,"</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname010html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName040' colspan='3'>","","</td>",
   "<td class='FieldName050' colspan='4'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName7","Task Queue(s):"),
   "</td>","<td class='FieldName082' colspan='14'>",taskqueuelist,"</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname011html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName040' colspan='3'>","","</td>",
   "<td class='FieldName050' colspan='4'>",
   i18ndaterange,"</td>","<td class='FieldName071' colspan='14'>",getdaterangedisplay(dates,
    him_prompt),"</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname012html(dummy=i2) =null WITH protect)
   IF (negate(_bgeneratehtml))
    SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0120' colspan='21'>",
 ...
 SUBROUTINE (fieldname013abs(ncalc=i2,offsetx=f8,offsety=f8,maxheight=f8,bcontinue=i2(ref)) =f8 WITH
  protect)
   ...
   DECLARE growsum = i4 WITH noconstant(0), private
   DECLARE drawheight_timestamp01 = f8 WITH noconstant(0.0), private
   ...
   DECLARE __timestamp01 = vc WITH noconstant(build(uar_i18ngetmessage(_hi18nhandle,
      "FieldName013_Timestamp01",build2("Date Stamp (Task Created)",char(0))),char(0))), protect
   ...
   SET _oldfont = uar_rptsetfont(_hreport,_times10b0)
   SET _oldpen = uar_rptsetpen(_hreport,_pen14s0c0)
   SET _holdremtimestamp01 = _remtimestamp01
   IF (_remtimestamp01 > 0)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(_remtimestamp01,((size(
        __timestamp01) - _remtimestamp01)+ 1),__timestamp01)))
    SET drawheight_timestamp01 = rptsd->m_height
    IF ((rptsd->m_height > ((offsety+ sectionheight) - rptsd->m_y)))
     SET sectionheight = ((rptsd->m_y+ _fdrawheight) - offsety)
    ENDIF
    IF ((rptsd->m_drawlength=0))
     SET _remtimestamp01 = 0
    ELSEIF ((rptsd->m_drawlength < size(nullterm(substring(_remtimestamp01,((size(__timestamp01) -
       _remtimestamp01)+ 1),__timestamp01)))))
     SET _remtimestamp01 += rptsd->m_drawlength
    ELSE
     SET _remtimestamp01 = 0
    ENDIF
    SET growsum += _remtimestamp01
   ENDIF
   ...
   SET rptsd->m_height = sectionheight
   IF (ncalc=rpt_render
    AND _holdremtimestamp01 > 0)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(_holdremtimestamp01,((size
       (__timestamp01) - _holdremtimestamp01)+ 1),__timestamp01)))
   ELSE
    SET _remtimestamp01 = _holdremtimestamp01
   ENDIF
   ...
   IF (ncalc=rpt_render)
    ...
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.000),offsety,(offsetx+ 0.000),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 1.781),offsety,(offsetx+ 1.781),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 2.479),offsety,(offsetx+ 2.479),(offsety+
     sectionheight))
    ...
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 5.344),offsety,(offsetx+ 5.344),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 6.021),offsety,(offsetx+ 6.021),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 7.260),offsety,(offsetx+ 7.260),(offsety+
     sectionheight))
 ...
 SUBROUTINE (fieldname013html(dummy=i2) =null WITH protect)
   IF (rowcount > 0)
    SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0130' colspan='5'>",
     uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName12","Patient Name"),
     "</td>","<td class='FieldName0131' colspan='1'>",
     uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName13","MRN"),"</td>",
     "<td class='FieldName0131' colspan='4'>",uar_i18ngetmessage(_hi18nhandle,
      "BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName14","FIN"),"</td>",
     "<td class='FieldName0133' colspan='4'>",uar_i18ngetmessage(_hi18nhandle,
      "BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName15","Patient Type"),"</td>",
     "<td class='FieldName0134' colspan='1'>",uar_i18ngetmessage(_hi18nhandle,
      "BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName16","Discharge Date"),
     "</td>","<td class='FieldName0135' colspan='1'>",uar_i18ngetmessage(_hi18nhandle,
      "BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName17","LOS (Days)"),"</td>",
     "<td class='FieldName0136' colspan='2'>",
     uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName21",
      "TAT (Discharge to Final)"),"</td>","<td class='FieldName0136' colspan='1'>",uar_i18ngetmessage
     (_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName22","TAT Task (Create to Final)"),"</td>",
     "<td class='FieldName0138' colspan='2'>","Date Stamp (Task Created)","</td>","</tr>")
    SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
   ENDIF
 END ;Subroutine
 SUBROUTINE (fieldname014(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = fieldname014abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (fieldname014abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
 ...
 SUBROUTINE (fieldname014html(dummy=i2) =null WITH protect)
   ...
   ENDIF
 END ;Subroutine
 SUBROUTINE (fieldname015(ncalc=i2) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = fieldname015abs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (fieldname015abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   RETURN(sectionheight)
 END ;Subroutine
 SUBROUTINE (fieldname015html(dummy=i2) =null WITH protect)
   IF (dataqualcount > 0)
    SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0150' colspan='21'>",
     organization,"</td>","</tr>")
    SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
   ENDIF
 END ;Subroutine
 ...
 SUBROUTINE (fieldname017abs(ncalc=i2,offsetx=f8,offsety=f8) =f8 WITH protect)
   ...
   IF (ncalc=rpt_render)
    ...
    SET rptsd->m_rotationangle = 0
    SET rptsd->m_y = (offsety+ 0.000)
    SET rptsd->m_x = (offsetx+ 4.282)
    SET rptsd->m_width = 5.719
    SET rptsd->m_height = 0.188
    SET _oldfont = uar_rptsetfont(_hreport,_times100)
    SET _oldpen = uar_rptsetpen(_hreport,_pen14s0c0)
    ...
    SET _dummyfont = uar_rptsetfont(_hreport,_times10b0)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build(uar_i18ngetmessage(_hi18nhandle,
       "FieldName017_field017ca",build2("User ID:",char(0))),char(0)))
    SET rptsd->m_flags = 256
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
    SET rptsd->m_paddingwidth = 0.000
    ...
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 3.740),offsety,(offsetx+ 3.740),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 4.281),offsety,(offsetx+ 4.281),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 10.000),offsety,(offsetx+ 10.000),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.000),(offsety+ sectionheight),(offsetx+ 10.000),(
 ...
 SUBROUTINE (fieldname017html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0160' colspan='1'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName23","User Name:"),"</td>",
   "<td class='FieldName071' colspan='10'>",
   usernamedisplay,"</td>","<td class='FieldName0172' colspan='2'>",uar_i18ngetmessage(_hi18nhandle,
    "BHS_HIM_PROD_ANALYSIS_DET_GRP_field017ca","User ID:"),"</td>",
 ...
 SUBROUTINE (fieldname019html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0180' colspan='2'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName24","Task Queue:"),"</td>",
   "<td class='FieldName071' colspan='19'>",
 ...
 SUBROUTINE (fieldname020abs(ncalc=i2,offsetx=f8,offsety=f8,maxheight=f8,bcontinue=i2(ref)) =f8 WITH
  protect)
   ...
   DECLARE __timestamp01 = vc WITH noconstant(build(uar_i18ngetmessage(_hi18nhandle,
      "FieldName020_Timestamp01",build2("Date Stamp (Task Created)",char(0))),char(0))), protect
   ...
   SET rptsd->m_rotationangle = 0
   SET rptsd->m_y = (offsety+ 0.000)
   SET rptsd->m_x = (offsetx+ 8.667)
   SET rptsd->m_width = 1.334
   SET rptsd->m_height = ((offsety+ maxheight) - rptsd->m_y)
   SET _oldfont = uar_rptsetfont(_hreport,_times10b0)
   SET _oldpen = uar_rptsetpen(_hreport,_pen14s0c0)
   SET _holdremtimestamp01 = _remtimestamp01
   ...
   IF (ncalc=rpt_render)
    ...
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 7.260),offsety,(offsetx+ 7.260),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 8.667),offsety,(offsetx+ 8.667),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 10.000),offsety,(offsetx+ 10.000),(offsety+
     sectionheight))
    SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.000),(offsety+ sectionheight),(offsetx+ 10.000),(
 ...
 SUBROUTINE (fieldname020html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0130' colspan='5'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName47","Patient Name"),"</td>",
   "<td class='FieldName0131' colspan='1'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName52","MRN"),"</td>",
   "<td class='FieldName0131' colspan='4'>",uar_i18ngetmessage(_hi18nhandle,
    "BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName53","FIN"),"</td>",
   "<td class='FieldName0203' colspan='4'>",uar_i18ngetmessage(_hi18nhandle,
    "BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName54","Patient Type"),"</td>",
   "<td class='FieldName0134' colspan='1'>",uar_i18ngetmessage(_hi18nhandle,
    "BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName55","Discharge Date"),
   "</td>","<td class='FieldName0135' colspan='1'>",uar_i18ngetmessage(_hi18nhandle,
    "BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName56","LOS (Days)"),"</td>",
   "<td class='FieldName0136' colspan='2'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName59",
    "TAT (Discharge to Final)"),"</td>","<td class='FieldName0136' colspan='2'>",uar_i18ngetmessage(
    _hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName60","TAT Task (Create to Final)"),"</td>",
   "<td class='FieldName0138' colspan='1'>","Date Stamp (Task Created)","</td>","</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname021html(dummy=i2) =null WITH protect)
   IF (mod(rowcount,2)=1)
    SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0210' colspan='4'>",
     patientnamerowone,"</td>","<td class='FieldName0211' colspan='2'>",
     trim(mrn,3),"</td>","<td class='FieldName0211' colspan='4'>",trim(fin,3),"</td>",
     ...
     cnvtminstodayshoursmins(tat_discharge_to_final),"</td>","<td class='FieldName0216' colspan='2'>",
 ...
 SUBROUTINE (fieldname022abs(ncalc=i2,offsetx=f8,offsety=f8,maxheight=f8,bcontinue=i2(ref)) =f8 WITH
  protect)
   DECLARE sectionheight = f8 WITH noconstant(0.240000), private
   DECLARE growsum = i4 WITH noconstant(0), private
   DECLARE drawheight_task_hist_task_create_dt_tm___ = f8 WITH noconstant(0.0), private
   ...
   DECLARE __task_hist_task_create_dt_tm___ = vc WITH noconstant(build(format(
      task_hist_task_create_dt_tm,"mm/dd/yyyy hh:mm;;Q"),char(0))), protect
   ...
   ENDIF
   IF (bcontinue=0)
    SET _remtask_hist_task_create_dt_tm___ = 1
   ...
   SET _oldfont = uar_rptsetfont(_hreport,_times100)
   SET _oldpen = uar_rptsetpen(_hreport,_pen14s0c0)
   SET _holdremtask_hist_task_create_dt_tm___ = _remtask_hist_task_create_dt_tm___
   IF (_remtask_hist_task_create_dt_tm___ > 0)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(
       _remtask_hist_task_create_dt_tm___,((size(__task_hist_task_create_dt_tm___) -
       _remtask_hist_task_create_dt_tm___)+ 1),__task_hist_task_create_dt_tm___)))
    SET drawheight_task_hist_task_create_dt_tm___ = rptsd->m_height
    IF ((rptsd->m_height > ((offsety+ sectionheight) - rptsd->m_y)))
     SET sectionheight = ((rptsd->m_y+ _fdrawheight) - offsety)
    ENDIF
    IF ((rptsd->m_drawlength=0))
     SET _remtask_hist_task_create_dt_tm___ = 0
    ELSEIF ((rptsd->m_drawlength < size(nullterm(substring(_remtask_hist_task_create_dt_tm___,((size(
        __task_hist_task_create_dt_tm___) - _remtask_hist_task_create_dt_tm___)+ 1),
       __task_hist_task_create_dt_tm___)))))
     SET _remtask_hist_task_create_dt_tm___ += rptsd->m_drawlength
    ELSE
     SET _remtask_hist_task_create_dt_tm___ = 0
    ENDIF
    SET growsum += _remtask_hist_task_create_dt_tm___
   ENDIF
   ...
   SET oldbackcolor = uar_rptsetbackcolor(_hreport,uar_rptencodecolor(232,232,232))
   IF (ncalc=rpt_render
    AND _holdremtask_hist_task_create_dt_tm___ > 0)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(
       _holdremtask_hist_task_create_dt_tm___,((size(__task_hist_task_create_dt_tm___) -
       _holdremtask_hist_task_create_dt_tm___)+ 1),__task_hist_task_create_dt_tm___)))
   ELSE
    SET _remtask_hist_task_create_dt_tm___ = _holdremtask_hist_task_create_dt_tm___
   ENDIF
   SET oldbackcolor = uar_rptresetbackcolor(_hreport)
   SET rptsd->m_flags = 324
   SET rptsd->m_borders = rpt_sdnoborders
 ...
 SUBROUTINE (fieldname022html(dummy=i2) =null WITH protect)
   IF (mod(rowcount,2)=0)
    SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0220' colspan='4'>",
     patientnamerowtwo,"</td>","<td class='FieldName0221' colspan='2'>",
     trim(mrn,3),"</td>","<td class='FieldName0221' colspan='4'>",trim(fin,3),"</td>",
     ...
     cnvtminstodayshoursmins(tat_discharge_to_final),"</td>","<td class='FieldName0226' colspan='2'>",
     cnvtminstodayshoursmins(tat_create_to_final),"</td>",
 ...
 SUBROUTINE (fieldname023html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0230' colspan='21'>","","</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname024html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0240' colspan='8'>",concat(
    uar_i18ngetmessage(i18nhandlehim,"TOTALCHARTSANALYZED","Total # of Charts Analyzed in "),trim(
     task_queue_name,3)," Task Queue",": "),"</td>","<td class='FieldName0241' colspan='4'>",
   totalchartsperqueuedisplay,"</td>","<td class='FieldName0242' colspan='3'>",uar_i18ngetmessage(
    _hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName46","Total LOS:"),"</td>",
   "<td class='FieldName0243' colspan='2'>",totallosdisplay,"</td>",
   "<td class='FieldName0242' colspan='4'>","",
   "</td>","</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 ...
 SUBROUTINE (fieldname025html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0250' colspan='8'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName48",
    "Total # of Charts Analyzed - All Task Queues:"),"</td>","<td class='FieldName0241' colspan='4'>",
   totalchartsperuserdisplay,"</td>","<td class='FieldName0241' colspan='9'>","","</td>",
   "</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 SUBROUTINE (fieldname026(ncalc=i2,maxheight=f8,bcontinue=i2(ref)) =f8 WITH protect)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = fieldname026abs(ncalc,_xoffset,_yoffset,maxheight,bcontinue)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE (fieldname026abs(ncalc=i2,offsetx=f8,offsety=f8,maxheight=f8,bcontinue=i2(ref)) =f8 WITH
  protect)
   DECLARE sectionheight = f8 WITH noconstant(0.220000), private
   DECLARE growsum = i4 WITH noconstant(0), private
   ...
   IF (_remcellname26 > 0)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(_remcellname26,((size(
        __cellname26) - _remcellname26)+ 1),__cellname26)))
    ...
    ELSEIF ((rptsd->m_drawlength < size(nullterm(substring(_remcellname26,((size(__cellname26) -
     ...
     SET _remcellname26 += rptsd->m_drawlength
    ELSE
     SET _remcellname26 = 0
    ENDIF
    SET growsum += _remcellname26
   ENDIF
   SET oldbackcolor = uar_rptsetbackcolor(_hreport,uar_rptencodecolor(255,255,128))
   SET oldbackcolor = uar_rptresetbackcolor(_hreport)
   SET rptsd->m_flags = 288
   ...
   IF (ncalc=rpt_render
    AND bcontinue=0)
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build(totalchartsperorganizationdisplay,char(
       0)))
   ENDIF
   SET oldbackcolor = uar_rptresetbackcolor(_hreport)
   SET rptsd->m_flags = 288
   ...
   IF (ncalc=rpt_render
    ...
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,nullterm(substring(_holdremcellname26,((size(
        __cellname26) - _holdremcellname26)+ 1),__cellname26)))
   ELSE
 ...
 SUBROUTINE (fieldname026html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0260' colspan='9'>",
   IF (i1multifacilitylogicind) build2(uar_i18ngetmessage(i18nhandlehim,"TOTALSFORORG","Totals for "),
     trim(organization_name,3),": ")
   ELSE build2(uar_i18ngetmessage(i18nhandlehim,"TOTALS","Totals:"))
   ENDIF
   ,"</td>","<td class='FieldName0250' colspan='5'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_CellName33",
    "Total # of Charts Analyzed:"),"</td>","<td class='FieldName0243' colspan='1'>",
   totalchartsperorganizationdisplay,"</td>",
 ...
 SUBROUTINE (fieldname027html(dummy=i2) =null WITH protect)
  SET _htmlfileinfo->file_buf = build2("<tr>","<td class='FieldName0270' colspan='21'>",
   uar_i18ngetmessage(_hi18nhandle,"BHS_HIM_PROD_ANALYSIS_DET_GRP_EndOfReport","**END OF REPORT**"),
   "</td>","</tr>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 END ;Subroutine
 SUBROUTINE initializereport(dummy)
   IF (_bsubreport=0)
    ...
    ELSE
     ...
     SET rptreport->m_reportname = "BHS_HIM_PROD_ANALYSIS_DET_GRP"
 ...
 IF (_bishtml != 0)
  SET _htmlfileinfo->file_buf = build2("<STYLE>",
   ...
   " vertical-align: bottom;}",".FieldName0138 { border-width: 0.014in; border-color: #000000;",
   " border-style: none none solid none;"," padding: 0.000in 0.000in 0.000in 0.100in;",
   " font:  bold 10pt Times;",
   " "," color: #000000;"," "," text-align: center;"," vertical-align: bottom;}",
   ".FieldName0140 { border-width: 0.015in; border-color: #000000;",
   " border-style: none none none none;"," padding: 0.000in 0.000in 0.000in 0.000in;",
   " font:   11pt Times;"," ",
   " color: #000000;"," "," text-align: left;"," vertical-align: bottom;}",
   ".FieldName0150 { border-width: 0.015in; border-color: #000000;",
   " border-style: none none solid none;"," padding: 0.000in 0.000in 0.000in 0.000in;",
   " font:  bold 11pt Times;"," "," color: #000000;",
   " "," text-align: left;"," vertical-align: bottom;}",
   ".FieldName0160 { border-width: 0.014in; border-color: #000000;",
   " border-style: none none none none;",
   " padding: 0.000in 0.000in 0.000in 0.000in;"," font:  bold 10pt Times;"," "," color: #000000;"," ",
   " text-align: left;"," vertical-align: middle;}",
   ...
   " font:   10pt Times;"," "," color: #000000;",
   " "," text-align: left;"," vertical-align: middle;}",
   ".FieldName0211 { border-width: 0.014in; border-color: #000000;",
   " border-style: none none none none;",
   " padding: 0.000in 0.000in 0.000in 0.000in;"," font:   10pt Times;"," "," color: #000000;"," ",
   ...
   ".FieldName0221 { border-width: 0.014in; border-color: #000000;",
   " border-style: none none none none;",
   " padding: 0.000in 0.000in 0.000in 0.000in;"," font:   10pt Times;"," "," color: #000000;",
   " background: #e8e8e8;",
   " text-align: right;"," vertical-align: middle;}",
   ...
   " border-style: none none none none;"," padding: 0.000in 0.000in 0.000in 0.000in;",
   " font:   10pt Times;"," "," color: #000000;"," background: #e8e8e8;"," text-align: center;",
   " vertical-align: middle;}",".FieldName0225 { border-width: 0.014in; border-color: #000000;",
   " border-style: none none none none;"," padding: 0.000in 0.050in 0.000in 0.000in;",
   " font:   10pt Times;",
   ...
   " border-style: none none none none;",
   " padding: 0.000in 0.000in 0.000in 0.100in;"," font:  bold 10pt Times;"," "," color: #000000;",
   " background: #ffff80;",
   " text-align: left;"," vertical-align: middle;}",
   ...
   " border-style: none none none none;"," padding: 0.000in 0.000in 0.000in 0.000in;",
   " font:   10pt Times;"," ",
   " color: #000000;"," background: #ffff80;"," text-align: center;"," vertical-align: middle;}",
   ...
   " border-style: none none none none;",
   " padding: 0.000in 0.000in 0.000in 0.000in;"," font:  bold 11pt Times;"," "," color: #000000;",
   " background: #ffff80;",
   " text-align: left;"," vertical-align: middle;}",
  ...
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
  SET _htmlfileinfo->file_buf = "<table width='100%'><caption>"
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
  SET _htmlfileinfo->file_buf = build2("<colgroup span=21>","<col width=94/>","<col width=12/>",
   "<col width=44/>","<col width=27/>",
   "<col width=1/>","<col width=70/>","<col width=40/>","<col width=6/>","<col width=12/>",
   "<col width=19/>","<col width=49/>","<col width=20/>","<col width=34/>","<col width=10/>",
   "<col width=96/>","<col width=68/>","<col width=73/>","<col width=51/>","<col width=124/>",
   "<col width=17/>","<col width=117/>","</colgroup>")
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
  SET _htmlfileinfo->file_buf = "<tbody>"
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 ENDIF
 ...
 IF (_bishtml != 0)
  SET _htmlfileinfo->file_buf = "</tbody>"
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
  SET _htmlfileinfo->file_buf = "</table>"
  SET _htmlfilestat = cclio("WRITE",_htmlfileinfo)
 ENDIF
END GO
