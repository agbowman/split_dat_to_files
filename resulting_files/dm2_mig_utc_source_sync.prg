CREATE PROGRAM dm2_mig_utc_source_sync
 ...
 SUBROUTINE retrieve_data(sbr_srch_str,sbr_sprtr,sbr_rd_str)
   ...
   ENDIF
 END ;Subroutine
 IF (check_logfile("dm2_mig_utc_src_sync",".log","dm2_mig_utc_source_sync")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_mig_utc_source_sync"
 CALL disp_msg(" ",dm_err->logfile,0)
 EXECUTE dm2_mig_utc_schema_sync "SOURCE"
 GO TO exit_program
#exit_program
 SET dm_err->eproc = "Ending dm2_mig_utc_source_sync"
