CREATE PROGRAM cp_create_node:dba
 ...
 SUBROUTINE insertrows(null)
   ...
   FOR (x = 1 TO size(request->node_list,5))
     ...
     INSERT  FROM cp_node cn
      SET cn.active_ind = 1, cn.publish_ind = 1, cn.cp_node_id = cp_node_id,
       ...
       node_list[x].category_mean, cn.collation_seq = request->node_list[x].sequence,
