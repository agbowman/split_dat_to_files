CREATE PROGRAM daf_icd9_txtfnd_load_wrapper:dba
 RECORD reply(
   1 message = vc
   1 status_data
     2 status = c1
 ...
 ELSEIF ((daf_icd9_reply->status="F"))
  ...
  SET reply->status_data.subeventstatus[1].operationname = "DAF_ICD9_TXTFND_LOAD_WRPR"
