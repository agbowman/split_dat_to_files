CREATE PROGRAM cr_set_feature_flag_masterlist:dba
 ...
 END ;Subroutine
 SET readme_data->status = "F"
 SET readme_data->message = concat("Error: Fail starting script cr_set_feature_flag_masterList:",
  error_msg)
 CALL setfeatureflag("MASTER LIST OF PROVIDER EXCLUSIONS",onflag)
