CREATE PROGRAM dm2_set_admin_conn:dba
 ...
 ENDIF
 IF (check_logfile("dm2_set_admin_conn",".log","dm2_set_admin_conn")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_set_admin_conn"
 CALL disp_msg(" ",dm_err->logfile,0)
 SET dm_err->eproc = "Connecting to CLinical DB"
 CALL disp_msg(" ",dm_err->logfile,0)
 ...
 IF (ds_scramble_init(null)=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Connecting to Admin DB"
 CALL disp_msg(" ",dm_err->logfile,0)
...
#exit_program
 IF ((dm_err->err_ind=1))
  CALL disp_msg(dm_err->emsg,dm_err->logfile,1)
 ELSE
  SET dm_err->eproc = "dm2_set_admin_conn completed"
 ENDIF
 CALL final_disp_msg("dm2_set_admin_conn")
END GO
