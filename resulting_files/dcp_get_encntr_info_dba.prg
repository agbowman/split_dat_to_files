CREATE PROGRAM dcp_get_encntr_info:dba
 SET count1 = 0
 ...
 IF (nbr_to_get > 0)
  SELECT INTO "nl:"
   ...
   DETAIL
    ...
    ENDIF
    reply->get_list[count1].encntr_id = e.encntr_id, reply->get_list[count1].loc_room_cd = e
    .loc_room_cd, reply->get_list[count1].loc_bed_cd = e.loc_bed_cd,
    reply->get_list[count1].isolation_cd = e.isolation_cd
   FOOT REPORT
