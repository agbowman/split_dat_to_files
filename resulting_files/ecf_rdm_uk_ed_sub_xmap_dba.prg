CREATE PROGRAM ecf_rdm_uk_ed_sub_xmap:dba
 ...
 SET kia_tbl_desc = "UK_ED_SUB XMAP"
 SET kia_short_desc = "UK_ED_SUB"
 SET kia_rdm_log_name = "ecf_rdm_uk_ed_sub_xmap.log"
 SET kia_rdm_nbr = 10389
 ...
 CALL log_sub(concat("ecf_rdm_uk_ed_sub_xmap Begin> ",format(cnvtdatetime(curdate,curtime3),
