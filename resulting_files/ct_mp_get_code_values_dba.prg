CREATE PROGRAM ct_mp_get_code_values:dba
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "CodeSet" = 0,
  "CvMode" = 1
  WITH outdev, codeset, cvmode
 RECORD reply(
   1 qual[*]
     2 code_value = f8
     2 code_set = f8
 ...
 SUBROUTINE (istaskgranted(task_number=i4(val)) =i2 WITH protect)
   ...
   RETURN(task_granted)
 END ;Subroutine
 SET log_program_name = "ct_mp_get_code_values"
 ...
 DECLARE paramcodeset = i4 WITH public, noconstant(0)
 SET paramcodeset = 17902
 SELECT INTO "nl:"
