CREATE PROGRAM bhs_phys_missing_dea:dba
 PROMPT
 ...
 SELECT INTO value(output_dest)
  ...
  HEAD REPORT
   ...
   FOR (y = 1 TO size(md_alias->qual[d.seq],5))
     IF ((((md_alias->qual[y].dea_nbr=null)) OR ((md_alias->qual[y].dea_nbr <= " "))) )
 ...
 IF (email_ind=1)
  ...
  SET filename_out = concat(format(curdate,"YYYY-MM-DD;;D"),"_PHYS_missing_DEA.csv")
  DECLARE subject_line = vc
  SET subject_line = concat(curprog,"-V1.x - PHYS missing DEA ",curnode)
