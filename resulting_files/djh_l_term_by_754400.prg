CREATE PROGRAM djh_l_term_by_754400
 PROMPT
 ...
 SELECT INTO  $OUTDEV
  ...
  HEAD PAGE
   ...
   CALL print(calcpos(306,(y_pos+ 0))), "List all TERM and/or Suppended IDs", row + 1,
   ...
   "Date", row + 1,
   CALL print(calcpos(486,(y_pos+ 36))),
   "|  Date / Time  |",
  ...
  DETAIL
   ...
   statcd = evaluate(p.active_status_cd,188.00,"",192.00,"*",
    194.00,"S"), row + 1,
   CALL print(calcpos(26,(y_pos+ 0))),
   statcd, row + 1,
