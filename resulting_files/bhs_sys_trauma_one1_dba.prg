CREATE PROGRAM bhs_sys_trauma_one1:dba
 PROMPT
 ...
 SELECT INTO "nl:"
  ...
  HEAD en.encntr_id
   ...
   ENDIF
   list->qual[list->cnt].dob = format(p.birth_dt_tm,"mm/dd/yyyy hh:mm;;d"), list->qual[list->cnt].sex
    = uar_get_code_display(p.sex_cd), list->qual[list->cnt].address = concat(trim(ad.street_addr,3),
    trim(ad.street_addr2,3)),
