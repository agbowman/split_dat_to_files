CREATE PROGRAM br_datamart_category_config:dba
 ...
 SET readme_data->message = "Readme Failed: Starting <br_datamart_category_config.prg> script"
 ...
 SET readme_data->message = "Readme Succeeded: <br_datamart_category_config.prg> script"
#exit_script
