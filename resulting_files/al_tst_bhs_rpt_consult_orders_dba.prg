CREATE PROGRAM al_tst_bhs_rpt_consult_orders:dba
 ...
 SELECT INTO "nl:"
  ...
  WHERE oc.primary_mnemonic IN ("Cardiac Rehab Inpt Medical (Phase 1)",
  "Cardiac Rehab Inpt Surgical (Phase 1)", "Cardiac Rehab Outpatient (Phase 2)",
  "Pulm Rehab Nurse Eval Treat", "Consult Acute Pain Service",
  "Psych Consult (Adult)", "Consult HBO Enterostomal Therapy", "Consult HBO Therapy",
  "Consult HBO Therapy & Wound Care", "Consult HBO Transcutaneous O2 Monitor",
  "Consult HBO Wound Care", "Consult Outpatient Diabetic Ed", "Consult Physician",
  "Consult Rehabilitation Medicine", "Consult Transfusion Medicine",
  "Consult Vent Management", "Consult BMC Inpatient Diabetes (BIDS)",
  "Consult Pediatric Infectious Disease", "Heart Failure Program Referral",
  "Consult Pediatric Hospitalist",
  "Consult Infectious Disease HIV Team", "CHF Program", "Consult Neurology (Adult)",
  "Consult Hospice", "Consult OB: Gestation >12 Weeks",
  "Consult Palliative Care", "COPD Program", "Consult GYN", "Consult OB/GYN",
  "Consult Lung Cancer Screening Program",
  "Consult Rehabilitation Medicine (BFMC)", "Consult Fracture Liaison Service",
  "Consult Palliative Care Practitioner", "Consult GYN/Oncology", "Consult Medicine",
  "Behavioral Health Consults", "Consult Gastroenterology BMP", "Consult Geriatric BMC",
  "Psych Consult (Child)", "Consult Medical-Behavioral",
  "Consult Psychiatry", "Neuropsych Testing")
  HEAD REPORT
   ord_cat->l_cnt = 0
  DETAIL
   ord_cat->l_cnt = (ord_cat->l_cnt+ 1), stat = alterlist(ord_cat->list,ord_cat->l_cnt), ord_cat->
   list[ord_cat->l_cnt].f_cat_cd = oc.catalog_cd,
 ...
 SELECT INTO "nl:"
  ...
  HEAD REPORT
   ord->l_cnt = 0
  DETAIL
   ord->l_cnt = (ord->l_cnt+ 1), stat = alterlist(ord->list,ord->l_cnt), ord->list[ord->l_cnt].
   s_ord_date = format(o.orig_order_dt_tm,"MM/DD/YYYY HH:mm:ss;;q"),
 ...
 SET ms_rec = "angelce.lazovski@bhs.org"
