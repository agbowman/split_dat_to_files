CREATE PROGRAM dd_set_feature_flag_cry_fwd:dba
 ...
 END ;Subroutine
 SET readme_data->status = "F"
 SET readme_data->message = concat("Error: Fail starting script dd_set_feature_flag_cry_fwd:",
  error_msg)
 CALL setfeatureflag("CARRY_FORWARD",onflag)
