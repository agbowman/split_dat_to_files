CREATE PROGRAM ec_profiler_m70:dba
 ...
 SELECT INTO "nl:"
  ...
  WHERE vp.prsnl_id=0
   ...
   AND vp.frame_type="PTINFO"
   AND vp.view_name="IMMUNIZATION"
  ...
  HEAD vp.view_name
   ...
   facilities[facilitycnt].positions[positioncnt].details[detailcnt].detail_value_txt = ""
  WITH nocounter
 ;end select
