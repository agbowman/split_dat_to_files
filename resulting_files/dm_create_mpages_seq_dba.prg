CREATE PROGRAM dm_create_mpages_seq:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_create_mpages_seq..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("MPAGES_SEQ")
 SELECT INTO "nl:"
