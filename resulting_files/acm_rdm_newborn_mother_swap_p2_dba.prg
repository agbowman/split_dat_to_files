CREATE PROGRAM acm_rdm_newborn_mother_swap_p2:dba
 ...
 SET ms_info_domain_nm = "ACM_RDM_NEWBORN_MOTHER"
 SET ms_range = "ACM_RDM_NEWBORN_MOTHER_RANGE FULL"
 SET ms_max_name_p = "MAX ENCNTR_ENCNTR_RELTN_ID EVALUATED"
 SET ms_child_script = "ACM_RDM_NEWBORN_MOTHER_SWAP_CC"
 SET mn_num_children = 3.0
 SELECT INTO "nl:"
  max_val = max(eer.encntr_encntr_reltn_id)
...
#exit_program
 ...
 ELSE
  COMMIT
  CALL sbr_add_dropped_object("INDEX","TEMPEERINDEX","Dropping index")
  CALL sbr_add_dropped_object("TABLE","TEMP_RDM_NEWBORN_MOTHER_SWAP","Dropping table")
