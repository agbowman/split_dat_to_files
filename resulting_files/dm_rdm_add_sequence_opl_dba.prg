CREATE PROGRAM dm_rdm_add_sequence_opl:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_rdm_add_sequence_opl..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("OPL_SEQ")
 SELECT INTO "nl:"
