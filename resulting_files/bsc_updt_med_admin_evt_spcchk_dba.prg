CREATE PROGRAM bsc_updt_med_admin_evt_spcchk:dba
 ...
 SET ms_process_name = "UPDATE ADMIN EVENT - EVENT_ID"
 SET ms_operation_init = "U"
 CALL sbr_add_table("MED_ADMIN_EVENT",1)
 ...
 CALL sbr_add_column("DOCUMENTATION_ACTION_SEQUENCE",0)
 CALL sbr_add_column("BEG_DT_TM",0)
