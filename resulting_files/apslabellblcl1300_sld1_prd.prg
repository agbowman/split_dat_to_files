CREATE PROGRAM apslabellblcl1300_sld1_prd
 PROMPT
 ...
 DECLARE _pen16s1c0 = i4 WITH noconstant(0), protect
 ...
 SUBROUTINE detailsectionabs(ncalc,offsetx,offsety)
   ...
   IF (ncalc=rpt_render)
    ...
    SET rptsd->m_height = 0.126
    SET _dummypen = uar_rptsetpen(_hreport,_pen16s1c0)
    ...
    IF (request_dt_tm1 != " ")
     SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.011),(offsety+ 0.625),(offsetx+ 0.938),(offsety
      + 0.625))
    ENDIF
    IF (request_dt_tm2 != " ")
     SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.938),(offsety+ 0.625),(offsetx+ 1.866),(offsety
      + 0.625))
    ENDIF
    IF (request_dt_tm3 != " ")
     SET _rptstat = uar_rptline(_hreport,(offsetx+ 1.865),(offsety+ 0.625),(offsetx+ 2.803),(offsety
      + 0.625))
    ENDIF
    IF (request_dt_tm4 != " ")
     SET _rptstat = uar_rptline(_hreport,(offsetx+ 2.803),(offsety+ 0.625),(offsetx+ 3.741),(offsety
      + 0.625))
    ENDIF
 ...
 SUBROUTINE initializereport(dummy)
   ...
   SET rptreport->m_reportname = "APSLABELLBLCL1300_SLD1_PRD"
 ...
 SUBROUTINE _createpens(dummy)
   ...
   SET rptpen->m_penwidth = 0.016
   SET rptpen->m_penstyle = 1
   SET _pen16s1c0 = uar_rptcreatepen(_hreport,rptpen)
