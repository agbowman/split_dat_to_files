CREATE PROGRAM dm2_aload_cs_cv
 ...
 SUBROUTINE dac_load_cload(lc_pkg_in)
   ...
   ENDIF
 END ;Subroutine
 IF (check_logfile("dm2_aload_cs_cv",".log","dm2_aload_cs_cv")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_aload_cs_cv"
 CALL disp_msg(" ",dm_err->logfile,0)
 DECLARE dcv_cnt = i4 WITH protect, noconstant(0)
 DECLARE dcv_str = vc WITH protect, noconstant("")
 IF (dac_pop_coldic_rec("DM_AFD_CODE_VALUE")=0)
  GO TO exit_program
 ENDIF
...
#exit_program
 IF ((dm_err->err_ind=0))
  SET dm_err->eproc = "Dm2_aload_cs_cv completed"
 ENDIF
 CALL final_disp_msg("dm2_aload_cs_cv")
END GO
