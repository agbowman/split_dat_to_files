CREATE PROGRAM djh_l_active_dbas
 PROMPT
 ...
 SELECT INTO  $OUTDEV
  ...
  WHERE p.active_ind=1
   AND ((p.position_cd=441) OR (((p.position_cd=686743) OR (p.position_cd=786870)) ))
  ORDER BY p_position_disp, p.name_full_formatted, p.position_cd
  HEAD REPORT
   y_pos = 18,
