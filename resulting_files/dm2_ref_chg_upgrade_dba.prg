CREATE PROGRAM dm2_ref_chg_upgrade:dba
 ...
 SUBROUTINE dir_get_admin_db_link(dgadl_report_fail_ind,dgadl_admin_db_link,dgadl_fail_ind)
   ...
   RETURN(1)
 END ;Subroutine
 CALL check_logfile("dm2_ref_chg_upgrade",".log","DM2_REF_CHG_UPGRADE LOGFILE")
 SET dm_err->eproc = "Beginning dm2_ref_chg_upgrade"
 CALL disp_msg(" ",dm_err->logfile,0)
 EXECUTE dm2_ref_chg_tbl "CODE_VALUE_SET"
#exit_program
 SET dm_err->eproc = "...Ending dm2_ref_chg_upgrade"
 CALL final_disp_msg("dm2_ref_chg_upgrade")
END GO
