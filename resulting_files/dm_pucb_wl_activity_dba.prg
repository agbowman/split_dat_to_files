CREATE PROGRAM dm_pucb_wl_activity:dba
 ...
 IF ((dm_cmb_cust_script->exc_maint_ind=1))
  ...
  SET dcem_request->qual[1].script_name = "DM_PUCB_WL_ACTIVITY"
 ...
 SUBROUTINE cust_ucb_upt_wl_activity(null)
   ...
   UPDATE  FROM wl_activity wl
    SET wl.person_id = request->xxx_uncombine[ucb_cnt].to_xxx_id, wl.updt_id = reqinfo->updt_id, wl
