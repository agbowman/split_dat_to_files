CREATE PROGRAM cv_da_del_cv_proc:dba
 IF (validate(stat)=0)
 ...
 SUBROUTINE (cv_log_msg_post(script_vrsn=vc) =null)
  ...
  ENDIF
 END ;Subroutine
 DECLARE cv_da_del_cv_proc_vrsn = vc WITH private, constant("20091117")
