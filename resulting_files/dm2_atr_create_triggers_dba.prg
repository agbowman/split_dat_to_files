CREATE PROGRAM dm2_atr_create_triggers:dba
 ...
 ENDIF
 DECLARE dact_validate_trigger(dact_cnt=i2) = i4
 DECLARE dact_logfile_name = vc WITH private, constant("dm2_atr_trig")
 DECLARE dact_text = vc WITH public, noconstant(" ")
 DECLARE dact_trigger_name = vc WITH public, noconstant(" ")
 DECLARE dact_trigger_tbl_name = vc WITH public, noconstant(" ")
 DECLARE dact_trigger_count = i4 WITH public, noconstant(0)
 DECLARE dact_table_count = i4 WITH public, noconstant(0)
 DECLARE dact_table_name = vc WITH public, noconstant(" ")
 DECLARE dact_tname1 = vc WITH public, noconstant(" ")
 RECORD tlist(
   1 qual[*]
     2 tbl_name = vc
     2 full_tbl_name = vc
 ...
 IF (check_logfile(dact_logfile_name,".log","DM2_ATR_CREATE_TRIGGER LOG ...") != 1)
  SET dm_err->err_ind = 1
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "BEGINNING DM2_ATR_CREATE_TRIGGERS.PRG ..."
 CALL disp_msg(" ",dm_err->logfile,0)
 CASE (currdb)
  OF "ORACLE":
   SET tcnt = 9
   SET stat = alterlist(tlist->qual,tcnt)
   SET tlist->qual[1].tbl_name = "APPLICATION"
   SET tlist->qual[1].full_tbl_name = "APPLICATION"
   SET tlist->qual[1].trig_name = "TRG_APP_INS_UPDT_DEL"
   SET tlist->qual[1].trig_type = "INSUPDTDEL"
   SET tlist->qual[2].tbl_name = "APPLICATION_TASK"
   SET tlist->qual[2].full_tbl_name = "APPLICATION_TASK"
   SET tlist->qual[2].trig_name = "TRG_TASK_INS_UPDT_DEL"
   SET tlist->qual[2].trig_type = "INSUPDTDEL"
   SET tlist->qual[3].tbl_name = "REQUEST"
   SET tlist->qual[3].full_tbl_name = "REQUEST"
   SET tlist->qual[3].trig_name = "TRG_REQ_INS_UPDT_DEL"
   SET tlist->qual[3].trig_type = "INSUPDTDEL"
   SET tlist->qual[4].tbl_name = "APPLICATION_TASK_R"
   SET tlist->qual[4].full_tbl_name = "APPLICATION_TASK_R"
   SET tlist->qual[4].trig_name = "TRG_APP_TSK_R_INS_UPDT_DEL"
   SET tlist->qual[4].trig_type = "INSUPDTDEL"
   SET tlist->qual[5].tbl_name = "TASK_REQUEST_R"
   SET tlist->qual[5].full_tbl_name = "TASK_REQUEST_R"
   SET tlist->qual[5].trig_name = "TRG_TASK_REQ_INS_UPDT_DEL"
   SET tlist->qual[5].trig_type = "INSUPDTDEL"
   SET tlist->qual[6].tbl_name = "TASK_ACCESS"
   SET tlist->qual[6].full_tbl_name = "TASK_ACCESS"
   SET tlist->qual[6].trig_name = "TRG_TASK_ACCESS_INS_UPDT_DEL"
   SET tlist->qual[6].trig_type = "INSUPDTDEL"
   SET tlist->qual[7].tbl_name = "APPLICATION_GROUP"
   SET tlist->qual[7].full_tbl_name = "APPLICATION_GROUP"
   SET tlist->qual[7].trig_name = "TRG_APP_GRP_INS_UPDT_DEL"
   SET tlist->qual[7].trig_type = "INSUPDTDEL"
   SET tlist->qual[8].tbl_name = "REQUEST_PROCESSING"
   SET tlist->qual[8].full_tbl_name = "REQUEST_PROCESSING"
   SET tlist->qual[8].trig_name = "TRG_REQ_PROC_INS_UPDT_DEL"
   SET tlist->qual[8].trig_type = "INSUPDTDEL"
   SET tlist->qual[9].tbl_name = "APPLICATION_ACCESS"
   SET tlist->qual[9].full_tbl_name = "APPLICATION_ACCESS"
   SET tlist->qual[9].trig_name = "TRG_APP_ACCESS_INS_UPDT_DEL"
   SET tlist->qual[9].trig_type = "INSUPDTDEL"
  OF "DB2UDB":
   SET tcnt = 27
   SET stat = alterlist(tlist->qual,tcnt)
   SET tlist->qual[1].tbl_name = "APPLICATION0918"
   SET tlist->qual[1].full_tbl_name = "APPLICATION"
   SET tlist->qual[1].trig_name = "APP_INS"
   SET tlist->qual[1].trig_type = "INSERT"
   SET tlist->qual[2].tbl_name = "APPLICATION0918"
   SET tlist->qual[2].full_tbl_name = "APPLICATION"
   SET tlist->qual[2].trig_name = "APP_UPDT"
   SET tlist->qual[2].trig_type = "UPDATE"
   SET tlist->qual[3].tbl_name = "APPLICATION0918"
   SET tlist->qual[3].full_tbl_name = "APPLICATION"
   SET tlist->qual[3].trig_name = "APP_DEL"
   SET tlist->qual[3].trig_type = "DELETE"
   SET tlist->qual[4].tbl_name = "APPLICATION_TA0922"
   SET tlist->qual[4].full_tbl_name = "APPLICATION_TASK"
   SET tlist->qual[4].trig_name = "TASK_INS"
   SET tlist->qual[4].trig_type = "INSERT"
   SET tlist->qual[5].tbl_name = "APPLICATION_TA0922"
   SET tlist->qual[5].full_tbl_name = "APPLICATION_TASK"
   SET tlist->qual[5].trig_name = "TASK_UPDT"
   SET tlist->qual[5].trig_type = "UPDATE"
   SET tlist->qual[6].tbl_name = "APPLICATION_TA0922"
   SET tlist->qual[6].full_tbl_name = "APPLICATION_TASK"
   SET tlist->qual[6].trig_name = "TASK_DEL"
   SET tlist->qual[6].trig_type = "DELETE"
   SET tlist->qual[7].tbl_name = "REQUEST0925"
   SET tlist->qual[7].full_tbl_name = "REQUEST"
   SET tlist->qual[7].trig_name = "REQ_INS"
   SET tlist->qual[7].trig_type = "INSERT"
   SET tlist->qual[8].tbl_name = "REQUEST0925"
   SET tlist->qual[8].full_tbl_name = "REQUEST"
   SET tlist->qual[8].trig_name = "REQ_UPDT"
   SET tlist->qual[8].trig_type = "UPDATE"
   SET tlist->qual[9].tbl_name = "REQUEST0925"
   SET tlist->qual[9].full_tbl_name = "REQUEST"
   SET tlist->qual[9].trig_name = "REQ_DEL"
   SET tlist->qual[9].trig_type = "DELETE"
   SET tlist->qual[10].tbl_name = "APPLICATION_TA0013"
   SET tlist->qual[10].full_tbl_name = "APPLICATION_TASK_R"
   SET tlist->qual[10].trig_name = "APP_TASK_INS"
   SET tlist->qual[10].trig_type = "INSERT"
   SET tlist->qual[11].tbl_name = "APPLICATION_TA0013"
   SET tlist->qual[11].full_tbl_name = "APPLICATION_TASK_R"
   SET tlist->qual[11].trig_name = "APP_TASK_UPDT"
   SET tlist->qual[11].trig_type = "UPDATE"
   SET tlist->qual[12].tbl_name = "APPLICATION_TA0013"
   SET tlist->qual[12].full_tbl_name = "APPLICATION_TASK_R"
   SET tlist->qual[12].trig_name = "APP_TASK_DEL"
   SET tlist->qual[12].trig_type = "DELETE"
   SET tlist->qual[13].tbl_name = "TASK_REQUEST_R0928"
   SET tlist->qual[13].full_tbl_name = "TASK_REQUEST_R"
   SET tlist->qual[13].trig_name = "TASK_REQ_INS"
   SET tlist->qual[13].trig_type = "INSERT"
   SET tlist->qual[14].tbl_name = "TASK_REQUEST_R0928"
   SET tlist->qual[14].full_tbl_name = "TASK_REQUEST_R"
   SET tlist->qual[14].trig_name = "TASK_REQ_UPDT"
   SET tlist->qual[14].trig_type = "UPDATE"
   SET tlist->qual[15].tbl_name = "TASK_REQUEST_R0928"
   SET tlist->qual[15].full_tbl_name = "TASK_REQUEST_R"
   SET tlist->qual[15].trig_name = "TASK_REQ_DEL"
   SET tlist->qual[15].trig_type = "DELETE"
   SET tlist->qual[16].tbl_name = "TASK_ACCESS0929"
   SET tlist->qual[16].full_tbl_name = "TASK_ACCESS"
   SET tlist->qual[16].trig_name = "TASK_ACCESS_INS"
   SET tlist->qual[16].trig_type = "INSERT"
   SET tlist->qual[17].tbl_name = "TASK_ACCESS0929"
   SET tlist->qual[17].full_tbl_name = "TASK_ACCESS"
   SET tlist->qual[17].trig_name = "TASK_ACCESS_UPDT"
   SET tlist->qual[17].trig_type = "UPDATE"
   SET tlist->qual[18].tbl_name = "TASK_ACCESS0929"
   SET tlist->qual[18].full_tbl_name = "TASK_ACCESS"
   SET tlist->qual[18].trig_name = "TASK_ACCESS_DEL"
   SET tlist->qual[18].trig_type = "DELETE"
   SET tlist->qual[19].tbl_name = "APPLICATION_GR0920"
   SET tlist->qual[19].full_tbl_name = "APPLICATION_GROUP"
   SET tlist->qual[19].trig_name = "APP_GRP_INS"
   SET tlist->qual[19].trig_type = "INSERT"
   SET tlist->qual[20].tbl_name = "APPLICATION_GR0920"
   SET tlist->qual[20].full_tbl_name = "APPLICATION_GROUP"
   SET tlist->qual[20].trig_name = "APP_GRP_UPDT"
   SET tlist->qual[20].trig_type = "UPDATE"
   SET tlist->qual[21].tbl_name = "APPLICATION_GR0920"
   SET tlist->qual[21].full_tbl_name = "APPLICATION_GROUP"
   SET tlist->qual[21].trig_name = "APP_GRP_DEL"
   SET tlist->qual[21].trig_type = "DELETE"
   SET tlist->qual[22].tbl_name = "REQUEST_PROCES0927"
   SET tlist->qual[22].full_tbl_name = "REQUEST_PROCESSING"
   SET tlist->qual[22].trig_name = "REQ_PROC_INS"
   SET tlist->qual[22].trig_type = "INSERT"
   SET tlist->qual[23].tbl_name = "REQUEST_PROCES0927"
   SET tlist->qual[23].full_tbl_name = "REQUEST_PROCESSING"
   SET tlist->qual[23].trig_name = "REQ_PROC_UPDT"
   SET tlist->qual[23].trig_type = "UPDATE"
   SET tlist->qual[24].tbl_name = "REQUEST_PROCES0927"
   SET tlist->qual[24].full_tbl_name = "REQUEST_PROCESSING"
   SET tlist->qual[24].trig_name = "REQ_PROC_DEL"
   SET tlist->qual[24].trig_type = "DELETE"
   SET tlist->qual[25].tbl_name = "APPLICATION_AC6988"
   SET tlist->qual[25].full_tbl_name = "APPLICATION_ACCESS"
   SET tlist->qual[25].trig_name = "APP_ACCESS_INS"
   SET tlist->qual[25].trig_type = "INSERT"
   SET tlist->qual[26].tbl_name = "APPLICATION_AC6988"
   SET tlist->qual[26].full_tbl_name = "APPLICATION_ACCESS"
   SET tlist->qual[26].trig_name = "APP_ACCESS_UPDT"
   SET tlist->qual[26].trig_type = "UPDATE"
   SET tlist->qual[27].tbl_name = "APPLICATION_AC6988"
   SET tlist->qual[27].full_tbl_name = "APPLICATION_ACCESS"
   SET tlist->qual[27].trig_name = "APP_ACCESS_DEL"
   SET tlist->qual[27].trig_type = "DELETE"
 ENDCASE
 FOR (cnt = 1 TO tcnt)
   SET trace symbol mark
   CASE (currdb)
    OF "ORACLE":
     IF (dact_validate_trigger(cnt) != 1)
      GO TO exit_program
     ENDIF
     SET dact_text = concat("           create or replace trigger ",value(dact_trigger_name),
      " before ")
     SET dact_text = concat(dact_text,"   update or insert or delete on ",value(dact_trigger_tbl_name
       ))
     SET dact_text = concat(dact_text,"   for each row  ")
     SET dact_text = concat(dact_text,"   begin  ")
     SET dact_text = concat(dact_text," 	  update dm_info ")
     SET dact_text = concat(dact_text," 	  set info_char = '",value(tlist->qual[cnt].full_tbl_name),
      "',")
     SET dact_text = concat(dact_text," 	    info_date = sysdate,")
     SET dact_text = concat(dact_text,"		updt_dt_tm = sysdate, ")
     SET dact_text = concat(dact_text,"		updt_cnt = updt_cnt + 1 ")
     SET dact_text = concat(dact_text,"	  where info_domain = 'ATR' ")
     SET dact_text = concat(dact_text,"	    and info_name = 'ATR UPDATE'; ")
     SET dact_text = concat(dact_text,"	  if sql%notfound then ")
     SET dact_text = concat(dact_text,"	    insert into dm_info ")
     SET dact_text = concat(dact_text,
      "		(info_domain, info_name, info_char, info_date, updt_dt_tm, updt_cnt) ")
     SET dact_text = concat(dact_text,"		values ")
     SET dact_text = concat(dact_text,"		('ATR','ATR UPDATE','",value(tlist->qual[cnt].full_tbl_name),
      "',sysdate,sysdate,0); ")
     SET dact_text = concat(dact_text,"	  end if;")
     SET dact_text = concat(dact_text," end;")
     SET dact_text = concat("RDB ASIS (^ ",dact_text," ^) GO")
     IF (dm2_push_cmd(dact_text,1) != 1)
      SET dm_err->err_ind = 1
      GO TO exit_program
     ENDIF
    OF "DB2UDB":
     IF (dact_validate_trigger(cnt) != 1)
      GO TO exit_program
     ENDIF
     SET dact_text = concat("create trigger ",value(dact_trigger_name))
     SET dact_text = concat(dact_text," after ",tlist->qual[cnt].trig_type," on ",value(
       dact_trigger_tbl_name))
     CASE (tlist->qual[cnt].trig_type)
      OF "INSERT":
       SET dact_text = concat(dact_text," referencing new as new ")
      OF "UPDATE":
       SET dact_text = concat(dact_text," referencing new as new old as old ")
      OF "DELETE":
       SET dact_text = concat(dact_text," referencing old as old ")
     ENDCASE
     SET dact_text = concat(dact_text," for each row mode db2sql ")
     SET dact_text = concat(dact_text," begin atomic ")
     SET dact_text = concat(dact_text," declare rcount integer; ")
     SET dact_text = concat(dact_text," declare v_str varchar(70); ")
     SET dact_text = concat(dact_text," 	update dm_info ")
     SET dact_text = concat(dact_text," 	set info_char = '",value(tlist->qual[cnt].full_tbl_name),
      "',")
     SET dact_text = concat(dact_text," 	    info_date = current timestamp, ")
     SET dact_text = concat(dact_text,"		updt_dt_tm = current timestamp, ")
     SET dact_text = concat(dact_text,"		updt_cnt = updt_cnt + 1 ")
     SET dact_text = concat(dact_text,"	where info_domain = 'ATR' ")
     SET dact_text = concat(dact_text,"      and info_name = 'ATR UPDATE'; ")
     SET dact_text = concat(dact_text,"	get diagnostics rcount = ROW_COUNT; ")
     SET dact_text = concat(dact_text,"  if (rcount = 0) then ")
     SET dact_text = concat(dact_text,"	  insert into dm_info ")
     SET dact_text = concat(dact_text,"		(info_domain, info_name, info_date,",
      "       info_char, updt_dt_tm, updt_cnt) ")
     SET dact_text = concat(dact_text,"	  values ")
     SET dact_text = concat(dact_text,"	 ('ATR', 'ATR UPDATE',current timestamp,","'",value(tlist->
       qual[cnt].full_tbl_name),"',",
      "current timestamp, 0 ); ")
     SET dact_text = concat(dact_text,"	   get diagnostics rcount = ROW_COUNT; ")
     SET dact_text = concat(dact_text,"	   if(rcount != 1) then ")
     SET dact_text = concat(dact_text,"	     set v_str= 'Bad diagnostic row_count value ('",
      "||rtrim(char(rcount))||') for insert command'; ")
     SET dact_text = concat(dact_text,"	     signal sqlstate '70999' set message_text = v_str; ")
     SET dact_text = concat(dact_text,"	   end if; ")
     SET dact_text = concat(dact_text,"  elseif (rcount != 1) then ")
     SET dact_text = concat(dact_text,"	  set v_str = 'Bad diagnostic row_count value ('||",
      "rtrim(char(rcount))||') for update command'; ")
     SET dact_text = concat(dact_text,"	  signal sqlstate '70999' set message_text = v_str; ")
     SET dact_text = concat(dact_text,"	end if;")
     SET dact_text = concat(dact_text," end")
     SET dact_text = concat("RDB ASIS (^ ",dact_text," ^) GO")
 ...
 ENDFOR
 GO TO exit_program
 SUBROUTINE dact_validate_trigger(dvt_cnt)
   DECLARE dvt_trig_name_dc = vc WITH protect, noconstant(" ")
   SET dact_tname1 = tlist->qual[dvt_cnt].tbl_name
   SET dact_table_count = 0
   SET dm_err->eproc = "Verifying table exists for ATR trigger creation. "
   SELECT INTO "nl:"
    FROM dm2_user_tables a
    WHERE a.table_name IN (value(dact_tname1))
    DETAIL
     dact_table_count = (dact_table_count+ 1), dact_table_name = a.table_name
    WITH nocounter
   ;end select
   IF (check_error(dm_err->eproc) != 0)
    CALL disp_msg(dm_err->emsg,dm_err->logfile,1)
    RETURN(0)
   ENDIF
   IF (dact_table_count=0)
    SET dm_err->emsg = concat("Table (",dact_tname1,") not found for creation of trigger (",tlist->
     qual[dvt_cnt].trig_name,")")
    CALL disp_msg(dm_err->emsg,dm_err->logfile,1)
    RETURN(0)
   ENDIF
   SET dact_trigger_count = 0
   SET dvt_trig_name_dc = concat(tlist->qual[dvt_cnt].trig_name,"$C")
   SET dm_err->eproc = "Verifying which triggers exist for the table. "
   SELECT INTO "nl:"
    FROM dm2_user_triggers a
    WHERE ((a.trigger_name=dvt_trig_name_dc) OR ((a.trigger_name=tlist->qual[dvt_cnt].trig_name)))
     AND (a.table_name=tlist->qual[dvt_cnt].tbl_name)
    DETAIL
     dact_trigger_name = a.trigger_name, dact_trigger_tbl_name = a.table_name, dact_trigger_count = (
     dact_trigger_count+ 1)
    WITH nocounter
   ;end select
   IF (check_error(dm_err->eproc) != 0)
    CALL disp_msg(dm_err->emsg,dm_err->logfile,1)
    RETURN(0)
   ENDIF
   CASE (dact_trigger_count)
    OF 1:
     IF (currdb="DB2UDB")
      SET dact_text = concat("RDB DROP TRIGGER ",dact_trigger_name," GO")
      SET dm_err->eproc = concat("Dropping trigger: ",dact_trigger_name)
      IF (dm2_push_cmd(dact_text,1) != 1)
       ROLLBACK
       RETURN(0)
      ENDIF
     ENDIF
    OF 0:
     SET dact_trigger_name = tlist->qual[dvt_cnt].trig_name
     SET dact_trigger_tbl_name = tlist->qual[dvt_cnt].tbl_name
    ELSE
     SET dm_err->eproc = concat("Dropping trigger: ",dact_trigger_name,"$C")
     SET dact_text = concat("RDB DROP TRIGGER ",trim(tlist->qual[dvt_cnt].trig_name),"$C GO")
     IF (dm2_push_cmd(dact_text,1) != 1)
      ROLLBACK
      RETURN(0)
     ENDIF
     IF (currdb="DB2UDB")
      SET dact_text = concat("RDB DROP TRIGGER ",trim(tlist->qual[dvt_cnt].trig_name)," GO")
      IF (dm2_push_cmd(dact_text,1) != 1)
       ROLLBACK
       RETURN(0)
      ENDIF
 ...
 END ;Subroutine
#exit_program
 SET dm_err->eproc = "ENDING DM2_ATR_CREATE_TRIGGERS.PRG"
 CALL final_disp_msg(dact_logfile_name)
 IF ((dm_err->err_ind=1))
  SET readme_data->status = "F"
  SET readme_data->message = dm_err->emsg
 ELSE
  SET readme_data->status = "S"
  SET readme_data->message = "Triggers added."
 ENDIF
