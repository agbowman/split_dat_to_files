CREATE PROGRAM dm2_mig_compare_rowcnts
 ...
 END ;Subroutine
 SET width = 132
 IF (check_logfile("dm2_migcmp_cnts",".log","dm2_mig_compare_rowcnts")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_mig_compare_rowcnts"
 CALL disp_msg(" ",dm_err->logfile,0)
 ...
 GO TO exit_program
#exit_program
 SET dm_err->eproc = "Dm2_mig_compare_rowcnts completed"
 CALL final_disp_msg("dm2_migcmp_cnts")
END GO
