CREATE PROGRAM dcp_clr_dup_prsnl_hist_ch:dba
 ...
 DECLARE update_size = i4 WITH protect, noconstant(0)
 SET ms_child_info_domain_nm = "DELETING PRSNL HISTORY FOR DUPS ON DCP_FORMS_ACTIVITY_PRSNL TABLE"
 SET ms_range_prefix = "DCP_FORMS_ACTIVITY_PRSNL_RANGE"
 SET ms_child_max_name = "MAX DCP_FORMS_ACTIVITY_PRSNL_ID EVALUATED"
 ...
 IF (sbr_claim_min_max_row(ms_child_info_domain_nm,ms_range_prefix,ms_child_max_name) IN (2, 0))
  GO TO exit_program
 ENDIF
 SET update_size = ceil((mf_range_id_increment/ 5))
