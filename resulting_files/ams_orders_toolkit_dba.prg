CREATE PROGRAM ams_orders_toolkit:dba
 PAINT
...
#main_menu
 ...
 CALL text((soffrow+ 2),(numcols - 28),"02 Create new orderables")
 CALL text((soffrow+ 3),(numcols - 28),"04 Inactivate PowerPlans")
 CALL text((soffrow+ 4),(numcols - 28),"06 Inactivate Orderables")
 ...
 CALL accept((soffrow+ 16),(soffcol+ 18),"99;",99
  WHERE curaccept IN (2, 4, 6, 98, 99))
 CASE (curaccept)
  OF 2:
   EXECUTE ams_order_import_utility
  OF 4:
   EXECUTE ams_inactivate_powerplan_util
  OF 6:
   EXECUTE ams_inactivate_orderable_util
  OF 98:
