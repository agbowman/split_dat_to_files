CREATE PROGRAM dm_rmc_mover_5251:dba
 ...
 DECLARE cust_from_value = vc
 DECLARE cust_attrib_type = vc
 DECLARE cust_val1 = vc
 DECLARE cust_new_value = vc
 DECLARE cust_rpt_missing = vc
 DECLARE cust_no_query = i2
 DECLARE cust_val = f8
 DECLARE cust_cd_pos = i4
 DECLARE cust_prefix = vc
 DECLARE cust_suffix = vc
 DECLARE cust_suffix_pos = i4
 DECLARE cust_xlat_cnt = i4
 DECLARE cust_for = i4
 DECLARE cust_missing = i4
 FREE RECORD cust_xlats
 RECORD cust_xlats(
   1 cust_xlat_list[*]
     2 cust_xlat_col = vc
     2 cust_process_tab = vc
     2 cust_process_col = vc
 )
 SET cust_tab_name = dm2_ref_data_doc->tbl_qual[temp_tbl_cnt].table_name
 SET cust_attrib_type = trim(get_value(cust_tab_name,"ATTRIB_TYPE","FROM"))
 SET cust_val1 = trim(get_value(cust_tab_name,"VAL1","FROM"))
 IF ((dm2_ref_data_reply->error_ind=1))
  GO TO exit_5251
 ENDIF
 IF (findstring("CONTEXT_",cust_attrib_type)=1)
  SET cust_prefix = " "
  SET cust_cd_pos = 0
  SET cust_xlat_cnt = 1
  SET stat = alterlist(cust_xlats->cust_xlat_list,cust_xlat_cnt)
  SET cust_xlats->cust_xlat_list[1].cust_xlat_col = "VAL1"
  SET cust_xlats->cust_xlat_list[1].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[1].cust_process_col = "CODE_VALUE"
 ELSEIF (findstring("CONFORMED_",cust_attrib_type)=1)
  SET cust_prefix = " "
  SET cust_cd_pos = 0
  SET cust_xlat_cnt = 4
  SET stat = alterlist(cust_xlats->cust_xlat_list,cust_xlat_cnt)
  ...
  SET cust_xlats->cust_xlat_list[1].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[1].cust_process_col = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[2].cust_xlat_col = "VAL2"
  SET cust_xlats->cust_xlat_list[2].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[2].cust_process_col = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[3].cust_xlat_col = "VAL3"
  SET cust_xlats->cust_xlat_list[3].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[3].cust_process_col = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[4].cust_xlat_col = "VAL4"
  SET cust_xlats->cust_xlat_list[4].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[4].cust_process_col = "CODE_VALUE"
 ELSEIF (findstring("LIST_FILTER_",cust_attrib_type)=1)
  SET cust_prefix = "LIST_FILTER_"
  SET cust_cd_pos = 13
  SET cust_xlat_cnt = 1
  SET stat = alterlist(cust_xlats->cust_xlat_list,cust_xlat_cnt)
  SET cust_xlats->cust_xlat_list[1].cust_xlat_col = "ATTRIB_TYPE"
  SET cust_xlats->cust_xlat_list[1].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[1].cust_process_col = "CODE_VALUE"
 ELSEIF (findstring("CAPTION",cust_attrib_type)=1)
  SET cust_prefix = "CAPTION"
  SET cust_cd_pos = 8
  SET cust_xlat_cnt = 1
  SET stat = alterlist(cust_xlats->cust_xlat_list,cust_xlat_cnt)
  SET cust_xlats->cust_xlat_list[1].cust_xlat_col = "ATTRIB_TYPE"
  SET cust_xlats->cust_xlat_list[1].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[1].cust_process_col = "CODE_VALUE"
 ELSEIF (findstring("ORIENTATION",cust_attrib_type)=1)
  SET cust_prefix = "ORIENTATION"
  SET cust_cd_pos = 12
  SET cust_xlat_cnt = 1
  SET stat = alterlist(cust_xlats->cust_xlat_list,cust_xlat_cnt)
  SET cust_xlats->cust_xlat_list[1].cust_xlat_col = "ATTRIB_TYPE"
  SET cust_xlats->cust_xlat_list[1].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[1].cust_process_col = "CODE_VALUE"
 ELSEIF (findstring("GROUP_FOOTER",cust_attrib_type)=1)
  SET cust_prefix = "GROUP_FOOTER"
  SET cust_cd_pos = 13
  SET cust_xlat_cnt = 1
  SET stat = alterlist(cust_xlats->cust_xlat_list,cust_xlat_cnt)
  SET cust_xlats->cust_xlat_list[1].cust_xlat_col = "ATTRIB_TYPE"
  SET cust_xlats->cust_xlat_list[1].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[1].cust_process_col = "CODE_VALUE"
 ELSEIF (findstring("RANK",cust_attrib_type)=1)
  SET cust_prefix = "RANK"
  SET cust_cd_pos = 5
  SET cust_xlat_cnt = 1
  SET stat = alterlist(cust_xlats->cust_xlat_list,cust_xlat_cnt)
  SET cust_xlats->cust_xlat_list[1].cust_xlat_col = "ATTRIB_TYPE"
  SET cust_xlats->cust_xlat_list[1].cust_process_tab = "CODE_VALUE"
  SET cust_xlats->cust_xlat_list[1].cust_process_col = "CODE_VALUE"
 ELSEIF (findstring("FORMAT",cust_attrib_type)=1)
  SET cust_prefix = "FORMAT"
  SET cust_cd_pos = 7
  SET cust_xlat_cnt = 1
  SET stat = alterlist(cust_xlats->cust_xlat_list,cust_xlat_cnt)
  SET cust_xlats->cust_xlat_list[1].cust_xlat_col = "ATTRIB_TYPE"
  ...
  SET cust_xlats->cust_xlat_list[1].cust_process_col = "CODE_VALUE"
 ELSE
  IF (cust_attrib_type=cust_val1
   AND isnumeric(cust_attrib_type) != 0)
   SET cust_prefix = " "
   SET cust_cd_pos = 0
   SET cust_xlat_cnt = 2
   SET stat = alterlist(cust_xlats->cust_xlat_list,cust_xlat_cnt)
   ...
   SET cust_xlats->cust_xlat_list[1].cust_process_tab = "CODE_VALUE"
   SET cust_xlats->cust_xlat_list[1].cust_process_col = "CODE_VALUE"
   SET cust_xlats->cust_xlat_list[2].cust_xlat_col = "VAL1"
   SET cust_xlats->cust_xlat_list[2].cust_process_tab = "CODE_VALUE"
   SET cust_xlats->cust_xlat_list[2].cust_process_col = "CODE_VALUE"
  ELSE
   SET cust_cd_pos = 0
  ...
  ENDIF
 ENDIF
 FOR (cust_for = 1 TO cust_xlat_cnt)
   SET cust_column_cnt = get_col_pos(cust_tab_name,cust_xlats->cust_xlat_list[cust_for].cust_xlat_col
    )
   SET dm2_ref_data_doc->tbl_qual[temp_tbl_cnt].col_qual[cust_column_cnt].translated = 0
   SET cust_suffix = ""
   SET cust_suffix_pos = 0
   IF ((cust_xlats->cust_xlat_list[cust_for].cust_xlat_col="ATTRIB_TYPE"))
    SET cust_from_value = substring(cust_cd_pos,size(cust_attrib_type,1),cust_attrib_type)
    SET cust_suffix_pos = findstring(".",cust_from_value,0,0)
    IF (cust_suffix_pos > 0)
     SET cust_suffix = substring(cust_suffix_pos,size(cust_attrib_type,1),cust_from_value)
     SET cust_from_value = substring(0,(cust_suffix_pos - 1),cust_from_value)
    ENDIF
   ELSE
    SET cust_from_value = get_value(cust_tab_name,cust_xlats->cust_xlat_list[cust_for].cust_xlat_col,
     "FROM")
    SET cust_suffix_pos = findstring(".",cust_from_value,0,0)
    IF (cust_suffix_pos > 0)
     SET cust_suffix = substring(cust_suffix_pos,size(cust_attrib_type,1),cust_from_value)
    ...
    ENDIF
   ENDIF
   SET cust_new_value = select_merge_translate(cust_from_value,cust_xlats->cust_xlat_list[cust_for].
    cust_process_tab)
   IF (isnumeric(cust_new_value))
    IF (cust_suffix != "")
     SET cust_new_value = concat(cust_new_value,cust_suffix)
    ENDIF
    SET cust_new_value = build(cust_prefix,cust_new_value)
    CALL put_value(cust_tab_name,cust_xlats->cust_xlat_list[cust_for].cust_xlat_col,cust_new_value)
   ELSE
    SET cust_rpt_missing = report_missing(cust_xlats->cust_xlat_list[cust_for].cust_process_tab,
     cust_xlats->cust_xlat_list[cust_for].cust_process_col,cnvtreal(cust_from_value))
    CALL evaluate_rpt_missing(cust_rpt_missing)
   ENDIF
 ENDFOR
 SET temp_col_cnt = get_col_pos(cust_tab_name,"ATTRIB_ID")
 IF ((dm2_ref_data_doc->tbl_qual[temp_tbl_cnt].col_qual[temp_col_cnt].translated=0))
  ...
  IF (cust_no_query=1)
   ...
   IF (cust_val < 0)
    IF ((cust_val=- (3)))
     SET cust_val = get_seq(cust_tab_name,"ATTRIB_ID")
     IF (cust_val > 0)
      CALL put_value(cust_tab_name,"ATTRIB_ID",cnvtstring(cust_val))
      SET current_merges = (current_merges+ 1)
      SET child_merge_audit->num[current_merges].action = "NEWSEQ"
      SET child_merge_audit->num[current_merges].text = concat(cust_tab_name,"  ATTRIB_ID")
     ELSE
      GO TO exit_5251
     ENDIF
    ELSE
   ...
   SET cust_from_cd = get_value(cust_tab_name,"ATTRIB_ID","FROM")
   IF ((dm2_ref_data_reply->error_ind=1))
    GO TO exit_5251
   ELSE
    SET dm2_ref_data_reply->qual[1].from_value = cnvtreal(cust_from_cd)
   ENDIF
   SET cust_new_cd = get_value(cust_tab_name,"ATTRIB_ID","TO")
   IF ((dm2_ref_data_reply->error_ind=1))
    GO TO exit_5251
   ELSE
 ...
 IF (cust_idcd_check=1)
  FOR (cust_for = 1 TO cust_xlat_cnt)
    IF (cust_idcd_check=1)
     SET cust_idcd_check = is_translated(cust_tab_name,cust_xlats->cust_xlat_list[cust_for].
      cust_xlat_col)
     SET dm_err->eproc = "Status of translation"
     IF (cust_idcd_check=0)
      SET cust_missing = cust_for
     ENDIF
    ENDIF
  ENDFOR
  IF (cust_idcd_check=1)
  ...
  ELSE
   ...
   IF (cust_err_val=0)
    SET dm2_ref_data_reply->error_ind = 1
    SET dm2_ref_data_reply->error_msg = concat("This row wasn't translated because of the ",
     cust_xlats->cust_xlat_list[cust_missing].cust_xlat_col," column")
