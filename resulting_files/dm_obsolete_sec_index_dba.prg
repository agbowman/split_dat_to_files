CREATE PROGRAM dm_obsolete_sec_index:dba
 ...
 IF (currdb="ORACLE")
  ...
  SET errcode = 0
  EXECUTE dm_drop_obsolete_objects "XAK1SEC_RESOURCE", "INDEX", 1
  IF (errcode != 0)
   SET readme_data->message = build(errmsg,"- Readme Failed.")
   GO TO exit_script
  ENDIF
  SET readme_data->status = "S"
  SET readme_data->message = "Index XAK1SEC_RESOURCE dropped successfully"
