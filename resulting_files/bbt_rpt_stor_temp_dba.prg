CREATE PROGRAM bbt_rpt_stor_temp:dba
 RECORD reply(
   1 rpt_list[*]
     2 rpt_filename = vc
   1 status_data
 ...
 SET captions->storage_temp_levels = uar_i18ngetmessage(i18nhandle,"storage_temp_levels",
 ...
 SET select_ok_ind = 0
 SET rpt_cnt = 0
 EXECUTE cpm_create_file_name_logical "bbt_stor_temp", "txt", "x"
 SELECT INTO cpm_cfn_info->file_name_logical
  ...
  HEAD PAGE
   ...
   col 47, captions->storage_temp_levels, row + 2,
