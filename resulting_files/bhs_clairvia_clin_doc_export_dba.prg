CREATE PROGRAM bhs_clairvia_clin_doc_export:dba
 PROMPT
  "Printer" = "MINE",
  "FACILITY" = 0,
 ...
 ENDIF
 SET filewrite = build2("clairvia_clin_doc_bhsma","_",format(curdate,"mmddyyyy;;d"),"_",format(
   curtime3,"hhmmss;3;m"),
  ".txt")
 SELECT INTO "nl:"
  cv.description
...
#exit_script
 ...
 IF ((transaction->trans_qual_cnt > 0))
  SET ms_dclcom = concat("mv ",trim(cnvtlower(filewrite),3)," ",build(logical("bhscust"),
    "/ftp/bhs_clairvia_clin_doc_export/"),trim(cnvtlower(filewrite),3))
  CALL echo(ms_dclcom)
 ...
 ENDIF
 SET last_mod = "003  3/21/24  Alex Bowman    removed ftp logic. writing to bhscust/ftp"
END GO
