...
#exit_script
 IF (curqual > 0)
  ...
  CALL logmsg("Removal of duplicate code_set 1636 entries failed.",((e_rdmstatus+ e_dispmsg)+
   e_logtofile))
 ELSE
  CALL logstatus("Execution successful.","S")
  CALL logmsg("Removal of duplicate code_set 1636 entries was successful.",((e_rdmstatus+ e_dispmsg)
   + e_logtofile))
 ENDIF
