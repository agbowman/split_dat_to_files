CREATE PROGRAM dcp_rdm_upd_ordtsk_docrefid:dba
 ...
 SET readme_data->message = "Readme Failed:  Starting script dcp_rdm_upd_ordtsk_docrefid"
 ...
 SUBROUTINE updatedocsetrefids(null)
  ...
  IF (error(err_msg,0) > 0)
   ...
   GO TO exit_script
  ELSE
   CALL echo("*** dcp_rdm_upd_ordtsk_docrefid - Updated successfully ***")
   SET readme_data->message = "Readme Succeeded:  dcp_rdm_upd_ordtsk_docrefid - Updated successfully"
