CREATE PROGRAM dm2_mig_custccl_automrg_w:dba
 ...
 SET readme_data->message = "Readme Failed: Starting script dm2_mig_custccl_automrg_w.prg..."
 DECLARE errcode = i4 WITH protect, noconstant(0)
 DECLARE errmsg = vc WITH protect
 IF (check_logfile("dm2_mig_cc_automrg",".log","dm2_mig_custccl_automrg_w")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Beginning dm2_mig_custccl_automrg_w"
 CALL disp_msg("",dm_err->logfile,0)
 EXECUTE dm_dbimport "cer_install:dm2_mig_custccl_automrg.csv", "dm2_mig_custccl_automrg_l", 1000
...
#exit_program
 ...
 SET dm_err->eproc = "Ending dm2_mig_custccl_automrg_w"
 CALL final_disp_msg("dm2_mig_custccl_automrg_w")
END GO
