CREATE PROGRAM dcp_elh_cleanup_p2:dba
 ...
 DECLARE dischargecd = f8 WITH protect
 DECLARE cancelcd = f8 WITH protect
 SET ms_info_domain_nm = "DCP_ELH_CLEANUP PROCESS"
 SET ms_range = "ENCNTR_LOC_HIST_ID RANGE 4 CAT5"
 SET ms_max_name_p = "MAX ENCNTR_LOC_HIST_ID EVALUATED"
 SET ms_child_script = "dcp_elh_cleanup_child_c"
 SET mn_num_children = 3
 IF (sbr_p2_check_for_prev_rdm(3233,4) IN (2, 1))
  GO TO exit_program
 ENDIF
 SELECT INTO "nl:"
  max_val = max(elh.encntr_loc_hist_id)
