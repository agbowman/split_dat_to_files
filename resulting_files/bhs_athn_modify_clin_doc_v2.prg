CREATE PROGRAM bhs_athn_modify_clin_doc_v2
 RECORD orequest(
   1 ensure_type = i2
 ...
 SET orequest->clin_event[1].event_id =  $4
 ...
 SET orequest->clin_event[1].event_prsnl_list[1].event_id =  $4
 SET orequest->clin_event[1].event_prsnl_list[1].action_prsnl_id =  $5
 SET orequest->clin_event[1].event_prsnl_list[1].action_type_cd = modify_cd
 ...
 SET orequest->clin_event[1].event_prsnl_list[2].event_id =  $4
 SET orequest->clin_event[1].event_prsnl_list[2].action_prsnl_id =  $5
 SET orequest->clin_event[1].event_prsnl_list[2].action_type_cd = sign_cd
 ...
 ELSEIF (( $14=1))
  SET orequest->clin_event[1].event_prsnl_list[2].action_status_cd = pending_cd
 ENDIF
 SET orequest->clin_event[1].event_prsnl_list[2].updt_id =  $5
 SET orequest->clin_event[1].event_prsnl_list[2].request_prsnl_id =  $5
 ...
 SELECT INTO "nl:"
  ...
  FOOT REPORT
   col_seq = ce.collating_seq
 ;end select
 SET col_seq = cnvtstring((cnvtint(col_seq)+ 1)) WITH nocounter, time = 30
 FREE RECORD preply
 SET prequest->clin_event[1].ensure_type = 2
 SET prequest->clin_event[1].person_id =  $2
 SET prequest->clin_event[1].encntr_id =  $3
 SET prequest->clin_event[1].parent_event_id =  $4
 SET prequest->clin_event[1].clinsig_updt_dt_tm = cnvtdatetime(sysdate)
 SET prequest->clin_event[1].event_cd =  $6
 SET prequest->clin_event[1].event_class_cd = doc_cd
 SET prequest->clin_event[1].view_level = 0
 SET prequest->clin_event[1].contributor_system_cd = powerchart_cd
 SET prequest->clin_event[1].event_reltn_cd = c_cd
 SET prequest->clin_event[1].valid_from_dt_tm = cnvtdatetime(sysdate)
 SET prequest->clin_event[1].event_tag = uar_get_code_display(cnvtreal( $6))
 SET prequest->clin_event[1].event_end_dt_tm = cnvtdatetime(sysdate)
 SET prequest->clin_event[1].record_status_cd = active_cd
 IF (( $14=0))
  SET prequest->clin_event[1].result_status_cd = authverified_cd
 ELSEIF (( $14=1))
 ...
 SET prequest->clin_event[1].subtable_bit_map = 1
 SET prequest->clin_event[1].updt_dt_tm = cnvtdatetime(sysdate)
 SET prequest->clin_event[1].updt_dt_tm_ind = 1
 SET prequest->clin_event[1].updt_id =  $5
 SET prequest->clin_event[1].updt_cnt = 1
 SET prequest->clin_event[1].updt_task = 3202004
 SET prequest->clin_event[1].updt_task_ind = 1
 SET prequest->clin_event[1].collating_seq = col_seq
 SET prequest->clin_event[1].order_id =  $8
 IF (( $13=564029427))
  SET prequest->clin_event[1].entry_mode_cd = dynamicdocumentation_cd
 ELSE
  SET prequest->clin_event[1].entry_mode_cd = undefined_cd
 ENDIF
 ...
 SET prequest->clin_event[1].blob_result[1].storage_cd = longblob_cd
 SET prequest->clin_event[1].blob_result[1].format_cd = uar_get_code_by("MEANING",23, $13)
 ...
 SET stat = alterlist(prequest->clin_event[1].blob_result.blob,1)
 SET prequest->clin_event[1].blob_result[1].blob[1].compression_cd = ocfcompression_cd
 SET prequest->clin_event[1].blob_result[1].blob[1].blob_contents = t_blob
 SET prequest->clin_event[1].blob_result[1].blob[1].blob_length = textlen(t_blob)
 SET stat = alterlist(prequest->clin_event[1].event_prsnl_list,3)
 SET prequest->clin_event[1].event_prsnl_list[1].action_prsnl_id =  $5
 SET prequest->clin_event[1].event_prsnl_list[1].action_type_cd = perform_cd
 SET prequest->clin_event[1].event_prsnl_list[1].action_dt_tm = action_dt_tm
 SET prequest->clin_event[1].event_prsnl_list[1].action_status_cd = completed_cd
 SET prequest->clin_event[1].event_prsnl_list[1].updt_id =  $5
 SET prequest->clin_event[1].event_prsnl_list[2].action_prsnl_id =  $5
 SET prequest->clin_event[1].event_prsnl_list[2].action_type_cd = verify_cd
 SET prequest->clin_event[1].event_prsnl_list[2].action_dt_tm = action_dt_tm
 SET prequest->clin_event[1].event_prsnl_list[2].action_status_cd = completed_cd
 SET prequest->clin_event[1].event_prsnl_list[2].updt_id =  $5
 SET prequest->clin_event[1].event_prsnl_list[3].action_prsnl_id =  $5
 SET prequest->clin_event[1].event_prsnl_list[3].action_type_cd = sign_cd
 SET prequest->clin_event[1].event_prsnl_list[3].action_dt_tm = action_dt_tm
 IF (( $14=0))
  SET prequest->clin_event[1].event_prsnl_list[3].action_status_cd = completed_cd
 ELSEIF (( $14=1))
  SET prequest->clin_event[1].event_prsnl_list[3].action_status_cd = pending_cd
 ENDIF
 SET prequest->clin_event[1].event_prsnl_list[3].updt_id =  $5
 FREE RECORD preply
 SET stat = tdbexecute(3200000,3202004,1000012,"REC",prequest,
  "REC",preply)
#exit_script
 IF (( $10=1))
  CALL echojson(preply, $1)
 ENDIF
 IF (( $10 > 1))
  IF (( $9 !=  $10))
   SET preply->status = concat("Successfully Sent Part ",trim(cnvtstring( $9))," of ",trim(cnvtstring
     ( $10)))
   CALL echojson(preply, $1)
  ENDIF
  IF (( $9= $10))
