CREATE PROGRAM cclocdbkreplace:dba
 SET interactive = validate(reply->ops_event,"ZZZ")
 IF (interactive="ZZZ")
  CALL echo("*****************************************************************")
  CALL echo("*** ERROR - cclocdbkreplace was used by Installation Manager. ***")
 ...
 ELSE
  ...
  CALL uar_sysevent(hsys,0,"CCLOCDBkReplace",nullterm(trim(reply->ops_event)))
