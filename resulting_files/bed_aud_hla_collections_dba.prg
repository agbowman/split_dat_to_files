CREATE PROGRAM bed_aud_hla_collections:dba
 ...
 DECLARE hla = f8 WITH protect, constant(uar_get_code_by("MEANING",106,"HLA"))
 ...
 IF (cnt > 0)
  ...
  IF ((request->skip_volume_check_ind=0))
   ...
   IF ((reply->high_volume_flag IN (1, 2)))
    SET reply->output_filename = build("hla_collections_audit.csv")
