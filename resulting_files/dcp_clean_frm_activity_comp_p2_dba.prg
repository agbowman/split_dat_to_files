CREATE PROGRAM dcp_clean_frm_activity_comp_p2:dba
 ...
 SET ms_info_domain_nm = "DELETING DUPS ON DCP_FORMS_ACTIVITY_COMP TABLE"
 SET ms_range = "DFAC DELETE RANGE 4 CAT 5"
 SET ms_max_name_p = "MAX DCP_FORMS_ACTIVITY_ID EVALUATED"
 SET ms_child_script = "dcp_clean_frm_activity_comp_cc"
 SET mn_num_children = 3
 SELECT INTO "nl:"
  max_val = max(dfac.dcp_forms_activity_comp_id)
