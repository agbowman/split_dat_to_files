CREATE PROGRAM bhs_prax_get_sticky_note_ls
 ...
 SELECT INTO value(moutputdevice)
  ...
  PLAN (s
   WHERE parser(where_params)
    AND s.updt_dt_tm BETWEEN cnvtdatetime(cnvtdate2(substring(1,8,begindate),"YYYYMMDD"),cnvttime2(
     substring(9,4,begindate),"HHMM")) AND cnvtdatetime(cnvtdate2(substring(1,8,enddate),"YYYYMMDD"),
