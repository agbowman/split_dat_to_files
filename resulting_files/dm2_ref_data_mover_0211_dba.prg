CREATE PROGRAM dm2_ref_data_mover_0211:dba
 ...
 DECLARE bad_species_cd = f8 WITH constant(30722.0)
 SET new_species_cd = "0"
 SET cust_tab_name = dm2_ref_data_doc->tbl_qual[temp_tbl_cnt].table_name
 SET from_species_cd = get_value(cust_tab_name,"SPECIES_CD","FROM")
 SET dm2_ref_data_doc->tbl_qual[temp_tbl_cnt].version_type = "ALG1"
 IF ((dm2_ref_data_reply->error_ind=1))
  GO TO exit_0211
 ENDIF
 IF (cnvtreal(from_species_cd)=bad_species_cd)
  CALL put_value(cust_tab_name,"SPECIES_CD",cnvtstring(bad_species_cd))
 ELSE
  SET new_species_cd = get_value(cust_tab_name,"SPECIES_CD","TO")
  IF ((dm2_ref_data_reply->error_ind=1))
   GO TO exit_0211
  ENDIF
 ENDIF
