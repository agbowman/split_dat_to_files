CREATE PROGRAM dm_install_schema3:dba
 ...
 SUBROUTINE dis_get_cur_schema(gcs_dummy)
   ...
   EXECUTE dm_get_current_schema3
 ...
 SUBROUTINE dis_get_sizing_data(dis_report_seq)
   IF (schema_diff=1)
    ...
    EXECUTE dm_get_sizing_data3 dis_report_seq
