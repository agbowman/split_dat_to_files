CREATE PROGRAM carenet_chk_omf_pv_view:dba
...
#exit_script
 ...
 ELSE
  ...
  SET readme_data->message = concat("CARENET_OMF_PV_VIEW: Expected ",trim(cnvtstring(v_expected_count
