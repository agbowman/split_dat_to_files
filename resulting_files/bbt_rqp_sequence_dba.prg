CREATE PROGRAM bbt_rqp_sequence:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "BBT_RQP_SEQUENCE"
 ...
 SET nullstr = "                                                  "
 SET dm_dcp_chg_seq->low_seq_request_number = 265043
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 951060.0
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_BB_BILLING_TRANS"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 225048
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 120210.0
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_BB_TRANS_TO_EVENT"
 ...
 SET dm_dcp_chg_seq->low_seq_request_number = 225064
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 951060.0
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_BB_BILLING_RETURN"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 225064
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 120210.0
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_BB_RETURN_TO_EVENT"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE dm_rqp_change_sequence
 SET dm_dcp_chg_seq->low_seq_request_number = 225070
 ...
 SET dm_dcp_chg_seq->high_seq_request_number = 225070
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 951060.0
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_BB_BILLING_TESTS"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE dm_rqp_change_sequence
 SET dm_dcp_chg_seq->low_seq_request_number = 225070
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 951060.0
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_BB_BILLING_TESTS"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 225070
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 120210.0
 ...
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_PLM_BB_VERIF_EVNT"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE dm_rqp_change_sequence
 SET dm_dcp_chg_seq->low_seq_request_number = 225070
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 0.0
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_PLM_BB_VERIF_EVNT"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 225070
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 2221.0
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_CSM_BB_225070"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 1037553
 SET dm_dcp_chg_seq->high_seq_service = "EKS_ASYNCH_02"
 EXECUTE dm_rqp_change_sequence
 SET dm_dcp_chg_seq->low_seq_request_number = 225193
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 120210.0
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_GL_TO_EVENT"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 225193
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 36010.0
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_GL_TO_EXPEDITE"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE dm_rqp_change_sequence
 SET dm_dcp_chg_seq->low_seq_request_number = 225210
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 951060.0
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_BB_BILLING_TRANS"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 225210
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 120210.0
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_BB_TRANS_TO_EVENT"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
