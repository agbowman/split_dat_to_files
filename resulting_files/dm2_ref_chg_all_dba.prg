CREATE PROGRAM dm2_ref_chg_all:dba
 ...
 SUBROUTINE dir_get_admin_db_link(dgadl_report_fail_ind,dgadl_admin_db_link,dgadl_fail_ind)
   ...
   RETURN(1)
 END ;Subroutine
 CALL check_logfile("dm2_ref_chg_all",".log","DM2_REF_CHG_ALL LOGFILE")
 SET dm_err->eproc = "Beginning dm2_ref_chg_all"
 CALL disp_msg(" ",dm_err->logfile,0)
 EXECUTE dm2_ref_chg_tbl "*"
#exit_program
 SET dm_err->eproc = "...Ending dm2_ref_chg_all"
 CALL final_disp_msg("dm2_ref_chg_all")
END GO
