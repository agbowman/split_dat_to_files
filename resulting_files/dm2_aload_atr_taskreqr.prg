CREATE PROGRAM dm2_aload_atr_taskreqr
 ...
 SUBROUTINE dac_load_cload(lc_pkg_in)
   ...
   ENDIF
 END ;Subroutine
 IF (check_logfile("dm2_aload_taskreqr",".log","dm2_aload_atr_taskreqr")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_aload_atr_taskreqr"
 CALL disp_msg(" ",dm_err->logfile,0)
 DECLARE dtskr_cnt = i4 WITH protect, noconstant(0)
 DECLARE dtskr_str = vc WITH protect, noconstant("")
 IF (dac_pop_coldic_rec("DM_OCD_TASK_REQ_R")=0)
  GO TO exit_program
 ENDIF
...
#exit_program
 IF ((dm_err->err_ind=0))
  SET dm_err->eproc = "dm2_aload_atr_taskreqr completed"
 ENDIF
 CALL final_disp_msg("dm2_aload_atr_taskreqr")
END GO
