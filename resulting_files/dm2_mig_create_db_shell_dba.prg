CREATE PROGRAM dm2_mig_create_db_shell:dba
 ...
 IF (check_logfile(dmir_lf_name,".log","Starting dm2_mig_create_db_shell.")=0)
  CALL disp_msg(dm_err->emsg,dm_err->logfile,dm_err->err_ind)
  GO TO exit_program
 ENDIF
...
#exit_program
 SET dm_err->eproc = "Finished executing dm2_mig_create_db_shell."
