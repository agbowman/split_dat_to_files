CREATE PROGRAM bed_ens_mos_ip_sentences:dba
 FREE SET reply
 RECORD reply(
   1 sentences[*]
     2 sentence_id = f8
 ...
 FOR (x = 1 TO req_cnt)
   ...
   IF ((request->sentences[x].ext_identifier="MUL.IP*"))
 ...
 UPDATE  FROM order_sentence o,
  ...
  SET o.order_sentence_display_line = request->sentences[d.seq].display, o.oe_format_id = request->
   ...
   o.updt_cnt = (o.updt_cnt+ 1), o.usage_flag = 1, o.order_encntr_group_cd = request->sentences[d.seq
   ...
   synonym_id,
   o.parent_entity2_name = "", o.parent_entity2_id = 0, o.external_identifier = request->sentences[d
   .seq].ext_identifier
  PLAN (d
