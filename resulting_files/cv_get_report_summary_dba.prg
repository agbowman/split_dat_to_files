CREATE PROGRAM cv_get_report_summary:dba
 IF (validate(stat)=0)
 ...
 SELECT INTO "NL:"
  ...
  DETAIL
   req_summary->scd_story_id = s.scd_story_id
  WITH nocounter, maxqual(s,1)
 ;end select
 IF ((req_summary->scd_story_id=0.0))
  SET reply->status_data.subeventstatus[1].operationname = "SELECT"
  SET reply->status_data.subeventstatus[1].operationstatus = "F"
  SET reply->status_data.subeventstatus[1].targetobjectname = "SCD_STORY"
  SET reply->status_data.subeventstatus[1].targetobjectvalue = "SCD_STORY_ID"
  CALL cv_log_msg(cv_audit,build("Subevent:SELECT=F:::SCD_STORY_ID"))
  GO TO exit_script
 ENDIF
 EXECUTE cps_get_scd_note_summary  WITH replace("REQUEST","REQ_SUMMARY")
 SET reply->status_data.status = "S"
#exit_script
 CALL cv_log_msg_post("001 MH9140 09/14/05")
END GO
