CREATE PROGRAM ags_exe_org_load:dba
 CALL echo("***")
 CALL echo("***   BEG AGS_EXE_ORG_LOAD")
 CALL echo("***")
 ...
 DECLARE sstatus_file_name = vc WITH public, noconstant(concat("ags_exe_org_load_",format(
 ...
 SET log->qual[log->qual_knt].smsg = "BEG >> AGS_EXE_ORG_LOAD"
 CALL echo("***")
