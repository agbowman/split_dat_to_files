CREATE PROGRAM dcp_get_ega_multiplegestation1:dba
 ...
 DECLARE populatelabelrequest(hrequest=i4,dlabelid=f8) = null WITH protect
 DECLARE getresultsbylabelid(null) = null WITH protect
 DECLARE getreplydata(hreply=i4,llabelidx=i4) = null WITH protect
 ...
 SUBROUTINE geteventsetsbyconcept(null)
   ...
   ENDIF
 END ;Subroutine
 SUBROUTINE populatelabelrequest(hrequest,dlabelid)
   ...
   SET nstat = uar_srvsetdate(hrequest,"anchor_date",cnvtdatetime(curdate,curtime3))
 ...
 SUBROUTINE getresultsbylabelid(null)
   ...
   ENDFOR
 END ;Subroutine
 SUBROUTINE getreplydata(hreply,llabelidx)
...
#script_end
 ...
 ENDIF
 CALL echo("Script was last modified on: 003 07/01/2020")
