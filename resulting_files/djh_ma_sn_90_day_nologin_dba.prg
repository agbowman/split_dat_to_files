CREATE PROGRAM djh_ma_sn_90_day_nologin:dba
 PROMPT
 ...
 IF (email_ind=1)
  ...
  SET filename_out = concat(format(curdate,"YYYY-MM-DD;;D"),"-SN.csv")
  DECLARE subject_line = vc
  SET subject_line = concat(curprog," V1 - SN Prefix CIS Acnts InActive 90 days")
