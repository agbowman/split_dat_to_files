CREATE PROGRAM dm2_mig_validate_target_pks
 ...
 SUBROUTINE dir_get_admin_db_link(dgadl_report_fail_ind,dgadl_admin_db_link,dgadl_fail_ind)
   ...
   RETURN(1)
 END ;Subroutine
 IF (check_logfile("dm2_mig_vtpk",".log","dm2_mig_validate_target_pks")=0)
  GO TO exit_script
 ENDIF
 IF (dmr_prompt_retrieve_mig_data(0,0,1,0)=0)
  GO TO exit_script
 ENDIF
 IF (dmr_issue_summary_screen(0,1,"")=0)
  GO TO exit_script
 ENDIF
 IF ((((dmr_mig_data->cur_db_type != "TARGET")) OR (currdbuser != "V500")) )
  ...
  ENDIF
 ENDIF
 EXECUTE dm2_validate_pks "DM2NOTSET", "DM2NOTSET", "MIGRATION TARGET"
 IF ((dm_err->err_ind=1))
  GO TO exit_script
 ENDIF
 GO TO exit_script
#exit_script
 SET dm_err->eproc = "dm2_mig_validate_target_pks completed"
 CALL final_disp_msg("dm2_mig_vtpk")
END GO
