CREATE PROGRAM acm_add_encntr_info_hist:dba
 ...
 INSERT  FROM encntr_info_hist eih,
  ...
  SET eih.encntr_info_hist_id = seq(encounter_seq,nextval), eih.transaction_dt_tm = cnvtdatetime(
    acm_request->encntr_info_qual[xref->add[d.seq].idx].transaction_dt_tm), eih.encntr_info_id =
   acm_request->encntr_info_qual[xref->add[d.seq].idx].encntr_info_id,
   eih.pm_hist_tracking_id = acm_request->encntr_info_qual[xref->add[d.seq].idx].pm_hist_tracking_id,
   eih.encntr_id = acm_request->encntr_info_qual[xref->add[d.seq].idx].encntr_id, eih.info_type_cd =
   acm_request->encntr_info_qual[xref->add[d.seq].idx].info_type_cd,
   eih.info_sub_type_cd = acm_request->encntr_info_qual[xref->add[d.seq].idx].info_sub_type_cd, eih
   .chartable_ind = acm_request->encntr_info_qual[xref->add[d.seq].idx].chartable_ind, eih
   .value_dt_tm = cnvtdatetime(acm_request->encntr_info_qual[xref->add[d.seq].idx].value_dt_tm),
   eih.value_numeric = acm_request->encntr_info_qual[xref->add[d.seq].idx].value_numeric, eih
   .value_long_text_id = acm_request->encntr_info_qual[xref->add[d.seq].idx].long_text_id, eih
   .internal_seq = acm_request->encntr_info_qual[xref->add[d.seq].idx].internal_seq,
   eih.priority_seq = acm_request->encntr_info_qual[xref->add[d.seq].idx].priority_seq, eih
   .tracking_bit = tracking_bit, eih.change_bit = chgbit,
