CREATE PROGRAM dcp_elh_cleanup_tm:dba
 ...
 SUBROUTINE setreadmetimings(null)
   ...
   RETURN(1)
 END ;Subroutine
 IF (fetchandsetdrivertable(4164)=0)
  GO TO exit_script
 ENDIF
 CALL setrangeincrement(250000)
 CALL settimeperbatch(0.006553)
 CALL addtimedreadme(4165)
 CALL addtimedreadme(4166)
 CALL addtimedreadme(4167)
