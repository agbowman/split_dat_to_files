CREATE PROGRAM ecf_rdm_dsm5_tr_ca_xmap:dba
 ...
 SET kia_tbl_desc = "DSM5-TR-CA XMAP"
 SET kia_short_desc = "DSM5-TR-CA"
 SET kia_rdm_log_name = "ecf_rdm_dsm5_tr_ca_xmap.log"
 SET kia_rdm_nbr = 11736
 SET kia_rdm_vocab_mean = "DSM5-TR-CA"
 SET readme_data->status = "F"
 ...
 EXECUTE kia_dm_dbimport "cer_install:dsm5_tr_ca_version.csv", "kia_get_rdm_vars", 100,
 0
 CALL kia_chk_script_failure("KIA_GET_RDM_VARS")
 SET start_time_var = cnvtdatetime(curdate,curtime3)
 CALL log_sub(concat("ECF_RDM_DSM5_TR_CA_XMAP Begin> ",format(cnvtdatetime(curdate,curtime3),
