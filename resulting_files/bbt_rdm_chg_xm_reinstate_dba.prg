...
#start_script
 ...
 UPDATE  FROM question q
  SET q.question = "Enter the number of days or hours a reinstated crossmatch should remain active.",
   q.updt_dt_tm = cnvtdatetime(curdate,curtime3), q.updt_id = 0,
   q.updt_cnt = (q.updt_cnt+ 1), q.updt_task = 0, q.updt_applctx = 0
  WHERE q.question_cd=dquestioncd
  WITH nocounter
 ;end update
