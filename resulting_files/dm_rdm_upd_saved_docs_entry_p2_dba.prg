CREATE PROGRAM dm_rdm_upd_saved_docs_entry_p2:dba
 ...
 IF (((error(ms_errmsg,0) != 0) OR (task_activity_cd_saved_doc <= 0)) )
  ...
  GO TO exit_program
 ENDIF
 SET ms_info_domain_nm = "DM_RDM_UPD_SAVED_DOCS_ENTRY_MODE_CODE"
 SET ms_range = "FINAL RANGE"
 SET ms_max_name_p = "MAX TASK_ACTIVITY_ID EVALUATED"
 SET ms_child_script = "dm_rdm_upd_saved_docs_entry_cc"
