CREATE PROGRAM bed_aud_ap_orc_dta:dba
 ...
 SET reply->collist[7].header_text = "Sequence"
 SET reply->collist[7].data_type = 1
 SET reply->collist[7].hide_ind = 0
 SET reply->collist[8].header_text = "Prompt"
 SET reply->collist[8].data_type = 1
 SET reply->collist[8].hide_ind = 0
 SET reply->collist[9].header_text = "Post Prompt"
 SET reply->collist[9].data_type = 1
 SET reply->collist[9].hide_ind = 0
 SET reply->collist[10].header_text = "Default Result Type"
 SET reply->collist[10].data_type = 1
 SET reply->collist[10].hide_ind = 0
 SET reply->collist[11].header_text = "Subactivity Type"
 ...
 SET reply->collist[13].header_text = "task_assay_cd"
 ...
 FOR (x = 1 TO temp->ocnt)
   ...
   SET reply->rowlist[row_nbr].celllist[11].string_value = temp->oqual[x].activity_subtype
   SET reply->rowlist[row_nbr].celllist[12].double_value = temp->oqual[x].catalog_cd
   FOR (y = 1 TO temp->oqual[x].dcnt)
     ...
     SET reply->rowlist[row_nbr].celllist[6].string_value = temp->oqual[x].dqual[y].pending
     SET reply->rowlist[row_nbr].celllist[7].string_value = temp->oqual[x].dqual[y].sequence
     SET reply->rowlist[row_nbr].celllist[8].string_value = temp->oqual[x].dqual[y].item
     SET reply->rowlist[row_nbr].celllist[9].string_value = temp->oqual[x].dqual[y].post_prompt
     SET reply->rowlist[row_nbr].celllist[10].string_value = temp->oqual[x].dqual[y].result_type
     SET reply->rowlist[row_nbr].celllist[3].string_value = temp->oqual[x].dept_name
     SET reply->rowlist[row_nbr].celllist[11].string_value = temp->oqual[x].activity_subtype
     SET reply->rowlist[row_nbr].celllist[12].double_value = temp->oqual[x].catalog_cd
     SET reply->rowlist[row_nbr].celllist[13].double_value = temp->oqual[x].dqual[y].dta_cd
   ENDFOR
 ENDFOR
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("ap_orc_dta_audit.csv")
 ENDIF
