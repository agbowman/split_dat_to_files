CREATE PROGRAM dd_set_feature_flag_diffview:dba
 ...
 END ;Subroutine
 SET readme_data->status = "F"
 SET readme_data->message = concat("Error: Fail starting script dd_set_feature_flag_diffview:",
  error_msg)
 CALL setfeatureflag("DYNDOC_DIFFVIEW",onflag)
