CREATE PROGRAM cdi_rpt_scan_del_by_user:dba
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "Layout Program" = "cdi_rpt_scan_del_by_user_lyt",
  "Begin Date" = "CURDATE",
  "End Date" = "CURDATE"
 ...
 DECLARE strlayoutprogram = vc WITH noconstant("cdi_rpt_scan_del_by_user_lyt")
