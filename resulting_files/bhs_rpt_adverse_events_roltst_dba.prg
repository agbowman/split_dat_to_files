CREATE PROGRAM bhs_rpt_adverse_events_roltst:dba
 PROMPT
 ...
 SELECT INTO "nl:"
  ...
  PLAN (ce
   ...
   mf_cs72_ph_cd, mf_cs72_deliverytype_cd))
   JOIN (e
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   IF (ce.event_cd=mf_cs72_deliverycomplications_cd)
    IF (trim(n.source_string,3)="Uterine rupture")
     IF ((m_enc->qual[ml_idx2].n_uterine_rupture_ind=0))
      m_enc->qual[ml_idx2].n_uterine_rupture_ind = 1, m_enc->qual[ml_idx2].l_qual_cnt = (m_enc->qual[
      ml_idx2].l_qual_cnt+ 1)
     ENDIF
    ENDIF
    IF (trim(n.source_string,3)="Suspected Intraamniotic infection")
     IF ((m_enc->qual[ml_idx2].n_inraamniotic_infection_ind=0))
      m_enc->qual[ml_idx2].n_inraamniotic_infection_ind = 1, m_enc->qual[ml_idx2].l_qual_cnt = (m_enc
    ...
    IF (isnumeric(ce.result_val) > 0)
     IF (cnvtreal(ce.result_val) > 1000.0)
      IF ((m_enc->qual[ml_idx2].n_postpartum_hemorrhage_ind=0))
       m_enc->qual[ml_idx2].n_postpartum_hemorrhage_ind = 1, m_enc->qual[ml_idx2].l_qual_cnt = (m_enc
       ->qual[ml_idx2].l_qual_cnt+ 1)
      ENDIF
     ENDIF
    ENDIF
   ELSEIF (ce.event_cd=mf_cs72_groupbstreptrans_cd)
    IF (trim(cnvtupper(ce.result_val),3)="POSITIVE")
     IF ((m_enc->qual[ml_idx2].n_antibiotic_prophylaxis_ind=0)
      ...
      m_enc->qual[ml_idx2].n_antibiotic_prophylaxis_ind = 1, m_enc->qual[ml_idx2].l_qual_cnt = (m_enc
      ->qual[ml_idx2].l_qual_cnt+ 1)
     ENDIF
    ENDIF
   ELSEIF (ce.event_cd=mf_cs72_csectionpriority_cd)
    IF (trim(n.source_string,3)="Code White")
     IF ((m_enc->qual[ml_idx2].n_csec_code_white_ind=0))
      m_enc->qual[ml_idx2].n_csec_code_white_ind = 1, m_enc->qual[ml_idx2].l_qual_cnt = (m_enc->qual[
      ml_idx2].l_qual_cnt+ 1)
     ENDIF
    ENDIF
   ...
   ELSEIF (ce.event_cd=mf_cs72_operativedelivery_cd)
    IF (trim(n.source_string,3)="Forceps")
     IF ((m_enc->qual[ml_idx2].n_forcep_delivery_ind=0))
      m_enc->qual[ml_idx2].n_forcep_delivery_ind = 1, m_enc->qual[ml_idx2].l_qual_cnt = (m_enc->qual[
      ml_idx2].l_qual_cnt+ 1)
     ENDIF
    ENDIF
   ...
   ELSEIF (ce.event_cd IN (mf_cs72_neonatecomplications1_cd, mf_cs72_neonatecomplications2_cd))
    IF (trim(n.source_string,3) IN ("Abrasion", "Bruising", "Cephalohematoma", "Deformity, suspected"
    ))
     IF ((m_enc->qual[ml_idx2].n_traumatic_birth_ind=0))
      m_enc->qual[ml_idx2].n_traumatic_birth_ind = 1, m_enc->qual[ml_idx2].l_qual_cnt = (m_enc->qual[
      ml_idx2].l_qual_cnt+ 1)
     ENDIF
    ENDIF
   ELSEIF (ce.event_cd IN (mf_cs72_transferredto1_cd, mf_cs72_transferredto2_cd))
    IF (trim(n.source_string,3)="NICU")
     IF ((m_enc->qual[ml_idx2].n_unexpected_nicu_ind=0))
      m_enc->qual[ml_idx2].n_unexpected_nicu_ind = 1, m_enc->qual[ml_idx2].l_qual_cnt = (m_enc->qual[
      ml_idx2].l_qual_cnt+ 1)
     ENDIF
    ENDIF
    ...
    IF (isnumeric(ce.result_val) > 0)
     IF (cnvtreal(ce.result_val) < 7.0)
      IF ((m_enc->qual[ml_idx2].n_cord_ph_ind=0))
       m_enc->qual[ml_idx2].n_cord_ph_ind = 1, m_enc->qual[ml_idx2].l_qual_cnt = (m_enc->qual[ml_idx2
       ].l_qual_cnt+ 1)
      ENDIF
     ENDIF
    ENDIF
 ...
 FOR (ml_idx1 = 1 TO m_enc->l_cnt)
   IF ((m_enc->qual[ml_idx1].l_dyn_cnt > 0)
    ...
    IF ((m_enc->qual[ml_idx1].f_decease_date > 0.0))
     ...
     SET t_rec->l_tot_mat_death = (t_rec->l_tot_mat_death+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_uterine_rupture_ind=1))
     ...
     SET t_rec->l_tot_uterine_rupture = (t_rec->l_tot_uterine_rupture+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_icu_ind=1))
     ...
     SET t_rec->l_tot_icu_admission = (t_rec->l_tot_icu_admission+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_surg_proc_ind=1))
     ...
     SET t_rec->l_tot_return_to_or = (t_rec->l_tot_return_to_or+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_transfusion_4_unit_ind=1))
     ...
     SET t_rec->l_tot_transfusion_of_4_units = (t_rec->l_tot_transfusion_of_4_units+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_hysterectomy_ind=1))
     ...
     SET t_rec->l_tot_hysterectomy = (t_rec->l_tot_hysterectomy+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_postpartum_hemorrhage_ind=1))
     ...
     SET t_rec->l_tot_postpartum_hemorrhage = (t_rec->l_tot_postpartum_hemorrhage+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_eclampsia_ind=1))
     ...
     SET t_rec->l_tot_eclampsia = (t_rec->l_tot_eclampsia+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_pulmedema_ind=1))
     ...
     SET t_rec->l_tot_pulmonary_edema = (t_rec->l_tot_pulmonary_edema+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_dvtpe_ind=1))
     ...
     SET t_rec->l_tot_dvt = (t_rec->l_tot_dvt+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_magnesium_tox_ind=1))
     ...
     SET m_enc->qual[ml_idx1].s_qual_str = concat(m_enc->qual[ml_idx1].s_qual_str,
      "Magnesium Toxicity")
     SET t_rec->l_tot_magnesium_tox = (t_rec->l_tot_magnesium_tox+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_antibiotic_prophylaxis_ind=1))
     ...
     SET t_rec->l_tot_fail_to_give_antibiotic = (t_rec->l_tot_fail_to_give_antibiotic+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_code_blue_ind=1))
     ...
     SET t_rec->l_tot_code_blue = (t_rec->l_tot_code_blue+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_inraamniotic_infection_ind=1))
     ...
     SET t_rec->l_tot_intraamniotic_infection = (t_rec->l_tot_intraamniotic_infection+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_csec_code_white_ind=1))
     ...
     SET t_rec->l_tot_code_white = (t_rec->l_tot_code_white+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_shoulder_dystocia_ind=1))
     ...
     SET t_rec->l_tot_shoulder_dystocia = (t_rec->l_tot_shoulder_dystocia+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_forcep_delivery_ind=1))
     ...
     SET t_rec->l_tot_forcep_delivery = (t_rec->l_tot_forcep_delivery+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_vacuum_deliver_ind=1))
     ...
     SET t_rec->l_tot_vacuum_delivery = (t_rec->l_tot_vacuum_delivery+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_failed_tolac_ind=1))
     ...
     SET t_rec->l_tot_failed_tolac = (t_rec->l_tot_failed_tolac+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_singleton_ind=1))
     ...
     SET t_rec->l_tot_breech_delivery = (t_rec->l_tot_breech_delivery+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_neonatal_death_ind=1))
     ...
     SET t_rec->l_tot_intrapartum_neonatal_death = (t_rec->l_tot_intrapartum_neonatal_death+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_traumatic_birth_ind=1))
     ...
     SET t_rec->l_tot_traumatic_birth_injury = (t_rec->l_tot_traumatic_birth_injury+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_unexpected_nicu_ind=1))
     ...
     SET t_rec->l_tot_unexpected_nicu = (t_rec->l_tot_unexpected_nicu+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_term_apgar_ind=1))
     ...
     SET t_rec->l_tot_term_apgr_lt7_at_5min = (t_rec->l_tot_term_apgr_lt7_at_5min+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_cord_ph_ind=1))
     ...
     SET t_rec->l_tot_ph_lt7 = (t_rec->l_tot_ph_lt7+ 1)
    ENDIF
    IF ((m_enc->qual[ml_idx1].n_nicu_code_c_ind=1))
     ...
     SET t_rec->l_tot_nicu_code_c = (t_rec->l_tot_nicu_code_c+ 1)
    ENDIF
   ENDIF
 ENDFOR
 CALL echorecord(m_enc)
 IF (ms_outdev="OPS")
  ...
  SET ms_tmp = concat("Adverse Events Rollup Report: ",format(cnvtdatetime(curdate,curtime3),
    "YYYYMMDDHHMMSS;;q"))
