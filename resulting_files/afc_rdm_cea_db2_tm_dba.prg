CREATE PROGRAM afc_rdm_cea_db2_tm:dba
 ...
 SUBROUTINE setreadmetimings(null)
   ...
   RETURN(1)
 END ;Subroutine
 IF (fetchandsetdrivertable(4033)=0)
  GO TO exit_script
 ENDIF
 CALL setrangeincrement(250000)
 CALL settimeperbatch(0.643635)
 CALL addtimedreadme(4034)
 CALL addtimedreadme(4035)
 CALL addtimedreadme(4036)
