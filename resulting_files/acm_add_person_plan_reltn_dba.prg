CREATE PROGRAM acm_add_person_plan_reltn:dba
 ...
 FOR (index = 1 TO xref->add_cnt)
   IF ((acm_request->person_plan_reltn_qual[xref->add[index].idx].person_plan_reltn_id <= 0.0))
    SELECT INTO "nl:"
     nextseqnum = seq(person_seq,nextval)
     FROM dual
     DETAIL
      acm_request->person_plan_reltn_qual[xref->add[index].idx].person_plan_reltn_id = cnvtreal(
       nextseqnum), reply->person_plan_reltn_qual[xref->add[index].idx].person_plan_reltn_id =
      cnvtreal(nextseqnum)
     WITH nocounter, format
    ;end select
    IF (curqual=0)
     SET reply->person_plan_reltn_qual[xref->add[index].idx].status = gen_nbr_error
     SET failed = gen_nbr_error
     GO TO exit_script
    ENDIF
   ELSE
    SET reply->person_plan_reltn_qual[xref->add[index].idx].person_plan_reltn_id = acm_request->
    person_plan_reltn_qual[xref->add[index].idx].person_plan_reltn_id
   ENDIF
   SET reply->person_plan_reltn_qual[xref->add[index].idx].status = 0
   IF ((acm_request->person_plan_reltn_qual[xref->add[index].idx].beg_effective_dt_tm <= 0))
    SET acm_request->person_plan_reltn_qual[xref->add[index].idx].beg_effective_dt_tm = cnvtdatetime(
     curdate,curtime3)
   ENDIF
   IF ((acm_request->person_plan_reltn_qual[xref->add[index].idx].end_effective_dt_tm <= 0))
    SET acm_request->person_plan_reltn_qual[xref->add[index].idx].end_effective_dt_tm = cnvtdatetime(
     "31-DEC-2100 00:00:00.00")
   ENDIF
 ENDFOR
 INSERT  FROM (dummyt d  WITH seq = value(xref->add_cnt)),
   person_plan_reltn p
  SET p.person_plan_reltn_id = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].
   person_plan_reltn_id, p.balance_type_cd = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx
   ].balance_type_cd, p.beg_effective_dt_tm = cnvtdatetime(acm_request->person_plan_reltn_qual[xref->
    add[d.seq].idx].beg_effective_dt_tm),
   p.card_category_cd = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].card_category_cd, p
   .card_issue_nbr = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].card_issue_nbr, p
   .contributor_system_cd =
   IF ((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].contributor_system_cd > 0.0))
    acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].contributor_system_cd
   ELSE pmhc_contributory_system_cd
   ENDIF
   ,
   p.coverage_comments_long_text_id = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].
   coverage_comments_long_text_id, p.coverage_type_cd = acm_request->person_plan_reltn_qual[xref->
   add[d.seq].idx].coverage_type_cd, p.deduct_amt = acm_request->person_plan_reltn_qual[xref->add[d
   .seq].idx].deduct_amt,
   p.deduct_met_amt = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].deduct_met_amt, p
   .deduct_met_dt_tm =
   IF ((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].deduct_met_dt_tm > 0)) cnvtdatetime
    (acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].deduct_met_dt_tm)
   ELSE null
   ENDIF
   , p.denial_reason_cd = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].denial_reason_cd,
   p.end_effective_dt_tm = cnvtdatetime(acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].
    end_effective_dt_tm), p.fam_deduct_met_amt = acm_request->person_plan_reltn_qual[xref->add[d.seq]
   .idx].fam_deduct_met_amt, p.fam_deduct_met_dt_tm =
   IF ((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].fam_deduct_met_dt_tm > 0))
    cnvtdatetime(acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].fam_deduct_met_dt_tm)
   ELSE null
   ENDIF
   ,
   p.group_name = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].group_name, p.group_nbr
    = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].group_nbr, p.health_plan_id =
   IF ((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].health_plan_id > 0)) acm_request->
    person_plan_reltn_qual[xref->add[d.seq].idx].health_plan_id
   ELSE reply->health_plan_qual[acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].
    health_plan_idx].health_plan_id
   ENDIF
   ,
   p.insured_card_name = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].insured_card_name,
   p.life_rsv_daily_ded_amt = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].
   life_rsv_daily_ded_amt, p.life_rsv_daily_ded_qual_cd = acm_request->person_plan_reltn_qual[xref->
   add[d.seq].idx].life_rsv_daily_ded_qual_cd,
   p.life_rsv_days = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].life_rsv_days, p
   .life_rsv_remain_days = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].
   life_rsv_remain_days, p.max_out_pckt_amt = acm_request->person_plan_reltn_qual[xref->add[d.seq].
   idx].max_out_pckt_amt,
   p.max_out_pckt_dt_tm =
   IF ((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].max_out_pckt_dt_tm > 0))
    cnvtdatetime(acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].max_out_pckt_dt_tm)
   ELSE null
   ENDIF
   , p.member_nbr = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].member_nbr, p
   .member_person_code = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].member_person_code,
   p.organization_id = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].organization_id, p
   .person_id =
   IF ((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].person_id > 0)) acm_request->
    person_plan_reltn_qual[xref->add[d.seq].idx].person_id
   ELSE reply->person_qual[acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].person_idx].
    person_id
   ENDIF
   , p.person_org_reltn_id =
   IF ((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].person_org_reltn_id > 0))
    acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].person_org_reltn_id
   ELSE reply->person_org_reltn_qual[acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].
    person_org_reltn_idx].person_org_reltn_id
   ENDIF
   ,
   p.person_plan_r_cd = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].person_plan_r_cd, p
   .plan_type_cd = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].plan_type_cd, p
   .policy_nbr = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].policy_nbr,
   p.priority_seq = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].priority_seq, p
   .program_status_cd = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].program_status_cd,
   p.signature_on_file_cd = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].
   signature_on_file_cd,
   p.sponsor_person_org_reltn_id = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].
   sponsor_person_org_reltn_id, p.subscriber_person_id = acm_request->person_plan_reltn_qual[xref->
   add[d.seq].idx].subscriber_person_id, p.verify_dt_tm =
   IF ((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].verify_dt_tm > 0)) cnvtdatetime(
     acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].verify_dt_tm)
   ELSE null
   ENDIF
   ,
   p.verify_prsnl_id = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].verify_prsnl_id, p
   .verify_status_cd = acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].verify_status_cd, p
   .active_ind =
   IF ((((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].active_status_cd=0.0)) OR ((
   acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].active_status_cd=reqdata->
   active_status_cd))) ) 1
   ELSE 0
   ENDIF
   ,
   p.active_status_cd =
   IF ((acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].active_status_cd > 0.0))
    acm_request->person_plan_reltn_qual[xref->add[d.seq].idx].active_status_cd
  ...
  PLAN (d)
   JOIN (p)
  WITH nocounter, status(reply->person_plan_reltn_qual[xref->add[d.seq].idx].status)
 ;end insert
 FOR (index = 1 TO xref->add_cnt)
   IF ((reply->person_plan_reltn_qual[xref->add[index].idx].status=0))
