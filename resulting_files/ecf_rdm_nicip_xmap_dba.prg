CREATE PROGRAM ecf_rdm_nicip_xmap:dba
 ...
 SET kia_tbl_desc = "NICIP XMAP"
 SET kia_short_desc = "NICIP XMAP"
 SET kia_rdm_log_name = "ecf_rdm_nicip_xmap.log"
 SET kia_rdm_nbr = 10081
 ...
 CALL log_sub(concat("ecf_rdm_nicip_xmap Begin>  ",format(cnvtdatetime(curdate,curtime3),
