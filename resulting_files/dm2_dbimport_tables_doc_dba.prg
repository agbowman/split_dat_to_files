CREATE PROGRAM dm2_dbimport_tables_doc:dba
 ...
 ENDIF
 DECLARE ddtd_curqual = i4 WITH noconstant(0)
 EXECUTE dm_dbimport "cer_install:dm2_mrg_tables_doc.csv", "dm2_mrg_load_tables_doc", 1000
 IF (checkprg("DM_RMC_AUTO_VERIFY_SETUP") > 0
  ...
  SET auto_ver_request->qual[1].event_reason = "DM_TABLES_DOC change by RDDS readme"
