CREATE PROGRAM dm2_dbimport_columns_doc:dba
 ...
 ENDIF
 DECLARE ddcd_curqual = i4
 EXECUTE dm_dbimport "cer_install:dm2_mrg_columns_doc.csv", "dm2_mrg_load_columns_doc", 1000
 EXECUTE dm_readme_status
 SET dm_err->eproc = "Starting dm2_ref_data_mover_main"
 IF (check_logfile("dm2_dbimport_cols",".log","DM2_DBIMPORT_COLS LOG")=0)
  SET dm_err->err_ind = 1
 ...
 IF (checkprg("DM_RMC_AUTO_VERIFY_SETUP") > 0
  ...
  SET auto_ver_request->qual[1].event_reason = "DM_COLUMNS_DOC change by RDDS readme"
