CREATE PROGRAM acm_add_person_org_reltn:dba
 ...
 FOR (index = 1 TO xref->add_cnt)
   IF ((acm_request->person_org_reltn_qual[xref->add[index].idx].person_org_reltn_id <= 0.0))
    SELECT INTO "nl:"
     nextseqnum = seq(person_seq,nextval)
     FROM dual
     DETAIL
      acm_request->person_org_reltn_qual[xref->add[index].idx].person_org_reltn_id = cnvtreal(
       nextseqnum), reply->person_org_reltn_qual[xref->add[index].idx].person_org_reltn_id = cnvtreal
      (nextseqnum)
     WITH nocounter, format
    ;end select
    IF (curqual=0)
     SET reply->person_org_reltn_qual[xref->add[index].idx].status = gen_nbr_error
     SET failed = gen_nbr_error
     GO TO exit_script
    ENDIF
   ELSE
    SET reply->person_org_reltn_qual[xref->add[index].idx].person_org_reltn_id = acm_request->
    person_org_reltn_qual[xref->add[index].idx].person_org_reltn_id
   ENDIF
   SET reply->person_org_reltn_qual[xref->add[index].idx].status = 0
   IF ((acm_request->person_org_reltn_qual[xref->add[index].idx].beg_effective_dt_tm <= 0))
    SET acm_request->person_org_reltn_qual[xref->add[index].idx].beg_effective_dt_tm = cnvtdatetime(
     curdate,curtime3)
   ENDIF
   IF ((acm_request->person_org_reltn_qual[xref->add[index].idx].end_effective_dt_tm <= 0))
    SET acm_request->person_org_reltn_qual[xref->add[index].idx].end_effective_dt_tm = cnvtdatetime(
     "31-DEC-2100 00:00:00.00")
   ENDIF
 ENDFOR
 INSERT  FROM (dummyt d  WITH seq = value(xref->add_cnt)),
   person_org_reltn p
  SET p.person_org_reltn_id = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].
   person_org_reltn_id, p.beg_effective_dt_tm = cnvtdatetime(acm_request->person_org_reltn_qual[xref
    ->add[d.seq].idx].beg_effective_dt_tm), p.contributor_system_cd =
   IF ((acm_request->person_org_reltn_qual[xref->add[d.seq].idx].contributor_system_cd > 0.0))
    acm_request->person_org_reltn_qual[xref->add[d.seq].idx].contributor_system_cd
   ELSE pmhc_contributory_system_cd
   ENDIF
   ,
   p.empl_contact = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_contact, p
   .empl_contact_title = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_contact_title,
   p.empl_hire_dt_tm =
   IF ((acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_hire_dt_tm > 0)) cnvtdatetime(
     acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_hire_dt_tm)
   ELSE null
   ENDIF
   ,
   p.empl_occupation_cd = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_occupation_cd,
   p.empl_occupation_text = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].
   empl_occupation_text, p.empl_position = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].
   empl_position,
   p.empl_retire_dt_tm =
   IF ((acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_retire_dt_tm > 0)) cnvtdatetime
    (acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_retire_dt_tm)
   ELSE null
   ENDIF
   , p.empl_status_cd = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_status_cd, p
   .empl_term_dt_tm =
   IF ((acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_term_dt_tm > 0)) cnvtdatetime(
     acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_term_dt_tm)
   ELSE null
   ENDIF
   ,
   p.empl_title = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_title, p.empl_type_cd
    = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].empl_type_cd, p.end_effective_dt_tm =
   cnvtdatetime(acm_request->person_org_reltn_qual[xref->add[d.seq].idx].end_effective_dt_tm),
   p.free_text_ind = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].free_text_ind, p
   .ft_org_name = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].ft_org_name, p
   .internal_seq = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].internal_seq,
   p.organization_id = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].organization_id, p
   .person_id =
   IF ((acm_request->person_org_reltn_qual[xref->add[d.seq].idx].person_id > 0)) acm_request->
    person_org_reltn_qual[xref->add[d.seq].idx].person_id
   ELSE reply->person_qual[acm_request->person_org_reltn_qual[xref->add[d.seq].idx].person_idx].
    person_id
   ENDIF
   , p.person_org_alias = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].person_org_alias,
   p.person_org_nbr = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].person_org_nbr, p
   .person_org_reltn_cd = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].
   person_org_reltn_cd, p.priority_seq = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].
   priority_seq,
   p.source_identifier = acm_request->person_org_reltn_qual[xref->add[d.seq].idx].source_identifier,
   p.data_status_cd =
   IF ((acm_request->person_org_reltn_qual[xref->add[d.seq].idx].data_status_cd > 0.0)) acm_request->
    person_org_reltn_qual[xref->add[d.seq].idx].data_status_cd
   ...
   IF ((((acm_request->person_org_reltn_qual[xref->add[d.seq].idx].active_status_cd=0.0)) OR ((
   acm_request->person_org_reltn_qual[xref->add[d.seq].idx].active_status_cd=reqdata->
   active_status_cd))) ) 1
   ELSE 0
   ENDIF
   , p.active_status_cd =
   IF ((acm_request->person_org_reltn_qual[xref->add[d.seq].idx].active_status_cd > 0.0)) acm_request
    ->person_org_reltn_qual[xref->add[d.seq].idx].active_status_cd
  ...
  PLAN (d)
   JOIN (p)
  WITH nocounter, status(reply->person_org_reltn_qual[xref->add[d.seq].idx].status)
 ;end insert
 FOR (index = 1 TO xref->add_cnt)
   IF ((reply->person_org_reltn_qual[xref->add[index].idx].status=0))
