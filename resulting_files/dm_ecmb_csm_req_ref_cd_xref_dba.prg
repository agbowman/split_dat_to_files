CREATE PROGRAM dm_ecmb_csm_req_ref_cd_xref:dba
 ...
 IF ((dm_cmb_cust_script->exc_maint_ind=1))
  ...
  SET dcem_request->qual[1].child_entity = "CSM_REQ_REF_CD_XREF"
  SET dcem_request->qual[1].op_type = "COMBINE"
  SET dcem_request->qual[1].script_name = "dm_ecmb_csm_req_ref_cd_xref"
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   ENDIF
   rreclist->from_rec[v_cust_count1].from_id = frm.csm_req_id, rreclist->from_rec[v_cust_count1].
   active_ind = 1, rreclist->from_rec[v_cust_count1].active_status_cd = 0,
 ...
 SUBROUTINE upt_from(s_uf_pk_id,s_uf_to_fk_id)
   UPDATE  FROM csm_req_ref_cd_xref frm
    SET frm.updt_cnt = (frm.updt_cnt+ 1), frm.updt_id = reqinfo->updt_id, frm.updt_applctx = reqinfo
     ...
     frm.updt_task = reqinfo->updt_task, frm.updt_dt_tm = cnvtdatetime(sysdate), frm.parent_entity_id
      = s_uf_to_fk_id
    WHERE frm.csm_req_id=s_uf_pk_id
    WITH nocounter
   ;end update
   SET icombinedet += 1
   ...
   SET request->xxx_combine_det[icombinedet].entity_name = "CSM_REQ_REF_CD_XREF"
