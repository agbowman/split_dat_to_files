CREATE PROGRAM dm2_pg_time_readme:dba
 ...
 SUBROUTINE setreadmetimings(null)
   ...
   RETURN(1)
 END ;Subroutine
 IF (setdrivertable("ENCNTR_PRSNL_RELTN")=0)
  GO TO exit_script
 ENDIF
 CALL setrangeincrement(250000)
 CALL settimeperbatch(1.846107)
 CALL addtimedreadme(3695)
 CALL addtimedreadme(3696)
 CALL addtimedreadme(3697)
