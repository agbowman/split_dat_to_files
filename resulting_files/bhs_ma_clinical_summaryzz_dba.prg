CREATE PROGRAM bhs_ma_clinical_summaryzz:dba
 ...
 IF ((request->visit_cnt > 0))
  ...
  SELECT DISTINCT INTO "nl:"
   ...
   PLAN (dd)
    JOIN (c
    WHERE (request->visit[dd.seq].encntr_id=c.encntr_id)
  ...
  SELECT INTO request->output_device
   ...
   HEAD PAGE
    ...
    curtime,
    CALL print(calcpos(xcol5,yrow1)), "{b}Clinical Summary V1{endb}",
    ...
    dlrec->seq[i].admit_dt, rowplusone2,
    CALL print(calcpos(xcol1,yrow1)),
   ...
   DETAIL
    FOR (i = 1 TO dlrec->encntr_total)
      ...
      last_title = "Documentation: Presenting Information/Nursing Assessments", rowplusone
