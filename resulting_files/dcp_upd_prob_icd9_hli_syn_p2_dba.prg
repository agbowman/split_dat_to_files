CREATE PROGRAM dcp_upd_prob_icd9_hli_syn_p2:dba
 ...
 SET ms_info_domain_nm = "DCP_UPD_PROB_ALL"
 SET ms_range = "UP RANGE"
 SET ms_max_name_p = "MAX ID EVALUATED"
 SET ms_child_script = "dcp_upd_prob_icd9_hli_syn_cc"
 SET mn_num_children = 5
 SELECT INTO "nl:"
  max_val = max(nomenclature_id)
  FROM nomenclature
  DETAIL
...
#exit_program
 ...
 ELSE
  COMMIT
  CALL sbr_add_dropped_object("INDEX","XIETEMPPROBICD9HLISYN","Dropping index")
  CALL sbr_add_dropped_object("TABLE","TEMP_PROB_ICD9_HLI_SYN","Dropping table")
