CREATE PROGRAM bbd_rpt_couriers:dba
 ...
 SET captions->rpt_title = uar_i18ngetmessage(i18nhandle,"rpt_title",
  "C O U R I E R   T Y P E   R E P O R T")
 ...
 SET captions->rpt_display = uar_i18ngetmessage(i18nhandle,"rpt_display","Courier Display")
 SET captions->rpt_descript = uar_i18ngetmessage(i18nhandle,"rpt_descript","Courier Description")
 ...
 SET captions->rpt_id = uar_i18ngetmessage(i18nhandle,"rpt_id","Report ID: BBD_RPT_COURIERS")
 ...
 SET captions->rpt_bbd_cont = uar_i18ngetmessage(i18nhandle,"rpt_bbd_cont","bbd_rpt_couries")
 ...
 SELECT INTO "cer_temp:bbdcouriers.txt"
  c.*
  FROM code_value c
  PLAN (c
   WHERE c.code_set=17032
    AND c.code_value > 0)
  ORDER BY c.display
  HEAD PAGE
