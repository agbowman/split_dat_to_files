CREATE PROGRAM bhs_hand_over_pat_list3:dba
 PROMPT
 ...
 SUBROUTINE headpageabs(ncalc,offsetx,offsety)
   ...
   IF (ncalc=rpt_render)
    ...
    SET _rptstat = uar_rptline(_hreport,(offsetx+ - (0.052)),(offsety+ 0.693),(offsetx+ 7.479),(
     offsety+ 0.693))
    SET _dummyfont = uar_rptsetfont(_hreport,_oldfont)
    SET _dummypen = uar_rptsetpen(_hreport,_oldpen)
    SET _yoffset = (offsety+ sectionheight)
 ...
 SUBROUTINE initializereport(dummy)
   ...
   SET rptreport->m_reportname = "BHS_HAND_OVER_PAT_LIST3"
