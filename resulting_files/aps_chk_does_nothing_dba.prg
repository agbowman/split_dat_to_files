CREATE PROGRAM aps_chk_does_nothing:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "APS_CHK_DOES_NOTHING"
 CALL logscriptstart(sreadme_name)
 CALL logmsg("APS_CHK_DOES_NOTHING script executing.",((e_rdmstatus+ e_dispmsg)+ e_logtofile))
#exit_script
 CALL logstatus("APS_CHK_DOES_NOTHING script execution successful.","S")
