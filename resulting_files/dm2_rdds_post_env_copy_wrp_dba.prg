CREATE PROGRAM dm2_rdds_post_env_copy_wrp:dba
 ...
 SUBROUTINE dir_get_ddl_gen_retry(dgr_retry_ceiling)
   ...
   RETURN(1)
 END ;Subroutine
 IF (check_logfile("dm2_rdds_pt_env_cp",".log","dm2_rdds_post_env_copy_wrp LOG...")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Beginning dm2_rdds_post_env_copy_wrp"
 CALL disp_msg(" ",dm_err->logfile,0)
...
#exit_program
 ...
 SET dm_err->eproc = "...Ending dm2_rdds_post_env_copy_wrp"
 CALL final_disp_msg("dm2_rdds_post_env_copy_wrp")
END GO
