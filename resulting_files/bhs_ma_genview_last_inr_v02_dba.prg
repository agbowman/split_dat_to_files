CREATE PROGRAM bhs_ma_genview_last_inr_v02:dba
 SET rhead =
 ...
 SELECT DISTINCT INTO "NL:"
  ...
  HEAD REPORT
   drec->line_qual[lidx].disp_line = concat(rh2bu3,"INR within the last 24 hrs",wr,
    "(Across Encounters)",reol,
    wr), lidx = (lidx+ 1), stat = alterlist(drec->line_qual,lidx)
