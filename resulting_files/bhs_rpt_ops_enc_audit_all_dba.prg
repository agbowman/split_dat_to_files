CREATE PROGRAM bhs_rpt_ops_enc_audit_all:dba
 FREE RECORD m_rec
 RECORD m_rec(
   1 accts[*]
     2 f_encntr_id = f8
 ...
 DECLARE ms_filename = vc WITH protect, noconstant("cisencounter_accounts.dat")
 ...
 SELECT INTO "nl:"
  ...
  PLAN (e
   ...
   mf_exp_obs_cd, mf_daystay_cd, mf_disch_day_cd, mf_exp_day_cd))
   JOIN (ea1
  ...
  HEAD e.encntr_id
   ...
   accts[pl_cnt].s_med_service = uar_get_code_display(e.med_service_cd)
  FOOT REPORT
