CREATE PROGRAM dm2_aload_atr_req
 ...
 SUBROUTINE dac_load_cload(lc_pkg_in)
   ...
   ENDIF
 END ;Subroutine
 IF (check_logfile("dm2_aload_atr_req",".log","dm2_aload_atr_req")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_aload_atr_req"
 CALL disp_msg(" ",dm_err->logfile,0)
 DECLARE daar_cnt = i4 WITH protect, noconstant(0)
 DECLARE daar_str = vc WITH protect, noconstant("")
 IF (dac_pop_coldic_rec("DM_OCD_REQUEST")=0)
  GO TO exit_program
 ENDIF
...
#exit_program
 IF ((dm_err->err_ind=0))
  SET dm_err->eproc = "dm2_aload_atr_req completed"
 ENDIF
 CALL final_disp_msg("dm2_aload_atr_req")
END GO
