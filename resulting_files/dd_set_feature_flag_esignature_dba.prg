CREATE PROGRAM dd_set_feature_flag_esignature:dba
 ...
 END ;Subroutine
 SET readme_data->status = "F"
 SET readme_data->message = concat("Error: Fail starting script dd_set_feature_flag_esignature:",
  error_msg)
 CALL setfeatureflag("ESIGNATURE",onflag)
