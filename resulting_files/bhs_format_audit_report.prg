CREATE PROGRAM bhs_format_audit_report
 EXECUTE cclseclogin
 RECORD oef(
   1 cnt = i4
   1 qual[*]
 ...
 SELECT INTO "nl:"
  ...
  HEAD oef.action_type_cd
   ...
   ENDIF
   oef->qual[oef->cnt].oe_format_name = substring(1,20,oef.oe_format_name), oef->qual[oef->cnt].
 ...
 FOR (ff = 1 TO oef->cnt)
  ...
  SELECT INTO "nl:"
   ...
   ORDER BY aff.flex_type_flag, aff.flex_cd
   HEAD aff.flex_cd
