CREATE PROGRAM bbt_solcap_ahg_xm_pref
 ...
 SET reply->solcap[1].identifier = "2014.2.00250.1"
 SET reply->solcap[1].degree_of_use_num = 0
 SET reply->solcap[1].distinct_user_count = 0
 SET reply->solcap[1].degree_of_use_str = bbtgetflexspecahgxmatch(0.0)
 FREE SET res_count
 ...
 SELECT
  ...
  DETAIL
   ...
   value_str = bbtgetflexspecahgxmatch(cv.code_value)
  FOOT REPORT
