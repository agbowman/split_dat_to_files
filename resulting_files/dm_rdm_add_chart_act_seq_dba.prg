CREATE PROGRAM dm_rdm_add_chart_act_seq:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_rdm_add_chart_act_seq..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("CHART_ACT_SEQ")
 SELECT INTO "nl:"
