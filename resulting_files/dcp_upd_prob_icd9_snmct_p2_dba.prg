CREATE PROGRAM dcp_upd_prob_icd9_snmct_p2:dba
...
#exit_program
 ...
 ELSE
  COMMIT
  CALL sbr_add_dropped_object("INDEX","XIETEMPPROBICD9SNMCT","Dropping index")
  CALL sbr_add_dropped_object("TABLE","TEMP_PROB_ICD9_SNMCT","Dropping table")
