CREATE PROGRAM cv_get_cdfmng_fro_cd:dba
 RECORD reply(
   1 get_list[*]
     2 cdf_meaning = c12
     2 code_value = f8
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   ENDIF
   reply->get_list[count1].cdf_meaning = c.cdf_meaning, reply->get_list[count1].code_value = c
   .code_value
  FOOT REPORT
 ...
 FOR (count = 1 TO count1)
  CALL echo(build("This is the cdfMng",reply->get_list[count].cdf_meaning))
