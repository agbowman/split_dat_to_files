CREATE PROGRAM dcp_clr_dup_prsnl_hist_p2:dba
 ...
 SET ms_info_domain_nm = "DELETING PRSNL HISTORY FOR DUPS ON DCP_FORMS_ACTIVITY_PRSNL TABLE"
 SET ms_range = "RANGE_UP 1"
 SET ms_max_name_p = "MAX DCP_FORMS_ACTIVITY_PRSNL_ID EVALUATED"
 SET ms_child_script = "dcp_clr_dup_prsnl_hist_chld_c"
 SET mn_num_children = 3
 SELECT INTO "nl:"
  max_val = seq(carenet_seq,nextval)
  FROM dual
  DETAIL
   max_range_id = cnvtreal(max_val)
  WITH nocounter
 ;end select
