CREATE PROGRAM bhs_dt_clin_sum2_test2:dba
   ...
   SELECT INTO "nl:"
    ...
    PLAN (o
     ...
     WHERE od.order_id=outerjoin(o.order_id)
      AND trim(od.oe_field_meaning)=outerjoin("OTHER"))
     JOIN (oef
