CREATE PROGRAM ecf_rdm_dsm5ca_xmap:dba
 ...
 SUBROUTINE kia_script_inc(pkg,ccl_obj)
   ...
   CALL parser(obj_prs)
 END ;Subroutine
 DECLARE kia_xmap_csv_filename = vc WITH public, constant("dsm5ca_xmap.csv")
 DECLARE kia_cur_ver_beg_dt = vc WITH public, noconstant("")
 SET kia_tbl_desc = "DSM5-CA XMAP"
 SET kia_short_desc = "DSM5-CA"
 SET kia_rdm_log_name = "ecf_rdm_dsm5ca_xmap.log"
 SET kia_rdm_nbr = 9847
 SET kia_rdm_vocab_mean = "DSM5-CA"
 SET readme_data->status = "F"
 ...
 EXECUTE kia_dm_dbimport "cer_install:dsm5ca_version.csv", "kia_get_rdm_vars", 100,
 0
 CALL kia_chk_script_failure("KIA_GET_RDM_VARS")
 SET start_time_var = cnvtdatetime(curdate,curtime3)
 CALL log_sub(concat("ECF_RDM_DSM5CA_XMAP Begin> ",format(cnvtdatetime(curdate,curtime3),
 ...
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9838,"DSM5-CA NOMEN"))
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9849,"DSM5-CA CONCEPT"))
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9846,"DSM5-CA RELTN"))
 SET kia_version_chk = (kia_version_chk+ kia_chk_status_readme(9847,"DSM5-CA XMAP"))
