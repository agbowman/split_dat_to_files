CREATE PROGRAM dm_owner_steps:dba
 SET env_name = cnvtupper( $1)
 SET owner_email = cnvtupper( $2)
 RECORD rproclist(
   1 qual[*]
     2 process_id = f8
     2 max_instance = i4
 ...
 ;end select
 SELECT
  d.owner_email, feature = d.effective_feature, environment = env_name,
  d.process_id, d.description, d.run_after_process_id,
  l.success_ind, l.error_msg
