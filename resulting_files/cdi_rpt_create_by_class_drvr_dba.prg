CREATE PROGRAM cdi_rpt_create_by_class_drvr:dba
 PROMPT
  "Begin Date" = "SYSDATE",
  "End Date" = "SYSDATE",
  "Batch Class" = ""
 ...
 SELECT INTO "nl:"
  l.username, m.documentscreated, m.documentsdeleted,
  ...
  DETAIL
   batch_lyt->batch_details[row_cnt].documentscreated = (m.documentscreated+ batch_lyt->
   batch_details[row_cnt].documentscreated), batch_lyt->batch_details[row_cnt].documentsdeleted = (m
