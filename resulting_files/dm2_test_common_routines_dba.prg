CREATE PROGRAM dm2_test_common_routines:dba
 ...
 SET tst_return_val = 0
 CALL echo("  ")
 CALL echo("  ")
 CALL echo(concat("***CURSYS=",cursys,"***"))
 CALL echo(concat("***CURRDB=",currdb,"***"))
 CALL echo(concat("***CURRDBLINK=",currdblink,"***"))
 CALL echo("  ")
 CALL echo("  ")
 SET dm_err->eproc = "***Test for get_unique_file, disp_msg and init_logfile***"
 CALL echo(
  "***Should see an error on the screen for init_logfile 2 times since the file name has not been initialized***"
  )
 CALL init_logfile(dm_err->logfile,"DM2_TEST_COMMON_ROUTINES log file")
 CALL init_logfile(" ","DM2_TEST_COMMON_ROUTINES log file")
 CALL echo("  ")
 CALL echo("  ")
 CALL echo(
  "***Should see an error on the screen for disp_msg 2 times since the file name has not been initialized***"
  )
 CALL disp_msg(" ",dm_err->logfile,1)
 DECLARE lfile = vc
 CALL disp_msg(" ",lfile,1)
 CALL echo("***Should see an error on the screen for init_logfile since the file name is too long***"
  )
 CALL echo("  ")
 CALL echo("*Call get_unique_file first*")
 SET tst_return_val = get_unique_file("DM2_TEST_COMMON_ROUTINES",".LOG")
 CALL echo(build("get_unique_file returned a value of:",tst_return_val))
 CALL init_logfile(dm_err->unique_fname,"DM2_TEST_COMMON_ROUTINES log file")
 CALL echo("  ")
 CALL echo("  ")
 CALL echo("***Should see an error on the screen for disp_msg since the file name is too long***")
 CALL echo("  ")
 CALL disp_msg(" ",dm_err->unique_fname,1)
 CALL echo("***No errors for init_logfile this time***")
 CALL echo("  ")
 CALL echo("*Call get_unique_file first*")
 SET tst_return_val = get_unique_file("DM2_TEST_CR",".LOG")
 CALL echo(build("get_unique_file returned a value of:",tst_return_val))
 SET dm_err->logfile = dm_err->unique_fname
 CALL init_logfile(dm_err->logfile,"DM2_TEST_COMMON_ROUTINES log file")
 CALL echo("  ")
 CALL echo("  ")
 CALL echo("***Test init_logfile***")
 CALL echo("  ")
 CALL echo("  ")
 SET dm_err->eproc = "***Test dm2_push_cmd, check_error, and disp_msg***"
 CALL disp_msg(" ",dm_err->logfile,0)
 CALL echo("***Full command, should execute without error***")
 SET tst_return_val = dm2_push_cmd(
  "select into 'nl:' p.person_id from person p where p.person_id=0 go",1)
 CALL echo(build("dm2_push_cmd returned a value of:",tst_return_val))
 CALL echo("  ")
 CALL echo("  ")
 CALL echo("***Full command, should detect and display an error***")
 SET tst_return_val = dm2_push_cmd(
  "select into 'nl:' p.person_id from prson p where p.person_id=0 go",1)
 CALL echo(build("dm2_push_cmd returned a value of:",tst_return_val))
 CALL echo("  ")
 CALL echo("  ")
 SET dm_err->emsg = " "
 CALL echo("***Send command in 2 calls, should execute without error***")
 CALL dm2_push_cmd("select into 'nl:' p.person_id",0)
 SET tst_return_val = dm2_push_cmd("from person p where p.person_id=0 go",1)
 CALL echo(build("dm2_push_cmd returned a value of:",tst_return_val))
 CALL echo("  ")
 CALL echo("  ")
 CALL echo("***Send command in 2 calls, should detect and display an error***")
 CALL dm2_push_cmd("select into 'nl:' p.person_id",0)
 SET tst_return_val = dm2_push_cmd("from perso p where p.person_id=0 go",1)
 CALL echo(build("dm2_push_cmd returned a value of:",tst_return_val))
 CALL echo("  ")
 CALL echo("  ")
 SET dm_err->emsg = " "
 SET dm_err->eproc = "***Test dm2_push_dcl, get_unique_file, parse_errfile, and disp_msg***"
 CALL disp_msg(" ",dm_err->logfile,0)
 IF (cursys="AIX")
  CALL echo("***Command should execute without error***")
  SET tst_return_val = dm2_push_dcl("ls $CCLUSERDIR/dm*.dat")
  CALL echo(build("dm2_push_dcl returned a value of:",tst_return_val))
  CALL echo("  ")
  CALL echo("  ")
  CALL echo("***Command should report an error***")
  SET tst_return_val = dm2_push_dcl("ls $CCLUSRDIR/dm2.dat")
  CALL echo(build("dm2_push_dcl returned a value of:",tst_return_val))
  CALL echo("  ")
  CALL echo("  ")
  SET dm_err->emsg = " "
  IF (currdb="DB2UDB")
   CALL echo("***DB2 Command should execute without error***")
   SET tst_return_val = dm2_push_dcl(concat("db2 connect to ",currdblink," user v500 using v500"))
   CALL echo(build("dm2_push_dcl returned a value of:",tst_return_val))
   CALL echo("  ")
   CALL echo("  ")
   CALL echo("***DB2 Command should report an error***")
   SET tst_return_val = dm2_push_dcl("db2 get cfg ")
   CALL echo(build("dm2_push_dcl returned a value of:",tst_return_val))
   CALL echo("  ")
   CALL echo("  ")
   SET dm_err->emsg = " "
 ...
 ELSE
  CALL echo("***Command should execute without error***")
  SET tst_return_val = dm2_push_dcl("dir CCLUSERDIR:dm*.dat")
  CALL echo(build("dm2_push_dcl returned a value of:",tst_return_val))
  CALL echo("  ")
  CALL echo("  ")
  CALL echo("***Command should report an error***")
  SET tst_return_val = dm2_push_dcl("dir CCLUSRDIR:dm2.dat")
  CALL echo(build("dm2_push_dcl returned a value of:",tst_return_val))
  CALL echo("  ")
  CALL echo("  ")
  SET dm_err->emsg = " "
 ENDIF
 CALL echo("***Test writing long messages to the log file***")
 SET dm_err->eproc = fillstring(500,"x")
 CALL disp_msg(" ",dm_err->logfile,0)
 SET dm_err->eproc = concat(dm_err->eproc,"robin")
 SET emsg = fillstring(255,"a")
 CALL disp_msg(emsg,dm_err->logfile,1)
END GO
