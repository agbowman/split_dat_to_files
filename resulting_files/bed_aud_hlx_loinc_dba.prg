CREATE PROGRAM bed_aud_hlx_loinc:dba
 ...
 SET reply->collist[1].header_text = uar_i18ngetmessage(i18nhandle,"Assay Short Name",
  "Assay Short Name")
 SET reply->collist[1].data_type = 1
 SET reply->collist[1].hide_ind = 0
 SET reply->collist[2].header_text = uar_i18ngetmessage(i18nhandle,"Assay Description",
  "Assay Description")
 SET reply->collist[2].data_type = 1
 SET reply->collist[2].hide_ind = 0
 SET reply->collist[3].header_text = uar_i18ngetmessage(i18nhandle,"Instrument/Bench",
  "Instrument/Bench")
 SET reply->collist[3].data_type = 1
 SET reply->collist[3].hide_ind = 0
 SET reply->collist[4].header_text = uar_i18ngetmessage(i18nhandle,
  "Instrument/Bench Subactivity Type","Instrument/Bench Subactivity Type")
 SET reply->collist[4].data_type = 1
 SET reply->collist[4].hide_ind = 0
 SET reply->collist[5].header_text = uar_i18ngetmessage(i18nhandle,"Specimen Type","Specimen Type")
 SET reply->collist[5].data_type = 1
 SET reply->collist[5].hide_ind = 0
 SET reply->collist[6].header_text = uar_i18ngetmessage(i18nhandle,"Ignore Analyte Code",
  "Ignore Analyte Code")
 SET reply->collist[6].data_type = 1
 SET reply->collist[6].hide_ind = 0
 SET reply->collist[7].header_text = uar_i18ngetmessage(i18nhandle,"Analyte Code","Analyte Code")
 SET reply->collist[7].data_type = 1
 SET reply->collist[7].hide_ind = 0
 SET reply->collist[8].header_text = uar_i18ngetmessage(i18nhandle,"Analyte Component",
  "Analyte Component")
 SET reply->collist[8].data_type = 1
 SET reply->collist[8].hide_ind = 0
 SET reply->collist[9].header_text = uar_i18ngetmessage(i18nhandle,"Analyte System","Analyte System")
 SET reply->collist[9].data_type = 1
 SET reply->collist[9].hide_ind = 0
 SET reply->collist[10].header_text = uar_i18ngetmessage(i18nhandle,"Analyte Time","Analyte Time")
 SET reply->collist[10].data_type = 1
 SET reply->collist[10].hide_ind = 0
 SET reply->collist[11].header_text = uar_i18ngetmessage(i18nhandle,"Analyte Scale","Analyte Scale")
 SET reply->collist[11].data_type = 1
 SET reply->collist[11].hide_ind = 0
 SET reply->collist[12].header_text = uar_i18ngetmessage(i18nhandle,"Analyte Property",
  "Analyte Property")
 SET reply->collist[12].data_type = 1
 SET reply->collist[12].hide_ind = 0
 SET reply->collist[13].header_text = uar_i18ngetmessage(i18nhandle,"Analyte Method","Analyte Method"
  )
 SET reply->collist[13].data_type = 1
 SET reply->collist[13].hide_ind = 0
 SET reply->collist[14].header_text = uar_i18ngetmessage(i18nhandle,"Analyte Short Name",
  "Analyte Short Name")
 SET reply->collist[14].data_type = 1
 SET reply->collist[14].hide_ind = 0
 SET reply->collist[15].header_text = uar_i18ngetmessage(i18nhandle,"Analyte Class","Analyte Class")
 SET reply->collist[15].data_type = 1
 SET reply->collist[15].hide_ind = 0
 SET reply->collist[16].header_text = uar_i18ngetmessage(i18nhandle,"Analyte Concept CKI",
  "Analyte Concept CKI")
 SET reply->collist[16].data_type = 1
 SET reply->collist[16].hide_ind = 0
 SET reply->collist[17].header_text = uar_i18ngetmessage(i18nhandle,"Ignore Attachment Code",
  "Ignore Attachment Code")
 SET reply->collist[17].data_type = 1
 SET reply->collist[17].hide_ind = 0
 SET reply->collist[18].header_text = uar_i18ngetmessage(i18nhandle,"Attachment Code",
  "Attachment Code")
 SET reply->collist[18].data_type = 1
 SET reply->collist[18].hide_ind = 0
 SET reply->collist[19].header_text = uar_i18ngetmessage(i18nhandle,"Attachment Component",
  "Attachment Component")
 SET reply->collist[19].data_type = 1
 SET reply->collist[19].hide_ind = 0
 SET reply->collist[20].header_text = uar_i18ngetmessage(i18nhandle,"Attachment System",
  "Attachment System")
 SET reply->collist[20].data_type = 1
 SET reply->collist[20].hide_ind = 0
 SET reply->collist[21].header_text = uar_i18ngetmessage(i18nhandle,"Attachment Time",
  "Attachment Time")
 SET reply->collist[21].data_type = 1
 SET reply->collist[21].hide_ind = 0
 SET reply->collist[22].header_text = uar_i18ngetmessage(i18nhandle,"Attachment Scale",
  "Attachment Scale")
 SET reply->collist[22].data_type = 1
 SET reply->collist[22].hide_ind = 0
 SET reply->collist[23].header_text = uar_i18ngetmessage(i18nhandle,"Attachment Property",
  "Attachment Property")
 SET reply->collist[23].data_type = 1
 SET reply->collist[23].hide_ind = 0
 SET reply->collist[24].header_text = uar_i18ngetmessage(i18nhandle,"Attachment Method",
  "Attachment Method")
 SET reply->collist[24].data_type = 1
 SET reply->collist[24].hide_ind = 0
 SET reply->collist[25].header_text = uar_i18ngetmessage(i18nhandle,"Attachment Short Name",
  "Attachment Short Name")
 SET reply->collist[25].data_type = 1
 SET reply->collist[25].hide_ind = 0
 SET reply->collist[26].header_text = uar_i18ngetmessage(i18nhandle,"Attachment Class",
  "Attachment Class")
 SET reply->collist[26].data_type = 1
 SET reply->collist[26].hide_ind = 0
 SET reply->collist[27].header_text = uar_i18ngetmessage(i18nhandle,"Attachment Concept CKI",
  "Attachment Concept CKI")
 SET reply->collist[27].data_type = 1
 SET reply->collist[27].hide_ind = 0
 SET reply->collist[28].header_text = uar_i18ngetmessage(i18nhandle,"Task Assay Code",
  "Task Assay Code")
 SET reply->collist[28].data_type = 2
 SET reply->collist[28].hide_ind = 0
 SET reply->collist[29].header_text = uar_i18ngetmessage(i18nhandle,"Service Resource Code",
  "Service Resource Code")
 SET reply->collist[29].data_type = 2
 SET reply->collist[29].hide_ind = 0
 SET reply->collist[30].header_text = uar_i18ngetmessage(i18nhandle,"Specimen Type Code",
  "Specimen Type Code")
 ...
 SELECT INTO "NL:"
  ...
  PLAN (cid
   ...
   JOIN (dta
   WHERE dta.task_assay_cd=cid.task_assay_cd
    AND dta.activity_type_cd IN (hlx_code))
  ORDER BY cid.task_assay_cd, cid.service_resource_cd, cid.specimen_type_cd
...
#exit_script
 ...
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("hlx_loinc_assos.csv")
 ENDIF
