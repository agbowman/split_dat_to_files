CREATE PROGRAM bhs_xsolis_clin_doc_export:dba
 PROMPT
  "Printer" = "MINE",
  "FACILITY" = 0,
 ...
 DECLARE end_dt_tm = dq8 WITH noconstant(parsedateprompt( $ENDDTTM,curdate,curtime2)), protect
 ...
 ENDIF
 SET filewrite = build2("/cerner/d_p627/bhscust/xsolis/clin_doc/xsolis_clin_doc_bhsma","_",format(
   curdate,"mmddyyyy;;d"),"_",format(curtime3,"hhmmss;3;m"),
  ".txt")
 SELECT INTO "nl:"
  cv.description
