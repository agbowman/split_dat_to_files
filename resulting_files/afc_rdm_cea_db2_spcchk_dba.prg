CREATE PROGRAM afc_rdm_cea_db2_spcchk:dba
 ...
 DECLARE ms_prev_readme_id = vc WITH protect, noconstant("")
 DECLARE mn_prev_instance = i2 WITH protect, noconstant(0)
 ...
 SET ms_process_name = "AFC_RDM_CEA_DB2"
 SET ms_prev_readme_id = "2697"
 SET mn_prev_instance = 2
 SET ms_operation_init = "U"
 CALL sbr_add_table("CHARGE_EVENT_ACT",1)
 CALL sbr_add_column("ITEM_EXT_PRICE",1)
 CALL sbr_add_column("ITEM_PRICE",1)
 CALL sbr_add_column("ITEM_COPAY",1)
 CALL sbr_add_column("ITEM_REIMBURSEMENT",1)
 CALL sbr_add_column("DISCOUNT_AMOUNT",1)
 CALL sbr_add_column("CEA_MISC2_ID",0)
 CALL sbr_add_column("CEA_MISC4_ID",0)
 CALL sbr_add_column("CEA_MISC5_ID",0)
 CALL sbr_add_column("CEA_MISC6_ID",0)
 CALL sbr_add_column("CEA_MISC7_ID",0)
