CREATE PROGRAM acm_rdm_newborn_mother_swap_c:dba
 ...
 SET ms_child_info_domain_nm = "ACM_RDM_NEWBORN_MOTHER"
 SET ms_range_prefix = "ACM_RDM_NEWBORN_MOTHER_RANGE"
 SET ms_child_max_name = "MAX ENCNTR_ENCNTR_RELTN_ID EVALUATED"
 ...
 IF (sbr_fetch_min_max(ms_child_info_domain_nm,ms_range_prefix,ms_child_max_name,mf_max_range_id,
  ...
  GO TO exit_program
 ENDIF
 IF (sbr_sync_ccl_tmp_def("TEMP_RDM_NEWBORN_MOTHER_SWAP")=0)
  GO TO exit_program
 ENDIF
 SELECT INTO "nl:"
  cv.code_value
