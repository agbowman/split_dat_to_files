CREATE PROGRAM dm2_can_subroutines_tst:dba
 ...
 SUBROUTINE dir_get_admin_db_link(dgadl_report_fail_ind,dgadl_admin_db_link,dgadl_fail_ind)
   ...
   RETURN(1)
 END ;Subroutine
 DECLARE tst_log_pre = vc WITH public, constant("dm2_can_sub")
 DECLARE tst_return = i4 WITH public, noconstant(0)
 DECLARE srch_str = vc WITH public, noconstant(" ")
 DECLARE sprtr = vc WITH public, noconstant(" ")
 DECLARE str = vc WITH public, noconstant(" ")
 IF (check_logfile(tst_log_pre,".log","DM2_CAN_SUBROUTINES_TST LOGFILE")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->debug_flag = 1
 SET dm_err->eproc = "*** Test 1 - Testing call of retrieve_data subroutine with invalid separator"
 CALL echo(dm_err->eproc)
 SET srch_str = " "
 SET sprtr = "b"
 SET str = " "
 CALL echo(concat("Search string = ",srch_str,'  Separator = "',sprtr,'"  String = ',
   str))
 SET tst_return = retrieve_data(srch_str,sprtr,str)
 CALL echo(concat("Subroutine Return value = ",cnvtstring(tst_return,4,0)))
 IF ((dm_err->err_ind=1))
  CALL disp_msg(dm_err->emsg,dm_err->logfile,dm_err->err_ind)
 ENDIF
 SET dm_err->err_ind = 0
 CALL echo("*** End of Test ***  ")
 SET dm_err->eproc =
 "*** Test 2 - Testing call of retrieve_data subroutine where separator not found"
 CALL echo(dm_err->eproc)
 SET srch_str = "data"
 SET sprtr = "="
 SET str = "This is string data that does not have the equal sign"
 CALL echo(concat("Search string = ",srch_str,'  Separator = "',sprtr,'"  String = ',
   str))
 SET tst_return = retrieve_data(srch_str,sprtr,str)
 CALL echo(concat("Subroutine Return value = ",cnvtstring(tst_return,4,0)))
 ...
 CALL echo("*** End of Test ***  ")
 SET dm_err->eproc =
 "*** Test 3 - Testing call of retrieve_data subroutine where search string not found"
 CALL echo(dm_err->eproc)
 SET srch_str = "amy"
 SET sprtr = "="
 SET str = "This the string of data that is being searched."
 CALL echo(concat("Search string = ",srch_str,'  Separator = "',sprtr,'"  String = ',
   str))
 SET tst_return = retrieve_data(srch_str,sprtr,str)
 CALL echo(concat("Subroutine Return Value = ",cnvtstring(tst_return,4,0),"   Result String = ",
   retrieve_data->result_str,"  Result Status = ",
   cnvtstring(retrieve_data->result_status,4,0)))
 IF ((dm_err->err_ind=1))
  CALL disp_msg(dm_err->emsg,dm_err->logfile,dm_err->err_ind)
 ENDIF
 CALL echo("*** End of Test ***  ")
 SET dm_err->eproc =
 "*** Test 4 - Testing call of retrieve_data subroutine where search string is found"
 CALL echo(dm_err->eproc)
 SET srch_str = "data"
 SET sprtr = "="
 SET str = "This the string of data   =    that is being searched."
 ...
 ENDIF
 CALL echo("*** End of Test ***  ")
 SET dm_err->eproc = '*** Test 5 - Testing call of retrieve_data subroutine where separator is " "'
 CALL echo(dm_err->eproc)
 SET srch_str = "data"
 SET sprtr = " "
 SET str = "This the string of data that is being searched."
 ...
 CALL echo("*** End of Test ***  ")
 SET dm_err->eproc =
 "*** Test 6 - Testing call of retrieve_data subroutine where search string is found"
 CALL echo(dm_err->eproc)
 SET srch_str = "data"
 SET sprtr = "="
 SET str = "This the string of data =     that is being searched."
 ...
 CALL echo("*** End of Test ***  ")
#exit_program
 SET dm_err->eproc = "Process to test subroutines in Create_Admin_Nicknames Completed."
 CALL final_disp_msg(tst_log_pre)
END GO
