CREATE PROGRAM dm_rdm_upd_erx_synonym_ids_c:dba
 ...
 SET ms_child_info_domain_nm = "DM_RDM_UPD_ERX_SYNONYM_IDS"
 SET ms_range_prefix = "MAX IB_RX_REQ_DRUG_ID RANGE"
 SET ms_child_max_name = "MAX IB_RX_REQ_DRUG_ID EVALUATED"
 ...
 IF (sbr_fetch_min_max(ms_child_info_domain_nm,ms_range_prefix,ms_child_max_name,mf_max_range_id,
  ...
  GO TO exit_program
 ENDIF
 IF (sbr_sync_ccl_tmp_def("TEMP_IB_RX_REQ_DRUG")=0)
  GO TO exit_program
 ENDIF
