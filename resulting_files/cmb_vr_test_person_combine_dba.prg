CREATE PROGRAM cmb_vr_test_person_combine:dba
 ...
 IF ((validate(cmb_test_from_person_id,- (99.00)) != - (99.00))
  AND (validate(cmb_test_to_person_id,- (99.00)) != - (99.00)))
  SET cmb_test_values->cmb_from_id = cmb_test_from_person_id
  SET cmb_test_values->cmb_to_id = cmb_test_to_person_id
 ELSE
  SELECT INTO "nl:"
