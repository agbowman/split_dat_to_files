CREATE PROGRAM dm_ecmb_onc_ii_auto_activity:dba
 ...
 IF ((dm_cmb_cust_script->exc_maint_ind=1))
  ...
  SET dcem_request->qual[1].script_name = "DM_ECMB_ONC_II_AUTO_ACTIVITY"
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   rreclist->from_rec[v_cust_count1].from_person_id = frm.person_id, rreclist->from_rec[v_cust_count1
   ].from_parent_event_id = frm.parent_event_id, rreclist->from_rec[v_cust_count1].from_order_id =
   frm.order_id
  FOOT REPORT
 ...
 IF (v_cust_count1 > 0)
  SELECT INTO "nl:"
   ...
   DETAIL
    ...
    .active_status_cd,
    rreclist->to_rec[v_cust_count2].to_person_id = tu.person_id, rreclist->to_rec[v_cust_count2].
  ...
  FOR (v_cust_loopcount = 1 TO v_cust_count1)
    ...
    FOR (v_cust_loopcount2 = 1 TO v_cust_count2)
      IF ((rreclist->from_rec[v_cust_loopcount].from_person_id=rreclist->to_rec[v_cust_loopcount2].
      to_person_id)
