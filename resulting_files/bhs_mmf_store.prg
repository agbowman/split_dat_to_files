CREATE PROGRAM bhs_mmf_store
 ...
 IF (validate(bhs_request->content_type,"-1")="-1")
  ...
  SET bhs_request->person_id = 18756776.0
  SET bhs_request->file_name = "al_test.xml"
  SET bhs_request->content_type = "CCD"
  SET bhs_request->name = "TEST_UPLOAD2"
 ...
 IF (bhs_temp_ret=0)
  ...
  GO TO exit_script
 ENDIF
 SET bhs_temp_ret = uar_dmsm_setmediacontent(bhs_media_handle,bhs_file_buffer,"text/xml",0)
 IF (bhs_temp_ret=0)
