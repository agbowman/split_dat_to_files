CREATE PROGRAM bhs_add_physician_loc:dba
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "Select a Physician" = 0,
 ...
 IF (( $LOC=0.00))
  ...
  GO TO exit_script
 ENDIF
 INSERT  FROM bhs_physician_location b
  SET b.person_id =  $PHYS, b.location_id =  $LOC
  WITH nocounter
 ;end insert
 COMMIT
 SELECT INTO "nl:"
 ...
 IF (exit_ind=1)
  IF (created_ind=1)
   SELECT INTO  $OUTDEV
    ...
    PLAN (d)
    DETAIL
     col 0, "Your physician was successfully added"
    WITH nocounter
   ;end select
  ELSE
   SELECT INTO  $OUTDEV
    ...
    PLAN (d)
    DETAIL
     col 0, "Your physician was not successfully added"
    WITH nocounter
   ;end select
  ENDIF
 ENDIF
