CREATE PROGRAM dm_pucb_person_military:dba
 ...
 IF ((dm_cmb_cust_script->exc_maint_ind=1))
  ...
  SET dcem_request->qual[1].script_name = "DM_PUCB_PERSON_MILITARY"
 ...
 SUBROUTINE cust_ucb_upt(dummy)
   IF ( NOT (restore_column_values("PERSON_MILITARY",request->parent_table,request->xxx_uncombine[
 ...
 SUBROUTINE initialize_hist_id(null)
  IF (v_hist_init_ind=0)
   ...
   SET dcipht_request->transaction_reason_txt = "DM_PUCB_PERSON_MILITARY"
