CREATE PROGRAM dm_rdm_cid_seq:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_rdm_cid_seq..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("CID_SEQ")
 SELECT INTO "nl:"
