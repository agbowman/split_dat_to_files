CREATE PROGRAM dm_rdm_add_epa_sequence:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_rdm_add_epa_sequence..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("EPA_SEQ")
 SELECT INTO "nl:"
