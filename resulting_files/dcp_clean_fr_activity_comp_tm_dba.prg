CREATE PROGRAM dcp_clean_fr_activity_comp_tm:dba
 ...
 SUBROUTINE setreadmetimings(null)
   ...
   RETURN(1)
 END ;Subroutine
 IF (setdrivertable("DCP_FORMS_ACTIVITY_COMP")=0)
  GO TO exit_script
 ENDIF
 CALL setrangeincrement(250000)
 CALL settimeperbatch(0.0167)
 CALL addtimedreadme(4507)
 CALL addtimedreadme(4508)
 CALL addtimedreadme(4509)
