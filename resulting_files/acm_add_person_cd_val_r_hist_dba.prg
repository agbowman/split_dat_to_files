CREATE PROGRAM acm_add_person_cd_val_r_hist:dba
 ...
 INSERT  FROM person_code_value_r_hist pcvrh,
  ...
  SET pcvrh.person_code_value_r_h_id = seq(person_seq,nextval), pcvrh.pm_hist_tracking_id =
   acm_request->person_code_value_r_qual[xref->add[d.seq].idx].pm_hist_tracking_id, pcvrh
   .transaction_dt_tm = cnvtdatetime(acm_request->person_code_value_r_qual[xref->add[d.seq].idx].
    transaction_dt_tm),
   pcvrh.person_id = acm_request->person_code_value_r_qual[xref->add[d.seq].idx].person_id, pcvrh
   .code_set = acm_request->person_code_value_r_qual[xref->add[d.seq].idx].code_set, pcvrh.code_value
    = acm_request->person_code_value_r_qual[xref->add[d.seq].idx].code_value,
   pcvrh.tracking_bit = tracking_bit, pcvrh.change_bit = chgbit, pcvrh.updt_dt_tm = cnvtdatetime(
    curdate,curtime3),
