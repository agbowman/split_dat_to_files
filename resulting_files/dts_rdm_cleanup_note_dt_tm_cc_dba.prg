CREATE PROGRAM dts_rdm_cleanup_note_dt_tm_cc:dba
 ...
 SET ms_child_c_info_domain_nm = "CE_EVENT_NOTE CLEANUP PROCESS"
 SET ms_child_c_max_name = "CE_EVENT_NOTE_ID RANGE"
 ...
 UPDATE  FROM ce_event_note c
  SET c.note_dt_tm = c.valid_from_dt_tm, c.updt_cnt = (c.updt_cnt+ 1), c.updt_dt_tm = cnvtdatetime(
   ...
   updt_applctx
  WHERE c.ce_event_note_id >= mf_min_id
   AND c.ce_event_note_id <= mf_max_id
   AND c.note_dt_tm > cnvtdatetime("01-JAN-2101")
