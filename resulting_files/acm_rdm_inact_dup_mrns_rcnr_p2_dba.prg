CREATE PROGRAM acm_rdm_inact_dup_mrns_rcnr_p2:dba
 ...
 SET ms_info_domain_nm = "ACM_RDM_INACT_DUP_MRNS_RCNR2"
 SET ms_range = "ACM_RDM_INACT_DUP_MRNS_RCNR_RANGE"
 SET ms_max_name_p = "MAX ENCNTR_ALIAS_ID EVALUATED"
 SET ms_child_script = "ACM_RDM_INACT_DUP_MRNS_RCNR_CC"
 SET mn_num_children = 5.0
 SELECT INTO "nl:"
  max_val = max(eer.encntr_alias_id)
  FROM encntr_alias eer
  DETAIL
