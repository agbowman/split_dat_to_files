CREATE PROGRAM dm_compile_objects:dba
 SET obj_name = cnvtupper( $1)
 SET obj_type = cnvtupper( $2)
 IF (obj_type != "TABLE"
  AND obj_type != "OBJECT")
  CALL echo("Second parameter must be 'TABLE' or 'OBJECT'.  Invalid parameter value entered.")
  GO TO exit_script
 ENDIF
 RECORD str(
   1 str = vc
