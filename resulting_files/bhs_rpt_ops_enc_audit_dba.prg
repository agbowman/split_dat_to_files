CREATE PROGRAM bhs_rpt_ops_enc_audit:dba
 FREE RECORD m_rec
 RECORD m_rec(
   1 accts[*]
     2 f_encntr_id = f8
 ...
 DECLARE mf_cat5_cd = f8 WITH protect, constant(uar_get_code_by("DISPLAYKEY",200,
 ...
 DECLARE mf_cat10_cd = f8 WITH protect, constant(uar_get_code_by("DISPLAYKEY",200,"STATUSINPATIENT"))
 ...
 DECLARE ms_filename = vc WITH protect, noconstant("cisencounter_orders30.dat")
 SET ms_end_dt_tm = "09-MAR-2011 00:00:00"
 SET ms_beg_dt_tm = trim(format(cnvtlookbehind("30,D",cnvtdatetime(ms_end_dt_tm)),
 ...
 SELECT INTO "nl:"
  ...
  HEAD o.order_id
   ...
   ->accts[pl_cnt].s_ord_by = substring(1,30,pr1.name_full_formatted)
