CREATE PROGRAM acm_add_person_patient_hist:dba
 ...
 INSERT  FROM person_patient_hist pph,
  ...
  SET pph.person_patient_hist_id = seq(person_seq,nextval), pph.person_id = acm_request->
   person_patient_qual[xref->add[d.seq].idx].person_id, pph.transaction_dt_tm = cnvtdatetime(
    acm_request->person_patient_qual[xref->add[d.seq].idx].transaction_dt_tm),
   pph.birth_sex_cd = acm_request->person_patient_qual[xref->add[d.seq].idx].birth_sex_cd, pph
   .pm_hist_tracking_id = acm_request->person_patient_qual[xref->add[d.seq].idx].pm_hist_tracking_id,
   pph.living_will_cd = acm_request->person_patient_qual[xref->add[d.seq].idx].living_will_cd,
   pph.organ_donor_cd = acm_request->person_patient_qual[xref->add[d.seq].idx].organ_donor_cd, pph
   .gest_age_at_birth = acm_request->person_patient_qual[xref->add[d.seq].idx].gest_age_at_birth, pph
   .gest_age_method_cd = acm_request->person_patient_qual[xref->add[d.seq].idx].gest_age_method_cd,
   pph.birth_order_cd = acm_request->person_patient_qual[xref->add[d.seq].idx].birth_order_cd, pph
   .interp_required_cd = acm_request->person_patient_qual[xref->add[d.seq].idx].interp_required_cd,
   pph.contact_method_cd = acm_request->person_patient_qual[xref->add[d.seq].idx].contact_method_cd,
   pph.contact_time = acm_request->person_patient_qual[xref->add[d.seq].idx].contact_time, pph
   .callback_consent_cd = acm_request->person_patient_qual[xref->add[d.seq].idx].callback_consent_cd,
   pph.written_format_cd = acm_request->person_patient_qual[xref->add[d.seq].idx].written_format_cd,
   pph.prev_contact_ind = acm_request->person_patient_qual[xref->add[d.seq].idx].prev_contact_ind,
   pph.tracking_bit = tracking_bit, pph.change_bit = chgbit,
