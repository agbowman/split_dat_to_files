CREATE PROGRAM bhs_phys_org_doc_nbr_csv1:dba
 PROMPT
 ...
 IF (email_ind=1)
  ...
  SET filename_out = concat(format(curdate,"YYYY-MM-DD;;D"),"_PHYS_ORG_DOC_nbr.csv1")
  DECLARE subject_line = vc
  SET subject_line = concat(curprog,"-V1.y - PHYS ORG ID nbr ",curnode)
