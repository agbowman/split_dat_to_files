CREATE PROGRAM bhs_athn_inbox_msg_save_v2
 FREE RECORD result
 RECORD result(
   1 modify_ind = i2
...
#exit_script
 ...
 SUBROUTINE buildmessageblob(null)
   ...
   IF ((result->parent_event.event_id=0))
    SET result->new_event_title_text = "Entered by"
   ELSE
    SET result->new_event_title_text = "Addendum by"
   ENDIF
   SET result->new_event_title_text = concat(result->new_event_title_text," ",result->
