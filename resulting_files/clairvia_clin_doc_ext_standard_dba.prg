CREATE PROGRAM clairvia_clin_doc_ext_standard:dba
 PROMPT
  "Printer" = "MINE",
  "FACILITY" = 0,
 ...
 ENDIF
 SET filename = build2("CLAIRVIA_CLIN_DOC","_",format(curdate,"mmddyyyy;;d"),"_",format(curtime3,
   "hhmmss;3;m"),
  ".txt")
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   ENDCASE
   IF (((textlen(mnemonic) > 0) OR (textlen(fileloc) > 0
    AND commwx="N")) )
    filewrite = build(fileloc,"CLAIRVIA_CLIN_DOC","_",mnemonic,"_",
     format(curdate,"mmddyyyy;;d"),"_",format(curtime3,"hhmmss;3;m"),".txt")
   ELSEIF (commwx="Y")
    filewrite = build(fileloc,ld_mnemonic,"_","CLAIRVIA_CLIN_DOC","_",
     mnemonic,"_",format(curdate,"mmddyyyy;;d"),"_",format(curtime3,"hhmmss;3;m"),
     ".txt")
   ENDIF
  WITH nocounter
 ;end select
...
#exit_script
 ...
 ENDIF
 SET last_mod =
 "003 05/30/2016 TD020616 Clairvia Clin Doc Standardization with Custom Code Set Extract"
END GO
