CREATE PROGRAM bhs_athn_cancel_order
 FREE RECORD result
 RECORD result(
   1 action_type_cd = f8
...
#exit_script
 ...
 SUBROUTINE callcancelorder(null)
   ...
   SET req560201->orderlist[1].communicationtypecd = 0
   SET req560201->orderlist[1].orderproviderid = 0
   SET req560201->orderlist[1].orderdttm = cnvtdatetime(result->orig_order_dt_tm)
 ...
 SUBROUTINE callcancelorderautoverify(null)
   ...
   SET req560251->orderlist[1].communicationtypecd = 0
   SET req560251->orderlist[1].orderproviderid = 0
   SET req560251->orderlist[1].orderdttm = cnvtdatetime(result->orig_order_dt_tm)
