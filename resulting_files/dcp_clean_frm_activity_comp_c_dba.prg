CREATE PROGRAM dcp_clean_frm_activity_comp_c:dba
 ...
 SET ms_child_info_domain_nm = "DELETING DUPS ON DCP_FORMS_ACTIVITY_COMP TABLE"
 SET ms_range_prefix = "DFAC DELETE RANGE "
 SET ms_child_max_name = "MAX DCP_FORMS_ACTIVITY_ID EVALUATED"
