CREATE PROGRAM afc_rdm_cea_db2_p2:dba
 ...
 SET ms_info_domain_nm = "AFC_RDM_CEA_DB2"
 SET ms_range = "UP RANGE"
 SET ms_max_name_p = "MAX CHARGE EVENT ID EVALUATED"
 SET ms_child_script = "afc_rdm_cea_db2_cc"
 SET mn_num_children = 3
 IF (sbr_p2_check_for_prev_rdm(2697,2) IN (2, 1))
  GO TO exit_program
 ENDIF
 SELECT INTO "nl:"
  max_val = max(charge_event_act_id)
  FROM charge_event_act
  DETAIL
