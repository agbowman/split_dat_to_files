CREATE PROGRAM djh_ma_prsnl_sn_nologin
 PROMPT
 ...
 IF (email_ind=1)
  ...
  SET filename_out = concat(format(curdate,"YYYYMMDD ;;D"),"-SN.csv")
  DECLARE subject_line = vc
  SET subject_line = concat(curprog,"Vx - Baystate Health CIS SN Acnts Inactive 90 days")
