CREATE PROGRAM bed_aud_inet_view_perf:dba
 ...
 SET reply->collist[2].header_text = "Greater than 400 primitive event sets (assays)"
 ...
 SET reply->statlist[1].statistic_meaning = "INETVIEWSTOOMANYPRIMS"
...
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("inet_view_perf_audit.csv")
 ENDIF
