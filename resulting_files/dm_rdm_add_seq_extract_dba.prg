CREATE PROGRAM dm_rdm_add_seq_extract:dba
 ...
 SET readme_data->message = "Readme failed: starting script dm_rdm_add_seq_extract..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("EXTRACT_SEQ")
 SELECT INTO "nl:"
