CREATE PROGRAM afc_rca_get_encntrs_for_batch:dba
 ...
 SELECT INTO "nl:"
  ...
  PLAN (c
   ...
   JOIN (d
   WHERE d.charge_batch_id=c.charge_batch_id
    AND d.active_ind=1)
   JOIN (e
  ...
  HEAD d.encntr_id
   ...
   reply->encounter[cntencntr].registrationdate = cnvtdatetime(e.reg_dt_tm)
  DETAIL
   null
  WITH nocounter
 ;end select
