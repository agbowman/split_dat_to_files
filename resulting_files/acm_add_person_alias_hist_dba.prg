CREATE PROGRAM acm_add_person_alias_hist:dba
 ...
 INSERT  FROM person_alias_hist pah,
  ...
  SET pah.person_alias_hist_id = seq(person_seq,nextval), pah.pm_hist_tracking_id = acm_request->
   person_alias_qual[xref->add[d.seq].idx].pm_hist_tracking_id, pah.person_id = acm_request->
   person_alias_qual[xref->add[d.seq].idx].person_id,
   pah.end_effective_dt_tm = cnvtdatetime(acm_request->person_alias_qual[xref->add[d.seq].idx].
    end_effective_dt_tm), pah.beg_effective_dt_tm = cnvtdatetime(acm_request->person_alias_qual[xref
    ->add[d.seq].idx].beg_effective_dt_tm), pah.transaction_dt_tm = cnvtdatetime(acm_request->
    person_alias_qual[xref->add[d.seq].idx].transaction_dt_tm),
   pah.person_alias_id = acm_request->person_alias_qual[xref->add[d.seq].idx].person_alias_id, pah
   .person_alias_status_cd = acm_request->person_alias_qual[xref->add[d.seq].idx].
   person_alias_status_cd, pah.health_card_ver_code = acm_request->person_alias_qual[xref->add[d.seq]
   .idx].health_card_ver_code,
   pah.health_card_province = acm_request->person_alias_qual[xref->add[d.seq].idx].
   health_card_province, pah.health_card_type = acm_request->person_alias_qual[xref->add[d.seq].idx].
   health_card_type, pah.health_card_expiry_dt_tm = cnvtdatetime(acm_request->person_alias_qual[xref
    ->add[d.seq].idx].health_card_expiry_dt_tm),
   pah.health_card_issue_dt_tm = cnvtdatetime(acm_request->person_alias_qual[xref->add[d.seq].idx].
    health_card_issue_dt_tm), pah.alias = acm_request->person_alias_qual[xref->add[d.seq].idx].alias,
   pah.tracking_bit = tracking_bit,
   pah.change_bit = chgbit, pah.active_ind = 1, pah.active_status_cd = reqdata->active_status_cd,
