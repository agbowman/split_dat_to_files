CREATE PROGRAM bhs_sfe_outcomes_summarydev:dba
 PROMPT
 ...
 SELECT INTO "NL:"
  dfr.dcp_forms_ref_id, dfr.end_effective_dt_tm
 ...
 FOR (x = 1 TO size(formlist->formqual,5))
   ...
   ENDIF
 ENDFOR
 IF (textlen(formsnotfound) > 0)
  SET inactiveforms = concat("Forms that have been inactivated since the creation of this report",
   char(13),formsnotfound)
 ENDIF
 ...
 ELSE
  SET stat = alterlist(output->qual,100)
  SET x = 1
  ...
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Unable to consent NRT/Cessation"
  ...
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Patient wants referal to quit smoking"
  SET output->qual[x].col2 = ""
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Yes"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->patreqestreferralyes)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "No"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->patreqestreferralno)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Smoking Cessation Resource / Information"
  SET output->qual[x].col2 = ""
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Resource infomation givin"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->patcresourceinfogiven)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Resource infomation NOT givin"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->patcresourceinfonotgiven)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Patient Wants NRT"
  SET output->qual[x].col2 = ""
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Yes"
  ...
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Patient who requested NRT recived NRT"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->patreqnrtgotnrt)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Patient who did not request NRT recived NRT"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->patnoreqnrtgotnrt)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Inpatient"
  SET output->qual[x].col2 = ""
  SET x = (x+ 1)
  SET output->qual[x].col1 = "BMC - patient wants referal"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->bmcpatientwantsrefer)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "BMC - patient referral compleated"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->bmcpatientwantsrefercompl)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "BFMC/BMLH - Patient wants referal"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->mlhfmcpatientwantsrefer)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "BFMC/BMLH - Patient referral compleated"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->mlhfmcpatientwantsrefercompl)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Smoking Referral Outcome"
  SET output->qual[x].col2 = ""
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Agreed to counseling"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->patagreetocounseling)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "not ready to quit at this time"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->notreadytoquit)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Refused counseling"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->refusedcounseling)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Clinical condition precludes counseling"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->clinicalcondition)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Smoking referrals"
  SET output->qual[x].col2 = ""
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Quit Works"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->quitworks)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Freedom from smoking"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->freedomfromsmokcnt)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Individual counseling"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->individualcounselingcnt)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Pharmacotherapy"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->pharmacotherapy)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Self help"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->selfhelp)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Telephone counseling"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->telephonecounseling)
  SET x = (x+ 1)
  SET output->qual[x].col1 = "Other"
  SET output->qual[x].col2 = cnvtstring(sfeinfo->other)
  SET stat = alterlist(output->qual,x)
  SELECT INTO  $OUTDEV
   substring(0,100,output->qual[d.seq].col1), output->qual[d.seq].col2
