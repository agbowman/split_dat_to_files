CREATE PROGRAM acm_rdm_svc_provider_org_p2:dba
 ...
 SET ms_range = "ACM_RDM_SVC_PROVIDER_ORG_RANGE FULL"
 SET ms_max_name_p = "MAX ENCNTR_ID EVALUATED"
 SET ms_child_script = "ACM_RDM_SVC_PROVIDER_ORG_CC"
