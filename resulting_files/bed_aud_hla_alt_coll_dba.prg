CREATE PROGRAM bed_aud_hla_alt_coll:dba
 ...
 SET rpt_request->activity_type_cd = uar_get_code_by("MEANING",106,"HLA")
 EXECUTE bed_aud_alt_collections  WITH replace("REQUEST",rpt_request)
 IF ((reply->output_filename > " "))
  SET request->output_filename = build("bed_aud_hla_alt_coll.csv")
