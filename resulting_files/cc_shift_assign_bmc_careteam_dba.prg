CREATE PROGRAM cc_shift_assign_bmc_careteam:dba
 PROMPT
 ...
 SELECT INTO  $1
  ...
  sa.beg_effective_dt_tm";;Q", sa.end_effective_dt_tm";;Q", sa.active_ind,
  sa.updt_cnt, sa.updt_dt_tm";;Q", sa.updt_id,
  ...
  FROM dcp_shift_assignment sa,
   ...
   dummyt d1
  PLAN (sa
   WHERE sa.loc_facility_cd IN (673936, 679549))
   JOIN (ctp
