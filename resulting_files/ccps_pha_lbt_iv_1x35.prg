CREATE PROGRAM ccps_pha_lbt_iv_1x35
 PROMPT
 ...
 DECLARE _remgeneric_name = i2 WITH noconstant(1), protect
 DECLARE _remingredients_freetext_dose = i2 WITH noconstant(1), protect
 ...
 SUBROUTINE initializereport(dummy)
   ...
   SET rptreport->m_reportname = "CCPS_PHA_LBT_IV_1X35"
