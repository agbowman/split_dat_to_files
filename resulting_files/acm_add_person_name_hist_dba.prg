CREATE PROGRAM acm_add_person_name_hist:dba
 ...
 INSERT  FROM person_name_hist pnh,
  ...
  SET pnh.person_name_hist_id = seq(person_seq,nextval), pnh.person_id = acm_request->
   person_name_qual[xref->add[d.seq].idx].person_id, pnh.pm_hist_tracking_id = acm_request->
   person_name_qual[xref->add[d.seq].idx].pm_hist_tracking_id,
   pnh.transaction_dt_tm = cnvtdatetime(acm_request->person_name_qual[xref->add[d.seq].idx].
    transaction_dt_tm), pnh.person_name_id = acm_request->person_name_qual[xref->add[d.seq].idx].
   person_name_id, pnh.end_effective_dt_tm = cnvtdatetime(acm_request->person_name_qual[xref->add[d
    .seq].idx].end_effective_dt_tm),
   pnh.beg_effective_dt_tm = cnvtdatetime(acm_request->person_name_qual[xref->add[d.seq].idx].
    beg_effective_dt_tm), pnh.name_type_cd = acm_request->person_name_qual[xref->add[d.seq].idx].
   name_type_cd, pnh.name_first = acm_request->person_name_qual[xref->add[d.seq].idx].name_first,
   pnh.name_middle = acm_request->person_name_qual[xref->add[d.seq].idx].name_middle, pnh.name_last
    = acm_request->person_name_qual[xref->add[d.seq].idx].name_last, pnh.name_degree = acm_request->
   person_name_qual[xref->add[d.seq].idx].name_degree,
   pnh.name_prefix = acm_request->person_name_qual[xref->add[d.seq].idx].name_prefix, pnh.name_suffix
    = acm_request->person_name_qual[xref->add[d.seq].idx].name_suffix, pnh.name_title = acm_request->
   person_name_qual[xref->add[d.seq].idx].name_title,
   pnh.name_full = acm_request->person_name_qual[xref->add[d.seq].idx].name_full, pnh.tracking_bit =
   tracking_bit, pnh.change_bit = chgbit,
