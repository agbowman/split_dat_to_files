CREATE PROGRAM dm_cmb_multimedia_82:dba
 ...
 ENDIF
 EXECUTE dm_dbimport "cer_install:dm_cmb_multimedia_82.csv", "dm_dm_cmb_exception_import", 10
 IF ((readme_data->status="F"))
  SET readme_data->message = "cer_install:cdi_custom_cmb_import.csv was not found"
  GO TO end_program
 ENDIF
