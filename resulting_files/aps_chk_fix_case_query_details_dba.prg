CREATE PROGRAM aps_chk_fix_case_query_details:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "aps_chk_fix_case_query_details"
...
#exit_script
 IF (itemcount > 0)
  ROLLBACK
  CALL logmsg("ap_case_query_details populate failed.",((e_rdmstatus+ e_dispmsg)+ e_logtofile))
  CALL logstatus("Execution failed - see log message for more details.","F")
 ELSE
  CALL logmsg("ap_case_query_details populate successful.",((e_rdmstatus+ e_dispmsg)+ e_logtofile))
