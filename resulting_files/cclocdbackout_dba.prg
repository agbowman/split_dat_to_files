CREATE PROGRAM cclocdbackout:dba
 SET interactive = validate(reply->ops_event,"ZZZ")
 IF (interactive="ZZZ")
  CALL echo("****************************************************************")
  CALL echo("*** ERROR - cclocdbackout was used by Installation Manager.  ***")
 ...
 ELSE
  ...
  CALL uar_sysevent(hsys,0,"CCLOCDBackout",nullterm(trim(reply->ops_event)))
