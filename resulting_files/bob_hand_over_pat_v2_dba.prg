CREATE PROGRAM bob_hand_over_pat_v2:dba
 PROMPT
 ...
 SUBROUTINE headpageabs(ncalc,offsetx,offsety)
   ...
   DECLARE __date = vc WITH noconstant(build2(format(cnvtdatetime(curdate,curtime2),
      "MM/DD/YY HH:MM ;;D"),char(0))), protect
   IF (ncalc=rpt_render)
    SET rptsd->m_flags = 0
    SET rptsd->m_borders = rpt_sdnoborders
    SET rptsd->m_padding = rpt_sdnoborders
 ...
 SUBROUTINE initializereport(dummy)
   ...
   SET rptreport->m_reportname = "BOB_HAND_OVER_PAT_V2"
