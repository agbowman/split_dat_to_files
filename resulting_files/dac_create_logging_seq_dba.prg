CREATE PROGRAM dac_create_logging_seq:dba
 ...
 SET readme_data->message = "Readme failed: starting script dac_create_logging_seq..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("DAC_LOGGING_SEQ")
 SELECT INTO "nl:"
