CREATE PROGRAM bhs_rpt_wound_vac:dba
 PROMPT
 ...
 SET echo_ind = 1
 SET rpt_name = "Patients with Active Wound Vac orders"
 SET prg_name = cnvtlower(curprog)
 DECLARE mf_woundvac_cd = f8 WITH protect, constant(uar_get_code_by("DISPLAYKEY",200,"WOUNDVAC"))
 DECLARE mrn_cd = f8
 SET mrn_cd = 0.0
 ...
 SELECT INTO  $OUTDEV
  ...
  PLAN (ed
   ...
   WHERE o.encntr_id=e.encntr_id
    AND o.catalog_cd=mf_woundvac_cd
 ...
 ;end select
#exit_script
 SET last_mod = "006 10/16/17 NA033934 SR 417129731- remove child orders"
END GO
