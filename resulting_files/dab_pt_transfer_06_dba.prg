CREATE PROGRAM dab_pt_transfer_06:dba
 PROMPT
 ...
 ELSE
  SET pt_transfer->encntr_id = 162232717.00
  SET printer_disp =  $1
 ENDIF
 ...
 SELECT INTO "nl"
  ...
  HEAD problem_string
   IF (size(trim(problem_string,3)) > 0)
    prob_cnt += 1, stat = alterlist(pt_transfer->problem,prob_cnt), pt_transfer->problem_cnt =
    prob_cnt,
  ...
  DETAIL
   IF (size(trim(problem_string,3)) > 0
    ...
    comm_cnt += 1, stat = alterlist(pt_transfer->problem[prob_cnt].comments,comm_cnt), pt_transfer->
    problem[prob_cnt].comment_cnt = comm_cnt,
 ...
 SELECT INTO "nl:"
  ...
  PLAN (o
   ...
   WHERE ce.order_id=o.order_id
    ...
    AND (((pt_transfer->disch_date > 0)
    AND ce.event_end_dt_tm >= cnvtdatetime(datetimeadd(pt_transfer->disch_date,- (7.0)))
 ...
 SELECT INTO "nl:"
  ...
  HEAD ce.event_id
   ...
   .event_set_name="Discharge Summary - Dictated")) )) )) )
    discharge_found = 1
   ENDIF
 ...
 SET form_data->qual[18].dcp_forms_ref_id = 84373734.00
 SET form_data->qual[18].type = "Braden"
 SET form_data->qual[18].max_cnt = 1
 SET form_data->qual[18].cur_cnt = 0
 SET form_data->qual[19].dcp_forms_ref_id = 90718331.00
 SET form_data->qual[19].type = "Braden Newborn"
 SET form_data->qual[19].max_cnt = 1
 SET form_data->qual[19].cur_cnt = 0
 SET form_data->qual[20].dcp_forms_ref_id = 90720693.00
 SET form_data->qual[20].type = "Braden Pedi"
 SET form_data->qual[20].max_cnt = 1
 SET form_data->qual[20].cur_cnt = 0
 SET form_data->qual[21].dcp_forms_ref_id = 90854766.00
 SET form_data->qual[21].type = "OT Eval Pedi"
 SET form_data->qual[21].max_cnt = 1
 SET form_data->qual[21].cur_cnt = 0
 SET form_data->qual[22].dcp_forms_ref_id = 90853490.00
 SET form_data->qual[22].type = "OT Feeding Eval Pedi"
 SET form_data->qual[22].max_cnt = 1
 SET form_data->qual[22].cur_cnt = 0
 SET form_data->qual[23].dcp_forms_ref_id = 90850179.00
 SET form_data->qual[23].type = "OT Swallow Pedi"
 SET form_data->qual[23].max_cnt = 1
 SET form_data->qual[23].cur_cnt = 0
 SET form_data->qual[24].dcp_forms_ref_id = 90848762.00
 SET form_data->qual[24].type = "OT Treatment Pedi"
 SET form_data->qual[24].max_cnt = 2
 SET form_data->qual[24].cur_cnt = 0
 SET form_data->qual[25].dcp_forms_ref_id = 90848198.00
 SET form_data->qual[25].type = "PT Eval Pedi"
 SET form_data->qual[25].max_cnt = 1
 SET form_data->qual[25].cur_cnt = 0
 SET form_data->qual[26].dcp_forms_ref_id = 90843017.00
 SET form_data->qual[26].type = "PT Treat Pedi"
 SET form_data->qual[26].max_cnt = 2
 SET form_data->qual[26].cur_cnt = 0
 SET form_data->qual[27].dcp_forms_ref_id = 90839162.00
 SET form_data->qual[27].type = "ST Barium Swallow Pedi"
 SET form_data->qual[27].max_cnt = 1
 SET form_data->qual[27].cur_cnt = 0
 SET form_data->qual[28].dcp_forms_ref_id = 90835564.00
 SET form_data->qual[28].type = "ST Speech Pedi"
 SET form_data->qual[28].max_cnt = 1
 SET form_data->qual[28].cur_cnt = 0
 SET form_data->qual[29].dcp_forms_ref_id = 90831090.00
 SET form_data->qual[29].type = "ST Treatment Pedi"
 SET form_data->qual[29].max_cnt = 2
 SET form_data->qual[29].cur_cnt = 0
 SET form_data->qual[30].dcp_forms_ref_id = 90841023.00
 SET form_data->qual[30].type = "ST BS Swallow Pedi"
 SET form_data->qual[30].max_cnt = 1
 ...
 SELECT INTO "nl:"
  ...
  ELSEIF ((form_results->form_qual[d.seq].form_type IN ("PT Eval1", "PT Eval2", "PT Eval Pedi"))) 3
  ELSEIF ((form_results->form_qual[d.seq].form_type="PT Eval3")) 4
  ELSEIF ((form_results->form_qual[d.seq].form_type IN ("PT Treat1", "PT Treat Pedi"))) 5
  ELSEIF ((form_results->form_qual[d.seq].form_type IN ("OT Eval1", "OT Eval Pedi",
  "OT Feeding Eval Pedi", "OT Swallow Pedi"))) 6
  ELSEIF ((form_results->form_qual[d.seq].form_type IN ("OT Treat1", "OT Treatment Pedi"))) 7
  ELSEIF ((form_results->form_qual[d.seq].form_type IN ("ST Eval1", "ST Eval2", "ST Eval3",
  "ST Eval4", "ST Barium Swallow Pedi",
  "ST Speech Pedi", "ST BS Swallow Pedi"))) 8
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   IF ((pt_transfer->disch_date > 0))
    xcol = 30, ycol += 12, row + 1,
    CALL print(calcpos(xcol,ycol)), "{b}{u}Dietary before discharge:{endb}{endu}"
   ELSE
    xcol = 30, ycol += 12, row + 1,
   ...
   ELSE
    ...
    ELSE
     xcol = 100
    ENDIF
    CALL print(calcpos(xcol,ycol)), "No Diet Orders found.", ycol += 12,
    row + 1
   ENDIF
   IF (ycol > 725)
    BREAK
   ...
   ELSE
    xcol = 100, row + 1,
    CALL print(calcpos(xcol,ycol)),
    "No Problem Assessment found.", ycol += 12
   ENDIF
   found = 0
   FOR (x = 1 TO pt_transfer->blob_cnt)
     FOR (y = 1 TO pt_transfer->blob_qual[x].blobs_cnt)
   ...
   IF (found=0)
    ycol += 12, row + 1, xcol = 30,
    CALL print(calcpos(xcol,ycol)),
    "{f/0}{cpi/14}{b}No Nursing Discharge Status Report documents found on visit.{endb}", ycol += 12,
    row + 1
   ENDIF
   output_display = " ", output_display1 = " ", output_display2 = " "
   ...
   ELSE
    xcol = 30, row + 1,
    CALL print(calcpos(xcol,ycol)),
    "{b}No Nutrition Form results found on visit.{endb}", ycol += 12, row + 1,
    xcol = 30, row + 1,
    CALL print(calcpos(xcol,ycol)),
    "{b}No Assessment or Treatment Form results found on visit.{endb}", ycol += 12, row + 1
   ENDIF
   IF (ycol > 725)
    BREAK
   ENDIF
   ...
   ycol += 12,
   row + 1, xcol = 30, row + 1,
   CALL print(calcpos(xcol,ycol)), "{b}Patient's Inpatient Stay.{endb}", ycol += 12,
   row + 1
   IF (ycol > 725)
    BREAK
   ENDIF
   ...
   IF ((pt_transfer->disch_date > 0))
    xcol = 30, row + 1,
    CALL print(calcpos(xcol,ycol)),
    "{f/0}{cpi/14}{b}{u}Lab results in the last 7 days before discharge:{endb}{endu}"
   ELSE
    xcol = 30, row + 1,
    CALL print(calcpos(xcol,ycol)),
    "{f/0}{cpi/14}{b}{u}Lab results in the last 7 days:{endb}{endu}"
   ENDIF
