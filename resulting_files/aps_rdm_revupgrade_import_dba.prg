CREATE PROGRAM aps_rdm_revupgrade_import:dba
 ...
 SET readme_data->message = "Failed starting script aps_rdm_revupgrade_import"
 SET errcode = 0
 SET importfile = build("apsrev")
 ...
 IF (errcode=0)
  ...
  ELSE
   SET readme_data->message = "Starting to import APS EKS Template changes"
...
#exit_program
 ...
 ELSE
  ...
  SET readme_data->message = "APS EKS Templates have been imported."
  CALL echo(readme_data->message)
 ENDIF
