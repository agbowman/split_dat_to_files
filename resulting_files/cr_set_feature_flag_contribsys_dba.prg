CREATE PROGRAM cr_set_feature_flag_contribsys:dba
 ...
 END ;Subroutine
 SET readme_data->status = "F"
 SET readme_data->message = concat("Error: Fail starting script cr_set_feature_flag_contribsys:",
  error_msg)
 CALL setfeatureflag("DIST CONTRIB SYS",onflag)
