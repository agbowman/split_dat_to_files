CREATE PROGRAM bbd_chg_donor_orgs_status:dba
 RECORD reply(
   1 status_data
     2 status = c1
     2 subeventstatus[1]
 ...
 IF ((request->active_ind=1))
  ...
  IF (curqual=0)
   ...
   SET reply->status_data.subeventstatus[1].sourceobjectvalue = "bbd_chg_donor_orgs_status"
  ...
  UPDATE  FROM person_org_reltn po
   ...
   WHERE po.person_org_reltn_cd=donor_org_cd
 ...
 ELSE
  ...
  IF (curqual=0)
   SET failed = "T"
   SET reply->status_data.subeventstatus[1].sourceobjectname = "script"
   SET reply->status_data.subeventstatus[1].sourceobjectvalue = "bbd_chg_donor_status_status"
   SET reply->status_data.subeventstatus[1].operationname = "update"
   SET reply->status_data.subeventstatus[1].operationstatus = "F"
   SET reply->status_data.subeventstatus[1].targetobjectname = "person organization relation"
   SET reply->status_data.subeventstatus[1].targetobjectvalue = "person_org_reltn"
