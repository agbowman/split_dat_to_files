CREATE PROGRAM dd_set_feature_flag_oos_meds:dba
 ...
 ENDIF
 DECLARE setfeatureflag(flagname=vc,flagvalue=i2) = i2
 DECLARE insertflag(flagname=vc,flagvalue=i2) = i2
 DECLARE updateflag(flagname=vc,flagvalue=i2) = i2
 ...
 SUBROUTINE setfeatureflag(flagname,flagvalue)
 ...
 END ;Subroutine
 SET readme_data->status = "F"
 SET readme_data->message = concat("Error: Fail starting script dd_set_feature_flag_oos_meds:",
  error_msg)
 CALL setfeatureflag("OVERRIDE_ORG_SECURITY_MEDS",onflag)
