CREATE PROGRAM dm_ocmb_order_hp_detail:dba
 ...
 IF ((dm_cmb_cust_script->exc_maint_ind=1))
  ...
  SET dcem_request->qual[1].child_entity = "ORDER_HEALTH_PLAN_DETAIL"
  SET dcem_request->qual[1].op_type = "COMBINE"
  SET dcem_request->qual[1].script_name = "DM_OCMB_ORDER_HP_DETAIL"
 ...
 SELECT INTO "nl:"
  frm.*
  FROM order_health_plan_detail frm
 ...
 SUBROUTINE (updt_from(lidx=i4) =i2)
   UPDATE  FROM order_health_plan_detail frm
   ...
   SET request->xxx_combine_det[icombinedet].entity_name = "ORDER_HEALTH_PLAN_DETAIL"
   ...
   IF (curqual=0)
    ...
    SET request->error_message = build("Error updating into order_health_plan_detail with id=",
