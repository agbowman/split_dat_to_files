CREATE PROGRAM bed_ens_rx_order_set:dba
 ...
 RECORD request_main(
   ...
   1 components[*]
     ...
     2 infuse_over = f8
     2 infuse_over_units_code_value = f8
     2 freetext_rate = vc
     2 stop_type_code_value = f8
     2 duration = f8
     2 duration_units_code_value = f8
     2 dispense_category_code_value = f8
     2 order_alert_code_value = f8
     ...
     2 notes[*]
       ...
       3 label_ind = i2
       3 fill_list_ind = i2
     2 default_ordered_as_synonym_id = f8
   1 facilities[*]
     2 action_flag = i2
     2 code_value = f8
   1 skip_duplicate_check_ind = i2
 )
 SET error_flag = "N"
 SET cnt = 0
 SET ccnt = 0
 ...
 SET ccnt = size(request->components,5)
 SET stat = alterlist(request_main->components,ccnt)
 DECLARE def_ord_as_value = f8
 FOR (y = 1 TO ccnt)
   SET request_main->components[y].action_ind = request->components[y].action_ind
   SET request_main->components[y].action_flag = request->components[y].action_flag
   SET request_main->components[y].sequence = request->components[y].sequence
   SET request_main->components[y].norm_rate_ind = request->components[y].norm_rate_ind
   SET request_main->components[y].medication_ind = request->components[y].medication_ind
   SET request_main->components[y].intermittent_ind = request->components[y].intermittent_ind
   SET request_main->components[y].continuous_ind = request->components[y].continuous_ind
   SET request_main->components[y].default_flag = request->components[y].default_flag
   SET request_main->components[y].route_code_value = request->components[y].route_code_value
   SET request_main->components[y].frequency_code_value = request->components[y].frequency_code_value
   SET request_main->components[y].prn_ind = request->components[y].prn_ind
   SET request_main->components[y].prn_reason_code_value = request->components[y].
   prn_reason_code_value
   SET request_main->components[y].rate = request->components[y].rate
   SET request_main->components[y].rate_units_code_value = request->components[y].
   rate_units_code_value
   SET request_main->components[y].normal_rate = request->components[y].normal_rate
   SET request_main->components[y].normal_rate_units_code_value = request->components[y].
   normal_rate_units_code_value
   SET request_main->components[y].infuse_over = request->components[y].infuse_over
   SET request_main->components[y].infuse_over_units_code_value = request->components[y].
   infuse_over_units_code_value
   SET request_main->components[y].freetext_rate = request->components[y].freetext_rate
   SET request_main->components[y].stop_type_code_value = request->components[y].stop_type_code_value
   SET request_main->components[y].duration = request->components[y].duration
   SET request_main->components[y].duration_units_code_value = request->components[y].
   duration_units_code_value
   SET request_main->components[y].dispense_category_code_value = request->components[y].
   dispense_category_code_value
   SET request_main->components[y].order_alert_code_value = request->components[y].
   order_alert_code_value
   SET request_main->components[y].price_schedule_id = request->components[y].price_schedule_id
   SET request_main->components[y].id = request->components[y].id
   SET request_main->components[y].dose = request->components[y].dose
   SET request_main->components[y].dose_unit_code_value = request->components[y].dose_unit_code_value
   SET request_main->components[y].freetext_dose = request->components[y].freetext_dose
   SET request_main->components[y].strength_ind = request->components[y].strength_ind
   SET request_main->components[y].volume_ind = request->components[y].volume_ind
   ...
   ENDFOR
   SET cnt = size(request->components[y].notes,5)
   SET stat = alterlist(request_main->components[y].notes,cnt)
   FOR (x = 1 TO cnt)
     SET request_main->components[y].notes[x].text = request->components[y].notes[x].text
     SET request_main->components[y].notes[x].mar_ind = request->components[y].notes[x].mar_ind
     SET request_main->components[y].notes[x].label_ind = request->components[y].notes[x].label_ind
     SET request_main->components[y].notes[x].fill_list_ind = request->components[y].notes[x].
     fill_list_ind
   ENDFOR
   SET def_ord_as_value = 0
   IF (validate(request->components[y].default_ordered_as_synonym_id))
    SET def_ord_as_value = request->components[y].default_ordered_as_synonym_id
   ENDIF
   SET request_main->components[y].default_ordered_as_synonym_id = def_ord_as_value
 ENDFOR
 SET request_main->skip_duplicate_check_ind = request->skip_duplicate_check_ind
 ...
 ;end select
 SET fac_found = 0
 SET cnt = size(request_main->facilities,5)
 IF (((cnt=0) OR ((request_main->facilities[1].code_value=0))) )
  SET fac = "All"
 ELSE
  FOR (x = 1 TO cnt)
    IF ((request_main->facilities[x].action_flag=1)
     AND fac_found=0)
     SET fac_found = 1
     SELECT INTO "nl:"
      FROM code_value c
      PLAN (c
       WHERE (c.code_value=request_main->facilities[x].code_value))
      DETAIL
       fac = c.display
      WITH nocounter
     ;end select
 ...
 SET unique_id_text = replace(unique_id_text,"/f",trim(fac))
 ...
 IF ((request_main->action_flag=1))
  ...
  IF ((request_main->skip_duplicate_check_ind=0))
   FREE SET iv
   RECORD iv(
     1 qual[*]
       2 id = f8
   ...
   SELECT INTO "nl:"
    ...
    HEAD mis.parent_item_id
     ...
     iv->qual[ivcnt].id = mis.parent_item_id, iv->qual[ivcnt].name = mi.value, iv->qual[ivcnt].
     dup_ind = 1
    HEAD mis.child_item_id
     ...
     ingred_found = 0
     FOR (x = 1 TO size(request_main->components,5))
       IF ((mis.child_item_id=request_main->components[x].id))
        ingred_found = 1, iv->qual[ivcnt].ingred[ingcnt].found_ind = 1
        IF ((request_main->components[x].strength_ind=1))
         IF ((round(mod.strength,4)=request_main->components[x].dose)
          AND (mod.strength_unit_cd=request_main->components[x].dose_unit_code_value))
          iv->qual[ivcnt].ingred[ingcnt].dup_ind = 1
         ENDIF
        ENDIF
        IF ((request_main->components[x].volume_ind=1))
         IF ((round(mod.volume,4)=request_main->components[x].dose)
          AND (mod.volume_unit_cd=request_main->components[x].dose_unit_code_value))
          iv->qual[ivcnt].ingred[ingcnt].dup_ind = 1
         ENDIF
        ENDIF
        IF ((request_main->components[x].strength_ind=0)
         AND (request_main->components[x].volume_ind=0))
         IF ((round(mod.strength,4)=request_main->components[x].dose)
          AND (mod.strength_unit_cd=request_main->components[x].dose_unit_code_value))
          iv->qual[ivcnt].ingred[ingcnt].dup_ind = 1
         ENDIF
   ...
   FOR (x = 1 TO ivcnt)
    IF ((iv->qual[x].dup_ind=1))
     IF (size(request_main->components,5) != size(iv->qual[x].ingred,5))
    ...
    ENDIF
    IF ((iv->qual[x].dup_ind=1))
     SET ingred_dup_ind = 1
     SET ingred_dup_name = iv->qual[x].name
    ENDIF
   ENDFOR
   IF (ingred_dup_ind=1)
    GO TO exit_script
  ...
  SET request->meddefqual[1].med_type_flag = 4
  ...
  SET ccnt = size(request_main->components,5)
  ...
  SET request->meddefqual[1].meddefflexqual[1].medidentifierqual[1].med_type_flag = 4
  ...
  SET request->meddefqual[1].meddefflexqual[1].medidentifierqual[2].med_type_flag = 4
  ...
  SET request->meddefqual[1].meddefflexqual[1].medidentifierqual[3].med_type_flag = 4
  ...
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  volume_unit_cd = 0
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].route_cd = 0
  ...
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  infuse_over_cd = 0
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].duration = 0
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  duration_unit_cd = 0
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].stop_type_cd
   = 0
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  dispense_category_cd = request_main->components[1].dispense_category_code_value
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  ...
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].nbr_labels
   = 0
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  ord_as_synonym_id = request_main->components[1].default_ordered_as_synonym_id
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  ord_as_synonym_exists = 1
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].rate =
  request_main->components[1].rate
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].rate_cd =
  request_main->components[1].rate_units_code_value
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  normalized_rate = request_main->components[1].normal_rate
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  normalized_rate_cd = request_main->components[1].normal_rate_units_code_value
  SET request->meddefqual[1].meddefflexqual[1].medflexobjidxqual[1].medoedefaultsqual[1].
  freetext_rate = request_main->components[1].freetext_rate
  ...
  SET request->meddefqual[1].meddefflexqual[2].active_status_cd = 188
  ...
  SET request->meddefqual[1].meddefflexqual[2].medflexobjidxqual[1].meddispensequal[1].oe_format_flag
   = request_main->components[1].default_flag
  SET request->meddefqual[1].meddefflexqual[2].medflexobjidxqual[1].meddispensequal[1].med_filter_ind
   = request_main->components[1].medication_ind
  SET request->meddefqual[1].meddefflexqual[2].medflexobjidxqual[1].meddispensequal[1].
  continuous_filter_ind = request_main->components[1].continuous_ind
  SET request->meddefqual[1].meddefflexqual[2].medflexobjidxqual[1].meddispensequal[1].
  intermittent_filter_ind = request_main->components[1].intermittent_ind
  ...
  FOR (y = 1 TO fcnt)
    ...
    request_main->facilities[y].code_value
  ...
  FOR (x = 1 TO ccnt)
    SET comment1_type = 0
    SET comment2_type = 0
    SET ncnt = size(request_main->components[x].notes,5)
    IF (ncnt > 0)
     SET comment1_text = request_main->components[x].notes[1].text
     IF ((request_main->components[x].notes[1].mar_ind=1))
      SET comment1_type = (comment1_type+ 2)
     ENDIF
     IF ((request_main->components[x].notes[1].fill_list_ind=1))
      SET comment1_type = (comment1_type+ 1)
     ENDIF
     IF ((request_main->components[x].notes[1].label_ind=1))
      SET comment1_type = (comment1_type+ 4)
     ENDIF
    ENDIF
    IF (ncnt=2)
     SET comment2_text = request_main->components[x].notes[2].text
     IF ((request_main->components[x].notes[2].mar_ind=1))
      SET comment2_type = (comment2_type+ 2)
     ENDIF
     IF ((request_main->components[x].notes[2].fill_list_ind=1))
      SET comment2_type = (comment2_type+ 1)
     ENDIF
     IF ((request_main->components[x].notes[2].label_ind=1))
    ...
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].sequence = request_main->components[x].sequence
    ...
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].pack[1].description = "EA"
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].pack[1].uom_cd = ea_cd
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].pack[1].base_uom_cd = 0
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].pack[1].qty = 1
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].pack[1].base_package_type_ind = 1
    ...
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[1].meddispensequal[1].
    formulary_status_cd = 0
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[1].meddispensequal[1].
    oe_format_flag = request_main->components[x].default_flag
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[1].meddispensequal[1].
    med_filter_ind = request_main->components[x].medication_ind
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[1].meddispensequal[1].
    continuous_filter_ind = request_main->components[x].continuous_ind
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[1].meddispensequal[1].
    intermittent_filter_ind = request_main->components[x].intermittent_ind
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[1].meddispensequal[1].
    tpn_filter_ind = 0
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[1].meddispensequal[1].
    max_par_supply = 0
    ...
    IF ((request_main->components[x].strength_ind=1))
     SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
     strength = request_main->components[x].dose
     SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
     strength_unit_cd = request_main->components[x].dose_unit_code_value
    ELSEIF ((request_main->components[x].volume_ind=1))
     SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
     volume = request_main->components[x].dose
     SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
     volume_unit_cd = request_main->components[x].dose_unit_code_value
    ENDIF
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    route_cd = request_main->components[x].route_code_value
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    frequency_cd = request_main->components[x].frequency_code_value
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    prn_ind = request_main->components[x].prn_ind
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    prn_reason_cd = request_main->components[x].prn_reason_code_value
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    infuse_over = request_main->components[x].infuse_over
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    infuse_over_cd = request_main->components[x].infuse_over_units_code_value
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    duration = request_main->components[x].duration
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    duration_unit_cd = request_main->components[x].duration_units_code_value
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    stop_type_cd = request_main->components[x].stop_type_code_value
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    dispense_category_cd = request_main->components[x].dispense_category_code_value
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    alternate_dispense_category_cd = 0
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    comment1_id = 0
    ...
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    price_sched_id = request_main->components[x].price_schedule_id
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    active_ind = 1
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    updt_cnt = 0
    ...
    nbr_labels = 1
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    ord_as_synonym_id = request_main->components[x].default_ordered_as_synonym_id
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    ord_as_synonym_exists = 1
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].rate
     = request_main->components[x].rate
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    rate_cd = request_main->components[x].rate_units_code_value
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    normalized_rate = request_main->components[x].normal_rate
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    normalized_rate_cd = request_main->components[x].normal_rate_units_code_value
    SET request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].medoedefaultsqual[1].
    freetext_rate = request_main->components[x].freetext_rate
    SET stat = alterlist(request->meddefqual[1].meddefflexqual[(z+ 1)].medflexobjidxqual[2].
     medproductqual,0)
    ...
    SET request->meddefqual[1].medingredqual[x].sequence = request_main->components[x].sequence
    SET request->meddefqual[1].medingredqual[x].child_item_id = request_main->components[x].id
    ...
    IF ((request_main->components[x].action_ind=1))
     SET action_cd = include_cd
    ELSEIF ((request_main->components[x].action_ind=2))
     SET action_cd = exclude_cd
    ELSEIF ((request_main->components[x].action_ind=3))
     SET action_cd = review_cd
    ENDIF
    SET request->meddefqual[1].medingredqual[x].default_action_cd = action_cd
    SET request->meddefqual[1].medingredqual[x].updt_cnt = 0
    SET request->meddefqual[1].medingredqual[x].normalized_rate_ind = request_main->components[x].
    norm_rate_ind
  ...
  FOR (y = 1 TO size(request->meddefqual[1].meddefflexqual,5))
    IF ((request->meddefqual[1].meddefflexqual[y].flex_type_cd=syspkg_cd))
     ...
     FOR (l = 1 TO size(request_main->facilities,5))
       ...
       ENDIF
     ENDFOR
     IF ((request->meddefqual[1].meddefflexqual[y].sequence=0))
      FOR (l = 1 TO size(request->meddefqual[1].meddefflexqual[y].medflexobjidxqual,5))
       ...
       dispense_cd))
        ...
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].meddispensequal[1].
        db_rec_status = 1
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].meddispensequal[1].
        oe_format_flag = request_main->components[1].default_flag
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].meddispensequal[1].
        med_filter_ind = request_main->components[1].medication_ind
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].meddispensequal[1].
        continuous_filter_ind = request_main->components[1].continuous_ind
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].meddispensequal[1].
        intermittent_filter_ind = request_main->components[1].intermittent_ind
       ...
       oedef_cd))
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].db_rec_status = 1
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].medoedefaultsqual[1].rate
         = request_main->components[1].rate
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].medoedefaultsqual[1].
        rate_cd = request_main->components[1].rate_units_code_value
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].medoedefaultsqual[1].
        normalized_rate = request_main->components[1].normal_rate
        SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[l].medoedefaultsqual[1].
        normalized_rate_cd = request_main->components[1].normal_rate_units_code_value
    ...
    ENDIF
  ENDFOR
  SET stat = alterlist(temp->qual,size(request->meddefqual[1].meddefflexqual,5))
  FOR (x = 1 TO size(request_main->components,5))
    SET comment1_type = 0
    SET comment2_type = 0
    SET ncnt = size(request_main->components[x].notes,5)
    ...
    SELECT INTO "nl:"
     ...
     PLAN (m
      WHERE (m.parent_item_id=request_main->item_id)
       AND (m.child_item_id=request_main->components[x].id)
       AND (m.sequence=request_main->components[x].sequence))
     DETAIL
      mis_id = m.med_ingred_set_id, mis_seq = m.sequence
     WITH nocounter
    ;end select
    IF ((request_main->components[x].action_flag=1))
     SET stat = alterlist(request->meddefqual[1].medingredqual,x)
     SET request->meddefqual[1].medingredqual[x].med_ingred_set_id = mis_id
     SET request->meddefqual[1].medingredqual[x].parent_item_id = 0
     SET request->meddefqual[1].medingredqual[x].sequence = request_main->components[x].sequence
     SET request->meddefqual[1].medingredqual[x].child_item_id = request_main->components[x].id
     SET request->meddefqual[1].medingredqual[x].child_med_prod_id = 0
    ...
    FOR (y = 1 TO size(request->meddefqual[1].meddefflexqual,5))
     ...
     IF ((request->meddefqual[1].meddefflexqual[y].flex_type_cd=syspkg_cd)
      ...
      IF ((request_main->components[x].action_flag=3))
       IF ((request->meddefqual[1].meddefflexqual[y].sequence=mis_seq))
      ...
      IF ((request_main->components[x].action_flag=1))
       IF ((request->meddefqual[1].meddefflexqual[y].sequence=mis_seq))
        SET request->meddefqual[1].meddefflexqual[y].db_rec_status = 1
        SET temp->qual[y].sequence = request_main->components[x].sequence
        FOR (q = 1 TO size(request->meddefqual[1].meddefflexqual[y].medflexobjidxqual,5))
         ...
         oedef_cd))
          ...
          SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[q].medoedefaultsqual[1].
          active_ind = 1
          SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[q].medoedefaultsqual[1].rate
           = request_main->components[x].rate
          SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[q].medoedefaultsqual[1].
          rate_cd = request_main->components[x].rate_units_code_value
          SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[q].medoedefaultsqual[1].
         ...
         dispense_cd))
          SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[q].db_rec_status = 1
          SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[q].meddispensequal[1].
          db_rec_status = 1
          SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[q].meddispensequal[1].
          oe_format_flag = request_main->components[x].default_flag
          SET request->meddefqual[1].meddefflexqual[y].medflexobjidxqual[q].meddispensequal[1].
    ...
    IF (mis_seq=0)
     SET z = size(request->meddefqual[1].meddefflexqual,5)
     SET stat = alterlist(request->meddefqual[1].meddefflexqual,(z+ 1))
     SET stat = alterlist(temp->qual,(z+ 1))
     SET temp->qual[(z+ 1)].sequence = request_main->components[x].sequence
     SET request->meddefqual[1].meddefflexqual[(z+ 1)].db_rec_status = 3
  ...
  FOR (y = 1 TO size(request->meddefqual[1].meddefflexqual,5))
    IF ((request->meddefqual[1].meddefflexqual[y].flex_type_cd=syspkg_cd)
     ...
     IF ((request->meddefqual[1].meddefflexqual[y].db_rec_status != 2))
      SET request->meddefqual[1].meddefflexqual[y].sequence = temp->qual[y].sequence
     ENDIF
    ENDIF
  ENDFOR
...
#exit_script
 ...
 ELSE
  ...
  ;end select
  IF (ingred_dup_ind=1)
   SET reply->duplicate_name = ingred_dup_name
  ENDIF
 ENDIF
 IF (error_flag="N")
