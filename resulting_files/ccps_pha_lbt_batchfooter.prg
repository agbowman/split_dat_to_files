CREATE PROGRAM ccps_pha_lbt_batchfooter
 PROMPT
 ...
 DECLARE batch_footer_sec(ncalc=i2) = f8 WITH protect
 DECLARE batch_footer_secabs(ncalc=i2,offsetx=f8,offsety=f8) = f8 WITH protect
 ...
 END ;Subroutine
 SUBROUTINE batch_footer_sec(ncalc)
   DECLARE a1 = f8 WITH noconstant(0.0), private
   SET a1 = batch_footer_secabs(ncalc,_xoffset,_yoffset)
   RETURN(a1)
 END ;Subroutine
 SUBROUTINE batch_footer_secabs(ncalc,offsetx,offsety)
   ...
   IF (ncalc=rpt_render)
    ...
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2("** END OF BATCH **",char(0)))
    SET rptsd->m_flags = 0
 ...
 SUBROUTINE initializereport(dummy)
   ...
   SET rptreport->m_reportname = "CCPS_PHA_LBT_BATCHFOOTER"
 ...
 SET _fdrawheight = batch_footer_sec(rpt_calcheight)
 IF (((_yoffset+ _fdrawheight) > _fenddetail))
  CALL pagebreak(0)
 ENDIF
 SET dummy_val = batch_footer_sec(rpt_render)
