CREATE PROGRAM cls_obalias_audit
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "Enter the Start Date (MMDDYYYY): " = "CURDATE",
  "Enter the End Date (MMDDYYYY) :" = "CURDATE"
 ...
 SELECT INTO  $OUTDEV
  ...
  obalias = substring(1,60,c.alias), cv1.display
  ...
  HEAD REPORT
   ...
   col 130, "Outbound Alias", col 194,
   "Display", row + 1
  DETAIL
