CREATE PROGRAM bhs_prax_recent_patient_ls
 ...
 IF (no_of_pairs > 0)
  ...
  SELECT INTO  $1
   ...
   HEAD e.encntr_id
    ...
    p_refer, row + 1, p_epr = build("<EncounterLevelRelationship>",epr,
     "</EncounterLevelRelationship>"),
    col + 1, p_epr, row + 1,
    ...
    p_patienttype, row + 1, col + 1,
    "</Encounter>", row + 1, col + 1,
    "</Encounters>", row + 1, col + 1,
    "</Patient>", row + 1
   FOOT REPORT
