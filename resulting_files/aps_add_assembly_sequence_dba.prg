CREATE PROGRAM aps_add_assembly_sequence:dba
 ...
 SET readme_data->message = "Readme failed: starting script aps_add_assembly_sequence..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("assembly_seq")
 SELECT INTO "nl:"
