CREATE PROGRAM ct_mp_get_org_of_prot:dba
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "Protocol ID:" = 0,
  "orgSecurity" = 0,
  "GetInactiveAlso" = false
  WITH outdev, protocolid, orgsecurity,
  getinactivealso
 ...
 SUBROUTINE (istaskgranted(task_number=i4(val)) =i2 WITH protect)
   ...
   RETURN(task_granted)
 END ;Subroutine
 SET log_program_name = "CT_MP_GET_ORG_OF_PROT"
 ...
 ELSE
  SELECT INTO "nl:"
   ...
   PLAN (pr_am
    WHERE (pr_am.prot_master_id= $PROTOCOLID))
    JOIN (p
