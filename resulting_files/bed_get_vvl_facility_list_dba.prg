CREATE PROGRAM bed_get_vvl_facility_list:dba
 FREE SET reply
 RECORD reply(
   1 facility[*]
 ...
 SELECT INTO "nl:"
  FROM order_catalog_synonym ocs,
   ocs_facility_r ofr
  PLAN (ocs
   WHERE ocs.catalog_type_cd=pharm_ct
    AND ocs.activity_type_cd=pharm_at
  ...
  HEAD ofr.facility_cd
   ...
   ENDIF
   treply->facility[tcnt].location_code_value = ofr.facility_cd
  FOOT REPORT
