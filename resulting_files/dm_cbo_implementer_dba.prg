CREATE PROGRAM dm_cbo_implementer:dba
 ...
 SUBROUTINE dcr_get_opt_mode_by_name(opt_name)
   RETURN(evaluate(opt_name,"RULE",1,"CHOOSE",2,
    ...
    "ALL_ROWS",8,0))
 END ;Subroutine
 SET dm_err->logfile = "dm_cbo_implementer_static.log"
 CALL init_logfile(dm_err->logfile,"DM_CBO_IMPLEMENTER_STATIC LOGFILE")
 SET dm_err->eproc = "Removing cbo implementer dm_info row"
 CALL disp_msg(" ",dm_err->logfile,0)
...
#exit_script
 IF ((dm_err->err_ind=1))
  SET dm_err->eproc = "DM_CBO_IMPLEMENTER failed"
 ELSE
  SET dm_err->eproc = "DM_CBO_IMPLEMENTER has been obsolesced"
 ENDIF
 CALL final_disp_msg("dm_cbo_implementer")
END GO
