CREATE PROGRAM dm2_ref_data_mover_6349:dba
 ...
 DECLARE cust_prefix = vc WITH protect, constant("RADUDF")
 DECLARE cust_cd_pos = i2 WITH protect, constant(7)
