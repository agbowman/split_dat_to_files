CREATE PROGRAM ccps_pha_lbt_med_1x35
 PROMPT
 ...
 DECLARE _remlabel_description = i2 WITH noconstant(1), protect
 DECLARE _bholdcontinue = i2 WITH noconstant(0), protect
 DECLARE _bcontlabel_description_sec = i2 WITH noconstant(0), protect
 DECLARE _rembrand_name = i2 WITH noconstant(1), protect
 DECLARE _bcontbrand_name_sec = i2 WITH noconstant(0), protect
 DECLARE _remmed_dose_route_freq_prn = i2 WITH noconstant(1), protect
 ...
 SUBROUTINE initializereport(dummy)
   IF (_bsubreport=0)
    ...
    SET rptreport->m_reportname = "CCPS_PHA_LBT_MED_1X35"
 ...
 SET _bsubreport = 1
 EXECUTE ccps_pha_lbt_header_1x35  $1
 SET _bsubreport = 0
 ...
 ENDWHILE
 SET _bsubreport = 1
 EXECUTE ccps_pha_lbt_footer_1x35  $1
 SET _bsubreport = 0
