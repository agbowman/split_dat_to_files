CREATE PROGRAM eds_charge_audit
 PROMPT
 ...
 SELECT INTO value(output_dest)
  ...
  HEAD REPORT
   ...
   held_count_bnh = 0, held_count_oth = 0, susp_count_tot = 0,
  ...
  FOOT  activity_class
   ...
   col + 1, delim, col + 1,
   "Held Charges", col + 1, delim,
   col + 1, held_count_bwh, col + 1,
   delim, col + 1, held_bwh_0_5,
   col + 1, delim, col + 1,
   held_bwh_6_15, col + 1, delim,
   col + 1, held_bwh_16_30, col + 1,
   delim, col + 1, held_bwh_31,
   row + 1, col 1, activity_class,
   col + 1, delim, col + 1,
   "BWH", col + 1, delim,
   col + 1, "Susp Charges", col + 1,
   delim, col + 1, susp_count_bwh,
   col + 1, delim, col + 1,
   susp_bwh_0_5, col + 1, delim,
   col + 1, susp_bwh_6_15, col + 1,
   delim, col + 1, susp_bwh_16_30,
   col + 1, delim, col + 1,
   susp_bwh_31, row + 1, col 1,
   activity_class, col + 1, delim,
   col + 1, "BWH", col + 1,
   delim, col + 1, "Tot  Charges",
   col + 1, delim, col + 1,
   detail_count_bwh, col + 1, delim,
   col + 1, bwh_tot_0_5, col + 1,
   delim, col + 1, bwh_tot_6_15,
   col + 1, delim, col + 1,
   bwh_tot_16_30, col + 1, delim,
   col + 1, bwh_tot_31, row + 1,
   col 1, activity_class, col + 1,
   delim, col + 1, "BNH",
   col + 1, delim, col + 1,
   "Held Charges", col + 1, delim,
   col + 1, held_count_bnh, col + 1,
   delim, col + 1, held_bnh_0_5,
   col + 1, delim, col + 1,
   held_bnh_6_15, col + 1, delim,
   col + 1, held_bnh_16_30, col + 1,
   delim, col + 1, held_bnh_31,
   row + 1, col 1, activity_class,
   col + 1, delim, col + 1,
   "BNH", col + 1, delim,
   col + 1, "Susp Charges", col + 1,
   delim, col + 1, susp_count_bnh,
   col + 1, delim, col + 1,
   susp_bnh_0_5, col + 1, delim,
   col + 1, susp_bnh_6_15, col + 1,
   delim, col + 1, susp_bnh_16_30,
   col + 1, delim, col + 1,
   susp_bnh_31, row + 1, col 1,
   activity_class, col + 1, delim,
   col + 1, "BNH", col + 1,
   delim, col + 1, "Tot  Charges",
   col + 1, delim, col + 1,
   detail_count_bnh, col + 1, delim,
   col + 1, bnh_tot_0_5, col + 1,
   delim, col + 1, bnh_tot_6_15,
   col + 1, delim, col + 1,
   bnh_tot_16_30, col + 1, delim,
   col + 1, bnh_tot_31, row + 1,
   col 1, activity_class, col + 1,
   delim, col + 1, "OTH",
   col + 1, delim, col + 1,
   "Held Charges", col + 1, delim,
   ...
   held_fmc_6_15 = 0, held_fmc_16_30 = 0, held_fmc_31 = 0,
   susp_fmc_0_5 = 0, susp_fmc_6_15 = 0, susp_fmc_16_30 = 0,
   susp_fmc_31 = 0, held_bwh_0_5 = 0, held_bwh_6_15 = 0,
   held_bwh_16_30 = 0, held_bwh_31 = 0, susp_bwh_0_5 = 0,
   susp_bwh_6_15 = 0, susp_bwh_16_30 = 0, susp_bwh_31 = 0,
   held_bnh_0_5 = 0, held_bnh_6_15 = 0, held_bnh_16_30 = 0,
   held_bnh_31 = 0, susp_bnh_0_5 = 0, susp_bnh_6_15 = 0,
   susp_bnh_16_30 = 0, susp_bnh_31 = 0, held_mlh_0_5 = 0,
   held_mlh_6_15 = 0, held_mlh_16_30 = 0, held_mlh_31 = 0,
   susp_mlh_0_5 = 0, susp_mlh_6_15 = 0, susp_mlh_16_30 = 0,
   susp_mlh_31 = 0, held_oth_0_5 = 0, held_oth_6_15 = 0,
   held_oth_16_30 = 0, held_oth_31 = 0, susp_oth_0_5 = 0,
   susp_oth_6_15 = 0, susp_oth_16_30 = 0, susp_oth_31 = 0,
  ...
  FOOT REPORT
   ...
   delim, col + 1, "Held Charges",
   col + 1, delim, col + 1,
   t_held_count_bwh, col + 1, delim,
   col + 1, t_held_bwh_0_5, col + 1,
   delim, col + 1, t_held_bwh_6_15,
   col + 1, delim, col + 1,
   t_held_bwh_16_30, col + 1, delim,
   col + 1, t_held_bwh_31, row + 1,
   col 1, "All Activity", col + 1,
   delim, col + 1, "BWH",
   col + 1, delim, col + 1,
   "Susp Charges", col + 1, delim,
   col + 1, t_susp_count_bwh, col + 1,
   delim, col + 1, t_susp_bwh_0_5,
   col + 1, delim, col + 1,
   t_susp_bwh_6_15, col + 1, delim,
   col + 1, t_susp_bwh_16_30, col + 1,
   delim, col + 1, t_susp_bwh_31,
   row + 1, col 1, "All Activity",
   col + 1, delim, col + 1,
   "BWH", col + 1, delim,
   col + 1, "Tot  Charges", col + 1,
   delim, col + 1, t_detail_count_bwh,
   col + 1, delim, col + 1,
   t_bwh_tot_0_5, col + 1, delim,
   col + 1, t_bwh_tot_6_15, col + 1,
   delim, col + 1, t_bwh_tot_16_30,
   col + 1, delim, col + 1,
   t_bwh_tot_31, row + 1, col 1,
   "All Activity", col + 1, delim,
   col + 1, "BNH", col + 1,
   delim, col + 1, "Held Charges",
   col + 1, delim, col + 1,
   t_held_count_bnh, col + 1, delim,
   col + 1, t_held_bnh_0_5, col + 1,
   delim, col + 1, t_held_bnh_6_15,
   col + 1, delim, col + 1,
   t_held_bnh_16_30, col + 1, delim,
   col + 1, t_held_bnh_31, row + 1,
   col 1, "All Activity", col + 1,
   delim, col + 1, "BNH",
   col + 1, delim, col + 1,
   "Susp Charges", col + 1, delim,
   col + 1, t_susp_count_bnh, col + 1,
   delim, col + 1, t_susp_bnh_0_5,
   col + 1, delim, col + 1,
   t_susp_bnh_6_15, col + 1, delim,
   col + 1, t_susp_bnh_16_30, col + 1,
   delim, col + 1, t_susp_bnh_31,
   row + 1, col 1, "All Activity",
   col + 1, delim, col + 1,
   "BNH", col + 1, delim,
   col + 1, "Tot  Charges", col + 1,
   delim, col + 1, t_detail_count_bnh,
   col + 1, delim, col + 1,
   t_bnh_tot_0_5, col + 1, delim,
   col + 1, t_bnh_tot_6_15, col + 1,
   delim, col + 1, t_bnh_tot_16_30,
   col + 1, delim, col + 1,
   t_bnh_tot_31, row + 1, col 1,
   "All Activity", col + 1, delim,
   col + 1, "OTH", col + 1,
   delim, col + 1, "Held Charges",
   col + 1, delim, col + 1,
 ...
 IF (email_ind=1)
  ...
  CALL emailfile(filename_in,filename_out, $1,concat(curprog,
    " - Baystate Medical Center Mgmt Charge Audit"),1)
 ENDIF
END GO
