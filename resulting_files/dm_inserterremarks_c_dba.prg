CREATE PROGRAM dm_inserterremarks_c:dba
 ...
 IF (((error(errmsg,0) != 0) OR (f_cs25753_reversal_cd=0.0)) )
  ...
  GO TO exit_program
 ENDIF
 SET ms_child_info_domain_nm = "DM_INSERTERREMARKS_README"
 SET ms_range_prefix = "MAX acct_id RANGE"
 SET ms_child_max_name = "MAX acct_id EVALUATED"
