CREATE PROGRAM bb_rdm_stamp_atr:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "bb_rdm_stamp_atr"
 CALL logscriptstart(sreadme_name)
 CALL logmsg("Stamping application ModProducts - 225065",(e_dispmsg+ e_logtofile))
 CALL stamp_app(225065)
 CALL logmsg("Stamping application Receive Products - 225080",(e_dispmsg+ e_logtofile))
 CALL stamp_app(225080)
 CALL logmsg("Stamping application BBVerifyLabel - 225073",(e_dispmsg+ e_logtofile))
 CALL stamp_app(225073)
 CALL logmsg("Stamping application ModifyProducts - 225027",(e_dispmsg+ e_logtofile))
 CALL stamp_app(225027)
 CALL logmsg("Stamping application PoolingTool - 225018",(e_dispmsg+ e_logtofile))
 CALL stamp_app(225018)
 CALL logmsg("Stamping application ModifyTool - 225019",(e_dispmsg+ e_logtofile))
 CALL stamp_app(225019)
 CALL logmsg("Stamping application PoolProducts - 225035",(e_dispmsg+ e_logtofile))
 CALL stamp_app(225035)
 CALL logmsg("Stamping application TransferProducts - 225050",(e_dispmsg+ e_logtofile))
 CALL stamp_app(225050)
