CREATE PROGRAM bed_aud_micro_orc_incmplt:dba
 ...
 SET reply->collist[6].header_text = "Catalog Cd"
 ...
 FOR (x = 1 TO temp->o_cnt)
   ...
   no_coll_req_ind=1))) )) )
    ...
    SET reply->rowlist[row_nbr].celllist[6].double_value = temp->olist[x].catalog_cd
 ...
 SET reply->statlist[1].statistic_meaning = "PATHMICROORCNODTA"
 IF (no_dta_cnt > 0)
 ...
 SET reply->statlist[2].statistic_meaning = "PATHMICROORCNOROUTING"
 IF (no_routing_cnt > 0)
 ...
 SET reply->statlist[3].statistic_meaning = "PATHMICROORCNOCOLLREQ"
...
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("micro_orc_incmplt_audit.csv")
 ENDIF
