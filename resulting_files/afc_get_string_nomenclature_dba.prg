CREATE PROGRAM afc_get_string_nomenclature:dba
 RECORD reply(
 ...
 ENDIF
 SET count1 = 0
 SET 400meaning = fillstring(12," ")
 SET codeset400 = 400
 SET code_value_returned = 0
 SET code_set = 48
 SET cdf_meaning = "ACTIVE"
 SET stat = alterlist(reply->nomenclature,10)
 SET maxnum = 0
 SELECT INTO "nl:"
  ...
  WITH orahint("Index (Nomenclature Nomenclature_1)"), nocounter
 ;end select
