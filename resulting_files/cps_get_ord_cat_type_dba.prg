CREATE PROGRAM cps_get_ord_cat_type:dba
 FREE SET reply
 RECORD context(
 ...
 SELECT
  ...
  DETAIL
   ...
   .orderable_type_flag,
   reply->catalog_item[count1].ref_text_mask = o.ref_text_mask, reply->catalog_item[count1].
   ...
   cki = oc.cki
   IF (count1=100)
    context->mnemonic_key_cap = o.mnemonic_key_cap, context->catalog_type_cd = o.catalog_type_cd
   ENDIF
  FOOT REPORT
