CREATE PROGRAM dm_create_dbarch_gttd:dba
 ...
 IF (check_logfile("dm_create_daf_gttd",".log","dm_create_dbarch_gttd LOG FILE...") != 1)
 ...
 IF ((dm_err->err_ind=0))
  ...
  SET readme_data->message = "Success: GTTDs created"
 ELSE
  SET readme_data->status = "F"
