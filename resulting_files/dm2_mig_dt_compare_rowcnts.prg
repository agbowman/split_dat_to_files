CREATE PROGRAM dm2_mig_dt_compare_rowcnts
 ...
 END ;Subroutine
 SET width = 132
 IF (check_logfile("dm2_migdtcmp_cnts",".log","dm2_mig_dt_compare_rowcnts")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_mig_dt_compare_rowcnts"
 CALL disp_msg(" ",dm_err->logfile,0)
 SET dcr_compare_rowcnts_rec->mode = "DOWNTIME"
 ...
 IF (dcr_prelim(1)=0)
  GO TO exit_program
 ENDIF
 EXECUTE dm2_compare_rowcnts
 IF ((dm_err->err_ind=1))
  GO TO exit_program
 ENDIF
 GO TO exit_program
#exit_program
 SET dm_err->eproc = "dm2_mig_dt_compare_rowcnts completed"
 CALL final_disp_msg("dm2_migdtcmp_cnts")
END GO
