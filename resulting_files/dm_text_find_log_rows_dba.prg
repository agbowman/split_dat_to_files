CREATE PROGRAM dm_text_find_log_rows:dba
 ...
 SET reply->table_name = "DM_TEXT_FIND_LOG"
 ...
 ENDIF
 SELECT INTO "nl:"
  d.dm_text_find_log_id
  FROM dm_text_find_log d
  WHERE parser(sbr_getrowidnotexists("d.dm_text_find_log_id+0 > 0","d"))
