CREATE PROGRAM bhs_ma_genview_consults1:dba
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   clinical_display_line = build(o.order_id,"--",o.clinical_display_line)
  FOOT  o.encntr_id
   stat = alterlist(dlrec->seq[dd.seq].orders,cnt), dlrec->seq[dd.seq].orders_total = cnt
  WITH nocounter
 ;end select
 SELECT INTO "nl:"
  FROM dummyt
