CREATE PROGRAM dcp_upd_fav_icd9_hli_syn_p2:dba
 ...
 SET ms_info_domain_nm = "DCP_UPD_FAV_ALL"
 SET ms_range = "UP RANGE"
 SET ms_max_name_p = "MAX ID EVALUATED"
 SET ms_child_script = "dcp_upd_fav_icd9_hli_syn_cc"
...
#exit_program
 ...
 ELSE
  COMMIT
  CALL sbr_add_dropped_object("INDEX","XIETEMPFAVICD9HLISYN","Dropping index")
  CALL sbr_add_dropped_object("TABLE","TEMP_FAV_ICD9_HLI_SYN","Dropping table")
