CREATE PROGRAM am_activity_seq:dba
 ...
 SET readme_data->message = "Readme failed: starting script add_sequence_tpl..."
 DECLARE errmsg = vc WITH protect, noconstant("")
 DECLARE seqexists = i2 WITH protect, noconstant(0)
 DECLARE sequencename = vc WITH protect, noconstant("AM_ACTIVITY_SEQ")
 SELECT INTO "nl:"
