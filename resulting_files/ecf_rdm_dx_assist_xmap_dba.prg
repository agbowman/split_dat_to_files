CREATE PROGRAM ecf_rdm_dx_assist_xmap:dba
 ...
 SET kia_tbl_desc = "DxAssist XMAP"
 SET kia_short_desc = "DxAssist XMAP"
 SET kia_rdm_log_name = "ecf_rdm_dx_assist_xmap.log"
 SET kia_rdm_nbr = 10877
 SET kia_rdm_vocab_mean = "DXASSIST"
 SET readme_data->status = "F"
 ...
 EXECUTE kia_dm_dbimport "cer_install:dx_assist_version.csv", "kia_get_rdm_vars", 100,
 0
 CALL kia_chk_script_failure("KIA_GET_RDM_VARS")
 SET start_time_var = cnvtdatetime(curdate,curtime3)
 CALL log_sub(concat("ecf_rdm_dx_assist_xmap Begin> ",format(cnvtdatetime(curdate,curtime3),
