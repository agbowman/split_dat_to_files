CREATE PROGRAM bhs_sys_trauma_one_test:dba
 PROMPT
 ...
 SELECT INTO "nl:"
  ...
  PLAN (fn
   ...
   WHERE e.encntr_id=fn.encntr_id
    ...
    AND ((e.disch_dt_tm = null) OR (e.disch_dt_tm BETWEEN cnvtdatetime(cnvtdate( $2),0) AND
   cnvtdatetime(cnvtdate( $2),235959))) )
  DETAIL
