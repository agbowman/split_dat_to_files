CREATE PROGRAM cdi_rpt_create_by_class:dba
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "Layout Program" = "cdi_rpt_create_by_class_lyt",
  "Begin Date" = "CURDATE",
  "End Date" = "CURDATE",
  "Batch Class" = ""
 ...
 DECLARE strlayoutprogram = vc WITH noconstant("cdi_rpt_create_by_class_lyt")
