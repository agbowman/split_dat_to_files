CREATE PROGRAM bbt_chk_del_duplicate_1635:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "bbt_chk_del_duplicate_1635"
...
#exit_script
 IF (curqual > 0)
  ...
  CALL logmsg("Removal of duplicate code_set 1635 entries failed.",((e_rdmstatus+ e_dispmsg)+
   e_logtofile))
 ELSE
  CALL logstatus("Execution successful.","S")
  CALL logmsg("Removal of duplicate code_set 1635 entries was successful.",((e_rdmstatus+ e_dispmsg)
   + e_logtofile))
 ENDIF
