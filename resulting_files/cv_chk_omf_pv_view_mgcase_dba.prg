CREATE PROGRAM cv_chk_omf_pv_view_mgcase:dba
 SET request->setup_proc[1].success_ind = 1
 SET request->setup_proc[1].error_msg = fillstring(200," ")
 SET request->setup_proc[1].error_msg = "CV_OMF_PV_VIEW_MGCASE Successful.  Count= "
 SET v_count1 = 0
 SET v_expected_count = 11
 SELECT INTO "nl:"
  table_count = count(*)
 ...
 IF (v_count1 < v_expected_count)
  ...
  SET request->setup_proc[1].error_msg = concat("CV_OMF_PV_VIEW_CVCASE: Expected ",trim(cnvtstring(
