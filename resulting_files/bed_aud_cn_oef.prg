CREATE PROGRAM bed_aud_cn_oef
 ...
 SET reply->collist[2].header_text = "Order Entry Format Name"
 SET reply->collist[2].data_type = 1
 SET reply->collist[2].hide_ind = 0
 SET reply->collist[3].header_text = "Order Action"
 SET reply->collist[3].data_type = 1
 SET reply->collist[3].hide_ind = 0
 SET reply->collist[4].header_text = "Field Label"
 SET reply->collist[4].data_type = 1
 SET reply->collist[4].hide_ind = 0
 SET reply->collist[5].header_text = "Field Meaning"
 SET reply->collist[5].data_type = 1
 SET reply->collist[5].hide_ind = 0
 SET reply->collist[6].header_text = "Field Description"
 SET reply->collist[6].data_type = 1
 SET reply->collist[6].hide_ind = 0
 SET reply->collist[7].header_text = "Default"
 SET reply->collist[7].data_type = 1
 SET reply->collist[7].hide_ind = 0
 SET reply->collist[8].header_text = "Accept Value"
 SET reply->collist[8].data_type = 1
 SET reply->collist[8].hide_ind = 0
 SET reply->collist[9].header_text = "Field Type"
 SET reply->collist[9].data_type = 1
 SET reply->collist[9].hide_ind = 0
 SET reply->collist[10].header_text = "Code Set Associated to Field"
 SET reply->collist[10].data_type = 1
 SET reply->collist[10].hide_ind = 0
 SET reply->collist[11].header_text = "Show on Clinical Display Line?"
 SET reply->collist[11].data_type = 1
 SET reply->collist[11].hide_ind = 0
 SET reply->collist[12].header_text = "Clinical Display Line Label"
 SET reply->collist[12].data_type = 1
 SET reply->collist[12].hide_ind = 0
 SET reply->collist[13].header_text = "Show label as suffix?"
 SET reply->collist[13].data_type = 1
 SET reply->collist[13].hide_ind = 0
 SET reply->collist[14].header_text = "Display Yes/No Values?"
 SET reply->collist[14].data_type = 1
 SET reply->collist[14].hide_ind = 0
 SET reply->collist[15].header_text = "Nurse Review?"
 SET reply->collist[15].data_type = 1
 SET reply->collist[15].hide_ind = 0
 SET reply->collist[16].header_text = "Doctor Cosign?"
 SET reply->collist[16].data_type = 1
 SET reply->collist[16].hide_ind = 0
 SET reply->collist[17].header_text = "Pharmacist Verify?"
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   cv.display, reply->rowlist[cnt].celllist[2].string_value = oefp.oe_format_name,
   reply->rowlist[cnt].celllist[3].string_value = cv2.display, reply->rowlist[cnt].celllist[4].
   string_value = off.label_text, reply->rowlist[cnt].celllist[5].string_value = oe.oe_field_meaning,
   reply->rowlist[cnt].celllist[6].string_value = oefields.description
   ...
   ELSEIF (off.default_parent_entity_name="CODE_VALUE")
    reply->rowlist[cnt].celllist[7].string_value = cv3.display
   ELSE
    reply->rowlist[cnt].celllist[7].string_value = off.default_value
   ENDIF
   reply->rowlist[cnt].celllist[8].string_value = df.description, reply->rowlist[cnt].celllist[9].
   string_value = dm.description
   IF (oefields.codeset > 0)
    reply->rowlist[cnt].celllist[10].string_value = concat(trim(cnvtstring(oefields.codeset))," (",
     trim(cvs.display),")"), reply->rowlist[cnt].celllist[10].double_value = oefields.codeset
   ELSE
   ...
   ENDIF
   reply->rowlist[cnt].celllist[12].string_value = off.clin_line_label
   IF (off.clin_suffix_ind=1)
    reply->rowlist[cnt].celllist[13].string_value = "X"
   ELSE
    reply->rowlist[cnt].celllist[13].string_value = ""
   ENDIF
   IF (off.disp_yes_no_flag=1)
    reply->rowlist[cnt].celllist[14].string_value = "Only Display Yes"
   ELSEIF (off.disp_yes_no_flag=2)
    reply->rowlist[cnt].celllist[14].string_value = "Only Display No"
   ELSEIF (off.disp_yes_no_flag=0)
    reply->rowlist[cnt].celllist[14].string_value = "Both"
   ENDIF
   ...
   IF (off.require_verify_ind=1)
    reply->rowlist[cnt].celllist[17].string_value = "X"
   ELSE
    reply->rowlist[cnt].celllist[17].string_value = ""
   ENDIF
   detail_cnt = 0
  FOOT REPORT
...
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("carenet_order_entry_formats.csv")
  SET reply->status_data.status = "S"
 ENDIF
