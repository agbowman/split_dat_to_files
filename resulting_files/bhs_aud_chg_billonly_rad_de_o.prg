CREATE PROGRAM bhs_aud_chg_billonly_rad_de_o
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "prompt2" = 0
  WITH outdev, bn
 SELECT INTO  $OUTDEV
  fin_num = ic.fin_nbr, accession = ord.accession, ic.prim_cdm,
  c.charge_description, c.item_quantity, c.service_dt_tm
  ...
  PLAN (ic
   ...
   WHERE bi.bill_item_id=c.bill_item_id
    AND bi.ext_parent_contributor_cd=0.00)
