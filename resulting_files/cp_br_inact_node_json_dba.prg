CREATE PROGRAM cp_br_inact_node_json:dba
 PROMPT
 ...
 DECLARE executedeletenoderows(null) = null WITH protect
 ...
 CALL executedeletenoderows(null)
 ...
 SUBROUTINE reporterrorandexit(operationname,targetobjectname,targetobjectvalue)
   ...
   GO TO exit_script
 END ;Subroutine
 SUBROUTINE reporterror(operationname,targetobjectname,targetobjectvalue)
