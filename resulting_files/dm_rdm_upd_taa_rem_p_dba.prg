CREATE PROGRAM dm_rdm_upd_taa_rem_p:dba
 ...
 IF (((column_exists("TASK_ACTIVITY_ASSIGNMENT","SHOWUP_DT_TM")=0) OR (column_exists(
  "TASK_ACTIVITY_ASSIGNMENT","NOTIFICATION_TYPE_CD")=0)) )
  SET readme_data->status = "F"
  SET readme_data->message = "Columns - Showup_dt_tm / Notification_type_cd not found in TAA schema"
  GO TO exit_program
 ENDIF
 SELECT INTO "nl:"
  cv.code_value
