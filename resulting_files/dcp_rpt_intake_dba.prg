CREATE PROGRAM dcp_rpt_intake:dba
 SET ns_cd = 227499
 SET d5w_cd = 227356
 SET norm_cd = 227680
 SET iv_cd = 111690
 ...
 SET diaperct_cd = 227671
 SET diaperwt_cd = 227672
 SET ostomy_cd = 227673
 SET stoolcnt_cd = 227258
 SET out_cd = 227676
 SET loss_cd = 227677
 SET pad_cd = 227678
 SET cbiout_cd = 227336
  ...
  DETAIL
   ...
   IF (diff < 480)
    ...
    ELSEIF (c.event_cd=urine_cd)
     temp->shift[x].urine = (temp->shift[x].urine+ cnvtreal(c.event_tag)), urine_ind = 1, temp->
     shift[x].urine_note_ind = btest(c.subtable_bit_map,1),
     temp->shift[x].urine_event_id = c.event_id
