CREATE PROGRAM aps_prt_db_proficiency_events:dba
 ...
 SET captions->apsrpt = uar_i18ngetmessage(i18nhandle,"h1",
  "REPORT: APS_PRT_DB_PROFICIENCY_EVENTS.PRG")
 ...
 SET captions->dbproficiencyevents = uar_i18ngetmessage(i18nhandle,"h8","DB PROFICIENCY EVENTS TOOL")
 ...
 ;end select
#report_maker
 EXECUTE cpm_create_file_name_logical "apsDbProfEvents", "dat", "x"
 ...
 SELECT INTO value(reply->print_status_data.print_filename)
  ...
  HEAD PAGE
   ...
   row + 1,
   CALL center(captions->dbproficiencyevents,0,132), col 110,
