CREATE PROGRAM dash_upd_anes_breaks_status:dba
 PROMPT
  "Output to File/Printer/MINE" = "MINE",
  "Provider ID:" = 0,
  "New Status:" = 0
  WITH outdev, providerid, newstatus
 ...
 SET log_program_name = "dash_upd_anes_breaks_status"
...
#exit_script
 IF (failed=1)
  ...
  CALL log_message(concat("Error updating status: ",err_msg),log_level_debug)
 ELSE
