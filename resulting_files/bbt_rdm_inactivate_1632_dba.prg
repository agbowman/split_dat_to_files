CREATE PROGRAM bbt_rdm_inactivate_1632:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "bbt_rdm_inactivate_1632"
 ...
 ENDIF
#exit_script
 CALL logstatus("Numeric values on 1632 code_set inactivated.","S")
 CALL logmsg("Numeric values on 1632 code_set inactivated.",((e_rdmstatus+ e_dispmsg)+ e_logtofile))
