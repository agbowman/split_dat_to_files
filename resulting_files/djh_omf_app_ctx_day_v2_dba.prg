CREATE PROGRAM djh_omf_app_ctx_day_v2:dba
 PROMPT
  "Person_ID" = 754400,
 ...
 SELECT INTO  $OUTDEV
  ...
  HEAD PAGE
   ...
   col + 5, p.username"################", col + 1,
   p.name_full_formatted"##############################", col 100, "Last ",
   daysback, " days", row + 2,
   col 1, " ln", col 9,
   " APPL", col 113, "Log",
   col 26, " LogIn", col 119,
   "Time", row + 1, col 1,
   " nbr", col 9, "NUMBER",
   col 20, "Application Description", col 67,
   "Object Name", col 104, "Freq",
   col 113, "Ins", col 118,
   "(mins)", col 127, "Date",
   row + 1, col 1, "---------+---------+---------+---------+---------+---------+---------+---------+",
   col + 0, "---------+---------+---------+---------+---------+---------+---------+---------+", row
