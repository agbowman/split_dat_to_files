CREATE PROGRAM bhs_him_combine_uncombine_old
 PROMPT
 ...
 SELECT INTO "NL:"
  ...
  FROM person_combine pc,
   ...
   person p2
  PLAN (pc
   WHERE pc.updt_dt_tm BETWEEN cnvtdatetime((curdate - 3),curtime3) AND cnvtdatetime(curdate,curtime3
    ))
   JOIN (pr
 ...
 SELECT INTO "NL:"
  FROM encntr_combine ec,
   ...
   encntr_alias ea2
  PLAN (ec
   WHERE ec.updt_dt_tm BETWEEN cnvtdatetime((curdate - 3),curtime3) AND cnvtdatetime(curdate,curtime3
    ))
   JOIN (pr
