CREATE PROGRAM djh_name_value_prfs
 PROMPT
 ...
 SELECT INTO  $OUTDEV
  ...
  v.position_cd, v_position_disp = uar_get_code_display(v.position_cd), v.view_name,
  ...
  PLAN (v
   ...
   WHERE n.active_ind=1
    ...
    AND ((n.pvc_value="Chart Summary") OR (((n.pvc_value="Med*") OR (n.pvc_value="Snap*")) )) )
  ORDER BY v_position_disp, n.pvc_value
