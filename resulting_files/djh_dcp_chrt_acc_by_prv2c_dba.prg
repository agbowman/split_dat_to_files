CREATE PROGRAM djh_dcp_chrt_acc_by_prv2c:dba
 PROMPT
 ...
 SELECT INTO value(output_dest)
  ...
  DETAIL
   ...
   ppa_date = format(ppa.ppa_first_dt_tm,"YYYY-MM-DD ;;D"), ppa_time = format(ppa.ppa_first_dt_tm,
    "HH:MM:SS ;;M"), output_string = build(',"',curnode,'","',dr_name,'","',
 ...
 IF (email_ind=1)
  ...
  SET filename_out = concat(format(curdate,"YYYY-MM-DD ;;D"),"_OCFReport",".csv")
  DECLARE subject_line = vc
  SET subject_line = concat(curprog,"-V1.0 - OCFReport",curnode)
