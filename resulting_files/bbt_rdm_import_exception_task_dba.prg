...
#script
 DELETE  FROM task_access ta,
  ...
  PLAN (d1)
   JOIN (ta
   WHERE (ta.task_number=request->qual[d1.seq].new_task))
  WITH nocounter
 ;end delete
 FOR (x = 1 TO size(request->qual,5))
   INSERT  FROM task_access n
    (n.task_number, n.app_group_cd, n.updt_dt_tm,
    n.updt_id, n.updt_task, n.updt_cnt,
    n.updt_applctx)(SELECT
     requestin->list_0[x].new_task, o.app_group_cd, o.updt_dt_tm,
     o.updt_id, o.updt_task, o.updt_cnt,
     o.updt_applctx
     FROM task_access o
