CREATE PROGRAM dm_obs_omf_dashboard_users:dba
 ...
 IF (currdb="ORACLE")
  ...
  SET errcode = 0
  EXECUTE dm_drop_obsolete_objects "OMF_DASHBOARD_USERS", "TABLE", 1
  IF (errcode != 0)
   SET readme_data->message = build(errmsg,"- Readme Failed.")
   GO TO exit_script
  ENDIF
  SET readme_data->status = "S"
  SET readme_data->message = "Table dropped successfully"
