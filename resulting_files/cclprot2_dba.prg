CREATE PROGRAM cclprot2:dba
 PAINT
  video(r), box(1,1,12,80), box(1,1,4,80),
  clear(2,2,78), text(02,10,"CCL PROGRAM CCLPROT2"), clear(3,2,78),
  text(03,05,"Report to get protect for CCL object(s)."), video(n), text(05,05,
  ...
  text(09,05,"Display Include Source Name"), text(10,05,"Number days to show for"), text(11,05,
   "Min binary size to show for"),
  accept(05,30,"X(31);CU","MINE"), accept(06,45,"P;CU","*"), accept(08,45,"P(30);CU","*"),
  accept(09,45,"P;CU","N"), accept(10,45,"999999",999999), accept(11,45,"999999",0)
