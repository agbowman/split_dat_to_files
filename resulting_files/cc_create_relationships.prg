CREATE PROGRAM cc_create_relationships
 PROMPT
 ...
 SUBROUTINE (check_log_level(arg_log_level=i4) =i2)
   ...
   ENDIF
 END ;Subroutine
 SET log_program_name = "CC_CREATE_RELATIONSHIPS"
 ...
 SUBROUTINE (validatesrvreply(nsrvstat=i4,recorddata=vc(ref),zeroforceexit=i2) =i4 WITH protect)
   ...
   ENDIF
 END ;Subroutine
 DECLARE request_number = i4 WITH protect, constant(3208643)
 DECLARE srv_request = vc WITH protect, constant("CreateRelationships")
 ...
 SET nsrvstat = uar_srvsetdouble(hreq,"ppr_cd", $PPRCD)
