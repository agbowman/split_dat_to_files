CREATE PROGRAM bb_chk_import_reg_conv:dba
 ...
 ENDIF
#start_script
 SET sreadme_name = "bb_chk_import_reg_conv"
...
#script
 ...
 SELECT INTO "nl:"
  ...
  WHERE cnvtupper(p.description)="BLOOD BANK REGISTRATION"
  DETAIL
 ...
 IF (conv_id=0)
  ...
  SET readme_data->message = "BLOOD BANK REGISTRATION Conversation not added"
  GO TO exit_script
 ENDIF
 SELECT INTO "nl:"
  p.seq
 ...
 IF (count < 9)
  SET select_failed_flag = 1
  SET readme_data->message = "PROMPT rows for BLOOD BANK REGISTRATION not added"
  GO TO exit_script
 ENDIF
 SET count = 0
