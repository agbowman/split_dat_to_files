CREATE PROGRAM dm2_pg_child_readme:dba
 ...
 DECLARE mf_update_size = f8 WITH protect, noconstant(0.0)
 SET ms_child_info_domain_nm = "UPDATE EPR'S ENCNTR_TYPE_CD"
 SET ms_range_prefix = "ENCNTR_PRSNL_RELTN_ID RANGE EVALUATED"
 SET ms_child_max_name = "MAX ENCNTR_PRSNL_RELTN_ID EVALUATED BY"
 SET ms_child_script = "dm2_pg_child_readme_c"
 ...
 IF (sbr_fetch_min_max(ms_child_info_domain_nm,ms_range_prefix,ms_child_max_name,mf_max_range_id,
  ...
  GO TO exit_program
 ENDIF
 SET mf_update_size = ceil((mf_max_range_id/ 5))
 ...
 ENDIF
 SET readme_data->status = "S"
 SET readme_data->message = "ENCNTR_TYPE_CD column on ENCNTR_PRSNL_RELTN table updated successfully."
#exit_program
