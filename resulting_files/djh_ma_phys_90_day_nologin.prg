CREATE PROGRAM djh_ma_phys_90_day_nologin
 PROMPT
 ...
 IF (email_ind=1)
  ...
  SET subject_line = concat(curprog," V1 - Baystate Health CIS PHYS Acnts Inactive 90 days")
