CREATE PROGRAM cdi_add_ac_prefs
 ...
 DECLARE pref_cnt = i4 WITH public, constant(1)
 DECLARE g_cdi_domain = vc WITH public, constant("IMAGING DOCUMENT")
 DECLARE g_auto = vc WITH public, constant("AC AUTO VALIDATE")
 FREE RECORD temp
 RECORD temp(
   1 qual[*]
     2 info_name = vc
 ...
 SET temp->qual[1].info_name = g_auto
