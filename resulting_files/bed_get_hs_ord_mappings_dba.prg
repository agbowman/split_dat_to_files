CREATE PROGRAM bed_get_hs_ord_mappings:dba
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   ENDIF
   reply->items[tcnt].reltns[r_tcnt].code_value = o.catalog_cd, reply->items[tcnt].reltns[r_tcnt].
   primary_mnemonic = o.primary_mnemonic, reply->items[tcnt].reltns[r_tcnt].description = o
   .description,
