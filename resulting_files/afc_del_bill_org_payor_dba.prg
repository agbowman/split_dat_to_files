CREATE PROGRAM afc_del_bill_org_payor:dba
 ...
 CALL del_bill_org_payor(action_begin,action_end)
 IF (failed != false)
  GO TO check_error
 ENDIF
#check_error
 ...
 ENDIF
 GO TO end_program
 SUBROUTINE del_bill_org_payor(del_begin,del_end)
