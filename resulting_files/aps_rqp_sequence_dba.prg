CREATE PROGRAM aps_rqp_sequence:dba
 ...
 SUBROUTINE insertreqproc(nrequest,spfmt,ntargetreq,ndeststep,sservice,nreprocess,naction,srefpfmt,
  nseq)
   ...
   ENDCASE
 END ;Subroutine
 DECLARE sreadme_name = vc WITH noconstant("")
 DECLARE nullstr = vc WITH noconstant("")
 DECLARE errmsgstr = vc WITH protect, noconstant("")
#start_script
 SET sreadme_name = "aps_rqp_sequence"
 CALL logscriptstart(sreadme_name)
 FREE SET dm_dcp_chg_seq
 ...
 SET nullstr = "                                                  "
 SET dm_dcp_chg_seq->low_seq_request_number = 200014
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 120210.00
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_APS_VERIFY_RPT_EVENT"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200014
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 120210.0
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_APS_CORR_TO_EVENT"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE aps_rqp_change_sequence
 IF ((dm_dcp_chg_seq->status="F"))
  GO TO failure
 ENDIF
 SET dm_dcp_chg_seq->low_seq_request_number = 200014
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 120210.00
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_APS_CORR_TO_EVENT"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200014
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 560201.00
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_APS_PATHOLOGY_ORDER"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 560201
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE aps_rqp_change_sequence
 IF ((dm_dcp_chg_seq->status="F"))
  GO TO failure
 ENDIF
 SET dm_dcp_chg_seq->low_seq_request_number = 200014
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 560201.00
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_APS_PATHOLOGY_ORDER"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 560201
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200014
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 0.00
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_APS_REVIEW_FOLLOWUP"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE aps_rqp_change_sequence
 IF ((dm_dcp_chg_seq->status="F"))
 ...
 ENDIF
 SET dm_dcp_chg_seq->low_seq_request_number = 200014
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 0.00
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_APS_REVIEW_FOLLOWUP"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200014
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 200061.00
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_APS_ADD_AUTO_CODES"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE aps_rqp_change_sequence
 IF ((dm_dcp_chg_seq->status="F"))
 ...
 ENDIF
 SET dm_dcp_chg_seq->low_seq_request_number = 200014
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 200061.00
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_APS_ADD_AUTO_CODES"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200014
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 0.00
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_APS_INITIATE_EXPEDITE"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE aps_rqp_change_sequence
 IF ((dm_dcp_chg_seq->status="F"))
 ...
 SET dm_dcp_chg_seq->low_seq_request_number = 200014
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 0.00
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_APS_INITIATE_EXPEDITE"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200014
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 2221.00
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_CSM_AP_200014"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 1037623
 SET dm_dcp_chg_seq->high_seq_service = "EKS_ASYNCH_03"
 EXECUTE aps_rqp_change_sequence
 IF ((dm_dcp_chg_seq->status="F"))
  GO TO failure
 ENDIF
 SET dm_dcp_chg_seq->low_seq_request_number = 200118
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 120210.00
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_APS_VERIFY_RPT_EVENT"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200118
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 120210.0
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_APS_CORR_TO_EVENT"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 ...
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200118
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 951060.00
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_APS_RPT_TO_AFC"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 EXECUTE aps_rqp_change_sequence
 IF ((dm_dcp_chg_seq->status="F"))
 ...
 ENDIF
 SET dm_dcp_chg_seq->low_seq_request_number = 200118
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 951060.00
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_APS_RPT_TO_AFC"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200118
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 2221.00
 ...
 IF ((dm_dcp_chg_seq->status="F"))
  GO TO failure
 ENDIF
 SET dm_dcp_chg_seq->low_seq_request_number = 200296
 SET dm_dcp_chg_seq->low_seq_destination_step_id = 120210.00
 SET dm_dcp_chg_seq->low_seq_format_script = "PFMT_APS_VERIFY_RPT_EVENT"
 SET dm_dcp_chg_seq->low_seq_target_request_number = 0
 SET dm_dcp_chg_seq->low_seq_service = nullstr
 SET dm_dcp_chg_seq->high_seq_request_number = 200296
 SET dm_dcp_chg_seq->high_seq_destination_step_id = 120210.0
 SET dm_dcp_chg_seq->high_seq_format_script = "PFMT_APS_CORR_TO_EVENT"
 SET dm_dcp_chg_seq->high_seq_target_request_number = 0
 SET dm_dcp_chg_seq->high_seq_service = nullstr
 ...
 ENDIF
 UPDATE  FROM request_processing rp
  SET rp.active_ind = 0, rp.updt_dt_tm = cnvtdatetime(curdate,curtime3), rp.updt_cnt = (rp.updt_cnt+
   1),
   rp.updt_id = reqinfo->updt_id, rp.updt_task = reqinfo->updt_task, rp.updt_applctx = reqinfo->
   updt_applctx
  WHERE rp.request_number IN (200014, 200118)
   AND rp.format_script="PFMT_CSM_AP_200014"
   AND rp.service IN ("EKS_ASYNCH_01", "EKS_ASYNCH_02")
   AND rp.active_ind=1
  WITH nocounter
 ;end update
 IF (error(errmsgstr,0) > 0)
  SET dm_dcp_chg_seq->message = concat(("Failure while inactivating unwanted rows. "+ errmsgstr))
  GO TO failure
 ENDIF
 COMMIT
 ...
 GO TO exit_script
#failure
 CALL logstatus(build("Execution Failure.",dm_dcp_chg_seq->message),"F")
 ROLLBACK
#exit_script
 CALL logscriptend(sreadme_name)
 FREE RECORD dm_dcp_chg_seq
END GO
