CREATE PROGRAM bhs_extract_hne_diag:dba
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   pat->qual[pat->l_cnt].s_plast_name = trim(p.name_last,3), pat->qual[pat->l_cnt].s_gender = trim(
    uar_get_code_display(p.sex_cd),3), pat->qual[pat->l_cnt].s_date_of_birth = trim(format(
     cnvtdatetimeutc(datetimezone(p.birth_dt_tm,p.birth_tz),1),"YYYYMMDD"),3)
 ...
 ;end select
 IF ((pat->l_cnt != 0))
  SELECT INTO value(gs_output_file)
   ms_displayline = trim(build(trim(pat->qual[d.seq].s_invoice_number,3),ms_separator_cd,trim(
      substring(1,100,pat->qual[d.seq].s_cmrn),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].s_encounter_number),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].s_hne_memberid),3),ms_separator_cd,trim(
      substring(1,100,pat->qual[d.seq].s_hne_claim_number),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].s_pfirst_name),3),ms_separator_cd,trim(substring(1,100,pat
       ->qual[d.seq].s_plast_name),3),ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].s_hicn),3
      ),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].s_mass_health_id),3),ms_separator_cd,trim(
      substring(1,100,pat->qual[d.seq].s_gender),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].s_date_of_birth),3),ms_separator_cd,trim(substring(1,100,
       pat->qual[d.seq].s_provider_id),3),ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].
       s_service_provider_name),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].s_npi),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].s_service_from_date),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].s_service_thru_date),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].icd9[1].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].icd9[2].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[3].s_icd9_cd),3),ms_separator_cd,trim
     (substring(1,100,pat->qual[d.seq].icd9[4].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[5].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,
       pat->qual[d.seq].icd9[6].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].
       icd9[7].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[8].s_icd9_cd),3),ms_separator_cd,trim
     (substring(1,100,pat->qual[d.seq].icd9[9].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[10].s_icd9_cd),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].icd9[11].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].icd9[12].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[13].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[14].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[15].s_icd9_cd),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].icd9[16].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].icd9[17].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[18].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[19].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[20].s_icd9_cd),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].icd9[21].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].icd9[22].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[23].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[24].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[25].s_icd9_cd),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].icd9[26].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].icd9[27].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[28].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[29].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[30].s_icd9_cd),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].icd9[31].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].icd9[32].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[33].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[34].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[35].s_icd9_cd),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].icd9[36].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].icd9[37].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[38].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[39].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[40].s_icd9_cd),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].icd9[41].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].icd9[42].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[43].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[44].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[45].s_icd9_cd),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].icd9[46].s_icd9_cd),3),ms_separator_cd,trim(substring(1,100,pat->qual[d
       .seq].icd9[47].s_icd9_cd),3),
     ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].icd9[48].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[49].s_icd9_cd),3),ms_separator_cd,
     trim(substring(1,100,pat->qual[d.seq].icd9[50].s_icd9_cd),3),ms_separator_cd,trim(substring(1,
       100,pat->qual[d.seq].s_transdate),3),ms_separator_cd,trim(substring(1,100,pat->qual[d.seq].
       s_record_type),3)),3)
   FROM (dummyt d  WITH seq = value(size(pat->qual,5)))
   PLAN (d
    WHERE (pat->qual[d.seq].l_diag_cnt > 0))
