CREATE PROGRAM djh_pwrchrt_pco_login_sum
 PROMPT
 ...
 ENDIF
 SELECT INTO  $OUTDEV
  o.application_number, a.description, o.start_day,
  sum_freq = sum(o.frequency)"############", sum_logins = sum(o.log_ins)"############", sum_min = sum
  (o.minutes)"############"
  ...
  ORDER BY o.application_number, o.start_day, a.description
