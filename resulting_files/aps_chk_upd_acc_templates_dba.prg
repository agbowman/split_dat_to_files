CREATE PROGRAM aps_chk_upd_acc_templates:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "aps_chk_upd_acc_templates"
...
#exit_script
 IF (itemcount > 0)
  ROLLBACK
  CALL logmsg("ap_accn_template_detail, populate failed.",((e_rdmstatus+ e_dispmsg)+ e_logtofile))
  CALL logstatus("Execution failed - see log message for more details.","F")
 ELSE
  CALL logmsg("ap_accn_template_detail, populate successful.",((e_rdmstatus+ e_dispmsg)+ e_logtofile)
   )
