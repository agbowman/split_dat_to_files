CREATE PROGRAM bed_aud_patcare_orc_match:dba
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   temp->fqual[fcnt].qual[cnt].catalog_type = b.catalog_type, temp->fqual[fcnt].qual[cnt].
 ...
 SET reply->collist[4].header_text = "Legacy Mnemonic"
 SET reply->collist[4].data_type = 1
 SET reply->collist[4].hide_ind = 0
 SET reply->collist[5].header_text = "Legacy Description"
 SET reply->collist[5].data_type = 1
 SET reply->collist[5].hide_ind = 0
 SET reply->collist[6].header_text = "Match"
 SET reply->collist[6].data_type = 1
 SET reply->collist[7].hide_ind = 0
 SET reply->collist[7].header_text = "Added"
 SET reply->collist[7].data_type = 1
 SET reply->collist[7].hide_ind = 0
 SET reply->collist[8].header_text = "Order Catalog Description"
 SET reply->collist[8].data_type = 1
 SET reply->collist[8].hide_ind = 0
 SET reply->collist[9].header_text = "Order Catalog CD"
 SET reply->collist[9].data_type = 2
 SET reply->collist[9].hide_ind = 1
 SET reply->collist[10].header_text = "Primary Name"
 SET reply->collist[10].data_type = 1
 SET reply->collist[10].hide_ind = 0
 SET reply->collist[11].header_text = "Remove"
 ...
 FOR (x = 1 TO fcnt)
  ...
  FOR (y = 1 TO cnt)
    ...
    SET reply->rowlist[row_nbr].celllist[2].string_value = temp->fqual[x].qual[y].catalog_type
    SET reply->rowlist[row_nbr].celllist[3].string_value = temp->fqual[x].qual[y].activity_type
    SET reply->rowlist[row_nbr].celllist[4].string_value = temp->fqual[x].qual[y].mnemonic
    SET reply->rowlist[row_nbr].celllist[5].string_value = temp->fqual[x].qual[y].desc
    SET reply->rowlist[row_nbr].celllist[6].string_value = temp->fqual[x].qual[y].match
    SET reply->rowlist[row_nbr].celllist[7].string_value = temp->fqual[x].qual[y].add
    SET reply->rowlist[row_nbr].celllist[8].string_value = temp->fqual[x].qual[y].oc_desc
    SET reply->rowlist[row_nbr].celllist[9].double_value = temp->fqual[x].qual[y].oc_cd
    SET reply->rowlist[row_nbr].celllist[10].string_value = temp->fqual[x].qual[y].synonym
    SET reply->rowlist[row_nbr].celllist[11].string_value = temp->fqual[x].qual[y].remove
  ENDFOR
 ENDFOR
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("patcare_orc_match_audit.csv")
 ENDIF
