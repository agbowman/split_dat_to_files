CREATE PROGRAM apslabellblcl1300_sld2bc_prd
 PROMPT
 ...
 SUBROUTINE detailsectionabs(ncalc,offsetx,offsety)
   ...
   IF (ncalc=rpt_render)
    ...
    SET rptsd->m_y = (offsety+ 0.146)
    SET rptsd->m_x = (offsetx+ 0.511)
    SET rptsd->m_width = 0.396
    SET rptsd->m_height = 0.126
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2(sld_modifier1,char(0)))
    SET rptsd->m_y = (offsety+ 0.146)
    SET rptsd->m_x = (offsetx+ 1.448)
    SET rptsd->m_width = 0.396
    SET rptsd->m_height = 0.126
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2(sld_modifier2,char(0)))
    SET rptsd->m_y = (offsety+ 0.146)
    SET rptsd->m_x = (offsetx+ 2.386)
    SET rptsd->m_width = 0.396
    SET rptsd->m_height = 0.126
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2(sld_modifier3,char(0)))
    SET rptsd->m_y = (offsety+ 0.146)
    SET rptsd->m_x = (offsetx+ 3.334)
    SET rptsd->m_width = 0.396
    SET rptsd->m_height = 0.126
    SET _fdrawheight = uar_rptstringdraw(_hreport,rptsd,build2(sld_modifier4,char(0)))
    SET rptsd->m_y = (offsety+ 0.230)
    SET rptsd->m_x = (offsetx+ 0.042)
    ...
    IF (formatted_accession1 != " ")
     SET _rptdummy = uar_rptbarcodeinit(rptbce,rpt_datamatrix,(offsetx+ 0.084),(offsety+ 0.333))
    ...
    IF (formatted_accession2 != " ")
     SET _rptdummy = uar_rptbarcodeinit(rptbce,rpt_datamatrix,(offsetx+ 1.021),(offsety+ 0.333))
     SET rptbce->m_recsize = 88
     SET rptbce->m_width = 0.27
     SET rptbce->m_height = 0.27
     SET rptbce->m_rotation = 0
    ...
    IF (formatted_accession3 != " ")
     SET _rptdummy = uar_rptbarcodeinit(rptbce,rpt_datamatrix,(offsetx+ 1.959),(offsety+ 0.333))
     SET rptbce->m_recsize = 88
     SET rptbce->m_width = 0.27
     SET rptbce->m_height = 0.27
     SET rptbce->m_rotation = 0
    ...
    IF (formatted_accession4 != " ")
     SET _rptdummy = uar_rptbarcodeinit(rptbce,rpt_datamatrix,(offsetx+ 2.896),(offsety+ 0.333))
     SET rptbce->m_recsize = 88
     SET rptbce->m_width = 0.27
     SET rptbce->m_height = 0.27
     SET rptbce->m_rotation = 0
 ...
 SUBROUTINE initializereport(dummy)
   ...
   SET rptreport->m_reportname = "APSLABELLBLCL1300_SLD2BC_PRD"
 ...
 END ;Subroutine
 DECLARE labelquerydata(dummy) = null WITH protect
 SUBROUTINE labelquerydata(ncalc)
   ...
   SELECT
    ...
    sld_modifier1 =
    IF ((((d1.seq * 4) - 3) <= size(data->resrc[1].label,5))) trim(data->resrc[1].label[((d1.seq * 4)
       - 3)].slide_origin_modifier,3)
    ELSE " "
    ENDIF
    , sld_modifier2 =
    IF ((((d1.seq * 4) - 2) <= size(data->resrc[1].label,5))) trim(data->resrc[1].label[((d1.seq * 4)
       - 2)].slide_origin_modifier,3)
    ELSE " "
    ENDIF
    , sld_modifier3 =
    IF ((((d1.seq * 4) - 1) <= size(data->resrc[1].label,5))) trim(data->resrc[1].label[((d1.seq * 4)
       - 1)].slide_origin_modifier,3)
    ELSE " "
    ENDIF
    ,
    sld_modifier4 =
    IF (((d1.seq * 4) <= size(data->resrc[1].label,5))) trim(data->resrc[1].label[(d1.seq * 4)].
      slide_origin_modifier,3)
    ELSE " "
    ENDIF
    , slide_tag1 =
    IF ((((d1.seq * 4) - 3) <= size(data->resrc[1].label,5))) trim(substring(1,6,data->resrc[1].
    ...
    PLAN (d1)
    HEAD REPORT
     _d0 = blk_sld_tag1, _d1 = blk_sld_tag2, _d2 = blk_sld_tag3,
     _d3 = blk_sld_tag4, _d4 = clientsite, _d5 = clientlocation,
     _d6 = formatted_accession1, _d7 = formatted_accession2, _d8 = formatted_accession3,
     _d9 = formatted_accession4, _d10 = patient_name1, _d11 = patient_name2,
     _d12 = patient_name3, _d13 = patient_name4, _d14 = request_dt_tm1,
     _d15 = request_dt_tm2, _d16 = request_dt_tm3, _d17 = request_dt_tm4,
     _d18 = sld_modifier1, _d19 = sld_modifier2, _d20 = sld_modifier3,
     _d21 = sld_modifier4, _d22 = specimen_desc1, _d23 = specimen_desc2,
     _d24 = specimen_desc3, _d25 = specimen_desc4, _d26 = spec_blk_sld_tag1,
