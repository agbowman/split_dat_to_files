CREATE PROGRAM br_turn_on_epa_for_eprs:dba
 CALL echo("***********************************************************")
 CALL echo("** Check if EPA is already turned on ... **")
 CALL echo("***********************************************************")
 ...
 IF (needtoupdate=0
  AND brnamevalueid > 0)
  CALL echo("***********************************************************")
  CALL echo("** EPA is already on. No furhter action reqired. **")
  CALL echo("***********************************************************")
 ENDIF
END GO
