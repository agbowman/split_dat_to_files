CREATE PROGRAM dm_pcmb_person_failure:dba
 ...
 IF ((dm_cmb_cust_script->exc_maint_ind=1))
  ...
  SET dcem_request->qual[1].child_entity = "CMB_GENERIC_TAB"
  SET dcem_request->qual[1].op_type = "COMBINE"
  SET dcem_request->qual[1].script_name = "DM_PCMB_PERSON_FAILURE"
...
#exit_sub
 IF (validate(recombining,0))
  ...
  SET request->error_message = "Forced combine failure"
 ENDIF
END GO
