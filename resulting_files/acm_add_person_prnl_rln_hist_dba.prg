CREATE PROGRAM acm_add_person_prnl_rln_hist:dba
 ...
 INSERT  FROM person_prsnl_reltn_hist pprh,
  ...
  SET pprh.person_id = acm_request->person_prsnl_reltn_qual[xref->add[d.seq].idx].person_id, pprh
   .person_prsnl_reltn_hist_id = seq(person_seq,nextval), pprh.person_prsnl_reltn_id = acm_request->
   person_prsnl_reltn_qual[xref->add[d.seq].idx].person_prsnl_reltn_id,
   pprh.pm_hist_tracking_id = acm_request->person_prsnl_reltn_qual[xref->add[d.seq].idx].
   pm_hist_tracking_id, pprh.transaction_dt_tm = cnvtdatetime(acm_request->person_prsnl_reltn_qual[
    xref->add[d.seq].idx].transaction_dt_tm), pprh.person_prsnl_r_cd = acm_request->
   person_prsnl_reltn_qual[xref->add[d.seq].idx].person_prsnl_r_cd,
   pprh.prsnl_person_id = acm_request->person_prsnl_reltn_qual[xref->add[d.seq].idx].prsnl_person_id,
   pprh.tracking_bit = tracking_bit, pprh.change_bit = chgbit,
