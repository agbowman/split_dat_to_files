CREATE PROGRAM cmt_q3_2003_log:dba
 PAINT
 FREE SET all
#accept_script
 CALL clear(1,1)
 CALL box(1,1,22,80)
 CALL text(2,4,"CMT Q3 2003 Log Menu")
 ...
 CALL text(17,4,"10) cpt4 obsolete nomen log")
 CALL text(18,4,"11) cpt4 new nomenclature import log")
 ...
 CASE (curaccept)
  ...
  OF 10:
   CALL display_logfile("kia_obs_imp_cpt4_nomen.log",0)
  OF 11:
   CALL display_logfile("kia_imp_ins_cpt4_nomen.log",0)
  OF 50:
   CALL get_counts("APC")
  OF 51:
   CALL obs_report("APC")
 ...
 SUBROUTINE kia_insert_cmt_version(beg_date,ver_ft)
   ...
   INSERT  FROM cmt_content_version c
    SET c.active_ind = 1, c.beg_effective_dt_tm = cnvtdatetime(beg_date), c.cmt_content_version_id =
     ...
     c.updt_task = 0, c.updt_dt_tm = cnvtdatetime(curdate,curtime3)
    WITH nocounter
   ;end insert
   COMMIT
 END ;Subroutine
 ...
 SUBROUTINE kia_inhouse_chk(var)
   IF ( NOT (trim(cnvtupper(curuser)) IN ("P30INS", "DD011127", "JL2501", "JP017059", "RS011138",
   "CA024256", "BG2117", "SA034725", "WC9492", "DK8704",
   "KV011080", "JB026288", "DM029128", "CM025745", "D_1002E",
   "D_1201E", "D_718E", "D_719E", "D_7EMAK", "D_CLNMAK",
   "D_DEVMAK", "D_1501E", "R_1501E", "D_1501D", "D_INDMAK",
   "D_INTMAK", "D_MAEMAK", "D_PRVMAK", "D_SOLMAK", "D_SRDMAK",
   "R_1002SE", "R_12S1E")))
    SELECT INTO "nl:"
     FROM dm_info d
    ...
    IF (curqual > 0)
     SET readme_data->status = "S"
     SET readme_data->message = concat("SUCCESS - SCRIPT DOES NOT RUN IN A INHOUSE DOMAIN - ",
      cnvtupper(curuser))
     GO TO exit_script
    ENDIF
   ENDIF
