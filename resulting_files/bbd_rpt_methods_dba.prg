CREATE PROGRAM bbd_rpt_methods:dba
 RECORD reply(
   1 status_data
     2 status = c1
     2 subeventstatus[1]
 ...
 RECORD captions(
   ...
   1 rpt_title = vc
   1 rpt_time = vc
   1 recruitment_methods = vc
   1 rpt_as_of_date = vc
   1 method_display = vc
   1 method_description = vc
   1 effective = vc
   1 end_effective = vc
   1 active = vc
   1 yes = vc
 ...
 SET captions->rpt_title = uar_i18ngetmessage(i18nhandle,"rpt_title",
  "R E C R U I T M E N T   M E T H O D S   R E P O R T")
 SET captions->rpt_time = uar_i18ngetmessage(i18nhandle,"rpt_time","Time:")
 SET captions->recruitment_methods = uar_i18ngetmessage(i18nhandle,"recruitment_methods",
  "(Recruitment Methods)")
 SET captions->rpt_as_of_date = uar_i18ngetmessage(i18nhandle,"rpt_as_of_date","As of Date:")
 SET captions->method_display = uar_i18ngetmessage(i18nhandle,"method_display","Method Display")
 SET captions->method_description = uar_i18ngetmessage(i18nhandle,"method_description",
  "Method Description")
 ...
 SET captions->rpt_id = uar_i18ngetmessage(i18nhandle,"rpt_id","Report ID: BBD_RPT_METHODS")
 ...
 SELECT INTO "cer_temp:bbdmethods.txt"
  c.*
  FROM code_value c
  PLAN (c
   WHERE c.code_set=17070
    AND c.code_value > 0)
  ...
  HEAD PAGE
   ...
   CALL center(captions->recruitment_methods,1,125),
   col 104, captions->rpt_as_of_date, col 118,
   curdate"@DATECONDENSED;;d", row + 2, col 3,
   captions->method_display, col 27, captions->method_description,
