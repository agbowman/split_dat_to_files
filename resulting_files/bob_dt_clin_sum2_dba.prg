CREATE PROGRAM bob_dt_clin_sum2:dba
 ...
 CALL echo(build("BOB - This is the .sec query"))
 SELECT INTO "MINE"
 ...
 FOR (x = 1 TO pat_cnt)
   ...
   SELECT INTO "nl:"
    ...
    DETAIL
     ...
     CALL echo(build("ORDERID:",o.order_id))
    WITH nocounter
   ;end select
   SET pt->line_cnt = 0
   SET max_length = 85
 ...
 FOR (x = 1 TO pat_cnt)
   ...
   SELECT INTO "MINE"
    ...
    DETAIL
     ...
     CALL echo(build(size(pat->qual[x].sec,5)))
