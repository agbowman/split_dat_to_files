CREATE PROGRAM apslabellblcl1300_sld2_prd
 PROMPT
 ...
 DECLARE _pen22s1c0 = i4 WITH noconstant(0), protect
 ...
 SUBROUTINE detailsectionabs(ncalc,offsetx,offsety)
   ...
   IF (ncalc=rpt_render)
    ...
    ENDIF
    SET _dummypen = uar_rptsetpen(_hreport,_pen22s1c0)
    IF (request_dt_tm1 != " ")
     SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.001),(offsety+ 0.625),(offsetx+ 0.928),(offsety
      + 0.625))
    ENDIF
    IF (request_dt_tm2 != " ")
     SET _rptstat = uar_rptline(_hreport,(offsetx+ 0.928),(offsety+ 0.625),(offsetx+ 1.855),(offsety
      + 0.625))
    ENDIF
    IF (request_dt_tm3 != " ")
     SET _rptstat = uar_rptline(_hreport,(offsetx+ 1.855),(offsety+ 0.625),(offsetx+ 2.793),(offsety
      + 0.625))
    ENDIF
    IF (request_dt_tm4 != " ")
     SET _rptstat = uar_rptline(_hreport,(offsetx+ 2.792),(offsety+ 0.625),(offsetx+ 3.730),(offsety
      + 0.625))
    ENDIF
 ...
 SUBROUTINE initializereport(dummy)
   ...
   SET rptreport->m_reportname = "APSLABELLBLCL1300_SLD2_PRD"
 ...
 SUBROUTINE _createpens(dummy)
   ...
   SET _pen22s1c0 = uar_rptcreatepen(_hreport,rptpen)
 END ;Subroutine
