CREATE PROGRAM bhs_athn_add_med_order
 FREE RECORD result
 RECORD result(
   1 encntr_id = f8
   1 person_id = f8
 ...
 DECLARE getdosecalctext(null) = vc
 ...
 SELECT INTO "NL:"
  ...
  HEAD oc.catalog_cd
   ...
   result->intermittent_ind = ocs.intermittent_ind, result->synonym_mnemonic = ocs.mnemonic
  WITH nocounter, time = 30
 ;end select
...
#exit_script
 ...
 SUBROUTINE calladdorder(null)
   ...
   SET req560201->orderlist[1].orderid =  $6
   ...
   SET req560201->orderlist[1].synonymid =  $4
   ...
   SET req560201->orderlist[1].subcomponentlist[1].scsynonymid =  $4
   ...
   SET req560201->orderlist[1].subcomponentlist[1].scdosecalculatorlongtext = getdosecalctext(null)
 ...
 SUBROUTINE (getsystempreference(entry=vc) =vc)
   ...
   RETURN(val)
 END ;Subroutine
 SUBROUTINE getdosecalctext(null)
 ...
 SUBROUTINE calladdorderautoverify(null)
   ...
   SET req560251->orderlist[1].orderid =  $6
   ...
   SET req560251->orderlist[1].synonymid =  $4
   ...
   SET req560251->orderlist[1].subcomponentlist[1].scsynonymid =  $4
   ...
   SET req560251->orderlist[1].subcomponentlist[1].scdosecalculatorlongtext = getdosecalctext(null)
   IF (size(result->diagnosisreltns,5) > 0)
