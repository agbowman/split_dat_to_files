CREATE PROGRAM cps_get_ord_cat_act:dba
 FREE SET reply
 RECORD context(
 ...
 SELECT
  ...
  FOOT REPORT
   ...
   context->catalog_type_cd = reply->catalog_item[count1].catalog_type_cd, context->activity_type_cd
    = reply->catalog_item[count1].activity_type_cd
