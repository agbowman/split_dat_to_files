CREATE PROGRAM carenet_chk_omf_view_indicator:dba
...
#exit_script
 ...
 ELSE
  ...
  SET readme_data->message = concat("CARENET_OMF_VIEW_INDICATOR: Expected ",trim(cnvtstring(
