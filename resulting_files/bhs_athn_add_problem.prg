CREATE PROGRAM bhs_athn_add_problem
 RECORD requestin(
   1 person_id = f8
   1 problem[*]
 ...
 DECLARE jsonout = vc
 DECLARE athena = f8 WITH protect, constant(uar_get_code_by("DISPLAYKEY",89,"Athena"))
 ...
 DECLARE c_athena_cd = f8 WITH protect, constant(uar_get_code_by("DISPLAY_KEY",89,"Athena"))
 ...
 SET requestin->problem[1].contributor_system_cd = c_athena_cd
 SET requestin->problem[1].life_cycle_dt_tm = cnvtdatetime( $17)
 SET requestin->problem[1].beg_effective_dt_tm = 0.0
 SET requestin->problem[1].end_effective_dt_tm = 0.0
 SET requestin->problem[1].problem_ftdesc = ""
 SET requestin->problem[1].problem_action_ind = 1
 SET requestin->problem[1].show_in_pm_history_ind =  $40
 SET requestin->problem[1].problem_id = - (34)
 SET requestin->problem[1].organization_id = organization_id
 ...
 SET requestin->problem[1].severity_ftdesc =  $42
 ...
 FOR (x = 1 TO mcnt)
   ...
   SET requestin->problem[1].problem_discipline[x].discipline_action_ind = 1
 ...
 FOR (x = 1 TO pcnt)
   ...
   SET requestin->problem[1].problem_prsnl[x].prsnl_action_ind = 1
