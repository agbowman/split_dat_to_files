CREATE PROGRAM djh_l_nrsstd_90_day_noact
 PROMPT
 ...
 IF (email_ind=1)
  ...
  SET filename_out = concat(format(curdate,"YYYY-MM-DD ;;D"),"-NrsStd.csv")
  DECLARE subject_line = vc
  SET subject_line = concat(curprog," - V1 - Nurse STD inactive 90 days")
