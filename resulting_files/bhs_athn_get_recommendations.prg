CREATE PROGRAM bhs_athn_get_recommendations
  ...
  SELECT INTO value(moutputdevice)
   ...
   DETAIL
    ...
    FOR (idx = 1 TO reminder_cnt)
      ...
      row + 1, v5 = build("<DueDate>",datetimezoneformat(result->reminder[idx].due_dt_tm,
        curtimezonesys,"MM/dd/yyyy HH:mm:ss",curtimezonedef),"</DueDate>"), col + 1,
