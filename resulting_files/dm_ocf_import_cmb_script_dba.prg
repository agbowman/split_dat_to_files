CREATE PROGRAM dm_ocf_import_cmb_script:dba
 ...
 ENDIF
 EXECUTE dm_dbimport "cer_install:dm_ocf_person_uncmb_clinical_event.csv",
 "dm_dm_cmb_exception_import", 10
 IF ((readme_data->status="F"))
  SET readme_data->message = "cer_install:dm_ocf_person_uncmb_clinical_event.csv was not found"
  GO TO end_program
 ENDIF
