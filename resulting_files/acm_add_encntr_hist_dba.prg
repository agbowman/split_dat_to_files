CREATE PROGRAM acm_add_encntr_hist:dba
 ...
 INSERT  FROM encntr_flex_hist efh,
  ...
  SET efh.encntr_flex_hist_id = seq(encounter_seq,nextval), efh.encntr_id = acm_request->
   encounter_qual[xref->add[d.seq].idx].encntr_id, efh.organization_id = acm_request->encounter_qual[
   xref->add[d.seq].idx].organization_id,
   efh.transaction_dt_tm = cnvtdatetime(acm_request->encounter_qual[xref->add[d.seq].idx].
    transaction_dt_tm), efh.pm_hist_tracking_id = acm_request->encounter_qual[xref->add[d.seq].idx].
   pm_hist_tracking_id, efh.placement_auth_prsnl_id = acm_request->encounter_qual[xref->add[d.seq].
   idx].placement_auth_prsnl_id,
   efh.person_id = acm_request->encounter_qual[xref->add[d.seq].idx].person_id, efh.mental_health_cd
    = acm_request->encounter_qual[xref->add[d.seq].idx].mental_health_cd, efh.mental_health_dt_tm =
   cnvtdatetime(acm_request->encounter_qual[xref->add[d.seq].idx].mental_health_dt_tm),
   efh.admit_src_cd = acm_request->encounter_qual[xref->add[d.seq].idx].admit_src_cd, efh
   .admit_mode_cd = acm_request->encounter_qual[xref->add[d.seq].idx].admit_mode_cd, efh
   .disch_disposition_cd = acm_request->encounter_qual[xref->add[d.seq].idx].disch_disposition_cd,
   efh.disch_dt_tm = cnvtdatetime(acm_request->encounter_qual[xref->add[d.seq].idx].disch_dt_tm), efh
   .disch_to_loctn_cd = acm_request->encounter_qual[xref->add[d.seq].idx].disch_to_loctn_cd, efh
   .encntr_status_cd = acm_request->encounter_qual[xref->add[d.seq].idx].encntr_status_cd,
   efh.reg_dt_tm = cnvtdatetime(acm_request->encounter_qual[xref->add[d.seq].idx].reg_dt_tm), efh
   .trauma_cd = acm_request->encounter_qual[xref->add[d.seq].idx].trauma_cd, efh.trauma_dt_tm =
   cnvtdatetime(acm_request->encounter_qual[xref->add[d.seq].idx].trauma_dt_tm),
   efh.triage_cd = acm_request->encounter_qual[xref->add[d.seq].idx].triage_cd, efh.triage_dt_tm =
   cnvtdatetime(acm_request->encounter_qual[xref->add[d.seq].idx].triage_dt_tm), efh
   .patient_classification_cd = acm_request->encounter_qual[xref->add[d.seq].idx].
   patient_classification_cd,
   efh.mental_category_cd = acm_request->encounter_qual[xref->add[d.seq].idx].mental_category_cd, efh
   .psychiatric_status_cd = acm_request->encounter_qual[xref->add[d.seq].idx].psychiatric_status_cd,
   efh.inpatient_admit_dt_tm = cnvtdatetime(acm_request->encounter_qual[xref->add[d.seq].idx].
    inpatient_admit_dt_tm),
   efh.loc_temp_cd = acm_request->encounter_qual[xref->add[d.seq].idx].loc_temp_cd, efh.tracking_bit
    = tracking_bit, efh.change_bit = chgbit,
