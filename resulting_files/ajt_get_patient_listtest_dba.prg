CREATE PROGRAM ajt_get_patient_listtest:dba
 PROMPT
 ...
 ELSEIF (( $PRINTOPTIONS IN (5, 7)))
  ...
  SET drd_request->script_name = "bhs_rounds_report_v3"
  EXECUTE bhs_rounds_report_v3  WITH replace(request,drd_request)
 ELSEIF (( $PRINTOPTIONS=6))
  SELECT INTO "nl:"
