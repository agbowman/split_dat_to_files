CREATE PROGRAM apslabelspec1b:dba
...
#script
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   data = data->resrc[d1.seq].label[d2.seq].fmt_accession_nbr, label->qual[lcnt].line[7].data =
   cnvtstring(data->resrc[d1.seq].label[d2.seq].accession_nbr),
  ...
  WITH nocounter
 ;end select
 EXECUTE cpm_create_file_name_logical "aps_labelspec1b", "dat", "x"
 ...
 SELECT INTO reply->print_status_data.print_filename
  ...
  DETAIL
   ...
   FOR (nlab = 1 TO size(label->qual,5))
     CALL print(calcpos((home_x_pos+ 0),(home_y_pos+ 0))), "{LPI/8}{CPI/18}{FONT/0}", "          Id:",
     CALL print(calcpos((home_x_pos+ 63),(home_y_pos+ 0))), "{LPI/8}{CPI/18}{FONT/0}", label->qual[
     nlab].line[1].data,
     row + 1,
     CALL print(calcpos((home_x_pos+ 0),(home_y_pos+ 8))), "{LPI/8}{CPI/18}{FONT/0}",
     "     Patient:",
     CALL print(calcpos((home_x_pos+ 63),(home_y_pos+ 8))), "{LPI/8}{CPI/18}{FONT/0}",
     label->qual[nlab].line[2].data, row + 1,
     CALL print(calcpos((home_x_pos+ 0),(home_y_pos+ 16))),
     "{LPI/8}{CPI/18}{FONT/0}", "      Gender:",
     CALL print(calcpos((home_x_pos+ 63),(home_y_pos+ 16))),
     "{LPI/8}{CPI/18}{FONT/0}", label->qual[nlab].line[3].data,
     CALL print(calcpos((home_x_pos+ 96),(home_y_pos+ 16))),
     "{LPI/8}{CPI/18}{FONT/0}", "DOB:",
     CALL print(calcpos((home_x_pos+ 114),(home_y_pos+ 16))),
     "{LPI/8}{CPI/18}{FONT/0}", label->qual[nlab].line[4].data,
     CALL print(calcpos((home_x_pos+ 150),(home_y_pos+ 16))),
     "{LPI/8}{CPI/18}{FONT/0}", "Age:",
     CALL print(calcpos((home_x_pos+ 168),(home_y_pos+ 16))),
     "{LPI/8}{CPI/18}{FONT/0}", label->qual[nlab].line[5].data, row + 1,
     CALL print(calcpos((home_x_pos+ 0),(home_y_pos+ 24))), "{LPI/8}{CPI/18}{FONT/0}",
     "        Case:",
     CALL print(calcpos((home_x_pos+ 63),(home_y_pos+ 24))), "{LPI/8}{CPI/18}{FONT/0}", label->qual[
     nlab].line[6].data,
     CALL print(calcpos((home_x_pos+ 150),(home_y_pos+ 24))), "{LPI/8}{CPI/18}{FONT/0}", "Collected:",
     CALL print(calcpos((home_x_pos+ 195),(home_y_pos+ 24))), "{LPI/8}{CPI/18}{FONT/0}", label->qual[
     nlab].line[10].data,
     row + 1,
     CALL print(calcpos((home_x_pos+ 0),(home_y_pos+ 32))), "{LPI/8}{CPI/18}{FONT/0}",
     "    Specimen:",
     CALL print(calcpos((home_x_pos+ 63),(home_y_pos+ 32))), "{LPI/8}{CPI/18}{FONT/0}",
     label->qual[nlab].line[8].data,
     CALL print(calcpos((home_x_pos+ 96),(home_y_pos+ 32))), "{LPI/8}{CPI/18}{FONT/0}",
     label->qual[nlab].line[9].data, row + 1,
     CALL print(calcpos((home_x_pos+ 0),(home_y_pos+ 40))),
     "{LPI/8}{CPI/18}{FONT/0}", "    Fixative:",
     CALL print(calcpos((home_x_pos+ 63),(home_y_pos+ 40))),
     "{LPI/8}{CPI/18}{FONT/0}", label->qual[nlab].line[11].data,
     CALL print(calcpos((home_x_pos+ 122),(home_y_pos+ 40))),
     "{LPI/8}{CPI/18}{FONT/0}", " / ",
     CALL print(calcpos((home_x_pos+ 140),(home_y_pos+ 40))),
     "{LPI/8}{CPI/18}{FONT/0}", label->qual[nlab].line[12].data, row + 1,
     CALL print(calcpos((home_x_pos+ 0),(home_y_pos+ 48))), "{LPI/8}{CPI/18}{FONT/0}",
     "Requested by:",
     CALL print(calcpos((home_x_pos+ 63),(home_y_pos+ 48))), "{LPI/8}{CPI/18}{FONT/0}", label->qual[
     nlab].line[13].data,
     row + 1,
     CALL print(calcpos((home_x_pos+ 0),(home_y_pos+ 48))), "{LPI/8}{CPI/18}{FONT/0}",
     "Today's date: ",
     CALL print(calcpos((home_x_pos+ 63),(home_y_pos+ 56))), "{LPI/8}{CPI/18}{FONT/0}",
     label->qual[nlab].line[14].data, row + 1, row + 1,
     CALL print(calcpos((home_x_pos+ 2),(home_y_pos+ 78))), "{LPI/4}{CPI/16}{BCR/250}{FONT/31/1}",
     CALL print(build("*>:",substring(1,3,cnvtalphanum(label->qual[nlab].line[7].data)),">5",
      substring(4,12,cnvtalphanum(label->qual[nlab].line[7].data)),"03*{font/0}"))
     IF (nlab <= size(label->qual,5))
      "{NP}"
     ENDIF
   ENDFOR
  WITH nocounter, dio = 16, format = undefined,
   noformfeed, maxcol = 300
 ;end select
END GO
