CREATE PROGRAM bed_aud_surginet_tabs:dba
 ...
 SELECT INTO "nl:"
  FROM application a
  PLAN (a
   WHERE a.application_number=820000
    AND a.active_ind=1)
  HEAD REPORT
   positioncnt = 0
  DETAIL
  ...
  SELECT INTO "nl"
   ...
   PLAN (d1)
    ...
    WHERE vp.prsnl_id=0
     ...
     AND vp.application_number=820000
  ...
  SELECT INTO "nl"
   ...
   PLAN (d1
    ...
    WHERE vcp.prsnl_id=0
     ...
     AND vcp.application_number=820000
       ...
       SELECT INTO "nl"
        ...
        PLAN (d)
         ...
         WHERE dp.prsnl_id=0
          ...
          AND dp.application_number=820000
...
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("br_surginet_tab.csv")
 ENDIF
