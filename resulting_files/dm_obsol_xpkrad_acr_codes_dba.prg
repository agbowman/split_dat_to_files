CREATE PROGRAM dm_obsol_xpkrad_acr_codes:dba
 ...
 IF (currdb="ORACLE")
  ...
  SET errcode = 0
  CALL echo("Running Obsolete Process on primary key XPKRAD_ACR_CODES...")
  ...
  SET readme_data->message = "Primary Key XPKRAD_ACR_CODES was dropped successfully"
 ELSEIF (currdb="DB2UDB")
  SET readme_data->status = "S"
  SET readme_data->message = "Auto-success for DB2 database"
 ENDIF
 CALL echo(readme_data->status)
