CREATE PROGRAM aps_rdm_ocd_et4:dba
 ...
 END ;Subroutine
#start_script
 SET sreadme_name = "aps_rdm_ocd_et4"
 CALL logscriptstart(sreadme_name)
 CALL logmsg("Beginning to delete AP Processing steps...",((e_dispmsg+ e_rdmstatus)+ e_logtofile))
 CALL delreqproc(200005,"#")
 CALL delreqproc(200006,"#")
 CALL delreqproc(200011,"#")
 CALL delreqproc(200012,"#")
 CALL delreqproc(200014,"#")
 CALL delreqproc(200019,"#")
 CALL delreqproc(200021,"#")
 CALL delreqproc(200118,"#")
 CALL delreqproc(200138,"#")
 CALL delreqproc(200150,"#")
 CALL delreqproc(200386,"#")
 CALL delreqproc(200390,"#")
 CALL logmsg("Finished deleting AP Processing steps...",((e_dispmsg+ e_rdmstatus)+ e_logtofile))
 CALL logmsg("Beginning to ADD AP Processing steps...",((e_dispmsg+ e_rdmstatus)+ e_logtofile))
 CALL addreqproc(200005,1,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "ORM.OrderWriteSynch",1)
 CALL addreqproc(200005,2,"PFMT_APS_INITIATE_SPC_PROT",0,0,
  "",0)
 CALL addreqproc(200005,3,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL addreqproc(200005,4,"PFMT_APS_CREATE_CASE_TO_EVENT",0,120210,
  "",0)
 CALL logmsg("Completed adding 4 of 31 AP Processing steps...",((e_dispmsg+ e_rdmstatus)+ e_logtofile
  ))
 CALL addreqproc(200006,1,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "ORM.OrderWriteSynch",1)
 CALL addreqproc(200006,2,"PFMT_APS_INITIATE_SPC_PROT",0,0,
  "",0)
 CALL addreqproc(200006,3,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL addreqproc(200011,1,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL logmsg("Completed adding 8 of 31 AP Processing steps...",((e_dispmsg+ e_rdmstatus)+ e_logtofile
  ))
 CALL addreqproc(200012,1,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL addreqproc(200012,2,"PFMT_APS_CANCEL_CE_EVENT",0,120210,
  "",0)
 CALL addreqproc(200014,1,"PFMT_APS_VERIFY_RPT_EVENT",0,120210,
  "",1)
 CALL addreqproc(200014,2,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL addreqproc(200014,3,"PFMT_APS_REVIEW_FOLLOWUP",0,0,
  "",0)
 CALL addreqproc(200014,4,"PFMT_APS_ADD_AUTO_CODES",0,200061,
  "",0)
 CALL addreqproc(200014,5,"PFMT_APS_INITIATE_EXPEDITE",0,0,
  "",0)
 CALL logmsg("Completed adding 15 of 31 AP Processing steps...",((e_dispmsg+ e_rdmstatus)+
  e_logtofile))
 CALL addreqproc(200019,1,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL addreqproc(200021,1,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL addreqproc(200021,2,"PFMT_APS_CANCEL_CE_EVENT",0,120210,
  "",0)
 CALL addreqproc(200118,1,"PFMT_APS_VERIFY_RPT_EVENT",0,120210,
  "",1)
 CALL addreqproc(200118,2,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL addreqproc(200118,3,"PFMT_APS_REVIEW_FOLLOWUP",0,0,
  "",0)
 CALL addreqproc(200118,4,"PFMT_APS_ADD_AUTO_CODES",0,200061,
  "",0)
 CALL addreqproc(200118,5,"PFMT_APS_INITIATE_EXPEDITE",0,0,
  "",0)
 CALL addreqproc(200118,6,"PFMT_APS_RPT_TO_AFC",0,951060,
  "",0)
 CALL logmsg("Completed adding 24 of 31 AP Processing steps...",((e_dispmsg+ e_rdmstatus)+
  e_logtofile))
 CALL addreqproc(200138,1,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL addreqproc(200150,1,"PFMT_APS_PROC_TASKS_TO_ORDER",0,0,
  "",0)
 CALL addreqproc(200150,2,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL addreqproc(200386,1,"PFMT_APS_OPS_EXCEPTION",560201,560201,
  "",1)
 CALL addreqproc(200390,1,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "ORM.OrderWriteSynch",1)
 CALL addreqproc(200390,2,"PFMT_APS_COMP_BILLING_TASKS",0,0,
  "",0)
 CALL addreqproc(200390,3,"PFMT_APS_PATHOLOGY_ORDER",560201,560201,
  "",1)
 CALL logmsg("Completed adding 31 of 31 AP Processing steps...",((e_dispmsg+ e_rdmstatus)+
  e_logtofile))
 CALL stamp_req(200011)
 CALL stamp_req(200138)
 CALL logmsg("Completed restamping requests 200011 and 200138...",((e_dispmsg+ e_rdmstatus)+
  e_logtofile))
