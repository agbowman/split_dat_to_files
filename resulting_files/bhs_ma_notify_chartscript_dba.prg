CREATE PROGRAM bhs_ma_notify_chartscript:dba
 PROMPT
 ...
 SET store_directory = "/cerner/d_test/esa/esa_in/"
 SET invalid_filename = "invalid_file.dat"
 SET new_chart_file = "/cerner/d_test/esa/esa_out/chartscript_file.dat"
 ...
 SET filename = concat("/cerner/d_test/esa/esa_in/",sdate,".DAT")
 FREE DEFINE rtl
