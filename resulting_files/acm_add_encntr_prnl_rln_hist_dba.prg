CREATE PROGRAM acm_add_encntr_prnl_rln_hist:dba
 ...
 INSERT  FROM encntr_prsnl_reltn_hist eprh,
  ...
  SET eprh.encntr_id = acm_request->encntr_prsnl_reltn_qual[xref->add[d.seq].idx].encntr_id, eprh
   .encntr_prsnl_reltn_hist_id = seq(encounter_seq,nextval), eprh.encntr_prsnl_reltn_id = acm_request
   ->encntr_prsnl_reltn_qual[xref->add[d.seq].idx].encntr_prsnl_reltn_id,
   eprh.pm_hist_tracking_id = acm_request->encntr_prsnl_reltn_qual[xref->add[d.seq].idx].
   pm_hist_tracking_id, eprh.transaction_dt_tm = cnvtdatetime(acm_request->encntr_prsnl_reltn_qual[
    xref->add[d.seq].idx].transaction_dt_tm), eprh.encntr_prsnl_r_cd = acm_request->
   encntr_prsnl_reltn_qual[xref->add[d.seq].idx].encntr_prsnl_r_cd,
   eprh.prsnl_person_id = acm_request->encntr_prsnl_reltn_qual[xref->add[d.seq].idx].prsnl_person_id,
   eprh.tracking_bit = tracking_bit, eprh.change_bit = chgbit,
