CREATE PROGRAM bed_aud_rad_orc_synonyms:dba
 ...
 SELECT INTO "nl:"
  ...
  HEAD oc.description
   ...
   ENDIF
   IF (oc.vetting_approval_flag=1)
    temp->oqual[ocnt].vetting = "Does Not Require Approval"
   ELSEIF (oc.vetting_approval_flag=2)
    temp->oqual[ocnt].vetting = "Requires Approval"
   ENDIF
  HEAD ocs.synonym_id
 ...
 SET reply->collist[3].header_text = "Orderable Item Description"
 SET reply->collist[3].data_type = 1
 SET reply->collist[3].hide_ind = 0
 SET reply->collist[4].header_text = "Synonym Type"
 SET reply->collist[4].data_type = 1
 SET reply->collist[4].hide_ind = 0
 SET reply->collist[5].header_text = "Synonym"
 SET reply->collist[5].data_type = 1
 SET reply->collist[5].hide_ind = 0
 SET reply->collist[6].header_text = "Order Entry Format"
 SET reply->collist[6].data_type = 1
 SET reply->collist[6].hide_ind = 0
 SET reply->collist[7].header_text = "Department Name"
 SET reply->collist[7].data_type = 1
 SET reply->collist[7].hide_ind = 0
 SET reply->collist[8].header_text = "Hide"
 SET reply->collist[8].data_type = 1
 SET reply->collist[8].hide_ind = 0
 SET reply->collist[9].header_text = "Care Set"
 SET reply->collist[9].data_type = 1
 SET reply->collist[9].hide_ind = 0
 SET reply->collist[10].header_text = "Vetting"
 SET reply->collist[10].data_type = 1
 SET reply->collist[10].hide_ind = 0
 SET reply->collist[11].header_text = "Clinical Category"
 SET reply->collist[11].data_type = 1
 SET reply->collist[11].hide_ind = 0
 SET reply->collist[12].header_text = "catalog_cd"
 ...
 FOR (z = 1 TO temp->ocnt)
   FOR (w = 1 TO temp->oqual[z].syncnt)
     ...
     SET reply->rowlist[row_nbr].celllist[2].string_value = temp->oqual[z].subtype
     SET reply->rowlist[row_nbr].celllist[3].string_value = temp->oqual[z].ord
     SET reply->rowlist[row_nbr].celllist[4].string_value = temp->oqual[z].synqual[w].synonym_type
     SET reply->rowlist[row_nbr].celllist[5].string_value = temp->oqual[z].synqual[w].synonym
     SET reply->rowlist[row_nbr].celllist[6].string_value = temp->oqual[z].synqual[w].format
     SET reply->rowlist[row_nbr].celllist[7].string_value = temp->oqual[z].dept
     SET reply->rowlist[row_nbr].celllist[8].string_value = temp->oqual[z].synqual[w].hide
     SET reply->rowlist[row_nbr].celllist[9].string_value = temp->oqual[z].careset
     SET reply->rowlist[row_nbr].celllist[10].string_value = temp->oqual[z].vetting
     SET reply->rowlist[row_nbr].celllist[11].string_value = temp->oqual[z].clin_category
     SET reply->rowlist[row_nbr].celllist[12].double_value = temp->oqual[z].catalog_cd
   ENDFOR
 ENDFOR
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("rad_orc_synonyms_audit.csv")
 ENDIF
