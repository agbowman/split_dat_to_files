CREATE PROGRAM ecf_rdm_asa_xmap:dba
 ...
 SET kia_tbl_desc = "ASA XMAP"
 SET kia_short_desc = "ASA XMAP"
 SET kia_rdm_log_name = "ecf_rdm_asa_xmap.log"
 SET kia_rdm_nbr = 9983
 ...
 CALL log_sub(concat("ecf_rdm_asa_xmap Begin> ",format(cnvtdatetime(curdate,curtime3),
