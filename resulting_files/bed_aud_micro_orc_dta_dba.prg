CREATE PROGRAM bed_aud_micro_orc_dta:dba
 ...
 DECLARE micro = f8 WITH public, noconstant(0.0)
 SELECT INTO "nl:"
  FROM code_value cv
  PLAN (cv
 ...
 SET reply->collist[9].header_text = "Default Result Type"
 SET reply->collist[9].data_type = 1
 SET reply->collist[9].hide_ind = 0
 SET reply->collist[10].header_text = "Department Name"
 ...
 FOR (x = 1 TO temp->ocnt)
   ...
   SET reply->rowlist[row_nbr].celllist[10].string_value = temp->oqual[x].dept_name
   ...
   FOR (y = 1 TO temp->oqual[x].dcnt)
     ...
     SET reply->rowlist[row_nbr].celllist[8].string_value = temp->oqual[x].dqual[y].post_prompt
     SET reply->rowlist[row_nbr].celllist[9].string_value = temp->oqual[x].dqual[y].result_type
     SET reply->rowlist[row_nbr].celllist[10].string_value = temp->oqual[x].dept_name
     SET reply->rowlist[row_nbr].celllist[11].string_value = temp->oqual[x].activity_subtype
     SET reply->rowlist[row_nbr].celllist[12].double_value = temp->oqual[x].catalog_cd
...
#exit_script
 IF ((reply->high_volume_flag IN (1, 2)))
  SET reply->output_filename = build("micro_orc_dta_audit.csv")
 ENDIF
