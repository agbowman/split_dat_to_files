CREATE PROGRAM djh_ma_90_day_nologin_medstd
 PROMPT
 ...
 IF (email_ind=1)
  ...
  SET filename_out = concat(format(curdate,"YYYYMMDD ;;D"),"-MedStd.csv")
  DECLARE subject_line = vc
  SET subject_line = concat(curprog," - CIS Med Std Acnts InAct 90 days")
