CREATE PROGRAM dm2_create_ocd_capture:dba
 ...
 DECLARE size_ocd_dmcolumn = i4
 CALL check_logfile("dm2_cre_ocd",".log","DM2_CREATE_OCD_CAPTURE")
 SET file_prefix = build("dm2o", $1)
 IF (create_sch_files(file_prefix, $2)=0)
  GO TO exit_script
 ENDIF
 INSERT  FROM dmheader dh
  SET dh.description = build("OCD", $1), dh.admin_load_ind = 1, dh.source_rdbms = "ORACLE",
   dh.sf_version = 1
  WITH nocounter
 ;end insert
 FREE RECORD ocd_dmtable
 RECORD ocd_dmtable(
   1 tbl[*]
     2 table_name = vc
 ...
 SET stat = alterlist(ocd_dmtable->tbl,2)
 SET tbl_cnt = 0
 SET tbl_cnt = (tbl_cnt+ 1)
 SET ocd_dmtable->tbl[tbl_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmtable->tbl[tbl_cnt].index_tspace_ni = 0
 SET ocd_dmtable->tbl[tbl_cnt].long_tspace_ni = 0
 SET ocd_dmtable->tbl[tbl_cnt].init_ext = 44
 SET ocd_dmtable->tbl[tbl_cnt].next_ext = 55
 SET ocd_dmtable->tbl[tbl_cnt].pct_increase = 11
 SET ocd_dmtable->tbl[tbl_cnt].pct_used = 40
 SET ocd_dmtable->tbl[tbl_cnt].pct_free = 10
 SET ocd_dmtable->tbl[tbl_cnt].bytes_allocated = 5
 SET ocd_dmtable->tbl[tbl_cnt].bytes_used = 6
 SET ocd_dmtable->tbl[tbl_cnt].schema_date = cnvtdatetime("12-oct-2000")
 SET ocd_dmtable->tbl[tbl_cnt].alpha_feature_nbr =  $1
 SET ocd_dmtable->tbl[tbl_cnt].feature_number = 1234
 SET ocd_dmtable->tbl[tbl_cnt].schema_instance = 2
 SET ocd_dmtable->tbl[tbl_cnt].updt_dt_tm = cnvtdatetime("12-oct-2000")
 SET tbl_cnt = (tbl_cnt+ 1)
 SET ocd_dmtable->tbl[tbl_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmtable->tbl[tbl_cnt].index_tspace_ni = 0
 SET ocd_dmtable->tbl[tbl_cnt].long_tspace_ni = 0
 SET ocd_dmtable->tbl[tbl_cnt].init_ext = 77
 SET ocd_dmtable->tbl[tbl_cnt].next_ext = 88
 SET ocd_dmtable->tbl[tbl_cnt].pct_increase = 33
 SET ocd_dmtable->tbl[tbl_cnt].pct_used = 45
 SET ocd_dmtable->tbl[tbl_cnt].pct_free = 15
 SET ocd_dmtable->tbl[tbl_cnt].bytes_allocated = 9
 SET ocd_dmtable->tbl[tbl_cnt].bytes_used = 8
 SET ocd_dmtable->tbl[tbl_cnt].schema_date = cnvtdatetime("12-oct-2000")
 SET ocd_dmtable->tbl[tbl_cnt].alpha_feature_nbr =  $1
 SET ocd_dmtable->tbl[tbl_cnt].feature_number = 1234
 SET ocd_dmtable->tbl[tbl_cnt].schema_instance = 2
 SET ocd_dmtable->tbl[tbl_cnt].updt_dt_tm = cnvtdatetime("12-oct-2000")
 SET stat = alterlist(ocd_dmtable->tbl,tbl_cnt)
 SET size_ocd_dmtable = size(ocd_dmtable->tbl,5)
 INSERT  FROM dmtable dt,
   (dummyt d  WITH seq = size_ocd_dmtable)
  SET dt.table_name = ocd_dmtable->tbl[d.seq].table_name, dt.tablespace_name = "D_A_SMALL", dt
   .index_tspace = "I_A_SMALL",
   dt.index_tspace_ni = ocd_dmtable->tbl[d.seq].index_tspace_ni, dt.long_tspace = "L_A_SMALL", dt
   .long_tspace_ni = ocd_dmtable->tbl[d.seq].long_tspace_ni,
   dt.init_ext = ocd_dmtable->tbl[d.seq].init_ext, dt.next_ext = ocd_dmtable->tbl[d.seq].next_ext, dt
   .pct_increase = ocd_dmtable->tbl[d.seq].pct_increase,
   dt.pct_used = ocd_dmtable->tbl[d.seq].pct_used, dt.pct_free = ocd_dmtable->tbl[d.seq].pct_free, dt
   .bytes_allocated = ocd_dmtable->tbl[d.seq].bytes_allocated,
   dt.bytes_used = ocd_dmtable->tbl[d.seq].bytes_used, dt.schema_date = ocd_dmtable->tbl[d.seq].
   schema_date, dt.alpha_feature_nbr = ocd_dmtable->tbl[d.seq].alpha_feature_nbr,
   dt.feature_number = ocd_dmtable->tbl[d.seq].feature_number, dt.schema_instance = ocd_dmtable->tbl[
   d.seq].schema_instance, dt.updt_dt_tm = ocd_dmtable->tbl[d.seq].updt_dt_tm
  PLAN (d)
   JOIN (dt
   WHERE (ocd_dmtable->tbl[d.seq].table_name=dt.table_name))
  WITH nocounter, outerjoin = d, dontexist
 ;end insert
 FREE RECORD ocd_dmcolumn
 RECORD ocd_dmcolumn(
   1 col[*]
     2 table_name = vc
     2 column_name = vc
 ...
 SET stat = alterlist(ocd_dmcolumn->col,15)
 SET col_cnt = 0
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL1"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 1
 SET ocd_dmcolumn->col[col_cnt].data_type = "NUMBER"
 SET ocd_dmcolumn->col[col_cnt].data_length = 22
 SET ocd_dmcolumn->col[col_cnt].nullable = "N"
 SET ocd_dmcolumn->col[col_cnt].data_default = "0"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 0
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL2"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 2
 SET ocd_dmcolumn->col[col_cnt].data_type = "CHAR"
 SET ocd_dmcolumn->col[col_cnt].data_length = 20
 SET ocd_dmcolumn->col[col_cnt].nullable = "Y"
 SET ocd_dmcolumn->col[col_cnt].data_default = "'TEST DEFAULT'"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 0
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL3"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 3
 SET ocd_dmcolumn->col[col_cnt].data_type = "DATE"
 SET ocd_dmcolumn->col[col_cnt].data_length = 7
 SET ocd_dmcolumn->col[col_cnt].nullable = "Y"
 SET ocd_dmcolumn->col[col_cnt].data_default = "SYSDATE"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 0
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL4"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 4
 SET ocd_dmcolumn->col[col_cnt].data_type = "DATE"
 SET ocd_dmcolumn->col[col_cnt].data_length = 7
 SET ocd_dmcolumn->col[col_cnt].nullable = "Y"
 SET ocd_dmcolumn->col[col_cnt].data_default =
 "TO_DATE('12/31/2100 00:00:00','MM/DD/YYYY HH24:MI:SS')"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 0
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL5"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 5
 SET ocd_dmcolumn->col[col_cnt].data_type = "VARCHAR2"
 SET ocd_dmcolumn->col[col_cnt].data_length = 100
 SET ocd_dmcolumn->col[col_cnt].nullable = "Y"
 SET ocd_dmcolumn->col[col_cnt].data_default = "'NULL'"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 1
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL6"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 6
 SET ocd_dmcolumn->col[col_cnt].data_type = "FLOAT"
 SET ocd_dmcolumn->col[col_cnt].data_length = 22
 SET ocd_dmcolumn->col[col_cnt].nullable = "Y"
 SET ocd_dmcolumn->col[col_cnt].data_default = "0.0"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 0
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL7"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 7
 SET ocd_dmcolumn->col[col_cnt].data_type = "LONG"
 SET ocd_dmcolumn->col[col_cnt].data_length = 0
 SET ocd_dmcolumn->col[col_cnt].nullable = "Y"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 1
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL8"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 8
 SET ocd_dmcolumn->col[col_cnt].data_type = "RAW"
 SET ocd_dmcolumn->col[col_cnt].data_length = 32
 SET ocd_dmcolumn->col[col_cnt].nullable = "Y"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 1
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL9"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 9
 SET ocd_dmcolumn->col[col_cnt].data_type = "ROWID"
 SET ocd_dmcolumn->col[col_cnt].data_length = 10
 SET ocd_dmcolumn->col[col_cnt].nullable = "Y"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 1
 SET col_cnt = (col_cnt+ 1)
 SET ocd_dmcolumn->col[col_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL1"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 1
 SET ocd_dmcolumn->col[col_cnt].data_type = "NUMBER"
 SET ocd_dmcolumn->col[col_cnt].data_length = 22
 ...
 SET ocd_dmcolumn->col[col_cnt].column_name = "COL2"
 SET ocd_dmcolumn->col[col_cnt].column_seq = 2
 SET ocd_dmcolumn->col[col_cnt].data_type = "LONG RAW"
 SET ocd_dmcolumn->col[col_cnt].data_length = 0
 SET ocd_dmcolumn->col[col_cnt].nullable = "Y"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 1
 SET col_cnt = (col_cnt+ 1)
 ...
 SET ocd_dmcolumn->col[col_cnt].data_default = "0"
 SET ocd_dmcolumn->col[col_cnt].data_default_ni = 0
 SET stat = alterlist(ocd_dmcolumn->col,col_cnt)
 SET size_ocd_dmcolumn = size(ocd_dmcolumn->col,5)
 INSERT  FROM dmcolumn dc,
   (dummyt d  WITH seq = size_ocd_dmcolumn)
  SET dc.table_name = ocd_dmcolumn->col[d.seq].table_name, dc.column_name = ocd_dmcolumn->col[d.seq].
   column_name, dc.column_seq = ocd_dmcolumn->col[d.seq].column_seq,
   dc.data_type = ocd_dmcolumn->col[d.seq].data_type, dc.data_length = ocd_dmcolumn->col[d.seq].
   data_length, dc.nullable = ocd_dmcolumn->col[d.seq].nullable,
   dc.data_default = ocd_dmcolumn->col[d.seq].data_default, dc.data_default_ni = ocd_dmcolumn->col[d
   .seq].data_default_ni
  PLAN (d)
   JOIN (dc
   WHERE (ocd_dmcolumn->col[d.seq].table_name=dc.table_name)
    AND (ocd_dmcolumn->col[d.seq].column_name=dc.column_name))
  WITH nocounter, outerjoin = d, dontexist
 ;end insert
 FREE RECORD ocd_dmindex
 RECORD ocd_dmindex(
   1 ind[*]
     2 table_name = vc
     2 index_name = vc
 ...
 SET stat = alterlist(ocd_dmindex->ind,2)
 SET ind_cnt = 0
 SET ind_cnt = (ind_cnt+ 1)
 SET ocd_dmindex->ind[ind_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmindex->ind[ind_cnt].index_name = "XPKAMY_TABLE1"
 SET ocd_dmindex->ind[ind_cnt].full_ind_name = "XPKAMY_TABLE1"
 SET ocd_dmindex->ind[ind_cnt].pct_increase = 12
 SET ocd_dmindex->ind[ind_cnt].pct_free = 14
 SET ocd_dmindex->ind[ind_cnt].init_ext = 100040
 SET ocd_dmindex->ind[ind_cnt].next_ext = 100060
 SET ocd_dmindex->ind[ind_cnt].unique_ind = 1
 SET ocd_dmindex->ind[ind_cnt].bytes_allocated = 0
 SET ocd_dmindex->ind[ind_cnt].bytes_used = 0
 SET ind_cnt = (ind_cnt+ 1)
 SET ocd_dmindex->ind[ind_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmindex->ind[ind_cnt].index_name = "XPKAMY_TABLE2"
 SET ocd_dmindex->ind[ind_cnt].full_ind_name = "XPKAMY_TABLE2"
 SET ocd_dmindex->ind[ind_cnt].pct_increase = 76
 SET ocd_dmindex->ind[ind_cnt].pct_free = 23
 SET ocd_dmindex->ind[ind_cnt].init_ext = 100070
 SET ocd_dmindex->ind[ind_cnt].next_ext = 100090
 SET ocd_dmindex->ind[ind_cnt].unique_ind = 1
 SET ocd_dmindex->ind[ind_cnt].bytes_allocated = 0
 SET ocd_dmindex->ind[ind_cnt].bytes_used = 0
 SET stat = alterlist(ocd_dmindex->ind,ind_cnt)
 SET size_ocd_dmindex = size(ocd_dmindex->ind,5)
 INSERT  FROM dmindex di,
   (dummyt d  WITH seq = size_ocd_dmindex)
  SET di.table_name = ocd_dmindex->ind[d.seq].table_name, di.index_name = ocd_dmindex->ind[d.seq].
   index_name, di.full_ind_name = ocd_dmindex->ind[d.seq].full_ind_name,
   di.pct_increase = ocd_dmindex->ind[d.seq].pct_increase, di.pct_free = ocd_dmindex->ind[d.seq].
   pct_free, di.init_ext = ocd_dmindex->ind[d.seq].init_ext,
   di.next_ext = ocd_dmindex->ind[d.seq].next_ext, di.unique_ind = ocd_dmindex->ind[d.seq].unique_ind,
   di.bytes_allocated = ocd_dmindex->ind[d.seq].bytes_allocated,
   di.bytes_used = ocd_dmindex->ind[d.seq].bytes_used
  PLAN (d)
   JOIN (di
   WHERE (ocd_dmindex->ind[d.seq].table_name=di.table_name)
    AND (ocd_dmindex->ind[d.seq].index_name=di.index_name))
  WITH nocounter, outerjoin = d, dontexist
 ;end insert
 FREE RECORD ocd_dmindcol
 RECORD ocd_dmindcol(
   1 idc[*]
     2 table_name = vc
     2 index_name = vc
 ...
 SET stat = alterlist(ocd_dmindcol->idc,2)
 SET idc_cnt = 0
 SET idc_cnt = (idc_cnt+ 1)
 SET ocd_dmindcol->idc[idc_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmindcol->idc[idc_cnt].index_name = "XPKAMY_TABLE1"
 SET ocd_dmindcol->idc[idc_cnt].column_name = "COL1"
 SET ocd_dmindcol->idc[idc_cnt].column_position = 1
 SET idc_cnt = (idc_cnt+ 1)
 SET ocd_dmindcol->idc[idc_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmindcol->idc[idc_cnt].index_name = "XPKAMY_TABLE2"
 SET ocd_dmindcol->idc[idc_cnt].column_name = "COL1"
 SET ocd_dmindcol->idc[idc_cnt].column_position = 1
 SET stat = alterlist(ocd_dmindcol->idc,idc_cnt)
 SET size_ocd_dmindcol = size(ocd_dmindcol->idc,5)
 INSERT  FROM dmindcol i,
   (dummyt d  WITH seq = size_ocd_dmindcol)
  SET i.table_name = ocd_dmindcol->idc[d.seq].table_name, i.index_name = ocd_dmindcol->idc[d.seq].
   index_name, i.column_name = ocd_dmindcol->idc[d.seq].column_name,
   i.column_position = ocd_dmindcol->idc[d.seq].column_position
  PLAN (d)
   JOIN (i
   WHERE (ocd_dmindcol->idc[d.seq].table_name=i.table_name)
    AND (ocd_dmindcol->idc[d.seq].index_name=i.index_name)
    AND (ocd_dmindcol->idc[d.seq].column_name=i.column_name))
  WITH nocounter, outerjoin = d, dontexist
 ;end insert
 FREE RECORD ocd_dmcons
 RECORD ocd_dmcons(
   1 con[*]
     2 table_name = vc
     2 constraint_name = vc
 ...
 SET stat = alterlist(ocd_dmcons->con,3)
 SET con_cnt = 0
 SET con_cnt = (con_cnt+ 1)
 SET ocd_dmcons->con[con_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcons->con[con_cnt].constraint_name = "XPKAMY_TABLE1"
 SET ocd_dmcons->con[con_cnt].full_cons_name = "XPKAMY_TABLE1"
 SET ocd_dmcons->con[con_cnt].constraint_type = "P"
 SET ocd_dmcons->con[con_cnt].status_ind = 1
 SET ocd_dmcons->con[con_cnt].r_constraint_name = " "
 SET ocd_dmcons->con[con_cnt].parent_table_name = " "
 SET ocd_dmcons->con[con_cnt].parent_table_columns = " "
 SET con_cnt = (con_cnt+ 1)
 SET ocd_dmcons->con[con_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmcons->con[con_cnt].constraint_name = "XPKAMY_TABLE2"
 SET ocd_dmcons->con[con_cnt].full_cons_name = "XPKAMY_TABLE2"
 SET ocd_dmcons->con[con_cnt].constraint_type = "P"
 SET ocd_dmcons->con[con_cnt].status_ind = 1
 SET ocd_dmcons->con[con_cnt].r_constraint_name = " "
 SET ocd_dmcons->con[con_cnt].parent_table_name = " "
 ...
 SET con_cnt = (con_cnt+ 1)
 SET ocd_dmcons->con[con_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmcons->con[con_cnt].constraint_name = "XFK001AMY_TABLE2"
 SET ocd_dmcons->con[con_cnt].full_cons_name = "XFK001AMY_TABLE2"
 SET ocd_dmcons->con[con_cnt].constraint_type = "R"
 SET ocd_dmcons->con[con_cnt].status_ind = 0
 SET ocd_dmcons->con[con_cnt].r_constraint_name = "XPKAMY_TABLE1"
 SET ocd_dmcons->con[con_cnt].parent_table_name = "AMY_TABLE1"
 SET ocd_dmcons->con[con_cnt].parent_table_columns = "COL1"
 SET stat = alterlist(ocd_dmcons->con,con_cnt)
 SET size_ocd_dmcons = size(ocd_dmcons->con,5)
 INSERT  FROM dmcons c,
   (dummyt d  WITH seq = size_ocd_dmcons)
  SET c.table_name = ocd_dmcons->con[d.seq].table_name, c.constraint_name = ocd_dmcons->con[d.seq].
   constraint_name, c.full_cons_name = ocd_dmcons->con[d.seq].full_cons_name,
   c.constraint_type = ocd_dmcons->con[d.seq].constraint_type, c.status_ind = ocd_dmcons->con[d.seq].
   status_ind, c.r_constraint_name = ocd_dmcons->con[d.seq].r_constraint_name,
   c.parent_table_name = ocd_dmcons->con[d.seq].parent_table_name, c.parent_table_columns =
   ocd_dmcons->con[d.seq].parent_table_columns
  PLAN (d)
   JOIN (c
   WHERE (ocd_dmcons->con[d.seq].table_name=c.table_name)
    AND (ocd_dmcons->con[d.seq].constraint_name=c.constraint_name))
  WITH nocounter, outerjoin = d, dontexist
 ;end insert
 FREE RECORD ocd_dmconscol
 RECORD ocd_dmconscol(
   1 mco[*]
     2 table_name = vc
     2 constraint_name = vc
     2 column_name = vc
 ...
 SET stat = alterlist(ocd_dmconscol->mco,3)
 SET mco_cnt = 0
 SET mco_cnt = (mco_cnt+ 1)
 SET ocd_dmconscol->mco[mco_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmconscol->mco[mco_cnt].constraint_name = "XPKAMY_TABLE1"
 SET ocd_dmconscol->mco[mco_cnt].column_name = "COL1"
 SET ocd_dmconscol->mco[mco_cnt].position = 1
 SET mco_cnt = (mco_cnt+ 1)
 SET ocd_dmconscol->mco[mco_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmconscol->mco[mco_cnt].constraint_name = "XPKAMY_TABLE2"
 SET ocd_dmconscol->mco[mco_cnt].column_name = "COL1"
 SET ocd_dmconscol->mco[mco_cnt].position = 1
 SET mco_cnt = (mco_cnt+ 1)
 SET ocd_dmconscol->mco[mco_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmconscol->mco[mco_cnt].constraint_name = "XFK001AMY_TABLE2"
 SET ocd_dmconscol->mco[mco_cnt].column_name = "COL3"
 SET ocd_dmconscol->mco[mco_cnt].position = 3
 SET stat = alterlist(ocd_dmconscol->mco,mco_cnt)
 SET size_ocd_dmconscol = size(ocd_dmconscol->mco,5)
 INSERT  FROM dmconscol dsc,
   (dummyt d  WITH seq = size_ocd_dmconscol)
  SET dsc.table_name = ocd_dmconscol->mco[d.seq].table_name, dsc.constraint_name = ocd_dmconscol->
   mco[d.seq].constraint_name, dsc.column_name = ocd_dmconscol->mco[d.seq].column_name,
   dsc.position = ocd_dmconscol->mco[d.seq].position
  PLAN (d)
   JOIN (dsc
   WHERE (ocd_dmconscol->mco[d.seq].table_name=dsc.table_name)
    AND (ocd_dmconscol->mco[d.seq].constraint_name=dsc.constraint_name)
    AND (ocd_dmconscol->mco[d.seq].column_name=dsc.column_name))
  WITH nocounter, outerjoin = d, dontexist
 ;end insert
 FREE RECORD ocd_dmtbldoc
 RECORD ocd_dmtbldoc(
   1 bld[*]
     2 table_name = vc
 ...
 SET stat = alterlist(ocd_dmtbldoc->bld,4)
 SET bld_cnt = 0
 SET bld_cnt = (bld_cnt+ 1)
 SET ocd_dmtbldoc->bld[bld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmtbldoc->bld[bld_cnt].data_model_section = "Test table 1"
 SET ocd_dmtbldoc->bld[bld_cnt].description = "This is Amy test table 1"
 SET ocd_dmtbldoc->bld[bld_cnt].definition = "Testing the translate load process I"
 SET ocd_dmtbldoc->bld[bld_cnt].static_rows = 0
 SET ocd_dmtbldoc->bld[bld_cnt].updt_cnt = 5
 SET ocd_dmtbldoc->bld[bld_cnt].reference_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].human_reqd_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].drop_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].table_suffix = "9974"
 SET ocd_dmtbldoc->bld[bld_cnt].full_table_name = "AMY_TABLE1"
 SET ocd_dmtbldoc->bld[bld_cnt].suffixed_table_name = "AMY_TABLE19974"
 SET ocd_dmtbldoc->bld[bld_cnt].person_cmb_trigger_type = " "
 SET ocd_dmtbldoc->bld[bld_cnt].default_row_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].encntr_cmb_trigger_type = " "
 SET bld_cnt = (bld_cnt+ 1)
 SET ocd_dmtbldoc->bld[bld_cnt].table_name = "AMY_TABLE19974"
 SET ocd_dmtbldoc->bld[bld_cnt].data_model_section = "Test table 1 9974"
 SET ocd_dmtbldoc->bld[bld_cnt].description = "This is Amy test table 1 9974"
 SET ocd_dmtbldoc->bld[bld_cnt].definition = "Testing the translate load process II"
 SET ocd_dmtbldoc->bld[bld_cnt].static_rows = 0
 SET ocd_dmtbldoc->bld[bld_cnt].updt_cnt = 5
 SET ocd_dmtbldoc->bld[bld_cnt].reference_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].human_reqd_ind = 0
 ...
 SET ocd_dmtbldoc->bld[bld_cnt].encntr_cmb_trigger_type = " "
 SET bld_cnt = (bld_cnt+ 1)
 SET ocd_dmtbldoc->bld[bld_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmtbldoc->bld[bld_cnt].data_model_section = "Test table 2"
 SET ocd_dmtbldoc->bld[bld_cnt].description = "This is Amy test table 2"
 SET ocd_dmtbldoc->bld[bld_cnt].definition = "Testing the translate load process III"
 SET ocd_dmtbldoc->bld[bld_cnt].static_rows = 0
 SET ocd_dmtbldoc->bld[bld_cnt].updt_cnt = 5
 SET ocd_dmtbldoc->bld[bld_cnt].reference_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].human_reqd_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].drop_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].table_suffix = "9975"
 SET ocd_dmtbldoc->bld[bld_cnt].full_table_name = "AMY_TABLE2"
 SET ocd_dmtbldoc->bld[bld_cnt].suffixed_table_name = "AMY_TABLE29975"
 SET ocd_dmtbldoc->bld[bld_cnt].person_cmb_trigger_type = " "
 SET ocd_dmtbldoc->bld[bld_cnt].default_row_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].encntr_cmb_trigger_type = " "
 SET bld_cnt = (bld_cnt+ 1)
 SET ocd_dmtbldoc->bld[bld_cnt].table_name = "AMY_TABLE29975"
 SET ocd_dmtbldoc->bld[bld_cnt].data_model_section = "Test table 2 9975"
 SET ocd_dmtbldoc->bld[bld_cnt].description = "This is Amy test table 2 9975"
 SET ocd_dmtbldoc->bld[bld_cnt].definition = "Testing the translate load process IV"
 SET ocd_dmtbldoc->bld[bld_cnt].static_rows = 0
 SET ocd_dmtbldoc->bld[bld_cnt].updt_cnt = 5
 SET ocd_dmtbldoc->bld[bld_cnt].reference_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].human_reqd_ind = 0
 ...
 SET ocd_dmtbldoc->bld[bld_cnt].default_row_ind = 0
 SET ocd_dmtbldoc->bld[bld_cnt].encntr_cmb_trigger_type = " "
 SET stat = alterlist(ocd_dmtbldoc->bld,bld_cnt)
 SET size_ocd_dmtbldoc = size(ocd_dmtbldoc->bld,5)
 INSERT  FROM dmtbldoc bl,
   (dummyt d  WITH seq = size_ocd_dmtbldoc)
  SET bl.table_name = ocd_dmtbldoc->bld[d.seq].table_name, bl.data_model_section = ocd_dmtbldoc->bld[
   d.seq].data_model_section, bl.description = ocd_dmtbldoc->bld[d.seq].description,
   bl.definition = ocd_dmtbldoc->bld[d.seq].definition, bl.static_rows = ocd_dmtbldoc->bld[d.seq].
   static_rows, bl.updt_cnt = ocd_dmtbldoc->bld[d.seq].updt_cnt,
   bl.reference_ind = ocd_dmtbldoc->bld[d.seq].reference_ind, bl.human_reqd_ind = ocd_dmtbldoc->bld[d
   .seq].human_reqd_ind, bl.drop_ind = ocd_dmtbldoc->bld[d.seq].drop_ind,
   bl.suffixed_table_name = ocd_dmtbldoc->bld[d.seq].suffixed_table_name, bl.table_suffix =
   ocd_dmtbldoc->bld[d.seq].table_suffix, bl.full_table_name = ocd_dmtbldoc->bld[d.seq].
   full_table_name,
   bl.person_cmb_trigger_type = ocd_dmtbldoc->bld[d.seq].person_cmb_trigger_type, bl.default_row_ind
    = ocd_dmtbldoc->bld[d.seq].default_row_ind, bl.encntr_cmb_trigger_type = ocd_dmtbldoc->bld[d.seq]
   .encntr_cmb_trigger_type
  PLAN (d)
   JOIN (bl
   WHERE (ocd_dmtbldoc->bld[d.seq].table_name=bl.table_name))
  WITH nocounter, outerjoin = d, dontexist
 ;end insert
 FREE RECORD ocd_dmcoldoc
 RECORD ocd_dmcoldoc(
   1 dld[*]
     2 table_name = vc
     2 column_name = vc
 ...
 SET stat = alterlist(ocd_dmcoldoc->dld,30)
 SET dld_cnt = 0
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL1"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column one"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 1"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_attr = " "
 SET ocd_dmcoldoc->dld[dld_cnt].constant_value = " "
 SET ocd_dmcoldoc->dld[dld_cnt].parent_entity_col = " "
 SET ocd_dmcoldoc->dld[dld_cnt].exception_flg = 0
 SET ocd_dmcoldoc->dld[dld_cnt].defining_attribute_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].merge_updateable_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].nls_col_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].absolute_date_ind = 0
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL2"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column two"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 2"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL3"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column three"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 3"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL4"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column four"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 4"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL5"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column five"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 5"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL6"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column six"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 6"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL7"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column seven"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 7"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL8"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column eight"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 8"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL9"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column nine"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 9"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].absolute_date_ind = 0
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE19974"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL1"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column one"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 1A "
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column two"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 2A"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column three"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 3A"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column four"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 4A"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column five"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 5A "
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column six"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 6A"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column seven"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 7A"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column eight"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 8A"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column nine"
 SET ocd_dmcoldoc->dld[dld_cnt].definition = "Def 9A"
 SET ocd_dmcoldoc->dld[dld_cnt].flag_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].updt_cnt = 5
 SET ocd_dmcoldoc->dld[dld_cnt].unique_ident_ind = 1
 SET ocd_dmcoldoc->dld[dld_cnt].root_entity_name = " "
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].absolute_date_ind = 0
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL1"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column one"
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].absolute_date_ind = 0
 SET dld_cnt = (dld_cnt+ 1)
 SET ocd_dmcoldoc->dld[dld_cnt].table_name = "AMY_TABLE29975"
 SET ocd_dmcoldoc->dld[dld_cnt].column_name = "COL1"
 SET ocd_dmcoldoc->dld[dld_cnt].sequence_name = " "
 SET ocd_dmcoldoc->dld[dld_cnt].code_set = 0
 SET ocd_dmcoldoc->dld[dld_cnt].description = "Test column one"
 ...
 SET ocd_dmcoldoc->dld[dld_cnt].nls_col_ind = 0
 SET ocd_dmcoldoc->dld[dld_cnt].absolute_date_ind = 0
 SET stat = alterlist(ocd_dmcoldoc->dld,dld_cnt)
 SET size_ocd_dmcoldoc = size(ocd_dmcoldoc->dld,5)
 INSERT  FROM dmcoldoc dod,
   (dummyt d  WITH seq = size_ocd_dmcoldoc)
  SET dod.table_name = ocd_dmcoldoc->dld[d.seq].table_name, dod.column_name = ocd_dmcoldoc->dld[d.seq
   ].column_name, dod.sequence_name = ocd_dmcoldoc->dld[d.seq].sequence_name,
   dod.code_set = ocd_dmcoldoc->dld[d.seq].code_set, dod.description = ocd_dmcoldoc->dld[d.seq].
   description, dod.definition = ocd_dmcoldoc->dld[d.seq].definition,
   dod.flag_ind = ocd_dmcoldoc->dld[d.seq].flag_ind, dod.updt_cnt = ocd_dmcoldoc->dld[d.seq].updt_cnt,
   dod.unique_ident_ind = ocd_dmcoldoc->dld[d.seq].unique_ident_ind,
   dod.root_entity_name = ocd_dmcoldoc->dld[d.seq].root_entity_name, dod.root_entity_attr =
   ocd_dmcoldoc->dld[d.seq].root_entity_attr, dod.constant_value = ocd_dmcoldoc->dld[d.seq].
   constant_value,
   dod.parent_entity_col = ocd_dmcoldoc->dld[d.seq].parent_entity_col, dod.exception_flg =
   ocd_dmcoldoc->dld[d.seq].exception_flg, dod.defining_attribute_ind = ocd_dmcoldoc->dld[d.seq].
   defining_attribute_ind,
   dod.merge_updateable_ind = ocd_dmcoldoc->dld[d.seq].merge_updateable_ind, dod.nls_col_ind =
   ocd_dmcoldoc->dld[d.seq].nls_col_ind, dod.absolute_date_ind = ocd_dmcoldoc->dld[d.seq].
   absolute_date_ind
  PLAN (d)
   JOIN (dod
   WHERE (ocd_dmcoldoc->dld[d.seq].table_name=dod.table_name)
    AND (ocd_dmcoldoc->dld[d.seq].column_name=dod.column_name))
  WITH nocounter, outerjoin = d, dontexist
 ;end insert
 FREE RECORD ocd_dmtsprec
 RECORD ocd_dmtsprec(
   1 spr[*]
     2 table_name = vc
     2 precedence = i4
 ...
 SET stat = alterlist(ocd_dmtsprec->spr,4)
 SET spr_cnt = 0
 SET spr_cnt = (spr_cnt+ 1)
 SET ocd_dmtsprec->spr[spr_cnt].table_name = "AMY_TABLE1"
 SET ocd_dmtsprec->spr[spr_cnt].precedence = 1
 SET ocd_dmtsprec->spr[spr_cnt].data_tablespace = "D_A_SMALL"
 SET ocd_dmtsprec->spr[spr_cnt].data_extent_size = 163840
 SET ocd_dmtsprec->spr[spr_cnt].index_tablespace = "I_A_SMALL"
 SET ocd_dmtsprec->spr[spr_cnt].index_extent_size = 163840
 SET ocd_dmtsprec->spr[spr_cnt].long_tablespace = "D_A_SMALL"
 SET ocd_dmtsprec->spr[spr_cnt].long_extent_size = 163840
 SET ocd_dmtsprec->spr[spr_cnt].updt_cnt = 5
 SET spr_cnt = (spr_cnt+ 1)
 SET ocd_dmtsprec->spr[spr_cnt].table_name = "AMY_TABLE19974"
 SET ocd_dmtsprec->spr[spr_cnt].precedence = 1
 SET ocd_dmtsprec->spr[spr_cnt].data_tablespace = "D_A_SMALL"
 SET ocd_dmtsprec->spr[spr_cnt].data_extent_size = 163840
 SET ocd_dmtsprec->spr[spr_cnt].index_tablespace = "I_A_SMALL"
 ...
 SET ocd_dmtsprec->spr[spr_cnt].updt_cnt = 5
 SET spr_cnt = (spr_cnt+ 1)
 SET ocd_dmtsprec->spr[spr_cnt].table_name = "AMY_TABLE2"
 SET ocd_dmtsprec->spr[spr_cnt].precedence = 1
 SET ocd_dmtsprec->spr[spr_cnt].data_tablespace = "D_A_SMALL"
 SET ocd_dmtsprec->spr[spr_cnt].data_extent_size = 163840
 SET ocd_dmtsprec->spr[spr_cnt].index_tablespace = "I_A_SMALL"
 ...
 SET ocd_dmtsprec->spr[spr_cnt].updt_cnt = 5
 SET spr_cnt = (spr_cnt+ 1)
 SET ocd_dmtsprec->spr[spr_cnt].table_name = "AMY_TABLE29975"
 SET ocd_dmtsprec->spr[spr_cnt].precedence = 1
 SET ocd_dmtsprec->spr[spr_cnt].data_tablespace = "D_A_SMALL"
 SET ocd_dmtsprec->spr[spr_cnt].data_extent_size = 163840
 SET ocd_dmtsprec->spr[spr_cnt].index_tablespace = "I_A_SMALL"
 ...
 SET ocd_dmtsprec->spr[spr_cnt].long_extent_size = 163840
 SET ocd_dmtsprec->spr[spr_cnt].updt_cnt = 5
 SET stat = alterlist(ocd_dmtsprec->spr,spr_cnt)
 SET size_ocd_dmtsprec = size(ocd_dmtsprec->spr,5)
 INSERT  FROM dmtsprec s,
   (dummyt d  WITH seq = size_ocd_dmtsprec)
  SET s.table_name = ocd_dmtsprec->spr[d.seq].table_name, s.precedence = ocd_dmtsprec->spr[d.seq].
   precedence, s.data_tablespace = ocd_dmtsprec->spr[d.seq].data_tablespace,
   s.data_extent_size = ocd_dmtsprec->spr[d.seq].data_extent_size, s.index_tablespace = ocd_dmtsprec
   ->spr[d.seq].index_tablespace, s.index_extent_size = ocd_dmtsprec->spr[d.seq].index_extent_size,
   s.long_tablespace = ocd_dmtsprec->spr[d.seq].long_tablespace, s.long_extent_size = ocd_dmtsprec->
   spr[d.seq].long_extent_size, s.updt_cnt = ocd_dmtsprec->spr[d.seq].updt_cnt
  PLAN (d)
   JOIN (s
   WHERE (ocd_dmtsprec->spr[d.seq].table_name=s.table_name)
    AND (ocd_dmtsprec->spr[d.seq].precedence=s.precedence))
  WITH nocounter, outerjoin = d, dontexist
 ;end insert
