CREATE PROGRAM dm2_mig_stop_verify_data
 ...
 SUBROUTINE dm2_get_rdbms_version(null)
   ...
   RETURN(1)
 END ;Subroutine
 IF (check_logfile("dm2migvtblstp",".log","dm2_mig_stop_verify_data")=0)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_mig_stop_verify_data"
 CALL disp_msg(" ",dm_err->logfile,0)
 ...
 IF (curqual=0)
  ...
  ENDIF
  COMMIT
  SET dm_err->eproc = "Verify Data was Stopped"
  CALL disp_msg("",dm_err->logfile,0)
 ELSE
  SET dm_err->eproc = "Verify Data already Stopped"
  CALL disp_msg("",dm_err->logfile,0)
 ENDIF
#exit_program
 SET dm_err->eproc = "dm2_mig_stop_verify_data completed"
 CALL final_disp_msg("dm2migvtblstp")
END GO
