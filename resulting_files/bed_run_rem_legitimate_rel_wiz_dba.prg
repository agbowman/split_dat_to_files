CREATE PROGRAM bed_run_rem_legitimate_rel_wiz:dba
 ...
 END ;Subroutine
 SET readme_data->status = "F"
 SET readme_data->message = "Readme failed: starting script bed_run_rem_legitimate_rel_wiz..."
 DECLARE step_mean = vc WITH protect, constant("LEGITIMATERELATIONSHIPS")
