CREATE PROGRAM dd_set_feature_flag_cados:dba
 ...
 END ;Subroutine
 SET readme_data->status = "F"
 SET readme_data->message = concat("Error: Fail starting script dd_set_feature_flag_cados:",error_msg
  )
 CALL setfeatureflag("CHANGE_AUTHOR_DOS",onflag)
