CREATE PROGRAM dm2_drop_refchg_log_triggers:dba
 ...
 SUBROUTINE dir_get_admin_db_link(dgadl_report_fail_ind,dgadl_admin_db_link,dgadl_fail_ind)
   ...
   RETURN(1)
 END ;Subroutine
 DECLARE refchg_log_type = vc WITH constant("REFCHG")
 IF (check_logfile("dm2_refchg_drop_",".log","DM2REFCHG_DROP LOG FILE...") != 1)
  SET dm_err->err_ind = 1
  SET dm_err->emsg = "Unable to Create Log File"
  CALL disp_msg(dm_err->emsg,dm_err->logfile,1)
  GO TO exit_program
 ENDIF
 SET dm_err->eproc = "Starting dm2_drop_refchg_log_triggers..."
 CALL disp_msg("",dm_err->logfile,0)
 EXECUTE dm2_drop_chg_log_triggers "*", refchg_log_type
#exit_program
 SET dm_err->eproc = "...Ending dm2_drop_refchg_log_triggers"
 CALL final_disp_msg("dm2_refchg_drop_")
END GO
