CREATE PROGRAM bhs_syn_med_rec_query6_prod:dba
 ...
 DECLARE dme_cd = f8 WITH constant(uar_get_code_by("DISPLAYKEY",30254,"DURABLEMEDICALEQUIPMENT"))
 DECLARE disch_med_cd = f8 WITH constant(uar_get_code_by("DISPLAYKEY",30254,"DISCHARGEMED"))
 ...
 SELECT INTO "nl:"
  ...
  HEAD ocd.order_nbr
   IF (ocd.compliance_status_cd IN (not_taking_cd, still_as_prescribed_cd, dme_cd, disch_med_cd,
